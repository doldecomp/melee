...
/* 80325C18 003227F8  41 80 00 1C */	blt .L_80325C34
/* 80325C1C 003227FC  2C 1C 00 01 */	cmpwi r28, 1
/* 80325C20 00322800  41 82 00 14 */	beq .L_80325C34
/* 80325C24 00322804  2C 1C 00 24 */	cmpwi r28, 0x24
/* 80325C28 00322808  41 81 00 0C */	bgt .L_80325C34
/* 80325C2C 0032280C  2C 16 00 01 */	cmpwi r22, 1
/* 80325C30 00322810  40 80 00 0C */	bge .L_80325C3C
.L_80325C34:
/* 80325C34 00322814  3B 00 00 40 */	li r24, 0x40
/* 80325C38 00322818  48 00 00 24 */	b .L_80325C5C
.L_80325C3C:
...
/* 80325C60 00322840  41 82 00 0C */	beq .L_80325C6C
/* 80325C64 00322844  38 00 FF FF */	li r0, -1
/* 80325C68 00322848  7F 40 E3 96 */	divwu r26, r0, r28
.L_80325C6C:
/* 80325C6C 0032284C  3C 60 80 3C */	lis r3, __ctype_map@ha
/* 80325C70 00322850  3C 80 80 40 */	lis r4, MSL_StrToUl_80400728@ha
/* 80325C74 00322854  3B 23 8C 30 */	addi r25, r3, __ctype_map@l
/* 80325C78 00322858  3A 84 07 28 */	addi r20, r4, MSL_StrToUl_80400728@l
/* 80325C7C 0032285C  48 00 02 38 */	b MSL_StrToUl_80325EB4
.L_80325C80:
/* 80325C80 00322860  28 18 00 10 */	cmplwi r24, 0x10
/* 80325C84 00322864  41 81 02 30 */	bgt MSL_StrToUl_80325EB4
...
.global MSL_StrToUl_80325C98
MSL_StrToUl_80325C98:
...
/* 80325CA8 00322888  41 82 00 28 */	beq .L_80325CD0
...
/* 80325CCC 003228AC  48 00 01 E8 */	b MSL_StrToUl_80325EB4
.L_80325CD0:
/* 80325CD0 003228B0  2C 12 00 2B */	cmpwi r18, 0x2b
/* 80325CD4 003228B4  40 82 00 28 */	bne .L_80325CFC
...
/* 80325CF8 003228D8  48 00 00 34 */	b .L_80325D2C
.L_80325CFC:
/* 80325CFC 003228DC  2C 12 00 2D */	cmpwi r18, 0x2d
/* 80325D00 003228E0  40 82 00 2C */	bne .L_80325D2C
...
/* 80325D30 00322910  48 00 01 84 */	b MSL_StrToUl_80325EB4
.global MSL_StrToUl_80325D34
MSL_StrToUl_80325D34:
/* 80325D34 00322914  2C 1C 00 00 */	cmpwi r28, 0
/* 80325D38 00322918  41 82 00 0C */	beq .L_80325D44
/* 80325D3C 0032291C  2C 1C 00 10 */	cmpwi r28, 0x10
/* 80325D40 00322920  40 82 00 34 */	bne .L_80325D74
.L_80325D44:
/* 80325D44 00322924  2C 12 00 30 */	cmpwi r18, 0x30
/* 80325D48 00322928  40 82 00 2C */	bne .L_80325D74
...
/* 80325D70 00322950  48 00 01 44 */	b MSL_StrToUl_80325EB4
.L_80325D74:
/* 80325D74 00322954  3B 00 00 08 */	li r24, 8
/* 80325D78 00322958  48 00 01 3C */	b MSL_StrToUl_80325EB4
.global MSL_StrToUl_80325D7C
MSL_StrToUl_80325D7C:
/* 80325D7C 0032295C  2C 12 00 58 */	cmpwi r18, 0x58
/* 80325D80 00322960  41 82 00 0C */	beq .L_80325D8C
/* 80325D84 00322964  2C 12 00 78 */	cmpwi r18, 0x78
/* 80325D88 00322968  40 82 00 30 */	bne .L_80325DB8
.L_80325D8C:
...
/* 80325DB4 00322994  48 00 01 00 */	b MSL_StrToUl_80325EB4
.L_80325DB8:
/* 80325DB8 00322998  2C 1C 00 00 */	cmpwi r28, 0
/* 80325DBC 0032299C  40 82 00 08 */	bne .L_80325DC4
/* 80325DC0 003229A0  3B 80 00 08 */	li r28, 8
.L_80325DC4:
/* 80325DC4 003229A4  3B 00 00 10 */	li r24, 0x10
/* 80325DC8 003229A8  48 00 00 EC */	b MSL_StrToUl_80325EB4
.global MSL_StrToUl_80325DCC
MSL_StrToUl_80325DCC:
/* 80325DCC 003229AC  2C 1C 00 00 */	cmpwi r28, 0
/* 80325DD0 003229B0  40 82 00 08 */	bne .L_80325DD8
/* 80325DD4 003229B4  3B 80 00 0A */	li r28, 0xa
.L_80325DD8:
/* 80325DD8 003229B8  28 1A 00 00 */	cmplwi r26, 0
/* 80325DDC 003229BC  40 82 00 0C */	bne .L_80325DE8
...
/* 80325E3C 00322A1C  41 80 00 1C */	blt .L_80325E58
.L_80325E40:
/* 80325E40 00322A20  2C 18 00 10 */	cmpwi r24, 0x10
/* 80325E44 00322A24  40 82 00 0C */	bne .L_80325E50
/* 80325E48 00322A28  3B 00 00 20 */	li r24, 0x20
/* 80325E4C 00322A2C  48 00 00 68 */	b MSL_StrToUl_80325EB4
.L_80325E50:
/* 80325E50 00322A30  3B 00 00 40 */	li r24, 0x40
/* 80325E54 00322A34  48 00 00 60 */	b MSL_StrToUl_80325EB4
.L_80325E58:
...
/* 80325E68 00322A48  40 81 00 0C */	ble .L_80325E74
...
/* 80325E80 00322A60  40 81 00 0C */	ble .L_80325E8C
...
.global MSL_StrToUl_80325EB4
MSL_StrToUl_80325EB4:
/* 80325EB4 00322A94  7C 1F B0 00 */	cmpw r31, r22
/* 80325EB8 00322A98  41 81 00 14 */	bgt .L_80325ECC
/* 80325EBC 00322A9C  2C 12 FF FF */	cmpwi r18, -1
/* 80325EC0 00322AA0  41 82 00 0C */	beq .L_80325ECC
/* 80325EC4 00322AA4  57 00 06 75 */	rlwinm. r0, r24, 0, 0x19, 0x1a
/* 80325EC8 00322AA8  41 82 FD B8 */	beq .L_80325C80
.L_80325ECC:
/* 80325ECC 00322AAC  73 00 00 34 */	andi. r0, r24, 0x34
/* 80325ED0 00322AB0  40 82 00 10 */	bne .L_80325EE0
/* 80325ED4 00322AB4  3B 60 00 00 */	li r27, 0
/* 80325ED8 00322AB8  3B E0 00 00 */	li r31, 0
/* 80325EDC 00322ABC  48 00 00 08 */	b .L_80325EE4
.L_80325EE0:
...
.section .data
    .balign 8
.global MSL_StrToUl_80400728
MSL_StrToUl_80400728:
    .4byte MSL_StrToUl_80325EB4
    .4byte MSL_StrToUl_80325C98
    .4byte MSL_StrToUl_80325D34
    .4byte MSL_StrToUl_80325EB4
    .4byte MSL_StrToUl_80325D7C
    .4byte MSL_StrToUl_80325EB4
    .4byte MSL_StrToUl_80325EB4
    .4byte MSL_StrToUl_80325EB4
    .4byte MSL_StrToUl_80325DCC
    .4byte MSL_StrToUl_80325EB4
    .4byte MSL_StrToUl_80325EB4
    .4byte MSL_StrToUl_80325EB4
    .4byte MSL_StrToUl_80325EB4
