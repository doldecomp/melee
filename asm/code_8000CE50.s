...
/* 8000CE58 00009A38  C0 02 80 A8 */	lfs f0, lbl_804D7A88-_SDA2_BASE_(r2)
/* 8000CE5C 00009A3C  C0 C2 80 98 */	lfs f6, lbl_804D7A78-_SDA2_BASE_(r2)
...
lbl_8000CE78:
/* 8000CE78 00009A58  C0 02 80 98 */	lfs f0, lbl_804D7A78-_SDA2_BASE_(r2)
/* 8000CE7C 00009A5C  FC 80 08 90 */	fmr f4, f1
/* 8000CE80 00009A60  C8 42 80 A0 */	lfd f2, lbl_804D7A80-_SDA2_BASE_(r2)
...
/* 8000CECC 00009AAC  C0 02 80 98 */	lfs f0, lbl_804D7A78-_SDA2_BASE_(r2)
...
/* 8000CEEC 00009ACC  C0 02 80 A8 */	lfs f0, lbl_804D7A88-_SDA2_BASE_(r2)
...
lbl_8000CF00:
/* 8000CF00 00009AE0  C0 02 80 98 */	lfs f0, lbl_804D7A78-_SDA2_BASE_(r2)
/* 8000CF04 00009AE4  38 80 00 01 */	li r4, 1
/* 8000CF08 00009AE8  C8 62 80 A0 */	lfd f3, lbl_804D7A80-_SDA2_BASE_(r2)
...
/* 8000CF54 00009B34  C0 02 80 9C */	lfs f0, lbl_804D7A7C-_SDA2_BASE_(r2)
...
/* 8000D018 00009BF8  C0 02 80 C0 */	lfs f0, lbl_804D7AA0-_SDA2_BASE_(r2)
/* 8000D01C 00009BFC  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 8000D020 00009C00  40 80 00 18 */	bge lbl_8000D038
/* 8000D024 00009C04  C0 02 80 C4 */	lfs f0, lbl_804D7AA4-_SDA2_BASE_(r2)
...
/* 8000D044 00009C24  C0 02 80 C0 */	lfs f0, lbl_804D7AA0-_SDA2_BASE_(r2)
/* 8000D048 00009C28  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8000D04C 00009C2C  40 80 00 18 */	bge lbl_8000D064
/* 8000D050 00009C30  C0 02 80 C4 */	lfs f0, lbl_804D7AA4-_SDA2_BASE_(r2)
...
/* 8000D070 00009C50  C0 22 80 A8 */	lfs f1, lbl_804D7A88-_SDA2_BASE_(r2)
/* 8000D074 00009C54  48 00 00 C0 */	b lbl_8000D134
lbl_8000D078:
/* 8000D078 00009C58  C0 02 80 A8 */	lfs f0, lbl_804D7A88-_SDA2_BASE_(r2)
...
/* 8000D094 00009C74  C8 22 80 A0 */	lfd f1, lbl_804D7A80-_SDA2_BASE_(r2)
/* 8000D098 00009C78  90 01 00 14 */	stw r0, 0x14(r1)
/* 8000D09C 00009C7C  3C 00 43 30 */	lis r0, 0x4330
/* 8000D0A0 00009C80  C8 42 80 88 */	lfd f2, lbl_804D7A68-_SDA2_BASE_(r2)
...
lbl_8000D0BC:
/* 8000D0BC 00009C9C  C0 02 80 A8 */	lfs f0, lbl_804D7A88-_SDA2_BASE_(r2)
...
lbl_8000D0E8:
/* 8000D0E8 00009CC8  C0 02 80 A8 */	lfs f0, lbl_804D7A88-_SDA2_BASE_(r2)
...
/* 8000D10C 00009CEC  C8 02 80 90 */	lfd f0, lbl_804D7A70-_SDA2_BASE_(r2)
/* 8000D110 00009CF0  90 01 00 14 */	stw r0, 0x14(r1)
/* 8000D114 00009CF4  3C 00 43 30 */	lis r0, 0x4330
/* 8000D118 00009CF8  C8 42 80 A0 */	lfd f2, lbl_804D7A80-_SDA2_BASE_(r2)
...
/* 8000D160 00009D40  C1 42 80 C0 */	lfs f10, lbl_804D7AA0-_SDA2_BASE_(r2)
...
lbl_8000D180:
/* 8000D180 00009D60  C1 42 80 A8 */	lfs f10, lbl_804D7A88-_SDA2_BASE_(r2)
...
/* 8000D190 00009D70  C9 A2 80 B0 */	lfd f13, lbl_804D7A90-_SDA2_BASE_(r2)
/* 8000D194 00009D74  C9 82 80 B8 */	lfd f12, lbl_804D7A98-_SDA2_BASE_(r2)
...
/* 8000D1E4 00009DC4  C1 02 80 A8 */	lfs f8, lbl_804D7A88-_SDA2_BASE_(r2)
