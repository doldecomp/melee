...
/* 80351EE8 0034EAC8  80 0D BE 3C */	lwz r0, lbl_804D74DC@sda21(r13)
/* 80351EEC 0034EACC  28 00 00 00 */	cmplwi r0, 0
/* 80351EF0 0034EAD0  40 82 00 1C */	bne lbl_80351F0C
/* 80351EF4 0034EAD4  80 6D BE 30 */	lwz r3, lbl_804D74D0@sda21(r13)
/* 80351EF8 0034EAD8  28 03 00 00 */	cmplwi r3, 0
/* 80351EFC 0034EADC  41 82 00 10 */	beq lbl_80351F0C
/* 80351F00 0034EAE0  90 6D BE 3C */	stw r3, lbl_804D74DC@sda21(r13)
/* 80351F04 0034EAE4  80 03 00 00 */	lwz r0, 0(r3)
/* 80351F08 0034EAE8  90 0D BE 30 */	stw r0, lbl_804D74D0@sda21(r13)
lbl_80351F0C:
/* 80351F0C 0034EAEC  80 AD BE 3C */	lwz r5, lbl_804D74DC@sda21(r13)
...
/* 80351F1C 0034EAFC  80 0D BE 48 */	lwz r0, lbl_804D74E8@sda21(r13)
...
lbl_80351F50:
/* 80351F50 0034EB30  80 6D BE 3C */	lwz r3, lbl_804D74DC@sda21(r13)
/* 80351F54 0034EB34  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 80351F58 0034EB38  90 0D BE 44 */	stw r0, lbl_804D74E4@sda21(r13)
...
lbl_80351F90:
/* 80351F90 0034EB70  80 6D BE 3C */	lwz r3, lbl_804D74DC@sda21(r13)
/* 80351F94 0034EB74  80 8D BE 48 */	lwz r4, lbl_804D74E8@sda21(r13)
...
/* 80351FA4 0034EB84  80 8D BE 3C */	lwz r4, lbl_804D74DC@sda21(r13)
/* 80351FA8 0034EB88  80 0D BE 48 */	lwz r0, lbl_804D74E8@sda21(r13)
...
/* 80351FB8 0034EB98  80 8D BE 3C */	lwz r4, lbl_804D74DC@sda21(r13)
/* 80351FBC 0034EB9C  80 0D BE 48 */	lwz r0, lbl_804D74E8@sda21(r13)
...
/* 80351FEC 0034EBCC  81 8D BE 40 */	lwz r12, lbl_804D74E0@sda21(r13)
/* 80351FF0 0034EBD0  28 0C 00 00 */	cmplwi r12, 0
/* 80351FF4 0034EBD4  41 82 00 20 */	beq lbl_80352014
/* 80351FF8 0034EBD8  80 6D BE 38 */	lwz r3, lbl_804D74D8@sda21(r13)
/* 80351FFC 0034EBDC  7D 88 03 A6 */	mtlr r12
/* 80352000 0034EBE0  4E 80 00 21 */	blrl 
/* 80352004 0034EBE4  38 00 00 00 */	li r0, 0
/* 80352008 0034EBE8  90 0D BE 38 */	stw r0, lbl_804D74D8@sda21(r13)
/* 8035200C 0034EBEC  90 0D BE 40 */	stw r0, lbl_804D74E0@sda21(r13)
/* 80352010 0034EBF0  48 00 00 28 */	b lbl_80352038
lbl_80352014:
/* 80352014 0034EBF4  81 8D BE 44 */	lwz r12, lbl_804D74E4@sda21(r13)
/* 80352018 0034EBF8  28 0C 00 00 */	cmplwi r12, 0
/* 8035201C 0034EBFC  41 82 00 1C */	beq lbl_80352038
/* 80352020 0034EC00  80 6D BE 3C */	lwz r3, lbl_804D74DC@sda21(r13)
/* 80352024 0034EC04  7D 88 03 A6 */	mtlr r12
/* 80352028 0034EC08  4E 80 00 21 */	blrl 
/* 8035202C 0034EC0C  38 00 00 00 */	li r0, 0
/* 80352030 0034EC10  90 0D BE 3C */	stw r0, lbl_804D74DC@sda21(r13)
/* 80352034 0034EC14  90 0D BE 44 */	stw r0, lbl_804D74E4@sda21(r13)
lbl_80352038:
/* 80352038 0034EC18  80 CD BE 28 */	lwz r6, lbl_804D74C8@sda21(r13)
...
lbl_80352074:
/* 80352074 0034EC54  80 6D BE 28 */	lwz r3, lbl_804D74C8@sda21(r13)
/* 80352078 0034EC58  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 8035207C 0034EC5C  90 0D BE 40 */	stw r0, lbl_804D74E0@sda21(r13)
/* 80352080 0034EC60  90 6D BE 38 */	stw r3, lbl_804D74D8@sda21(r13)
/* 80352084 0034EC64  80 03 00 00 */	lwz r0, 0(r3)
/* 80352088 0034EC68  90 0D BE 28 */	stw r0, lbl_804D74C8@sda21(r13)
lbl_8035208C:
/* 8035208C 0034EC6C  80 0D BE 38 */	lwz r0, lbl_804D74D8@sda21(r13)
...
/* 803520BC 0034EC9C  80 0D BE 4C */	lwz r0, lbl_804D74EC@sda21(r13)
...
/* 803520D0 0034ECB0  93 ED BE 30 */	stw r31, lbl_804D74D0@sda21(r13)
/* 803520D4 0034ECB4  3C 60 80 35 */	lis r3, lbl_80351FE0@ha
/* 803520D8 0034ECB8  93 ED BE 28 */	stw r31, lbl_804D74C8@sda21(r13)
/* 803520DC 0034ECBC  38 63 1F E0 */	addi r3, r3, lbl_80351FE0@l
/* 803520E0 0034ECC0  90 0D BE 48 */	stw r0, lbl_804D74E8@sda21(r13)
/* 803520E4 0034ECC4  4B FF EB A9 */	bl func_80350C8C
/* 803520E8 0034ECC8  38 00 00 01 */	li r0, 1
/* 803520EC 0034ECCC  93 ED BE 38 */	stw r31, lbl_804D74D8@sda21(r13)
/* 803520F0 0034ECD0  93 ED BE 3C */	stw r31, lbl_804D74DC@sda21(r13)
/* 803520F4 0034ECD4  93 ED BE 40 */	stw r31, lbl_804D74E0@sda21(r13)
/* 803520F8 0034ECD8  93 ED BE 44 */	stw r31, lbl_804D74E4@sda21(r13)
/* 803520FC 0034ECDC  90 0D BE 4C */	stw r0, lbl_804D74EC@sda21(r13)
lbl_80352100:
...
lbl_8035218C:
/* 8035218C 0034ED6C  80 0D BE 30 */	lwz r0, lbl_804D74D0@sda21(r13)
/* 80352190 0034ED70  28 00 00 00 */	cmplwi r0, 0
/* 80352194 0034ED74  41 82 00 10 */	beq lbl_803521A4
/* 80352198 0034ED78  80 6D BE 34 */	lwz r3, lbl_804D74D4@sda21(r13)
/* 8035219C 0034ED7C  93 A3 00 00 */	stw r29, 0(r3)
/* 803521A0 0034ED80  48 00 00 08 */	b lbl_803521A8
lbl_803521A4:
/* 803521A4 0034ED84  93 AD BE 30 */	stw r29, lbl_804D74D0@sda21(r13)
lbl_803521A8:
/* 803521A8 0034ED88  93 AD BE 34 */	stw r29, lbl_804D74D4@sda21(r13)
/* 803521AC 0034ED8C  48 00 00 24 */	b lbl_803521D0
lbl_803521B0:
/* 803521B0 0034ED90  80 0D BE 28 */	lwz r0, lbl_804D74C8@sda21(r13)
/* 803521B4 0034ED94  28 00 00 00 */	cmplwi r0, 0
/* 803521B8 0034ED98  41 82 00 10 */	beq lbl_803521C8
/* 803521BC 0034ED9C  80 6D BE 2C */	lwz r3, lbl_804D74CC@sda21(r13)
/* 803521C0 0034EDA0  93 A3 00 00 */	stw r29, 0(r3)
/* 803521C4 0034EDA4  48 00 00 08 */	b lbl_803521CC
lbl_803521C8:
/* 803521C8 0034EDA8  93 AD BE 28 */	stw r29, lbl_804D74C8@sda21(r13)
lbl_803521CC:
/* 803521CC 0034EDAC  93 AD BE 2C */	stw r29, lbl_804D74CC@sda21(r13)
lbl_803521D0:
/* 803521D0 0034EDB0  80 0D BE 38 */	lwz r0, lbl_804D74D8@sda21(r13)
/* 803521D4 0034EDB4  28 00 00 00 */	cmplwi r0, 0
/* 803521D8 0034EDB8  40 82 00 74 */	bne lbl_8035224C
/* 803521DC 0034EDBC  80 0D BE 3C */	lwz r0, lbl_804D74DC@sda21(r13)
/* 803521E0 0034EDC0  28 00 00 00 */	cmplwi r0, 0
/* 803521E4 0034EDC4  40 82 00 68 */	bne lbl_8035224C
/* 803521E8 0034EDC8  80 CD BE 28 */	lwz r6, lbl_804D74C8@sda21(r13)
...
lbl_80352224:
/* 80352224 0034EE04  80 6D BE 28 */	lwz r3, lbl_804D74C8@sda21(r13)
/* 80352228 0034EE08  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 8035222C 0034EE0C  90 0D BE 40 */	stw r0, lbl_804D74E0@sda21(r13)
/* 80352230 0034EE10  90 6D BE 38 */	stw r3, lbl_804D74D8@sda21(r13)
/* 80352234 0034EE14  80 03 00 00 */	lwz r0, 0(r3)
/* 80352238 0034EE18  90 0D BE 28 */	stw r0, lbl_804D74C8@sda21(r13)
lbl_8035223C:
/* 8035223C 0034EE1C  80 0D BE 38 */	lwz r0, lbl_804D74D8@sda21(r13)
