...
/* 8033B7A0 00338380  80 6D A5 08 */	lwz r3, __GXDatas@sda21(r13)
/* 8033B7A4 00338384  A0 05 00 00 */	lhz r0, 0(r5)
/* 8033B7A8 00338388  90 03 00 0C */	stw r0, 0xc(r3)
/* 8033B7AC 0033838C  80 6D A5 08 */	lwz r3, __GXDatas@sda21(r13)
...
lbl_8033B7F0:
/* 8033B7F0 003383D0  80 6D A5 08 */	lwz r3, __GXDatas@sda21(r13)
...
lbl_8033B840:
/* 8033B840 00338420  80 6D A5 08 */	lwz r3, __GXDatas@sda21(r13)
...
/* 8033B868 00338448  80 8D A5 08 */	lwz r4, __GXDatas@sda21(r13)
...
# decl GXFifo.c
__GXFifoReadEnable:
/* 8033BC80 00338860  80 6D A5 08 */	lwz r3, __GXDatas@sda21(r13)
...
/* 8033BC94 00338874  80 8D A5 08 */	lwz r4, __GXDatas@sda21(r13)
...
# decl GXFifo.c
__GXFifoReadDisable:
/* 8033BCA8 00338888  80 6D A5 08 */	lwz r3, __GXDatas@sda21(r13)
...
/* 8033BCB8 00338898  80 8D A5 08 */	lwz r4, __GXDatas@sda21(r13)
...
lbl_8033BCE0:
/* 8033BCE0 003388C0  80 6D A5 08 */	lwz r3, __GXDatas@sda21(r13)
...
/* 8033BCFC 003388DC  80 8D A5 08 */	lwz r4, __GXDatas@sda21(r13)
...
/* 8033BD10 003388F0  80 AD A5 08 */	lwz r5, __GXDatas@sda21(r13)
...
/* 8033BD30 00338910  80 6D A5 08 */	lwz r3, __GXDatas@sda21(r13)
...
/* 8033BD48 00338928  80 8D A5 08 */	lwz r4, __GXDatas@sda21(r13)
...
/* 8033BD5C 0033893C  80 AD A5 08 */	lwz r5, __GXDatas@sda21(r13)
...
/* 8033BD7C 0033895C  80 6D A5 08 */	lwz r3, __GXDatas@sda21(r13)
...
/* 8033BD94 00338974  80 8D A5 08 */	lwz r4, __GXDatas@sda21(r13)
