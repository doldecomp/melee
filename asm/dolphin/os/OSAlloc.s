...
.global DLInsert
DLInsert:
/* 80343E44 00340A24  38 E3 00 00 */	addi r7, r3, 0
/* 80343E48 00340A28  38 C0 00 00 */	li r6, 0
/* 80343E4C 00340A2C  48 00 00 14 */	b lbl_80343E60
lbl_80343E50:
/* 80343E50 00340A30  7C 04 38 40 */	cmplw r4, r7
/* 80343E54 00340A34  40 81 00 14 */	ble lbl_80343E68
/* 80343E58 00340A38  7C E6 3B 78 */	mr r6, r7
/* 80343E5C 00340A3C  80 E7 00 04 */	lwz r7, 4(r7)
lbl_80343E60:
/* 80343E60 00340A40  28 07 00 00 */	cmplwi r7, 0
/* 80343E64 00340A44  40 82 FF EC */	bne lbl_80343E50
lbl_80343E68:
/* 80343E68 00340A48  90 E4 00 04 */	stw r7, 4(r4)
/* 80343E6C 00340A4C  28 07 00 00 */	cmplwi r7, 0
/* 80343E70 00340A50  90 C4 00 00 */	stw r6, 0(r4)
/* 80343E74 00340A54  41 82 00 38 */	beq lbl_80343EAC
/* 80343E78 00340A58  90 87 00 00 */	stw r4, 0(r7)
/* 80343E7C 00340A5C  80 A4 00 08 */	lwz r5, 8(r4)
/* 80343E80 00340A60  7C 04 2A 14 */	add r0, r4, r5
/* 80343E84 00340A64  7C 00 38 40 */	cmplw r0, r7
/* 80343E88 00340A68  40 82 00 24 */	bne lbl_80343EAC
/* 80343E8C 00340A6C  80 07 00 08 */	lwz r0, 8(r7)
/* 80343E90 00340A70  7C 05 02 14 */	add r0, r5, r0
/* 80343E94 00340A74  90 04 00 08 */	stw r0, 8(r4)
/* 80343E98 00340A78  80 E7 00 04 */	lwz r7, 4(r7)
/* 80343E9C 00340A7C  28 07 00 00 */	cmplwi r7, 0
/* 80343EA0 00340A80  90 E4 00 04 */	stw r7, 4(r4)
/* 80343EA4 00340A84  41 82 00 08 */	beq lbl_80343EAC
/* 80343EA8 00340A88  90 87 00 00 */	stw r4, 0(r7)
lbl_80343EAC:
/* 80343EAC 00340A8C  28 06 00 00 */	cmplwi r6, 0
/* 80343EB0 00340A90  41 82 00 38 */	beq lbl_80343EE8
/* 80343EB4 00340A94  90 86 00 04 */	stw r4, 4(r6)
/* 80343EB8 00340A98  80 A6 00 08 */	lwz r5, 8(r6)
/* 80343EBC 00340A9C  7C 06 2A 14 */	add r0, r6, r5
/* 80343EC0 00340AA0  7C 00 20 40 */	cmplw r0, r4
/* 80343EC4 00340AA4  4C 82 00 20 */	bnelr 
/* 80343EC8 00340AA8  80 04 00 08 */	lwz r0, 8(r4)
/* 80343ECC 00340AAC  28 07 00 00 */	cmplwi r7, 0
/* 80343ED0 00340AB0  7C 05 02 14 */	add r0, r5, r0
/* 80343ED4 00340AB4  90 06 00 08 */	stw r0, 8(r6)
/* 80343ED8 00340AB8  90 E6 00 04 */	stw r7, 4(r6)
/* 80343EDC 00340ABC  4D 82 00 20 */	beqlr 
/* 80343EE0 00340AC0  90 C7 00 00 */	stw r6, 0(r7)
/* 80343EE4 00340AC4  4E 80 00 20 */	blr 
lbl_80343EE8:
/* 80343EE8 00340AC8  7C 83 23 78 */	mr r3, r4
/* 80343EEC 00340ACC  4E 80 00 20 */	blr 

.global OSAllocFromHeap
OSAllocFromHeap:
/* 80343EF0 00340AD0  1C 03 00 0C */	mulli r0, r3, 0xc
/* 80343EF4 00340AD4  80 6D BC C0 */	lwz r3, HeapArray@sda21(r13)
/* 80343EF8 00340AD8  7C A3 02 14 */	add r5, r3, r0
/* 80343EFC 00340ADC  38 04 00 3F */	addi r0, r4, 0x3f
/* 80343F00 00340AE0  80 C5 00 04 */	lwz r6, 4(r5)
/* 80343F04 00340AE4  54 03 00 34 */	rlwinm r3, r0, 0, 0, 0x1a
/* 80343F08 00340AE8  48 00 00 14 */	b lbl_80343F1C
lbl_80343F0C:
/* 80343F0C 00340AEC  80 06 00 08 */	lwz r0, 8(r6)
/* 80343F10 00340AF0  7C 03 00 00 */	cmpw r3, r0
/* 80343F14 00340AF4  40 81 00 10 */	ble lbl_80343F24
/* 80343F18 00340AF8  80 C6 00 04 */	lwz r6, 4(r6)
lbl_80343F1C:
/* 80343F1C 00340AFC  28 06 00 00 */	cmplwi r6, 0
/* 80343F20 00340B00  40 82 FF EC */	bne lbl_80343F0C
lbl_80343F24:
/* 80343F24 00340B04  28 06 00 00 */	cmplwi r6, 0
/* 80343F28 00340B08  40 82 00 0C */	bne lbl_80343F34
/* 80343F2C 00340B0C  38 60 00 00 */	li r3, 0
/* 80343F30 00340B10  4E 80 00 20 */	blr 
lbl_80343F34:
/* 80343F34 00340B14  80 06 00 08 */	lwz r0, 8(r6)
/* 80343F38 00340B18  7C 03 00 50 */	subf r0, r3, r0
/* 80343F3C 00340B1C  28 00 00 40 */	cmplwi r0, 0x40
/* 80343F40 00340B20  40 80 00 40 */	bge lbl_80343F80
/* 80343F44 00340B24  80 86 00 04 */	lwz r4, 4(r6)
/* 80343F48 00340B28  80 65 00 04 */	lwz r3, 4(r5)
/* 80343F4C 00340B2C  28 04 00 00 */	cmplwi r4, 0
/* 80343F50 00340B30  41 82 00 0C */	beq lbl_80343F5C
/* 80343F54 00340B34  80 06 00 00 */	lwz r0, 0(r6)
/* 80343F58 00340B38  90 04 00 00 */	stw r0, 0(r4)
lbl_80343F5C:
/* 80343F5C 00340B3C  80 86 00 00 */	lwz r4, 0(r6)
/* 80343F60 00340B40  28 04 00 00 */	cmplwi r4, 0
/* 80343F64 00340B44  40 82 00 0C */	bne lbl_80343F70
/* 80343F68 00340B48  80 66 00 04 */	lwz r3, 4(r6)
/* 80343F6C 00340B4C  48 00 00 0C */	b lbl_80343F78
lbl_80343F70:
/* 80343F70 00340B50  80 06 00 04 */	lwz r0, 4(r6)
/* 80343F74 00340B54  90 04 00 04 */	stw r0, 4(r4)
lbl_80343F78:
/* 80343F78 00340B58  90 65 00 04 */	stw r3, 4(r5)
/* 80343F7C 00340B5C  48 00 00 48 */	b lbl_80343FC4
lbl_80343F80:
/* 80343F80 00340B60  90 66 00 08 */	stw r3, 8(r6)
/* 80343F84 00340B64  7C 86 1A 14 */	add r4, r6, r3
/* 80343F88 00340B68  90 04 00 08 */	stw r0, 8(r4)
/* 80343F8C 00340B6C  80 06 00 00 */	lwz r0, 0(r6)
/* 80343F90 00340B70  90 04 00 00 */	stw r0, 0(r4)
/* 80343F94 00340B74  80 06 00 04 */	lwz r0, 4(r6)
/* 80343F98 00340B78  90 04 00 04 */	stw r0, 4(r4)
/* 80343F9C 00340B7C  80 64 00 04 */	lwz r3, 4(r4)
/* 80343FA0 00340B80  28 03 00 00 */	cmplwi r3, 0
/* 80343FA4 00340B84  41 82 00 08 */	beq lbl_80343FAC
/* 80343FA8 00340B88  90 83 00 00 */	stw r4, 0(r3)
lbl_80343FAC:
/* 80343FAC 00340B8C  80 64 00 00 */	lwz r3, 0(r4)
/* 80343FB0 00340B90  28 03 00 00 */	cmplwi r3, 0
/* 80343FB4 00340B94  41 82 00 0C */	beq lbl_80343FC0
/* 80343FB8 00340B98  90 83 00 04 */	stw r4, 4(r3)
/* 80343FBC 00340B9C  48 00 00 08 */	b lbl_80343FC4
lbl_80343FC0:
/* 80343FC0 00340BA0  90 85 00 04 */	stw r4, 4(r5)
lbl_80343FC4:
/* 80343FC4 00340BA4  80 65 00 08 */	lwz r3, 8(r5)
/* 80343FC8 00340BA8  38 00 00 00 */	li r0, 0
/* 80343FCC 00340BAC  90 66 00 04 */	stw r3, 4(r6)
/* 80343FD0 00340BB0  28 03 00 00 */	cmplwi r3, 0
/* 80343FD4 00340BB4  90 06 00 00 */	stw r0, 0(r6)
/* 80343FD8 00340BB8  41 82 00 08 */	beq lbl_80343FE0
/* 80343FDC 00340BBC  90 C3 00 00 */	stw r6, 0(r3)
lbl_80343FE0:
/* 80343FE0 00340BC0  90 C5 00 08 */	stw r6, 8(r5)
/* 80343FE4 00340BC4  38 66 00 20 */	addi r3, r6, 0x20
/* 80343FE8 00340BC8  4E 80 00 20 */	blr 

.global OSFreeToHeap
OSFreeToHeap:
/* 80343FEC 00340BCC  7C 08 02 A6 */	mflr r0
/* 80343FF0 00340BD0  38 C4 FF E0 */	addi r6, r4, -32
/* 80343FF4 00340BD4  90 01 00 04 */	stw r0, 4(r1)
/* 80343FF8 00340BD8  1C 03 00 0C */	mulli r0, r3, 0xc
/* 80343FFC 00340BDC  94 21 FF E8 */	stwu r1, -0x18(r1)
/* 80344000 00340BE0  93 E1 00 14 */	stw r31, 0x14(r1)
/* 80344004 00340BE4  80 8D BC C0 */	lwz r4, HeapArray@sda21(r13)
/* 80344008 00340BE8  80 66 00 04 */	lwz r3, 4(r6)
/* 8034400C 00340BEC  7F E4 02 14 */	add r31, r4, r0
/* 80344010 00340BF0  28 03 00 00 */	cmplwi r3, 0
/* 80344014 00340BF4  80 BF 00 08 */	lwz r5, 8(r31)
/* 80344018 00340BF8  7C C4 33 78 */	mr r4, r6
/* 8034401C 00340BFC  41 82 00 0C */	beq lbl_80344028
/* 80344020 00340C00  80 04 00 00 */	lwz r0, 0(r4)
/* 80344024 00340C04  90 03 00 00 */	stw r0, 0(r3)
lbl_80344028:
/* 80344028 00340C08  80 64 00 00 */	lwz r3, 0(r4)
/* 8034402C 00340C0C  28 03 00 00 */	cmplwi r3, 0
/* 80344030 00340C10  40 82 00 0C */	bne lbl_8034403C
/* 80344034 00340C14  80 A4 00 04 */	lwz r5, 4(r4)
/* 80344038 00340C18  48 00 00 0C */	b lbl_80344044
lbl_8034403C:
/* 8034403C 00340C1C  80 04 00 04 */	lwz r0, 4(r4)
/* 80344040 00340C20  90 03 00 04 */	stw r0, 4(r3)
lbl_80344044:
/* 80344044 00340C24  90 BF 00 08 */	stw r5, 8(r31)
/* 80344048 00340C28  80 7F 00 04 */	lwz r3, 4(r31)
/* 8034404C 00340C2C  4B FF FD F9 */	bl DLInsert
/* 80344050 00340C30  90 7F 00 04 */	stw r3, 4(r31)
/* 80344054 00340C34  80 01 00 1C */	lwz r0, 0x1c(r1)
/* 80344058 00340C38  83 E1 00 14 */	lwz r31, 0x14(r1)
/* 8034405C 00340C3C  38 21 00 18 */	addi r1, r1, 0x18
/* 80344060 00340C40  7C 08 03 A6 */	mtlr r0
/* 80344064 00340C44  4E 80 00 20 */	blr 

.global func_80344068
func_80344068:
/* 80344068 00340C48  80 0D A5 68 */	lwz r0, __OSCurrHeap@sda21(r13)
/* 8034406C 00340C4C  90 6D A5 68 */	stw r3, __OSCurrHeap@sda21(r13)
/* 80344070 00340C50  7C 03 03 78 */	mr r3, r0
/* 80344074 00340C54  4E 80 00 20 */	blr 
