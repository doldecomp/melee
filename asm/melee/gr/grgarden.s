...
/* 80202BB4 001FF794  48 00 00 C5 */	bl grGarden_80202C78
/* 80202BB8 001FF798  38 60 00 04 */	li r3, 4
/* 80202BBC 001FF79C  48 00 00 BD */	bl grGarden_80202C78
/* 80202BC0 001FF7A0  38 60 00 05 */	li r3, 5
/* 80202BC4 001FF7A4  48 00 00 B5 */	bl grGarden_80202C78
/* 80202BC8 001FF7A8  38 60 00 06 */	li r3, 6
/* 80202BCC 001FF7AC  48 00 00 AD */	bl grGarden_80202C78
/* 80202BD0 001FF7B0  38 60 00 01 */	li r3, 1
/* 80202BD4 001FF7B4  48 00 00 A5 */	bl grGarden_80202C78
/* 80202BD8 001FF7B8  38 60 00 03 */	li r3, 3
/* 80202BDC 001FF7BC  48 00 00 9D */	bl grGarden_80202C78
/* 80202BE0 001FF7C0  38 60 00 02 */	li r3, 2
/* 80202BE4 001FF7C4  48 00 00 95 */	bl grGarden_80202C78
/* 80202BE8 001FF7C8  4B FC 0D D9 */	bl Ground_801C39C0
/* 80202BEC 001FF7CC  4B FC 0F C9 */	bl Ground_801C3BB4
/* 80202BF0 001FF7D0  48 02 25 A5 */	bl Stage_80225194
/* 80202BF4 001FF7D4  2C 03 00 3E */	cmpwi r3, 0x3e
/* 80202BF8 001FF7D8  41 82 00 1C */	beq .L_80202C14
/* 80202BFC 001FF7DC  4B F6 86 3D */	bl gm_8016B238
/* 80202C00 001FF7E0  2C 03 00 00 */	cmpwi r3, 0
/* 80202C04 001FF7E4  40 82 00 10 */	bne .L_80202C14
/* 80202C08 001FF7E8  3C 60 00 06 */	lis r3, 0x00064194@ha
/* 80202C0C 001FF7EC  38 63 41 94 */	addi r3, r3, 0x00064194@l
/* 80202C10 001FF7F0  4B FC 27 DD */	bl Ground_801C53EC
.L_80202C14:
...
/* 80202C38 001FF818  4B FC 27 B5 */	bl Ground_801C53EC
...
/* 80202C5C 001FF83C  4B FC 81 A9 */	bl grZakoGenerator_801CAE04
...
/* 80202C9C 001FF87C  3C 60 80 3E */	lis r3, grGd_803E5248@ha
/* 80202CA0 001FF880  3B E3 52 48 */	addi r31, r3, grGd_803E5248@l
/* 80202CA4 001FF884  38 7C 00 00 */	addi r3, r28, 0
/* 80202CA8 001FF888  7F BF 02 14 */	add r29, r31, r0
/* 80202CAC 001FF88C  4B FB E8 25 */	bl Ground_801C14D0
/* 80202CB0 001FF890  7C 7E 1B 79 */	or. r30, r3, r3
/* 80202CB4 001FF894  41 82 00 70 */	beq .L_80202D24
/* 80202CB8 001FF898  83 FE 00 2C */	lwz r31, 0x2c(r30)
/* 80202CBC 001FF89C  38 00 00 00 */	li r0, 0
/* 80202CC0 001FF8A0  3C 60 80 1C */	lis r3, grDisplay_801C5DB0@ha
/* 80202CC4 001FF8A4  90 1F 00 08 */	stw r0, 8(r31)
/* 80202CC8 001FF8A8  38 83 5D B0 */	addi r4, r3, grDisplay_801C5DB0@l
...
/* 80202CE8 001FF8C8  41 82 00 08 */	beq .L_80202CF0
...
/* 80202CF8 001FF8D8  41 82 00 10 */	beq .L_80202D08
...
/* 80202D10 001FF8F0  41 82 00 2C */	beq .L_80202D3C
/* 80202D14 001FF8F4  38 7E 00 00 */	addi r3, r30, 0
/* 80202D18 001FF8F8  38 A0 00 04 */	li r5, 4
/* 80202D1C 001FF8FC  48 18 D0 39 */	bl HSD_GObjProc_8038FD54
/* 80202D20 001FF900  48 00 00 1C */	b .L_80202D3C
.L_80202D24:
...
/* 80202D78 001FF958  4B FC 53 C1 */	bl grAnime_801C8138
...
/* 80202DEC 001FF9CC  4B FC 53 4D */	bl grAnime_801C8138
/* 80202DF0 001FF9D0  38 00 00 00 */	li r0, 0
/* 80202DF4 001FF9D4  90 1F 00 08 */	stw r0, 8(r31)
/* 80202DF8 001FF9D8  3C 60 80 20 */	lis r3, .L_80202D9C@ha
/* 80202DFC 001FF9DC  38 83 2D 9C */	addi r4, r3, .L_80202D9C@l
/* 80202E00 001FF9E0  90 1F 00 0C */	stw r0, 0xc(r31)
/* 80202E04 001FF9E4  7F C3 F3 78 */	mr r3, r30
/* 80202E08 001FF9E8  4B FB E2 B1 */	bl Ground_801C10B8
...
.global grGarden_80202E68
grGarden_80202E68:
/* 80202E68 001FFA48  4E 80 00 20 */	blr
.global grGarden_80202E6C
grGarden_80202E6C:
...
/* 80202E8C 001FFA6C  4B FC 52 AD */	bl grAnime_801C8138
...
/* 80202EB4 001FFA94  4B FC 10 F1 */	bl Ground_801C3FA4
...
/* 80202EC4 001FFAA4  4B FC 10 E1 */	bl Ground_801C3FA4
...
/* 80202ED4 001FFAB4  4B FC 10 D1 */	bl Ground_801C3FA4
...
/* 80202EE4 001FFAC4  4B FC 10 C1 */	bl Ground_801C3FA4
...
/* 80202EF4 001FFAD4  4B FC 10 B1 */	bl Ground_801C3FA4
...
/* 80202F04 001FFAE4  4B FC 10 A1 */	bl Ground_801C3FA4
...
/* 80202F1C 001FFAFC  4B FC 1F 55 */	bl Ground_801C4E70
...
/* 80202F60 001FFB40  4B FC 51 D9 */	bl grAnime_801C8138
...
/* 80202FC0 001FFBA0  4B FC 51 79 */	bl grAnime_801C8138
...
/* 80203028 001FFC08  80 6D B3 88 */	lwz r3, grGd_804D6A28@sda21(r13)
/* 8020302C 001FFC0C  80 63 00 08 */	lwz r3, 8(r3)
/* 80203030 001FFC10  2C 03 00 00 */	cmpwi r3, 0
/* 80203034 001FFC14  41 82 00 0C */	beq .L_80203040
/* 80203038 001FFC18  48 17 D5 49 */	bl HSD_Randi
/* 8020303C 001FFC1C  48 00 00 08 */	b .L_80203044
.L_80203040:
...
/* 80203058 001FFC38  4B FC 50 E1 */	bl grAnime_801C8138
...
/* 80203100 001FFCE0  40 81 00 0C */	ble .L_8020310C
...
/* 80203114 001FFCF4  40 82 00 2C */	bne .L_80203140
/* 80203118 001FFCF8  80 6D B3 88 */	lwz r3, grGd_804D6A28@sda21(r13)
/* 8020311C 001FFCFC  80 63 00 08 */	lwz r3, 8(r3)
/* 80203120 001FFD00  2C 03 00 00 */	cmpwi r3, 0
/* 80203124 001FFD04  41 82 00 0C */	beq .L_80203130
/* 80203128 001FFD08  48 17 D4 59 */	bl HSD_Randi
/* 8020312C 001FFD0C  48 00 00 08 */	b .L_80203134
.L_80203130:
...
/* 8020313C 001FFD1C  48 00 00 30 */	b .L_8020316C
.L_80203140:
/* 80203140 001FFD20  2C 00 00 02 */	cmpwi r0, 2
/* 80203144 001FFD24  40 82 00 28 */	bne .L_8020316C
/* 80203148 001FFD28  80 6D B3 88 */	lwz r3, grGd_804D6A28@sda21(r13)
/* 8020314C 001FFD2C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80203150 001FFD30  2C 03 00 00 */	cmpwi r3, 0
/* 80203154 001FFD34  41 82 00 0C */	beq .L_80203160
/* 80203158 001FFD38  48 17 D4 29 */	bl HSD_Randi
/* 8020315C 001FFD3C  48 00 00 08 */	b .L_80203164
.L_80203160:
...
/* 80203178 001FFD58  4B FC 4F C1 */	bl grAnime_801C8138
/* 8020317C 001FFD5C  48 00 00 0C */	b .L_80203188
.L_80203180:
...
.global grGarden_802031A0
grGarden_802031A0:
/* 802031A0 001FFD80  4E 80 00 20 */	blr
.global grGarden_802031A4
grGarden_802031A4:
...
/* 802031BC 001FFD9C  4B FC 0D E9 */	bl Ground_801C3FA4
/* 802031C0 001FFDA0  3C 80 80 20 */	lis r4, .L_80203498@ha
/* 802031C4 001FFDA4  38 E4 34 98 */	addi r7, r4, .L_80203498@l
...
/* 802031E0 001FFDC0  4B FC 5B 1D */	bl grMaterial_801C8CFC
/* 802031E4 001FFDC4  90 7F 00 C4 */	stw r3, 0xc4(r31)
/* 802031E8 001FFDC8  80 6D B3 88 */	lwz r3, grGd_804D6A28@sda21(r13)
/* 802031EC 001FFDCC  80 63 00 14 */	lwz r3, 0x14(r3)
/* 802031F0 001FFDD0  2C 03 00 00 */	cmpwi r3, 0
/* 802031F4 001FFDD4  41 82 00 0C */	beq .L_80203200
/* 802031F8 001FFDD8  48 17 D3 89 */	bl HSD_Randi
/* 802031FC 001FFDDC  48 00 00 08 */	b .L_80203204
.L_80203200:
/* 80203200 001FFDE0  38 60 00 00 */	li r3, 0
.L_80203204:
/* 80203204 001FFDE4  80 AD B3 88 */	lwz r5, grGd_804D6A28@sda21(r13)
...
/* 80203278 001FFE58  4B FC 0D 2D */	bl Ground_801C3FA4
...
/* 8020328C 001FFE6C  41 82 01 38 */	beq .L_802033C4
/* 80203290 001FFE70  40 80 01 E4 */	bge .L_80203474
/* 80203294 001FFE74  2C 00 00 00 */	cmpwi r0, 0
/* 80203298 001FFE78  40 80 00 08 */	bge .L_802032A0
/* 8020329C 001FFE7C  48 00 01 D8 */	b .L_80203474
.L_802032A0:
/* 802032A0 001FFE80  80 7F 00 CC */	lwz r3, 0xcc(r31)
/* 802032A4 001FFE84  2C 03 00 00 */	cmpwi r3, 0
/* 802032A8 001FFE88  40 82 01 10 */	bne .L_802033B8
/* 802032AC 001FFE8C  80 7F 00 C4 */	lwz r3, 0xc4(r31)
/* 802032B0 001FFE90  38 80 00 02 */	li r4, 2
/* 802032B4 001FFE94  38 A0 00 02 */	li r5, 2
/* 802032B8 001FFE98  48 06 5B A5 */	bl Item_80268E5C
...
/* 802032C8 001FFEA8  4B FC 4E 71 */	bl grAnime_801C8138
/* 802032CC 001FFEAC  80 6D B3 88 */	lwz r3, grGd_804D6A28@sda21(r13)
/* 802032D0 001FFEB0  C0 02 BD 38 */	lfs f0, grGd_804DB718@sda21(r2)
...
/* 802032E4 001FFEC4  40 80 00 08 */	bge .L_802032EC
...
/* 80203304 001FFEE4  41 82 00 0C */	beq .L_80203310
/* 80203308 001FFEE8  48 17 D2 79 */	bl HSD_Randi
/* 8020330C 001FFEEC  48 00 00 08 */	b .L_80203314
.L_80203310:
/* 80203310 001FFEF0  38 60 00 00 */	li r3, 0
.L_80203314:
/* 80203314 001FFEF4  6C 60 80 00 */	xoris r0, r3, 0x8000
/* 80203318 001FFEF8  C8 22 BD 40 */	lfd f1, grGd_804DB720@sda21(r2)
...
/* 80203338 001FFF18  40 82 00 14 */	bne .L_8020334C
/* 8020333C 001FFF1C  38 6D 91 08 */	addi r3, r13, grGd_804D47A8@sda21
/* 80203340 001FFF20  38 80 03 A4 */	li r4, 0x3a4
/* 80203344 001FFF24  38 AD 91 10 */	addi r5, r13, grGd_804D47B0@sda21
...
/* 80203358 001FFF38  40 82 00 4C */	bne .L_802033A4
/* 8020335C 001FFF3C  28 1E 00 00 */	cmplwi r30, 0
/* 80203360 001FFF40  41 82 00 44 */	beq .L_802033A4
/* 80203364 001FFF44  40 82 00 14 */	bne .L_80203378
/* 80203368 001FFF48  38 6D 91 08 */	addi r3, r13, grGd_804D47A8@sda21
/* 8020336C 001FFF4C  38 80 02 34 */	li r4, 0x234
/* 80203370 001FFF50  38 AD 91 10 */	addi r5, r13, grGd_804D47B0@sda21
...
/* 80203384 001FFF64  40 82 00 10 */	bne .L_80203394
/* 80203388 001FFF68  54 80 06 73 */	rlwinm. r0, r4, 0, 0x19, 0x19
/* 8020338C 001FFF6C  41 82 00 08 */	beq .L_80203394
/* 80203390 001FFF70  38 60 00 01 */	li r3, 1
.L_80203394:
/* 80203394 001FFF74  2C 03 00 00 */	cmpwi r3, 0
/* 80203398 001FFF78  40 82 00 0C */	bne .L_802033A4
...
/* 80203530 00200110  C0 02 BD 38 */	lfs f0, grGd_804DB718@sda21(r2)
/* 80203534 00200114  D0 1F 00 04 */	stfs f0, 4(r31)
/* 80203538 00200118  D0 1F 00 08 */	stfs f0, 8(r31)
/* 8020353C 0020011C  48 00 00 08 */	b .L_80203544
.L_80203540:
...
/* 80203580 00200160  4B FC 61 79 */	bl grLib_801C96F8
/* 80203584 00200164  28 03 00 00 */	cmplwi r3, 0
/* 80203588 00200168  41 82 00 2C */	beq .L_802035B4
...
/* 802035F0 002001D0  4B E0 7B DD */	bl lb_8000B1CC
...
/* 80203600 002001E0  40 81 00 0C */	ble .L_8020360C
/* 80203604 002001E4  38 60 00 01 */	li r3, 1
/* 80203608 002001E8  48 00 00 08 */	b .L_80203610
.L_8020360C:
...
.global grGarden_80203624
grGarden_80203624:
/* 80203624 00200204  C0 22 BD 50 */	lfs f1, grGd_804DB730@sda21(r2)
/* 80203628 00200208  4E 80 00 20 */	blr


.section .data
    .balign 8
.global grGd_803E5248
grGd_803E5248:
    .4byte grGarden_80202D60
    .4byte grGarden_80202D8C
    .4byte grGarden_80202D94
    .4byte grGarden_80202D98
    .4byte NULL
    .4byte grGarden_80203004
    .4byte grGarden_80203090
    .4byte grGarden_80203098
    .4byte grGarden_802031A0
    .4byte NULL
    .4byte grGarden_80202DC8
    .4byte grGarden_80202E40
    .4byte grGarden_80202E48
    .4byte grGarden_80202E68
    .4byte 0xC0000000
    .4byte grGarden_802031A4
    .4byte grGarden_80203248
    .4byte grGarden_80203250
    .4byte grGarden_80203494
    .4byte NULL
    .4byte grGarden_80202E6C
    .4byte grGarden_80202F34
    .4byte grGarden_80202F3C
    .4byte grGarden_80202F40
    .4byte NULL
    .4byte grGarden_80202F44
    .4byte grGarden_80202F94
    .4byte grGarden_80202F9C
    .4byte grGarden_80202FA0
    .4byte NULL
    .4byte grGarden_80202FA4
    .4byte grGarden_80202FF4
    .4byte grGarden_80202FFC
    .4byte grGarden_80203000
    .4byte NULL
.global grGd_803E52D4
grGd_803E52D4:
    .asciz "/GrGd.dat"
    .balign 4
.global grGd_803E52E0
grGd_803E52E0:
    .4byte 0x00000005
    .4byte grGd_803E5248
    .4byte grGd_803E52D4
    .4byte grGarden_80202B70
    .4byte grGarden_80202B6C
    .4byte grGarden_80202C24
    .4byte grGarden_80202C4C
    .4byte grGarden_80202C70
    .4byte grGarden_802035C8
    .4byte grGarden_802035D0
    .4byte 0x00000001
    .4byte NULL
    .4byte NULL
...
.section .sdata
    .balign 8
.global grGd_804D47A8
grGd_804D47A8:
    .asciz "jobj.h"
    .balign 4
.global grGd_804D47B0
grGd_804D47B0:
    .asciz "jobj"
    .balign 4
...
.section .sdata2
    .balign 8
.global grGd_804DB718
grGd_804DB718:
    .4byte 0x00000000
    .4byte 0x00000000
.global grGd_804DB720
grGd_804DB720:
    .4byte 0x43300000
    .4byte 0x80000000
.global grGd_804DB728
grGd_804DB728:
    .4byte 0x41200000
.global grGd_804DB72C
grGd_804DB72C:
    .4byte 0xC1F00000
.global grGd_804DB730
grGd_804DB730:
    .4byte 0xC1A00000
    .4byte 0x00000000
