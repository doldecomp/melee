...
/* 80202BF8 001FF7D8  41 82 00 1C */	beq grGarden_80202C14
/* 80202BFC 001FF7DC  4B F6 86 3D */	bl gm_8016B238
/* 80202C00 001FF7E0  2C 03 00 00 */	cmpwi r3, 0
/* 80202C04 001FF7E4  40 82 00 10 */	bne grGarden_80202C14
...
/* 80202CB4 001FF894  41 82 00 70 */	beq grGarden_80202D24
...
/* 80202CE8 001FF8C8  41 82 00 08 */	beq grGarden_80202CF0
...
/* 80202CF8 001FF8D8  41 82 00 10 */	beq grGarden_80202D08
...
/* 80202D10 001FF8F0  41 82 00 2C */	beq grGarden_80202D3C
...
/* 80202D20 001FF900  48 00 00 1C */	b grGarden_80202D3C
grGarden_80202D24:
...
/* 80202DA0 001FF980  3C 80 80 20 */	lis r4, grGarden_8020349C@ha
/* 80202DA4 001FF984  90 01 00 04 */	stw r0, 4(r1)
/* 80202DA8 001FF988  38 A4 34 9C */	addi r5, r4, grGarden_8020349C@l
...
/* 80202DF8 001FF9D8  3C 60 80 20 */	lis r3, grGarden_80202D9C@ha
/* 80202DFC 001FF9DC  38 83 2D 9C */	addi r4, r3, grGarden_80202D9C@l
...
/* 80203034 001FFC14  41 82 00 0C */	beq grGarden_80203040
/* 80203038 001FFC18  48 17 D5 49 */	bl HSD_Randi
/* 8020303C 001FFC1C  48 00 00 08 */	b grGarden_80203044
grGarden_80203040:
...
/* 802030C4 001FFCA4  40 82 00 1C */	bne grGarden_802030E0
...
/* 802030DC 001FFCBC  41 82 00 AC */	beq grGarden_80203188
grGarden_802030E0:
/* 802030E0 001FFCC0  80 7F 00 C8 */	lwz r3, 0xc8(r31)
/* 802030E4 001FFCC4  2C 03 00 00 */	cmpwi r3, 0
/* 802030E8 001FFCC8  40 82 00 98 */	bne grGarden_80203180
...
/* 80203100 001FFCE0  40 81 00 0C */	ble grGarden_8020310C
...
/* 80203114 001FFCF4  40 82 00 2C */	bne grGarden_80203140
...
/* 80203124 001FFD04  41 82 00 0C */	beq grGarden_80203130
/* 80203128 001FFD08  48 17 D4 59 */	bl HSD_Randi
/* 8020312C 001FFD0C  48 00 00 08 */	b grGarden_80203134
grGarden_80203130:
...
/* 8020313C 001FFD1C  48 00 00 30 */	b grGarden_8020316C
grGarden_80203140:
/* 80203140 001FFD20  2C 00 00 02 */	cmpwi r0, 2
/* 80203144 001FFD24  40 82 00 28 */	bne grGarden_8020316C
...
/* 80203154 001FFD34  41 82 00 0C */	beq grGarden_80203160
/* 80203158 001FFD38  48 17 D4 29 */	bl HSD_Randi
/* 8020315C 001FFD3C  48 00 00 08 */	b grGarden_80203164
grGarden_80203160:
...
/* 8020317C 001FFD5C  48 00 00 0C */	b grGarden_80203188
grGarden_80203180:
...
/* 802031C0 001FFDA0  3C 80 80 20 */	lis r4, grGarden_80203498@ha
/* 802031C4 001FFDA4  38 E4 34 98 */	addi r7, r4, grGarden_80203498@l
...
/* 802031F4 001FFDD4  41 82 00 0C */	beq grGarden_80203200
/* 802031F8 001FFDD8  48 17 D3 89 */	bl HSD_Randi
/* 802031FC 001FFDDC  48 00 00 08 */	b grGarden_80203204
grGarden_80203200:
...
/* 8020328C 001FFE6C  41 82 01 38 */	beq grGarden_802033C4
/* 80203290 001FFE70  40 80 01 E4 */	bge grGarden_80203474
/* 80203294 001FFE74  2C 00 00 00 */	cmpwi r0, 0
/* 80203298 001FFE78  40 80 00 08 */	bge grGarden_802032A0
/* 8020329C 001FFE7C  48 00 01 D8 */	b grGarden_80203474
grGarden_802032A0:
/* 802032A0 001FFE80  80 7F 00 CC */	lwz r3, 0xcc(r31)
/* 802032A4 001FFE84  2C 03 00 00 */	cmpwi r3, 0
/* 802032A8 001FFE88  40 82 01 10 */	bne grGarden_802033B8
...
/* 802032E4 001FFEC4  40 80 00 08 */	bge grGarden_802032EC
...
/* 80203304 001FFEE4  41 82 00 0C */	beq grGarden_80203310
/* 80203308 001FFEE8  48 17 D2 79 */	bl HSD_Randi
/* 8020330C 001FFEEC  48 00 00 08 */	b grGarden_80203314
grGarden_80203310:
...
/* 80203338 001FFF18  40 82 00 14 */	bne grGarden_8020334C
...
/* 80203358 001FFF38  40 82 00 4C */	bne grGarden_802033A4
/* 8020335C 001FFF3C  28 1E 00 00 */	cmplwi r30, 0
/* 80203360 001FFF40  41 82 00 44 */	beq grGarden_802033A4
/* 80203364 001FFF44  40 82 00 14 */	bne grGarden_80203378
...
/* 80203384 001FFF64  40 82 00 10 */	bne grGarden_80203394
/* 80203388 001FFF68  54 80 06 73 */	rlwinm. r0, r4, 0, 0x19, 0x19
/* 8020338C 001FFF6C  41 82 00 08 */	beq grGarden_80203394
/* 80203390 001FFF70  38 60 00 01 */	li r3, 1
grGarden_80203394:
/* 80203394 001FFF74  2C 03 00 00 */	cmpwi r3, 0
/* 80203398 001FFF78  40 82 00 0C */	bne grGarden_802033A4
...
/* 802033E4 001FFFC4  48 00 00 20 */	b grGarden_80203404
grGarden_802033E8:
/* 802033E8 001FFFC8  2C 00 00 6E */	cmpwi r0, 0x6e
/* 802033EC 001FFFCC  41 82 00 0C */	beq grGarden_802033F8
/* 802033F0 001FFFD0  2C 00 00 D2 */	cmpwi r0, 0xd2
/* 802033F4 001FFFD4  40 82 00 10 */	bne grGarden_80203404
grGarden_802033F8:
...
/* 80203418 001FFFF8  41 82 00 50 */	beq grGarden_80203468
...
/* 80203440 00200020  41 82 00 0C */	beq grGarden_8020344C
/* 80203444 00200024  48 17 D1 3D */	bl HSD_Randi
/* 80203448 00200028  48 00 00 08 */	b grGarden_80203450
grGarden_8020344C:
...
/* 802034E4 002000C4  40 80 00 5C */	bge grGarden_80203540
/* 802034E8 002000C8  C0 01 00 18 */	lfs f0, 0x18(r1)
/* 802034EC 002000CC  FC 00 F8 40 */	fcmpo cr0, f0, f31
/* 802034F0 002000D0  40 81 00 30 */	ble grGarden_80203520
...
/* 8020353C 0020011C  48 00 00 08 */	b grGarden_80203544
grGarden_80203540:
...
/* 80203588 00200168  41 82 00 2C */	beq grGarden_802035B4
...
/* 80203600 002001E0  40 81 00 0C */	ble grGarden_8020360C
/* 80203604 002001E4  38 60 00 01 */	li r3, 1
/* 80203608 002001E8  48 00 00 08 */	b grGarden_80203610
grGarden_8020360C:
