...
/* 8021EF4C 0021BB2C  3C 80 80 4A */	lis r4, lbl_8049E6C8@ha
/* 8021EF50 0021BB30  90 6D B4 50 */	stw r3, lbl_804D6AF0-_SDA_BASE_(r13)
/* 8021EF54 0021BB34  38 64 E6 C8 */	addi r3, r4, lbl_8049E6C8@l
...
/* 8021EFA0 0021BB80  C0 02 C2 B8 */	lfs f0, lbl_804DBC98-_SDA2_BASE_(r2)
...
/* 8021F054 0021BC34  48 17 16 49 */	bl func_8039069C
...
/* 8021F10C 0021BCEC  3B CD 93 38 */	addi r30, r13, lbl_804D49D8-_SDA_BASE_
...
lbl_8021F144:
/* 8021F144 0021BD24  80 6D B4 50 */	lwz r3, lbl_804D6AF0-_SDA_BASE_(r13)
...
/* 8021F1A4 0021BD84  80 6D B4 50 */	lwz r3, lbl_804D6AF0-_SDA_BASE_(r13)
...
/* 8021F490 0021C070  C0 22 C2 BC */	lfs f1, lbl_804DBC9C-_SDA2_BASE_(r2)
/* 8021F494 0021C074  C0 42 C2 C0 */	lfs f2, lbl_804DBCA0-_SDA2_BASE_(r2)
...
/* 8021F524 0021C104  38 AD 93 40 */	addi r5, r13, lbl_804D49E0-_SDA_BASE_
...
/* 8021F540 0021C120  C8 22 C2 C8 */	lfd f1, lbl_804DBCA8-_SDA2_BASE_(r2)
/* 8021F544 0021C124  90 01 00 1C */	stw r0, 0x1c(r1)
/* 8021F548 0021C128  3C 00 43 30 */	lis r0, 0x4330
/* 8021F54C 0021C12C  C0 42 C2 C4 */	lfs f2, lbl_804DBCA4-_SDA2_BASE_(r2)
...
/* 8021F664 0021C244  38 AD 93 40 */	addi r5, r13, lbl_804D49E0-_SDA_BASE_
...
/* 8021F680 0021C260  C8 22 C2 C8 */	lfd f1, lbl_804DBCA8-_SDA2_BASE_(r2)
/* 8021F684 0021C264  90 01 00 1C */	stw r0, 0x1c(r1)
/* 8021F688 0021C268  3C 00 43 30 */	lis r0, 0x4330
/* 8021F68C 0021C26C  C0 42 C2 C4 */	lfs f2, lbl_804DBCA4-_SDA2_BASE_(r2)
