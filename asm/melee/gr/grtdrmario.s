...
.global grTDonkey_8022050C
grTDonkey_8022050C:
/* 8022050C 0021D0EC  4E 80 00 20 */	blr
.global grTDonkey_80220510
grTDonkey_80220510:
...
/* 8022054C 0021D12C  48 00 00 65 */	bl grTDonkey_802205B0
/* 80220550 0021D130  38 60 00 01 */	li r3, 1
/* 80220554 0021D134  48 00 00 5D */	bl grTDonkey_802205B0
/* 80220558 0021D138  38 60 00 02 */	li r3, 2
/* 8022055C 0021D13C  48 00 00 55 */	bl grTDonkey_802205B0
/* 80220560 0021D140  4B FA 34 61 */	bl Ground_801C39C0
/* 80220564 0021D144  4B FA 36 51 */	bl Ground_801C3BB4
/* 80220568 0021D148  4B FA 3C A9 */	bl Ground_801C4210
/* 8022056C 0021D14C  4B FA 3D 41 */	bl Ground_801C42AC
...
.global grTDonkey_80220580
grTDonkey_80220580:
/* 80220580 0021D160  4E 80 00 20 */	blr
.global grTDonkey_80220584
grTDonkey_80220584:
...
/* 80220594 0021D174  4B FA A8 71 */	bl grZakoGenerator_801CAE04
...
/* 802205EC 0021D1CC  41 82 00 70 */	beq grTDonkey_8022065C
/* 802205F0 0021D1D0  83 FE 00 2C */	lwz r31, 0x2c(r30)
/* 802205F4 0021D1D4  38 00 00 00 */	li r0, 0
/* 802205F8 0021D1D8  3C 60 80 1C */	lis r3, grDisplay_801C5DB0@ha
/* 802205FC 0021D1DC  90 1F 00 08 */	stw r0, 8(r31)
/* 80220600 0021D1E0  38 83 5D B0 */	addi r4, r3, grDisplay_801C5DB0@l
...
/* 80220620 0021D200  41 82 00 08 */	beq grTDonkey_80220628
...
/* 80220630 0021D210  41 82 00 10 */	beq grTDonkey_80220640
...
/* 80220648 0021D228  41 82 00 2C */	beq grTDonkey_80220674
...
/* 80220658 0021D238  48 00 00 1C */	b grTDonkey_80220674
grTDonkey_8022065C:
...
/* 802206B0 0021D290  4B FA 7A 89 */	bl grAnime_801C8138
...
/* 802206F8 0021D2D8  4B FA 27 D9 */	bl Ground_801C2ED0
...
/* 80220708 0021D2E8  4B FA 7A 31 */	bl grAnime_801C8138
...
/* 80220740 0021D320  4B DF 0E B5 */	bl lb_800115F4
/* 80220744 0021D324  7F E3 FB 78 */	mr r3, r31
/* 80220748 0021D328  4B FA 28 99 */	bl Ground_801C2FE0
...
.global grTDonkey_80220760
grTDonkey_80220760:
/* 80220760 0021D340  4E 80 00 20 */	blr
.global grTDonkey_80220764
grTDonkey_80220764:
...
/* 80220788 0021D368  4B FA 27 49 */	bl Ground_801C2ED0
...
/* 80220798 0021D378  4B FA 79 A1 */	bl grAnime_801C8138
...
lbl_803E8850:
    ...
    .4byte grTDonkey_802206D0
    .4byte NULL
    .4byte grTDonkey_80220764
    .4byte grTDonkey_802207B4
    .4byte grTDonkey_802207BC
    .4byte grTDonkey_802207DC
    .4byte NULL
    .4byte grTDonkey_802206D4
    .4byte grTDonkey_80220724
    .4byte grTDonkey_8022072C
    .4byte grTDonkey_80220760
    .4byte 0xC0000000
    .4byte NULL
    .4byte NULL
    .4byte NULL
...
lbl_803E88AC:
    ...
    .4byte grTDonkey_80220584
    .4byte grTDonkey_802205A8
    .4byte grTDonkey_802207E0
    .4byte grTDonkey_802207E8
    .4byte 0x00000001
    .4byte NULL
    .4byte NULL
