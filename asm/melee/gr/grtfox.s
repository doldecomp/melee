...
/* 80220BC8 0021D7A8  48 00 00 65 */	bl grTFalco_80220C2C
/* 80220BCC 0021D7AC  38 60 00 01 */	li r3, 1
/* 80220BD0 0021D7B0  48 00 00 5D */	bl grTFalco_80220C2C
/* 80220BD4 0021D7B4  38 60 00 02 */	li r3, 2
/* 80220BD8 0021D7B8  48 00 00 55 */	bl grTFalco_80220C2C
/* 80220BDC 0021D7BC  4B FA 2D E5 */	bl Ground_801C39C0
/* 80220BE0 0021D7C0  4B FA 2F D5 */	bl Ground_801C3BB4
/* 80220BE4 0021D7C4  4B FA 36 2D */	bl Ground_801C4210
/* 80220BE8 0021D7C8  4B FA 36 C5 */	bl Ground_801C42AC
...
.global grTFalco_80220BFC
grTFalco_80220BFC:
/* 80220BFC 0021D7DC  4E 80 00 20 */	blr
.global grTFalco_80220C00
grTFalco_80220C00:
...
/* 80220C10 0021D7F0  4B FA A1 F5 */	bl grZakoGenerator_801CAE04
...
/* 80220C50 0021D830  3C 60 80 3F */	lis r3, grTFx_803E89D8@ha
/* 80220C54 0021D834  3B E3 89 D8 */	addi r31, r3, grTFx_803E89D8@l
/* 80220C58 0021D838  38 7C 00 00 */	addi r3, r28, 0
/* 80220C5C 0021D83C  7F BF 02 14 */	add r29, r31, r0
/* 80220C60 0021D840  4B FA 08 71 */	bl Ground_801C14D0
/* 80220C64 0021D844  7C 7E 1B 79 */	or. r30, r3, r3
/* 80220C68 0021D848  41 82 00 70 */	beq .L_80220CD8
/* 80220C6C 0021D84C  83 FE 00 2C */	lwz r31, 0x2c(r30)
/* 80220C70 0021D850  38 00 00 00 */	li r0, 0
/* 80220C74 0021D854  3C 60 80 1C */	lis r3, grDisplay_801C5DB0@ha
/* 80220C78 0021D858  90 1F 00 08 */	stw r0, 8(r31)
/* 80220C7C 0021D85C  38 83 5D B0 */	addi r4, r3, grDisplay_801C5DB0@l
...
/* 80220C9C 0021D87C  41 82 00 08 */	beq .L_80220CA4
...
/* 80220CAC 0021D88C  41 82 00 10 */	beq .L_80220CBC
...
/* 80220CC4 0021D8A4  41 82 00 2C */	beq .L_80220CF0
/* 80220CC8 0021D8A8  38 7E 00 00 */	addi r3, r30, 0
/* 80220CCC 0021D8AC  38 A0 00 04 */	li r5, 4
/* 80220CD0 0021D8B0  48 16 F0 85 */	bl HSD_GObjProc_8038FD54
/* 80220CD4 0021D8B4  48 00 00 1C */	b .L_80220CF0
.L_80220CD8:
...
/* 80220D2C 0021D90C  4B FA 74 0D */	bl grAnime_801C8138
...
/* 80220D74 0021D954  4B FA 21 5D */	bl Ground_801C2ED0
...
/* 80220D84 0021D964  4B FA 73 B5 */	bl grAnime_801C8138
...
/* 80220DBC 0021D99C  4B DF 08 39 */	bl lb_800115F4
/* 80220DC0 0021D9A0  7F E3 FB 78 */	mr r3, r31
/* 80220DC4 0021D9A4  4B FA 22 1D */	bl Ground_801C2FE0
...
.global grTFalco_80220DDC
grTFalco_80220DDC:
/* 80220DDC 0021D9BC  4E 80 00 20 */	blr
.global grTFalco_80220DE0
grTFalco_80220DE0:
...
/* 80220E04 0021D9E4  4B FA 20 CD */	bl Ground_801C2ED0
...
/* 80220E14 0021D9F4  4B FA 73 25 */	bl grAnime_801C8138
...
.global grTFalco_80220E58
grTFalco_80220E58:
/* 80220E58 0021DA38  4E 80 00 20 */	blr
.global grTFalco_80220E5C
grTFalco_80220E5C:
...
/* 80220E74 0021DA54  41 82 00 7C */	beq .L_80220EF0
/* 80220E78 0021DA58  7F E3 FB 78 */	mr r3, r31
/* 80220E7C 0021DA5C  4B E3 5C F1 */	bl mpLib_80056B6C
/* 80220E80 0021DA60  2C 03 FF FF */	cmpwi r3, -1
/* 80220E84 0021DA64  41 82 00 6C */	beq .L_80220EF0
/* 80220E88 0021DA68  2C 03 00 01 */	cmpwi r3, 1
/* 80220E8C 0021DA6C  40 82 00 64 */	bne .L_80220EF0
/* 80220E90 0021DA70  7F E3 FB 78 */	mr r3, r31
/* 80220E94 0021DA74  4B E3 3D D9 */	bl mpLib_80054C6C
/* 80220E98 0021DA78  2C 03 00 01 */	cmpwi r3, 1
/* 80220E9C 0021DA7C  40 82 00 10 */	bne .L_80220EAC
/* 80220EA0 0021DA80  80 6D B4 60 */	lwz r3, grTFx_804D6B00@sda21(r13)
/* 80220EA4 0021DA84  80 63 00 00 */	lwz r3, 0(r3)
/* 80220EA8 0021DA88  48 00 00 4C */	b .L_80220EF4
.L_80220EAC:
/* 80220EAC 0021DA8C  2C 03 00 02 */	cmpwi r3, 2
/* 80220EB0 0021DA90  40 82 00 10 */	bne .L_80220EC0
/* 80220EB4 0021DA94  80 6D B4 60 */	lwz r3, grTFx_804D6B00@sda21(r13)
/* 80220EB8 0021DA98  80 63 00 04 */	lwz r3, 4(r3)
/* 80220EBC 0021DA9C  48 00 00 38 */	b .L_80220EF4
.L_80220EC0:
/* 80220EC0 0021DAA0  2C 03 00 04 */	cmpwi r3, 4
/* 80220EC4 0021DAA4  40 82 00 10 */	bne .L_80220ED4
/* 80220EC8 0021DAA8  80 6D B4 60 */	lwz r3, grTFx_804D6B00@sda21(r13)
/* 80220ECC 0021DAAC  80 63 00 08 */	lwz r3, 8(r3)
/* 80220ED0 0021DAB0  48 00 00 24 */	b .L_80220EF4
.L_80220ED4:
/* 80220ED4 0021DAB4  2C 03 00 08 */	cmpwi r3, 8
/* 80220ED8 0021DAB8  40 82 00 10 */	bne .L_80220EE8
/* 80220EDC 0021DABC  80 6D B4 60 */	lwz r3, grTFx_804D6B00@sda21(r13)
/* 80220EE0 0021DAC0  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80220EE4 0021DAC4  48 00 00 10 */	b .L_80220EF4
.L_80220EE8:
/* 80220EE8 0021DAC8  38 60 00 00 */	li r3, 0
/* 80220EEC 0021DACC  48 00 00 08 */	b .L_80220EF4
.L_80220EF0:
...
.section .data
    .balign 8
.global grTFx_803E89D8
grTFx_803E89D8:
    .4byte grTFalco_80220D14
    .4byte grTFalco_80220D40
    .4byte grTFalco_80220D48
    .4byte grTFalco_80220D4C
    .4byte NULL
    .4byte grTFalco_80220DE0
    .4byte grTFalco_80220E30
    .4byte grTFalco_80220E38
    .4byte grTFalco_80220E58
    .4byte NULL
    .4byte grTFalco_80220D50
    .4byte grTFalco_80220DA0
    .4byte grTFalco_80220DA8
    .4byte grTFalco_80220DDC
    .4byte 0xC0000000
    .4byte NULL
    .4byte NULL
    .4byte NULL
    .4byte NULL
    .4byte NULL
.global grTFx_803E8A28
grTFx_803E8A28:
    .asciz "/GrTFx.dat"
    .balign 4
.global grTFx_803E8A34
grTFx_803E8A34:
    .4byte 0x0000002E
    .4byte grTFx_803E89D8
    .4byte grTFx_803E8A28
    .4byte grTFalco_80220B84
    .4byte grTFalco_80220B80
    .4byte grTFalco_80220BFC
    .4byte grTFalco_80220C00
    .4byte grTFalco_80220C24
    .4byte grTFalco_80220E5C
    .4byte grTFalco_80220F08
    .4byte 0x00000001
    .4byte NULL
    .4byte NULL
