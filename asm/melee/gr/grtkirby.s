...
.global grTIceClimber_80221364
grTIceClimber_80221364:
/* 80221364 0021DF44  4E 80 00 20 */	blr
.global grTIceClimber_80221368
grTIceClimber_80221368:
...
/* 802213A4 0021DF84  48 00 00 65 */	bl grTIceClimber_80221408
/* 802213A8 0021DF88  38 60 00 01 */	li r3, 1
/* 802213AC 0021DF8C  48 00 00 5D */	bl grTIceClimber_80221408
/* 802213B0 0021DF90  38 60 00 02 */	li r3, 2
/* 802213B4 0021DF94  48 00 00 55 */	bl grTIceClimber_80221408
/* 802213B8 0021DF98  4B FA 26 09 */	bl Ground_801C39C0
/* 802213BC 0021DF9C  4B FA 27 F9 */	bl Ground_801C3BB4
/* 802213C0 0021DFA0  4B FA 2E 51 */	bl Ground_801C4210
/* 802213C4 0021DFA4  4B FA 2E E9 */	bl Ground_801C42AC
...
.global grTIceClimber_802213D8
grTIceClimber_802213D8:
/* 802213D8 0021DFB8  4E 80 00 20 */	blr
.global grTIceClimber_802213DC
grTIceClimber_802213DC:
...
/* 802213EC 0021DFCC  4B FA 9A 19 */	bl grZakoGenerator_801CAE04
...
.global grTIceClimber_80221400
grTIceClimber_80221400:
/* 80221400 0021DFE0  38 60 00 00 */	li r3, 0
/* 80221404 0021DFE4  4E 80 00 20 */	blr

.global grTIceClimber_80221408
grTIceClimber_80221408:
...
/* 80221444 0021E024  41 82 00 70 */	beq grTIceClimber_802214B4
/* 80221448 0021E028  83 FE 00 2C */	lwz r31, 0x2c(r30)
/* 8022144C 0021E02C  38 00 00 00 */	li r0, 0
/* 80221450 0021E030  3C 60 80 1C */	lis r3, grDisplay_801C5DB0@ha
/* 80221454 0021E034  90 1F 00 08 */	stw r0, 8(r31)
/* 80221458 0021E038  38 83 5D B0 */	addi r4, r3, grDisplay_801C5DB0@l
...
/* 802214B0 0021E090  48 00 00 1C */	b grTIceClimber_802214CC
grTIceClimber_802214B4:
...
.global grTIceClimber_802214F0
grTIceClimber_802214F0:
...
/* 80221508 0021E0E8  4B FA 6C 31 */	bl grAnime_801C8138
...
.global grTIceClimber_8022151C
grTIceClimber_8022151C:
/* 8022151C 0021E0FC  38 60 00 00 */	li r3, 0
/* 80221520 0021E100  4E 80 00 20 */	blr
.global grTIceClimber_80221524
grTIceClimber_80221524:
/* 80221524 0021E104  4E 80 00 20 */	blr
.global grTIceClimber_80221528
grTIceClimber_80221528:
/* 80221528 0021E108  4E 80 00 20 */	blr
.global grTIceClimber_8022152C
grTIceClimber_8022152C:
...
/* 80221550 0021E130  4B FA 19 81 */	bl Ground_801C2ED0
...
/* 80221560 0021E140  4B FA 6B D9 */	bl grAnime_801C8138
...
.global grTIceClimber_8022157C
grTIceClimber_8022157C:
/* 8022157C 0021E15C  38 60 00 00 */	li r3, 0
/* 80221580 0021E160  4E 80 00 20 */	blr
.global grTIceClimber_80221584
grTIceClimber_80221584:
...
/* 80221598 0021E178  4B DF 00 5D */	bl lb_800115F4
/* 8022159C 0021E17C  7F E3 FB 78 */	mr r3, r31
/* 802215A0 0021E180  4B FA 1A 41 */	bl Ground_801C2FE0
...
.global grTIceClimber_802215B8
grTIceClimber_802215B8:
/* 802215B8 0021E198  4E 80 00 20 */	blr
.global grTIceClimber_802215BC
grTIceClimber_802215BC:
...
/* 802215E0 0021E1C0  4B FA 18 F1 */	bl Ground_801C2ED0
...
/* 802215F0 0021E1D0  4B FA 6B 49 */	bl grAnime_801C8138
...
.global grTIceClimber_80221634
grTIceClimber_80221634:
/* 80221634 0021E214  4E 80 00 20 */	blr
.global grTIceClimber_80221638
grTIceClimber_80221638:
/* 80221638 0021E218  38 60 00 00 */	li r3, 0
/* 8022163C 0021E21C  4E 80 00 20 */	blr
.global grTIceClimber_80221640
grTIceClimber_80221640:
...
lbl_803E8BB0:
    ...
    .4byte grTIceClimber_80221528
    .4byte NULL
    .4byte grTIceClimber_802215BC
    .4byte grTIceClimber_8022160C
    .4byte grTIceClimber_80221614
    .4byte grTIceClimber_80221634
    .4byte NULL
    .4byte grTIceClimber_8022152C
    .4byte grTIceClimber_8022157C
    .4byte grTIceClimber_80221584
    .4byte grTIceClimber_802215B8
    .4byte 0xC0000000
    .4byte NULL
    .4byte NULL
    .4byte NULL
...
lbl_803E8C0C:
    ...
    .4byte grTIceClimber_802213DC
    .4byte grTIceClimber_80221400
    .4byte grTIceClimber_80221638
    .4byte grTIceClimber_80221640
    .4byte 0x00000001
    .4byte NULL
    .4byte NULL
    .4byte 0x25733A25
