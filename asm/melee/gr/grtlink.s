...
.global grTLink_8022192C
grTLink_8022192C:
/* 8022192C 0021E50C  4E 80 00 20 */	blr
.global grTLink_80221930
grTLink_80221930:
...
/* 8022196C 0021E54C  48 00 00 65 */	bl grTLink_802219D0
/* 80221970 0021E550  38 60 00 01 */	li r3, 1
/* 80221974 0021E554  48 00 00 5D */	bl grTLink_802219D0
/* 80221978 0021E558  38 60 00 02 */	li r3, 2
/* 8022197C 0021E55C  48 00 00 55 */	bl grTLink_802219D0
/* 80221980 0021E560  4B FA 20 41 */	bl Ground_801C39C0
/* 80221984 0021E564  4B FA 22 31 */	bl Ground_801C3BB4
/* 80221988 0021E568  4B FA 28 89 */	bl Ground_801C4210
/* 8022198C 0021E56C  4B FA 29 21 */	bl Ground_801C42AC
...
.global grTLink_802219A0
grTLink_802219A0:
/* 802219A0 0021E580  4E 80 00 20 */	blr
.global grTLink_802219A4
grTLink_802219A4:
...
/* 802219B4 0021E594  4B FA 94 51 */	bl grZakoGenerator_801CAE04
...
/* 80221A0C 0021E5EC  41 82 00 70 */	beq grTLink_80221A7C
/* 80221A10 0021E5F0  83 FE 00 2C */	lwz r31, 0x2c(r30)
/* 80221A14 0021E5F4  38 00 00 00 */	li r0, 0
/* 80221A18 0021E5F8  3C 60 80 1C */	lis r3, grDisplay_801C5DB0@ha
/* 80221A1C 0021E5FC  90 1F 00 08 */	stw r0, 8(r31)
/* 80221A20 0021E600  38 83 5D B0 */	addi r4, r3, grDisplay_801C5DB0@l
...
/* 80221A40 0021E620  41 82 00 08 */	beq grTLink_80221A48
...
/* 80221A50 0021E630  41 82 00 10 */	beq grTLink_80221A60
...
/* 80221A68 0021E648  41 82 00 2C */	beq grTLink_80221A94
...
/* 80221A78 0021E658  48 00 00 1C */	b grTLink_80221A94
grTLink_80221A7C:
...
/* 80221AD0 0021E6B0  4B FA 66 69 */	bl grAnime_801C8138
...
/* 80221B18 0021E6F8  4B FA 13 B9 */	bl Ground_801C2ED0
...
/* 80221B28 0021E708  4B FA 66 11 */	bl grAnime_801C8138
...
/* 80221B60 0021E740  4B DE FA 95 */	bl lb_800115F4
/* 80221B64 0021E744  7F E3 FB 78 */	mr r3, r31
/* 80221B68 0021E748  4B FA 14 79 */	bl Ground_801C2FE0
...
.global grTLink_80221B80
grTLink_80221B80:
/* 80221B80 0021E760  4E 80 00 20 */	blr
.global grTLink_80221B84
grTLink_80221B84:
...
/* 80221BA8 0021E788  4B FA 13 29 */	bl Ground_801C2ED0
...
/* 80221BB8 0021E798  4B FA 65 81 */	bl grAnime_801C8138
...
lbl_803E8D30:
    ...
    .4byte grTLink_80221AF0
    .4byte NULL
    .4byte grTLink_80221B84
    .4byte grTLink_80221BD4
    .4byte grTLink_80221BDC
    .4byte grTLink_80221BFC
    .4byte NULL
    .4byte grTLink_80221AF4
    .4byte grTLink_80221B44
    .4byte grTLink_80221B4C
    .4byte grTLink_80221B80
    .4byte 0xC0000000
    .4byte NULL
    .4byte NULL
    .4byte NULL
...
lbl_803E8D8C:
    ...
    .4byte grTLink_802219A4
    .4byte grTLink_802219C8
    .4byte grTLink_80221C00
    .4byte grTLink_80221C08
    .4byte 0x00000001
    .4byte NULL
    .4byte NULL
    .4byte 0x25733A25
