...
.global grTMario_8021F840
grTMario_8021F840:
/* 8021F840 0021C420  4E 80 00 20 */	blr
.global grTMario_8021F844
grTMario_8021F844:
...
/* 8021F880 0021C460  48 00 00 65 */	bl grTMario_8021F8E4
/* 8021F884 0021C464  38 60 00 01 */	li r3, 1
/* 8021F888 0021C468  48 00 00 5D */	bl grTMario_8021F8E4
/* 8021F88C 0021C46C  38 60 00 02 */	li r3, 2
/* 8021F890 0021C470  48 00 00 55 */	bl grTMario_8021F8E4
/* 8021F894 0021C474  4B FA 41 2D */	bl Ground_801C39C0
/* 8021F898 0021C478  4B FA 43 1D */	bl Ground_801C3BB4
/* 8021F89C 0021C47C  4B FA 49 75 */	bl Ground_801C4210
/* 8021F8A0 0021C480  4B FA 4A 0D */	bl Ground_801C42AC
...
.global grTMario_8021F8B4
grTMario_8021F8B4:
/* 8021F8B4 0021C494  4E 80 00 20 */	blr
.global grTMario_8021F8B8
grTMario_8021F8B8:
...
/* 8021F8C8 0021C4A8  4B FA B5 3D */	bl grZakoGenerator_801CAE04
...
/* 8021F920 0021C500  41 82 00 70 */	beq grTMario_8021F990
/* 8021F924 0021C504  83 FE 00 2C */	lwz r31, 0x2c(r30)
/* 8021F928 0021C508  38 00 00 00 */	li r0, 0
/* 8021F92C 0021C50C  3C 60 80 1C */	lis r3, grDisplay_801C5DB0@ha
/* 8021F930 0021C510  90 1F 00 08 */	stw r0, 8(r31)
/* 8021F934 0021C514  38 83 5D B0 */	addi r4, r3, grDisplay_801C5DB0@l
...
/* 8021F954 0021C534  41 82 00 08 */	beq grTMario_8021F95C
...
/* 8021F964 0021C544  41 82 00 10 */	beq grTMario_8021F974
...
/* 8021F97C 0021C55C  41 82 00 2C */	beq grTMario_8021F9A8
...
/* 8021F98C 0021C56C  48 00 00 1C */	b grTMario_8021F9A8
grTMario_8021F990:
...
/* 8021F9E4 0021C5C4  4B FA 87 55 */	bl grAnime_801C8138
...
/* 8021FA58 0021C638  4B FA 34 79 */	bl Ground_801C2ED0
...
/* 8021FA68 0021C648  4B FA 86 D1 */	bl grAnime_801C8138
/* 8021FA6C 0021C64C  3C 60 80 22 */	lis r3, grTMario_8021FA08@ha
/* 8021FA70 0021C650  38 83 FA 08 */	addi r4, r3, grTMario_8021FA08@l
/* 8021FA74 0021C654  38 7E 00 00 */	addi r3, r30, 0
/* 8021FA78 0021C658  4B FA 16 41 */	bl Ground_801C10B8
...
/* 8021FAB0 0021C690  4B DF 1B 45 */	bl lb_800115F4
/* 8021FAB4 0021C694  7F E3 FB 78 */	mr r3, r31
/* 8021FAB8 0021C698  4B FA 35 29 */	bl Ground_801C2FE0
...
.global grTMario_8021FAD0
grTMario_8021FAD0:
/* 8021FAD0 0021C6B0  4E 80 00 20 */	blr
.global grTMario_8021FAD4
grTMario_8021FAD4:
...
/* 8021FAF8 0021C6D8  4B FA 33 D9 */	bl Ground_801C2ED0
...
/* 8021FB08 0021C6E8  4B FA 86 31 */	bl grAnime_801C8138
...
/* 8021FC08 0021C7E8  4B FA 9A F1 */	bl grLib_801C96F8
/* 8021FC0C 0021C7EC  28 03 00 00 */	cmplwi r3, 0
/* 8021FC10 0021C7F0  41 82 00 2C */	beq grTMario_8021FC3C
...
lbl_803E8548:
    ...
    .4byte grTMario_8021FA04
    .4byte NULL
    .4byte grTMario_8021FAD4
    .4byte grTMario_8021FB24
    .4byte grTMario_8021FB2C
    .4byte grTMario_8021FB4C
    .4byte NULL
    .4byte grTMario_8021FA34
    .4byte grTMario_8021FA94
    .4byte grTMario_8021FA9C
    .4byte grTMario_8021FAD0
    .4byte 0xC0000000
    .4byte NULL
    .4byte NULL
    .4byte NULL
...
lbl_803E85A4:
    ...
    .4byte grTMario_8021F8B8
    .4byte grTMario_8021F8DC
    .4byte grTMario_8021FC50
    .4byte grTMario_8021FC58
    .4byte 0x00000001
    .4byte NULL
    .4byte NULL
    .4byte 0x25733A25
