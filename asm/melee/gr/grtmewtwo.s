...
/* 80222220 0021EE00  48 00 00 65 */	bl grTMars_80222284
/* 80222224 0021EE04  38 60 00 01 */	li r3, 1
/* 80222228 0021EE08  48 00 00 5D */	bl grTMars_80222284
/* 8022222C 0021EE0C  38 60 00 02 */	li r3, 2
/* 80222230 0021EE10  48 00 00 55 */	bl grTMars_80222284
/* 80222234 0021EE14  4B FA 17 8D */	bl Ground_801C39C0
/* 80222238 0021EE18  4B FA 19 7D */	bl Ground_801C3BB4
/* 8022223C 0021EE1C  4B FA 1F D5 */	bl Ground_801C4210
/* 80222240 0021EE20  4B FA 20 6D */	bl Ground_801C42AC
...
.global grTMars_80222254
grTMars_80222254:
/* 80222254 0021EE34  4E 80 00 20 */	blr
.global grTMars_80222258
grTMars_80222258:
...
/* 80222268 0021EE48  4B FA 8B 9D */	bl grZakoGenerator_801CAE04
...
/* 802222A8 0021EE88  3C 60 80 3F */	lis r3, grTMt_803E8F70@ha
/* 802222AC 0021EE8C  3B E3 8F 70 */	addi r31, r3, grTMt_803E8F70@l
/* 802222B0 0021EE90  38 7C 00 00 */	addi r3, r28, 0
/* 802222B4 0021EE94  7F BF 02 14 */	add r29, r31, r0
/* 802222B8 0021EE98  4B F9 F2 19 */	bl Ground_801C14D0
/* 802222BC 0021EE9C  7C 7E 1B 79 */	or. r30, r3, r3
/* 802222C0 0021EEA0  41 82 00 70 */	beq .L_80222330
/* 802222C4 0021EEA4  83 FE 00 2C */	lwz r31, 0x2c(r30)
/* 802222C8 0021EEA8  38 00 00 00 */	li r0, 0
/* 802222CC 0021EEAC  3C 60 80 1C */	lis r3, grDisplay_801C5DB0@ha
/* 802222D0 0021EEB0  90 1F 00 08 */	stw r0, 8(r31)
/* 802222D4 0021EEB4  38 83 5D B0 */	addi r4, r3, grDisplay_801C5DB0@l
...
/* 802222F4 0021EED4  41 82 00 08 */	beq .L_802222FC
...
/* 80222304 0021EEE4  41 82 00 10 */	beq .L_80222314
...
/* 8022231C 0021EEFC  41 82 00 2C */	beq .L_80222348
/* 80222320 0021EF00  38 7E 00 00 */	addi r3, r30, 0
/* 80222324 0021EF04  38 A0 00 04 */	li r5, 4
/* 80222328 0021EF08  48 16 DA 2D */	bl HSD_GObjProc_8038FD54
/* 8022232C 0021EF0C  48 00 00 1C */	b .L_80222348
.L_80222330:
...
/* 80222384 0021EF64  4B FA 5D B5 */	bl grAnime_801C8138
...
/* 802223CC 0021EFAC  4B FA 0B 05 */	bl Ground_801C2ED0
...
/* 802223DC 0021EFBC  4B FA 5D 5D */	bl grAnime_801C8138
...
/* 80222414 0021EFF4  4B DE F1 E1 */	bl lb_800115F4
/* 80222418 0021EFF8  7F E3 FB 78 */	mr r3, r31
/* 8022241C 0021EFFC  4B FA 0B C5 */	bl Ground_801C2FE0
...
.global grTMars_80222434
grTMars_80222434:
/* 80222434 0021F014  4E 80 00 20 */	blr
.global grTMars_80222438
grTMars_80222438:
...
/* 8022245C 0021F03C  4B FA 0A 75 */	bl Ground_801C2ED0
...
/* 8022246C 0021F04C  4B FA 5C CD */	bl grAnime_801C8138
...
.global grTMars_802224B0
grTMars_802224B0:
/* 802224B0 0021F090  4E 80 00 20 */	blr
.global grTMars_802224B4
grTMars_802224B4:
...
/* 802224CC 0021F0AC  41 82 00 E4 */	beq .L_802225B0
...
/* 802224DC 0021F0BC  41 82 00 D4 */	beq .L_802225B0
/* 802224E0 0021F0C0  2C 03 00 00 */	cmpwi r3, 0
/* 802224E4 0021F0C4  40 82 00 64 */	bne .L_80222548
...
/* 802224F4 0021F0D4  40 82 00 10 */	bne .L_80222504
/* 802224F8 0021F0D8  80 6D B4 68 */	lwz r3, grTMt_804D6B08@sda21(r13)
/* 802224FC 0021F0DC  80 63 00 00 */	lwz r3, 0(r3)
/* 80222500 0021F0E0  48 00 00 B4 */	b .L_802225B4
.L_80222504:
/* 80222504 0021F0E4  2C 03 00 02 */	cmpwi r3, 2
/* 80222508 0021F0E8  40 82 00 10 */	bne .L_80222518
/* 8022250C 0021F0EC  80 6D B4 68 */	lwz r3, grTMt_804D6B08@sda21(r13)
/* 80222510 0021F0F0  80 63 00 04 */	lwz r3, 4(r3)
/* 80222514 0021F0F4  48 00 00 A0 */	b .L_802225B4
.L_80222518:
/* 80222518 0021F0F8  2C 03 00 04 */	cmpwi r3, 4
/* 8022251C 0021F0FC  40 82 00 10 */	bne .L_8022252C
/* 80222520 0021F100  80 6D B4 68 */	lwz r3, grTMt_804D6B08@sda21(r13)
/* 80222524 0021F104  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80222528 0021F108  48 00 00 8C */	b .L_802225B4
.L_8022252C:
/* 8022252C 0021F10C  2C 03 00 08 */	cmpwi r3, 8
/* 80222530 0021F110  40 82 00 10 */	bne .L_80222540
/* 80222534 0021F114  80 6D B4 68 */	lwz r3, grTMt_804D6B08@sda21(r13)
/* 80222538 0021F118  80 63 00 08 */	lwz r3, 8(r3)
/* 8022253C 0021F11C  48 00 00 78 */	b .L_802225B4
.L_80222540:
/* 80222540 0021F120  38 60 00 00 */	li r3, 0
/* 80222544 0021F124  48 00 00 70 */	b .L_802225B4
.L_80222548:
/* 80222548 0021F128  2C 03 00 01 */	cmpwi r3, 1
/* 8022254C 0021F12C  40 82 00 64 */	bne .L_802225B0
...
/* 8022255C 0021F13C  40 82 00 10 */	bne .L_8022256C
/* 80222560 0021F140  80 6D B4 68 */	lwz r3, grTMt_804D6B08@sda21(r13)
/* 80222564 0021F144  80 63 00 10 */	lwz r3, 0x10(r3)
/* 80222568 0021F148  48 00 00 4C */	b .L_802225B4
.L_8022256C:
/* 8022256C 0021F14C  2C 03 00 02 */	cmpwi r3, 2
/* 80222570 0021F150  40 82 00 10 */	bne .L_80222580
/* 80222574 0021F154  80 6D B4 68 */	lwz r3, grTMt_804D6B08@sda21(r13)
/* 80222578 0021F158  80 63 00 14 */	lwz r3, 0x14(r3)
/* 8022257C 0021F15C  48 00 00 38 */	b .L_802225B4
.L_80222580:
/* 80222580 0021F160  2C 03 00 04 */	cmpwi r3, 4
/* 80222584 0021F164  40 82 00 10 */	bne .L_80222594
/* 80222588 0021F168  80 6D B4 68 */	lwz r3, grTMt_804D6B08@sda21(r13)
/* 8022258C 0021F16C  80 63 00 1C */	lwz r3, 0x1c(r3)
/* 80222590 0021F170  48 00 00 24 */	b .L_802225B4
.L_80222594:
/* 80222594 0021F174  2C 03 00 08 */	cmpwi r3, 8
/* 80222598 0021F178  40 82 00 10 */	bne .L_802225A8
/* 8022259C 0021F17C  80 6D B4 68 */	lwz r3, grTMt_804D6B08@sda21(r13)
/* 802225A0 0021F180  80 63 00 18 */	lwz r3, 0x18(r3)
/* 802225A4 0021F184  48 00 00 10 */	b .L_802225B4
.L_802225A8:
/* 802225A8 0021F188  38 60 00 00 */	li r3, 0
/* 802225AC 0021F18C  48 00 00 08 */	b .L_802225B4
.L_802225B0:
...
.section .data
    .balign 8
.global grTMt_803E8F70
grTMt_803E8F70:
    .4byte grTMars_8022236C
    .4byte grTMars_80222398
    .4byte grTMars_802223A0
    .4byte grTMars_802223A4
    .4byte NULL
    .4byte grTMars_80222438
    .4byte grTMars_80222488
    .4byte grTMars_80222490
    .4byte grTMars_802224B0
    .4byte NULL
    .4byte grTMars_802223A8
    .4byte grTMars_802223F8
    .4byte grTMars_80222400
    .4byte grTMars_80222434
    .4byte 0xC0000000
    .4byte NULL
    .4byte NULL
    .4byte NULL
    .4byte NULL
    .4byte NULL
.global grTMt_803E8FC0
grTMt_803E8FC0:
    .4byte 0x2F477254
    .4byte 0x4D742E64
    .4byte 0x61740000
.global grTMt_803E8FCC
grTMt_803E8FCC:
    .4byte 0x00000035
    .4byte grTMt_803E8F70
    .4byte grTMt_803E8FC0
    .4byte grTMars_802221DC
    .4byte grTMars_802221D8
    .4byte grTMars_80222254
    .4byte grTMars_80222258
    .4byte grTMars_8022227C
    .4byte grTMars_802224B4
    .4byte grTMars_802225C8
    .4byte 0x00000001
    .4byte NULL
    .4byte NULL
    .4byte 0x25733A25
