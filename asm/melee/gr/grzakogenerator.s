...
/* 801CA3D0 001C6FB0  41 82 00 44 */    beq .L_801CA414
...
/* 801CA3E4 001C6FC4  41 82 00 24 */    beq .L_801CA408
...
/* 801CA404 001C6FE4  48 00 00 10 */    b .L_801CA414
.L_801CA408:
...
/* 801CA468 001C7048  41 82 00 0C */    beq .L_801CA474
/* 801CA46C 001C704C  28 1B 00 00 */    cmplwi r27, 0
/* 801CA470 001C7050  40 82 00 0C */    bne .L_801CA47C
.L_801CA474:
/* 801CA474 001C7054  38 60 00 00 */    li r3, 0
/* 801CA478 001C7058  48 00 01 E4 */    b .L_801CA65C
.L_801CA47C:
...
/* 801CA488 001C7068  48 00 00 30 */    b .L_801CA4B8
.L_801CA48C:
...
/* 801CA51C 001C70FC  40 80 01 28 */    bge .L_801CA644
.L_801CA520:
...
/* 801CA534 001C7114  40 80 00 0C */    bge .L_801CA540
/* 801CA538 001C7118  FC 00 18 50 */    fneg f0, f3
/* 801CA53C 001C711C  48 00 00 08 */    b .L_801CA544
.L_801CA540:
/* 801CA540 001C7120  FC 00 18 90 */    fmr f0, f3
.L_801CA544:
/* 801CA544 001C7124  FC 00 F8 40 */    fcmpo cr0, f0, f31
/* 801CA548 001C7128  40 81 00 3C */    ble .L_801CA584
...
/* 801CA580 001C7160  48 00 00 34 */    b .L_801CA5B4
.L_801CA584:
...
/* 801CA5BC 001C719C  40 80 00 48 */    bge .L_801CA604
/* 801CA5C0 001C71A0  80 7A 00 14 */    lwz r3, 0x14(r26)
/* 801CA5C4 001C71A4  28 03 00 00 */    cmplwi r3, 0
/* 801CA5C8 001C71A8  40 82 00 20 */    bne .L_801CA5E8
...
/* 801CA5E4 001C71C4  48 00 00 34 */    b .L_801CA618
.L_801CA5E8:
...
/* 801CA600 001C71E0  48 00 00 18 */    b .L_801CA618
.L_801CA604:
...
/* 801CA654 001C7234  41 80 FE 84 */    blt .L_801CA4D8
...
/* 801CA698 001C7278  40 82 00 18 */    bne .L_801CA6B0
/* 801CA69C 001C727C  3C 60 80 3E */    lis r3, .L_803E0BA8@ha
/* 801CA6A0 001C7280  38 63 0B A8 */    addi r3, r3, .L_803E0BA8@l
/* 801CA6A4 001C7284  38 80 00 52 */    li r4, 0x52
/* 801CA6A8 001C7288  38 AD 8E F0 */    addi r5, r13, .L_804D4590@sda21
...
/* 801CA7CC 001C73AC  42 00 FE F4 */    bdnz .L_801CA6C0
...
/* 801CA858 001C7438  42 00 FF 9C */    bdnz .L_801CA7F4
/* 801CA85C 001C743C  70 63 00 07 */    andi. r3, r3, 7
/* 801CA860 001C7440  41 82 00 1C */    beq .L_801CA87C
.L_801CA864:
...
/* 801CA878 001C7458  42 00 FF F0 */    bdnz .L_801CA868
.L_801CA87C:
/* 801CA87C 001C745C  3C 60 80 4A */    lis r3, .L_8049F030@ha
/* 801CA880 001C7460  38 83 F0 30 */    addi r4, r3, .L_8049F030@l
...
/* 801CA8B8 001C7498  3C 80 80 4A */    lis r4, .L_8049F030@ha
...
/* 801CA8E8 001C74C8  3B 64 F0 30 */    addi r27, r4, .L_8049F030@l
...
/* 801CA934 001C7514  C0 02 B3 D0 */    lfs f0, .L_804DADB0@sda21(r2)
...
/* 801CA944 001C7524  C0 02 B3 D0 */    lfs f0, .L_804DADB0@sda21(r2)
...
/* 801CA954 001C7534  C0 02 B3 D0 */    lfs f0, .L_804DADB0@sda21(r2)
...
/* 801CA964 001C7544  C0 02 B3 D0 */    lfs f0, .L_804DADB0@sda21(r2)
...
/* 801CA990 001C7570  41 82 02 28 */    beq .L_801CABB8
/* 801CA994 001C7574  80 04 00 04 */    lwz r0, 4(r4)
/* 801CA998 001C7578  28 00 00 00 */    cmplwi r0, 0
/* 801CA99C 001C757C  40 82 02 1C */    bne .L_801CABB8
...
/* 801CA9AC 001C758C  41 82 02 0C */    beq .L_801CABB8
/* 801CA9B0 001C7590  7C 80 07 35 */    extsh. r0, r4
/* 801CA9B4 001C7594  40 81 00 10 */    ble .L_801CA9C4
/* 801CA9B8 001C7598  38 04 FF FF */    addi r0, r4, -1
/* 801CA9BC 001C759C  B0 05 00 00 */    sth r0, 0(r5)
/* 801CA9C0 001C75A0  48 00 01 F8 */    b .L_801CABB8
.L_801CA9C4:
...
/* 801CAA68 001C7648  48 00 01 50 */    b .L_801CABB8
.L_801CAA6C:
/* 801CAA6C 001C764C  80 BB 00 00 */    lwz r5, 0(r27)
/* 801CAA70 001C7650  28 05 00 00 */    cmplwi r5, 0
/* 801CAA74 001C7654  41 82 01 44 */    beq .L_801CABB8
...
/* 801CAA88 001C7668  41 82 00 B0 */    beq .L_801CAB38
/* 801CAA8C 001C766C  40 80 00 2C */    bge .L_801CAAB8
/* 801CAA90 001C7670  2C 00 00 2D */    cmpwi r0, 0x2d
/* 801CAA94 001C7674  41 82 00 6C */    beq .L_801CAB00
/* 801CAA98 001C7678  40 80 00 14 */    bge .L_801CAAAC
/* 801CAA9C 001C767C  2C 00 00 2B */    cmpwi r0, 0x2b
/* 801CAAA0 001C7680  41 82 00 34 */    beq .L_801CAAD4
/* 801CAAA4 001C7684  40 80 00 4C */    bge .L_801CAAF0
/* 801CAAA8 001C7688  48 00 00 F4 */    b .L_801CAB9C
.L_801CAAAC:
/* 801CAAAC 001C768C  2C 00 00 2F */    cmpwi r0, 0x2f
/* 801CAAB0 001C7690  40 80 00 EC */    bge .L_801CAB9C
/* 801CAAB4 001C7694  48 00 00 68 */    b .L_801CAB1C
.L_801CAAB8:
/* 801CAAB8 001C7698  2C 00 00 D9 */    cmpwi r0, 0xd9
/* 801CAABC 001C769C  41 82 00 C8 */    beq .L_801CAB84
/* 801CAAC0 001C76A0  40 80 00 DC */    bge .L_801CAB9C
/* 801CAAC4 001C76A4  2C 00 00 D5 */    cmpwi r0, 0xd5
/* 801CAAC8 001C76A8  41 82 00 A4 */    beq .L_801CAB6C
/* 801CAACC 001C76AC  40 80 00 D0 */    bge .L_801CAB9C
/* 801CAAD0 001C76B0  48 00 00 84 */    b .L_801CAB54
.L_801CAAD4:
...
/* 801CAAEC 001C76CC  48 00 00 B0 */    b .L_801CAB9C
.L_801CAAF0:
...
/* 801CAAFC 001C76DC  48 00 00 A0 */    b .L_801CAB9C
.L_801CAB00:
...
/* 801CAB18 001C76F8  48 00 00 84 */    b .L_801CAB9C
.L_801CAB1C:
...
/* 801CAB34 001C7714  48 00 00 68 */    b .L_801CAB9C
.L_801CAB38:
...
/* 801CAB50 001C7730  48 00 00 4C */    b .L_801CAB9C
.L_801CAB54:
...
/* 801CAB68 001C7748  48 00 00 34 */    b .L_801CAB9C
.L_801CAB6C:
...
/* 801CAB80 001C7760  48 00 00 1C */    b .L_801CAB9C
.L_801CAB84:
...
/* 801CABA0 001C7780  41 82 00 18 */    beq .L_801CABB8
...
/* 801CABC0 001C77A0  41 80 00 08 */    blt .L_801CABC8
/* 801CABC4 001C77A4  3B A0 00 00 */    li r29, 0
.L_801CABC8:
/* 801CABC8 001C77A8  7C 1D D0 00 */    cmpw r29, r26
/* 801CABCC 001C77AC  41 82 00 0C */    beq .L_801CABD8
/* 801CABD0 001C77B0  37 9C FF FF */    addic. r28, r28, -1
/* 801CABD4 001C77B4  41 81 FD A8 */    bgt .L_801CA97C
.L_801CABD8:
...
/* 801CAC38 001C7818  40 82 00 2C */    bne .L_801CAC64
/* 801CAC3C 001C781C  3C 60 80 4A */    lis r3, .L_8049F030@ha
/* 801CAC40 001C7820  38 63 F0 30 */    addi r3, r3, .L_8049F030@l
...
/* 801CAC58 001C7838  40 82 00 48 */    bne .L_801CACA0
/* 801CAC5C 001C783C  90 04 00 00 */    stw r0, 0(r4)
/* 801CAC60 001C7840  48 00 00 40 */    b .L_801CACA0
.L_801CAC64:
/* 801CAC64 001C7844  80 1F 0D D8 */    lwz r0, 0xdd8(r31)
/* 801CAC68 001C7848  2C 00 FF FF */    cmpwi r0, -1
/* 801CAC6C 001C784C  41 82 00 34 */    beq .L_801CACA0
/* 801CAC70 001C7850  3C 60 80 4A */    lis r3, .L_8049F030@ha
/* 801CAC74 001C7854  38 63 F0 30 */    addi r3, r3, .L_8049F030@l
...
/* 801CACBC 001C789C  3C 80 80 4A */    lis r4, .L_8049F030@ha
...
/* 801CACD4 001C78B4  3B A4 F0 30 */    addi r29, r4, .L_8049F030@l
...
/* 801CACF8 001C78D8  40 82 00 34 */    bne .L_801CAD2C
...
/* 801CAD18 001C78F8  40 82 00 84 */    bne .L_801CAD9C
...
/* 801CAD28 001C7908  48 00 00 74 */    b .L_801CAD9C
.L_801CAD2C:
/* 801CAD2C 001C790C  80 1F 0D D8 */    lwz r0, 0xdd8(r31)
/* 801CAD30 001C7910  2C 00 FF FF */    cmpwi r0, -1
/* 801CAD34 001C7914  41 82 00 68 */    beq .L_801CAD9C
...
/* 801CAD6C 001C794C  40 82 00 18 */    bne .L_801CAD84
...
/* 801CAD80 001C7960  48 00 00 14 */    b .L_801CAD94
.L_801CAD84:
...
/* 801CAE3C 001C7A1C  40 82 00 30 */    bne .L_801CAE6C
/* 801CAE40 001C7A20  3C 60 80 3E */    lis r3, .L_803E0BBC@ha
/* 801CAE44 001C7A24  4C C6 31 82 */    crclr 6
/* 801CAE48 001C7A28  3C 80 80 3E */    lis r4, .L_803E0BA8@ha
/* 801CAE4C 001C7A2C  38 63 0B BC */    addi r3, r3, .L_803E0BBC@l
/* 801CAE50 001C7A30  38 84 0B A8 */    addi r4, r4, .L_803E0BA8@l
...
/* 801CAE68 001C7A48  48 00 00 2C */    b .L_801CAE94
.L_801CAE6C:
/* 801CAE6C 001C7A4C  3C 60 80 1D */    lis r3, .L_801CADBC@ha
/* 801CAE70 001C7A50  38 83 AD BC */    addi r4, r3, .L_801CADBC@l
...
/* 801CAE80 001C7A60  3C 60 80 4A */    lis r3, .L_8049F030@ha
/* 801CAE84 001C7A64  38 83 F0 30 */    addi r4, r3, .L_8049F030@l
...
func_801CAEB0:
/* 801CAEB0 001C7A90  3C A0 80 4A */    lis r5, .L_8049F030@ha
/* 801CAEB4 001C7A94  38 A5 F0 30 */    addi r5, r5, .L_8049F030@l
...
func_801CAEF0:
/* 801CAEF0 001C7AD0  3C 80 80 4A */    lis r4, .L_8049F030@ha
/* 801CAEF4 001C7AD4  38 84 F0 30 */    addi r4, r4, .L_8049F030@l
...
/* 801CAF0C 001C7AEC  3C 60 80 4A */    lis r3, .L_8049F030@ha
/* 801CAF10 001C7AF0  90 01 00 04 */    stw r0, 4(r1)
/* 801CAF14 001C7AF4  38 63 F0 30 */    addi r3, r3, .L_8049F030@l
...
/* 801CAF50 001C7B30  41 80 00 0C */    blt .L_801CAF5C
/* 801CAF54 001C7B34  2C 03 00 30 */    cmpwi r3, 0x30
/* 801CAF58 001C7B38  41 80 00 14 */    blt .L_801CAF6C
.L_801CAF5C:
/* 801CAF5C 001C7B3C  2C 03 00 D0 */    cmpwi r3, 0xd0
/* 801CAF60 001C7B40  41 80 00 28 */    blt .L_801CAF88
/* 801CAF64 001C7B44  2C 03 00 E8 */    cmpwi r3, 0xe8
/* 801CAF68 001C7B48  40 80 00 20 */    bge .L_801CAF88
.L_801CAF6C:
...
/* 801CAF78 001C7B58  41 82 00 20 */    beq .L_801CAF98
/* 801CAF7C 001C7B5C  7F C3 F3 78 */    mr r3, r30
/* 801CAF80 001C7B60  48 09 F9 6D */    bl func_8026A8EC
/* 801CAF84 001C7B64  48 00 00 14 */    b .L_801CAF98
.L_801CAF88:
/* 801CAF88 001C7B68  2C 03 00 9F */    cmpwi r3, 0x9f
/* 801CAF8C 001C7B6C  40 82 00 0C */    bne .L_801CAF98
...
/* 801CAFA0 001C7B80  40 82 FF A0 */    bne .L_801CAF40
