...
/* 802F33A0 002EFF80  48 00 34 F9 */	bl ifStatus_802F6898
/* 802F33A4 002EFF84  48 00 0C B9 */	bl ifTime_802F405C
/* 802F33A8 002EFF88  48 00 A0 A9 */	bl un_802FD450
/* 802F33AC 002EFF8C  48 00 95 3D */	bl ifMagnify_802FC8E8
...
/* 802F33D8 002EFFB8  48 00 35 19 */	bl ifStatus_802F68F0
/* 802F33DC 002EFFBC  48 00 0C DD */	bl ifTime_802F40B8
/* 802F33E0 002EFFC0  48 00 A0 7D */	bl un_802FD45C
/* 802F33E4 002EFFC4  48 00 95 5D */	bl ifMagnify_802FC940
...
ifAll_802F3404:
/* 802F3404 002EFFE4  3C 60 80 4A */	lis r3, ifAll_804A0FD8@ha
/* 802F3408 002EFFE8  38 63 0F D8 */	addi r3, r3, ifAll_804A0FD8@l
/* 802F340C 002EFFEC  80 63 00 00 */	lwz r3, 0(r3)
/* 802F3410 002EFFF0  4E 80 00 20 */	blr

.global ifAll_802F3414
ifAll_802F3414:
/* 802F3414 002EFFF4  3C 60 80 4A */	lis r3, ifAll_804A0FD8@ha
/* 802F3418 002EFFF8  38 63 0F D8 */	addi r3, r3, ifAll_804A0FD8@l
...
/* 802F3428 002F0008  3C 60 80 4A */	lis r3, ifAll_804A0FD8@ha
/* 802F342C 002F000C  38 03 0F D8 */	addi r0, r3, ifAll_804A0FD8@l
...
/* 802F3458 002F0038  3C 60 80 4A */	lis r3, ifAll_804A0FD8@ha
/* 802F345C 002F003C  93 A1 00 14 */	stw r29, 0x14(r1)
/* 802F3460 002F0040  3B E3 0F D8 */	addi r31, r3, ifAll_804A0FD8@l
...
/* 802F3470 002F0050  41 82 00 A4 */	beq .L_802F3514
/* 802F3474 002F0054  40 80 00 14 */	bge .L_802F3488
/* 802F3478 002F0058  2C 1E 00 01 */	cmpwi r30, 1
/* 802F347C 002F005C  41 82 00 20 */	beq .L_802F349C
/* 802F3480 002F0060  40 80 00 48 */	bge .L_802F34C8
/* 802F3484 002F0064  48 00 01 E8 */	b .L_802F366C
.L_802F3488:
/* 802F3488 002F0068  2C 1E 00 07 */	cmpwi r30, 7
/* 802F348C 002F006C  40 80 01 E0 */	bge .L_802F366C
/* 802F3490 002F0070  2C 1E 00 05 */	cmpwi r30, 5
/* 802F3494 002F0074  40 80 01 18 */	bge .L_802F35AC
/* 802F3498 002F0078  48 00 00 C8 */	b .L_802F3560
.L_802F349C:
...
/* 802F34C4 002F00A4  48 00 01 A8 */	b .L_802F366C
.L_802F34C8:
...
/* 802F34D4 002F00B4  48 00 00 34 */	b .L_802F3508
.L_802F34D8:
...
/* 802F350C 002F00EC  41 80 FF CC */	blt .L_802F34D8
/* 802F3510 002F00F0  48 00 01 5C */	b .L_802F366C
.L_802F3514:
...
/* 802F3520 002F0100  48 00 00 34 */	b .L_802F3554
.L_802F3524:
...
/* 802F3558 002F0138  41 80 FF CC */	blt .L_802F3524
/* 802F355C 002F013C  48 00 01 10 */	b .L_802F366C
.L_802F3560:
...
/* 802F356C 002F014C  48 00 00 34 */	b .L_802F35A0
.L_802F3570:
...
/* 802F35A4 002F0184  41 80 FF CC */	blt .L_802F3570
/* 802F35A8 002F0188  48 00 00 C4 */	b .L_802F366C
.L_802F35AC:
...
/* 802F35DC 002F01BC  C0 02 E0 50 */	lfs f0, ifAll_804DDA30@sda21(r2)
...
/* 802F3614 002F01F4  C3 E2 E0 50 */	lfs f31, ifAll_804DDA30@sda21(r2)
...
/* 802F3668 002F0248  41 80 FF C0 */	blt .L_802F3628
.L_802F366C:
...
ifAll_802F3690:
/* 802F3690 002F0270  38 6D B6 BC */	addi r3, r13, ifAll_804D6D5C@sda21
/* 802F3694 002F0274  4E 80 00 20 */	blr

.global ifAll_802F3698
ifAll_802F3698:
/* 802F3698 002F0278  38 00 00 01 */	li r0, 1
/* 802F369C 002F027C  98 0D B6 B8 */	stb r0, ifAll_804D6D58@sda21(r13)
/* 802F36A0 002F0280  4E 80 00 20 */	blr

.global ifAll_802F36A4
ifAll_802F36A4:
/* 802F36A4 002F0284  38 00 00 00 */	li r0, 0
/* 802F36A8 002F0288  98 0D B6 B8 */	stb r0, ifAll_804D6D58@sda21(r13)
/* 802F36AC 002F028C  4E 80 00 20 */	blr

.global ifAll_802F36B0
ifAll_802F36B0:
/* 802F36B0 002F0290  88 6D B6 B8 */	lbz r3, ifAll_804D6D58@sda21(r13)
...
/* 802F36CC 002F02AC  88 0D B6 B8 */	lbz r0, ifAll_804D6D58@sda21(r13)
/* 802F36D0 002F02B0  2C 00 00 00 */	cmpwi r0, 0
/* 802F36D4 002F02B4  40 82 00 24 */	bne .L_802F36F8
...
/* 802F36E4 002F02C4  41 82 00 14 */	beq .L_802F36F8
/* 802F36E8 002F02C8  38 7F 00 00 */	addi r3, r31, 0
/* 802F36EC 002F02CC  38 80 00 07 */	li r4, 7
/* 802F36F0 002F02D0  48 09 D7 E1 */	bl HSD_GObj_80390ED0
...
/* 802F3710 002F02F0  3C 80 80 4A */	lis r4, ifAll_804A0FD8@ha
...
/* 802F3728 002F0308  3B E4 0F D8 */	addi r31, r4, ifAll_804A0FD8@l
...
/* 802F38A8 002F0488  41 80 FF CC */	blt .L_802F3874
...
/* 802F38EC 002F04CC  41 80 FF CC */	blt .L_802F38B8
/* 802F38F0 002F04D0  7F 83 E3 78 */	mr r3, r28
/* 802F38F4 002F04D4  48 09 C9 35 */	bl HSD_GObjPLink_80390228
...
/* 802F3910 002F04F0  38 8D A0 E0 */	addi r4, r13, ifAll_804D5780@sda21
...
/* 802F3920 002F0500  3B ED B6 BC */	addi r31, r13, ifAll_804D6D5C@sda21
...
/* 802F3934 002F0514  9B CD B6 B8 */	stb r30, ifAll_804D6D58@sda21(r13)
/* 802F3938 002F0518  4B D2 36 49 */	bl lbArchive_80016F80
/* 802F393C 002F051C  3C 80 80 40 */	lis r4, ifAll_803F94D0@ha
/* 802F3940 002F0520  80 7F 00 00 */	lwz r3, 0(r31)
/* 802F3944 002F0524  38 A4 94 D0 */	addi r5, r4, ifAll_803F94D0@l
/* 802F3948 002F0528  4C C6 31 82 */	crclr 6
/* 802F394C 002F052C  38 81 00 14 */	addi r4, r1, 0x14
/* 802F3950 002F0530  38 C0 00 00 */	li r6, 0
/* 802F3954 002F0534  4B D2 31 9D */	bl lbArchive_LoadSections
...
/* 802F3988 002F0568  88 8D C1 AB */	lbz r4, HSD_GObj_804D784B@sda21(r13)
/* 802F398C 002F056C  38 A3 00 00 */	addi r5, r3, 0
/* 802F3990 002F0570  38 7D 00 00 */	addi r3, r29, 0
/* 802F3994 002F0574  48 09 D0 DD */	bl HSD_GObjObject_80390A70
/* 802F3998 002F0578  3C 60 80 2F */	lis r3, .L_802F36B8@ha
/* 802F399C 002F057C  38 83 36 B8 */	addi r4, r3, .L_802F36B8@l
...
/* 802F39B4 002F0594  3C 60 80 4A */	lis r3, ifAll_804A0FD8@ha
/* 802F39B8 002F0598  3B E3 0F D8 */	addi r31, r3, ifAll_804A0FD8@l
...
/* 802F39F0 002F05D0  88 8D C1 AA */	lbz r4, HSD_GObj_804D784A@sda21(r13)
/* 802F39F4 002F05D4  38 A3 00 00 */	addi r5, r3, 0
/* 802F39F8 002F05D8  38 7D 00 00 */	addi r3, r29, 0
/* 802F39FC 002F05DC  48 09 D0 75 */	bl HSD_GObjObject_80390A70
/* 802F3A00 002F05E0  3C 60 80 39 */	lis r3, HSD_GObj_LObjCallback@ha
/* 802F3A04 002F05E4  38 83 10 44 */	addi r4, r3, HSD_GObj_LObjCallback@l
...
/* 802F3A1C 002F05FC  48 00 37 19 */	bl ifStatus_802F7134
/* 802F3A20 002F0600  48 00 2C 85 */	bl ifStatus_802F66A4
/* 802F3A24 002F0604  48 00 74 A1 */	bl ifStock_802FAEC4
/* 802F3A28 002F0608  48 00 0D E5 */	bl ifTime_802F480C
/* 802F3A2C 002F060C  48 00 43 F9 */	bl if_802F7E24
/* 802F3A30 002F0610  48 00 8E 41 */	bl ifMagnify_802FC870
...
/* 802F3A78 002F0658  48 00 79 19 */	bl ifStock_802FB390
/* 802F3A7C 002F065C  48 00 79 A1 */	bl ifStock_802FB41C
/* 802F3A80 002F0660  48 00 7A 05 */	bl ifStock_802FB484
/* 802F3A84 002F0664  48 00 8C CD */	bl ifMagnify_802FC750
/* 802F3A88 002F0668  48 00 43 F5 */	bl if_802F7E7C
/* 802F3A8C 002F066C  48 00 0D B1 */	bl ifTime_802F483C
/* 802F3A90 002F0670  48 00 2D 75 */	bl ifStatus_802F6804
/* 802F3A94 002F0674  48 00 37 8D */	bl ifStatus_802F7220
/* 802F3A98 002F0678  3C 60 80 4A */	lis r3, ifAll_804A0FD8@ha
/* 802F3A9C 002F067C  3B E3 0F D8 */	addi r31, r3, ifAll_804A0FD8@l
/* 802F3AA0 002F0680  80 7F 00 00 */	lwz r3, 0(r31)
/* 802F3AA4 002F0684  28 03 00 00 */	cmplwi r3, 0
/* 802F3AA8 002F0688  41 82 00 08 */	beq .L_802F3AB0
/* 802F3AAC 002F068C  48 09 C7 7D */	bl HSD_GObjPLink_80390228
.L_802F3AB0:
/* 802F3AB0 002F0690  80 7F 00 04 */	lwz r3, 4(r31)
/* 802F3AB4 002F0694  28 03 00 00 */	cmplwi r3, 0
/* 802F3AB8 002F0698  41 82 00 08 */	beq .L_802F3AC0
/* 802F3ABC 002F069C  48 09 C7 6D */	bl HSD_GObjPLink_80390228
.L_802F3AC0:
...
.section .sbss
    .balign 8
.global ifAll_804D6D58
ifAll_804D6D58:
    .skip 0x4
.global ifAll_804D6D5C
ifAll_804D6D5C:
    .skip 0x4
