...
/* 8000CE58 00009A38  C0 02 80 A8 */	lfs f0, lb_804D7A88@sda21(r2)
/* 8000CE5C 00009A3C  C0 C2 80 98 */	lfs f6, lb_804D7A78@sda21(r2)
/* 8000CE60 00009A40  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8000CE64 00009A44  40 80 00 10 */	bge .L_8000CE74
/* 8000CE68 00009A48  FC 20 08 50 */	fneg f1, f1
/* 8000CE6C 00009A4C  38 80 00 01 */	li r4, 1
/* 8000CE70 00009A50  48 00 00 08 */	b .L_8000CE78
.L_8000CE74:
/* 8000CE74 00009A54  38 80 00 00 */	li r4, 0
.L_8000CE78:
/* 8000CE78 00009A58  C0 02 80 98 */	lfs f0, lb_804D7A78@sda21(r2)
/* 8000CE7C 00009A5C  FC 80 08 90 */	fmr f4, f1
/* 8000CE80 00009A60  C8 42 80 A0 */	lfd f2, lb_804D7A80@sda21(r2)
...
/* 8000CEC0 00009AA0  40 82 FF CC */	bne .L_8000CE8C
/* 8000CEC4 00009AA4  2C 04 00 00 */	cmpwi r4, 0
/* 8000CEC8 00009AA8  41 82 00 0C */	beq .L_8000CED4
/* 8000CECC 00009AAC  C0 02 80 98 */	lfs f0, lb_804D7A78@sda21(r2)
...
/* 8000CEEC 00009ACC  C0 02 80 A8 */	lfs f0, lb_804D7A88@sda21(r2)
/* 8000CEF0 00009AD0  FC 00 08 00 */	fcmpu cr0, f0, f1
/* 8000CEF4 00009AD4  40 82 00 0C */	bne .L_8000CF00
/* 8000CEF8 00009AD8  FC 20 00 90 */	fmr f1, f0
/* 8000CEFC 00009ADC  48 00 00 68 */	b .L_8000CF64
.L_8000CF00:
/* 8000CF00 00009AE0  C0 02 80 98 */	lfs f0, lb_804D7A78@sda21(r2)
/* 8000CF04 00009AE4  38 80 00 01 */	li r4, 1
/* 8000CF08 00009AE8  C8 62 80 A0 */	lfd f3, lb_804D7A80@sda21(r2)
...
/* 8000CF50 00009B30  40 82 FF D4 */	bne .L_8000CF24
/* 8000CF54 00009B34  C0 02 80 9C */	lfs f0, lb_804D7A7C@sda21(r2)
...
/* 8000CFB4 00009B94  40 81 00 2C */	ble .L_8000CFE0
.L_8000CFB8:
...
/* 8000CFDC 00009BBC  42 00 FF DC */	bdnz .L_8000CFB8
.L_8000CFE0:
...
/* 8000CFEC 00009BCC  40 80 00 0C */	bge .L_8000CFF8
.L_8000CFF0:
/* 8000CFF0 00009BD0  7C E7 19 D6 */	mullw r7, r7, r3
/* 8000CFF4 00009BD4  42 00 FF FC */	bdnz .L_8000CFF0
.L_8000CFF8:
...
/* 8000D018 00009BF8  C0 02 80 C0 */	lfs f0, lb_804D7AA0@sda21(r2)
/* 8000D01C 00009BFC  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 8000D020 00009C00  40 80 00 18 */	bge .L_8000D038
/* 8000D024 00009C04  C0 02 80 C4 */	lfs f0, lb_804D7AA4@sda21(r2)
/* 8000D028 00009C08  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 8000D02C 00009C0C  40 81 00 0C */	ble .L_8000D038
/* 8000D030 00009C10  38 00 00 01 */	li r0, 1
/* 8000D034 00009C14  48 00 00 08 */	b .L_8000D03C
.L_8000D038:
/* 8000D038 00009C18  38 00 00 00 */	li r0, 0
.L_8000D03C:
/* 8000D03C 00009C1C  2C 00 00 00 */	cmpwi r0, 0
/* 8000D040 00009C20  41 82 00 7C */	beq .L_8000D0BC
/* 8000D044 00009C24  C0 02 80 C0 */	lfs f0, lb_804D7AA0@sda21(r2)
/* 8000D048 00009C28  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8000D04C 00009C2C  40 80 00 18 */	bge .L_8000D064
/* 8000D050 00009C30  C0 02 80 C4 */	lfs f0, lb_804D7AA4@sda21(r2)
/* 8000D054 00009C34  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8000D058 00009C38  40 81 00 0C */	ble .L_8000D064
/* 8000D05C 00009C3C  38 00 00 01 */	li r0, 1
/* 8000D060 00009C40  48 00 00 08 */	b .L_8000D068
.L_8000D064:
/* 8000D064 00009C44  38 00 00 00 */	li r0, 0
.L_8000D068:
/* 8000D068 00009C48  2C 00 00 00 */	cmpwi r0, 0
/* 8000D06C 00009C4C  41 82 00 0C */	beq .L_8000D078
/* 8000D070 00009C50  C0 22 80 A8 */	lfs f1, lb_804D7A88@sda21(r2)
/* 8000D074 00009C54  48 00 00 C0 */	b .L_8000D134
.L_8000D078:
/* 8000D078 00009C58  C0 02 80 A8 */	lfs f0, lb_804D7A88@sda21(r2)
/* 8000D07C 00009C5C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8000D080 00009C60  40 80 00 0C */	bge .L_8000D08C
/* 8000D084 00009C64  38 00 FF FF */	li r0, -1
/* 8000D088 00009C68  48 00 00 08 */	b .L_8000D090
.L_8000D08C:
/* 8000D08C 00009C6C  38 00 00 01 */	li r0, 1
.L_8000D090:
/* 8000D090 00009C70  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 8000D094 00009C74  C8 22 80 A0 */	lfd f1, lb_804D7A80@sda21(r2)
/* 8000D098 00009C78  90 01 00 14 */	stw r0, 0x14(r1)
/* 8000D09C 00009C7C  3C 00 43 30 */	lis r0, 0x4330
/* 8000D0A0 00009C80  C8 42 80 88 */	lfd f2, lb_804D7A68@sda21(r2)
...
/* 8000D0B8 00009C98  48 00 00 7C */	b .L_8000D134
.L_8000D0BC:
/* 8000D0BC 00009C9C  C0 02 80 A8 */	lfs f0, lb_804D7A88@sda21(r2)
/* 8000D0C0 00009CA0  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 8000D0C4 00009CA4  40 81 00 10 */	ble .L_8000D0D4
/* 8000D0C8 00009CA8  EC 21 10 24 */	fdivs f1, f1, f2
/* 8000D0CC 00009CAC  48 01 5D 9D */	bl atanf
/* 8000D0D0 00009CB0  48 00 00 64 */	b .L_8000D134
.L_8000D0D4:
/* 8000D0D4 00009CB4  40 80 00 60 */	bge .L_8000D134
/* 8000D0D8 00009CB8  EC 41 10 24 */	fdivs f2, f1, f2
/* 8000D0DC 00009CBC  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 8000D0E0 00009CC0  40 80 00 08 */	bge .L_8000D0E8
/* 8000D0E4 00009CC4  FC 40 10 50 */	fneg f2, f2
.L_8000D0E8:
/* 8000D0E8 00009CC8  C0 02 80 A8 */	lfs f0, lb_804D7A88@sda21(r2)
/* 8000D0EC 00009CCC  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8000D0F0 00009CD0  40 80 00 0C */	bge .L_8000D0FC
/* 8000D0F4 00009CD4  3B E0 FF FF */	li r31, -1
/* 8000D0F8 00009CD8  48 00 00 08 */	b .L_8000D100
.L_8000D0FC:
...
/* 8000D10C 00009CEC  C8 02 80 90 */	lfd f0, lb_804D7A70@sda21(r2)
/* 8000D110 00009CF0  90 01 00 14 */	stw r0, 0x14(r1)
/* 8000D114 00009CF4  3C 00 43 30 */	lis r0, 0x4330
/* 8000D118 00009CF8  C8 42 80 A0 */	lfd f2, lb_804D7A80@sda21(r2)
...
/* 8000D160 00009D40  C1 42 80 C0 */	lfs f10, lb_804D7AA0@sda21(r2)
...
/* 8000D174 00009D54  40 80 00 0C */	bge .L_8000D180
/* 8000D178 00009D58  38 60 00 00 */	li r3, 0
/* 8000D17C 00009D5C  48 00 01 64 */	b .L_8000D2E0
.L_8000D180:
/* 8000D180 00009D60  C1 42 80 A8 */	lfs f10, lb_804D7A88@sda21(r2)
/* 8000D184 00009D64  FC 1F 50 40 */	fcmpo cr0, f31, f10
/* 8000D188 00009D68  40 81 00 54 */	ble .L_8000D1DC
/* 8000D18C 00009D6C  FD 60 F8 34 */	frsqrte f11, f31
/* 8000D190 00009D70  C9 A2 80 B0 */	lfd f13, lb_804D7A90@sda21(r2)
/* 8000D194 00009D74  C9 82 80 B8 */	lfd f12, lb_804D7A98@sda21(r2)
...
/* 8000D1D8 00009DB8  48 00 00 08 */	b .L_8000D1E0
.L_8000D1DC:
/* 8000D1DC 00009DBC  FD 60 F8 90 */	fmr f11, f31
.L_8000D1E0:
/* 8000D1E0 00009DC0  ED 48 01 B2 */	fmuls f10, f8, f6
/* 8000D1E4 00009DC4  C1 02 80 A8 */	lfs f8, lb_804D7A88@sda21(r2)
...
/* 8000D1F4 00009DD4  40 80 00 08 */	bge .L_8000D1FC
...
/* 8000D208 00009DE8  40 82 00 D4 */	bne .L_8000D2DC
...
/* 8000D23C 00009E1C  40 80 00 28 */	bge .L_8000D264
/* 8000D240 00009E20  FC 00 58 40 */	fcmpo cr0, f0, f11
/* 8000D244 00009E24  40 81 00 0C */	ble .L_8000D250
/* 8000D248 00009E28  38 60 00 01 */	li r3, 1
/* 8000D24C 00009E2C  48 00 00 94 */	b .L_8000D2E0
.L_8000D250:
/* 8000D250 00009E30  40 80 00 0C */	bge .L_8000D25C
/* 8000D254 00009E34  38 60 00 00 */	li r3, 0
/* 8000D258 00009E38  48 00 00 88 */	b .L_8000D2E0
.L_8000D25C:
/* 8000D25C 00009E3C  38 60 00 01 */	li r3, 1
/* 8000D260 00009E40  48 00 00 80 */	b .L_8000D2E0
.L_8000D264:
/* 8000D264 00009E44  40 81 00 70 */	ble .L_8000D2D4
/* 8000D268 00009E48  FC 00 58 40 */	fcmpo cr0, f0, f11
/* 8000D26C 00009E4C  40 81 00 54 */	ble .L_8000D2C0
/* 8000D270 00009E50  FC 01 28 40 */	fcmpo cr0, f1, f5
/* 8000D274 00009E54  40 81 00 0C */	ble .L_8000D280
/* 8000D278 00009E58  FC 03 28 40 */	fcmpo cr0, f3, f5
/* 8000D27C 00009E5C  41 80 00 34 */	blt .L_8000D2B0
.L_8000D280:
/* 8000D280 00009E60  FC 01 28 40 */	fcmpo cr0, f1, f5
/* 8000D284 00009E64  40 80 00 0C */	bge .L_8000D290
/* 8000D288 00009E68  FC 03 28 40 */	fcmpo cr0, f3, f5
/* 8000D28C 00009E6C  41 81 00 24 */	bgt .L_8000D2B0
.L_8000D290:
/* 8000D290 00009E70  FC 02 30 40 */	fcmpo cr0, f2, f6
/* 8000D294 00009E74  40 81 00 0C */	ble .L_8000D2A0
/* 8000D298 00009E78  FC 04 30 40 */	fcmpo cr0, f4, f6
/* 8000D29C 00009E7C  41 80 00 14 */	blt .L_8000D2B0
.L_8000D2A0:
/* 8000D2A0 00009E80  FC 02 30 40 */	fcmpo cr0, f2, f6
/* 8000D2A4 00009E84  40 80 00 14 */	bge .L_8000D2B8
/* 8000D2A8 00009E88  FC 04 30 40 */	fcmpo cr0, f4, f6
/* 8000D2AC 00009E8C  40 81 00 0C */	ble .L_8000D2B8
.L_8000D2B0:
/* 8000D2B0 00009E90  38 60 00 01 */	li r3, 1
/* 8000D2B4 00009E94  48 00 00 2C */	b .L_8000D2E0
.L_8000D2B8:
/* 8000D2B8 00009E98  38 60 00 00 */	li r3, 0
/* 8000D2BC 00009E9C  48 00 00 24 */	b .L_8000D2E0
.L_8000D2C0:
/* 8000D2C0 00009EA0  40 80 00 0C */	bge .L_8000D2CC
/* 8000D2C4 00009EA4  38 60 00 01 */	li r3, 1
/* 8000D2C8 00009EA8  48 00 00 18 */	b .L_8000D2E0
.L_8000D2CC:
/* 8000D2CC 00009EAC  38 60 00 01 */	li r3, 1
/* 8000D2D0 00009EB0  48 00 00 10 */	b .L_8000D2E0
.L_8000D2D4:
/* 8000D2D4 00009EB4  38 60 00 01 */	li r3, 1
/* 8000D2D8 00009EB8  48 00 00 08 */	b .L_8000D2E0
.L_8000D2DC:
