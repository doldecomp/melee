...
.fn lbArchive_InitializeDAT, global
/* 80016A54 00013634  7C 08 02 A6 */	mflr r0
/* 80016A58 00013638  90 01 00 04 */	stw r0, 0x4(r1)
...
/* 80016A68 00013648  3B C0 00 00 */	li r30, 0x0
/* 80016A6C 0001364C  93 A1 00 1C */	stw r29, 0x1c(r1)
/* 80016A70 00013650  3B A3 00 00 */	addi r29, r3, 0x0
/* 80016A74 00013654  48 36 97 71 */	bl HSD_ArchiveParse
/* 80016A78 00013658  2C 03 FF FF */	cmpwi r3, -0x1
/* 80016A7C 0001365C  40 82 00 28 */	bne .L_80016AA4
/* 80016A80 00013660  3C 60 80 3C */	lis r3, lbArchive_803BA588@ha
/* 80016A84 00013664  4C C6 31 82 */	crclr cr1eq
/* 80016A88 00013668  38 63 A5 88 */	addi r3, r3, lbArchive_803BA588@l
/* 80016A8C 0001366C  48 32 EC 1D */	bl OSReport
/* 80016A90 00013670  3C 60 80 3C */	lis r3, lbArchive_803BA5A4@ha
/* 80016A94 00013674  38 63 A5 A4 */	addi r3, r3, lbArchive_803BA5A4@l
/* 80016A98 00013678  38 80 00 49 */	li r4, 0x49
/* 80016A9C 0001367C  38 AD 81 20 */	li r5, lbArchive_804D37C0@sda21
/* 80016AA0 00013680  48 37 17 81 */	bl __assert
.L_80016AA4:
/* 80016AA4 00013684  38 9E 00 00 */	addi r4, r30, 0x0
/* 80016AA8 00013688  38 7D 00 00 */	addi r3, r29, 0x0
/* 80016AAC 0001368C  3B DE 00 01 */	addi r30, r30, 0x1
/* 80016AB0 00013690  48 36 99 4D */	bl HSD_ArchiveGetExtern
/* 80016AB4 00013694  7C 7F 1B 79 */	mr. r31, r3
/* 80016AB8 00013698  41 82 00 14 */	beq .L_80016ACC
/* 80016ABC 0001369C  38 7D 00 00 */	addi r3, r29, 0x0
/* 80016AC0 000136A0  38 9F 00 00 */	addi r4, r31, 0x0
/* 80016AC4 000136A4  38 A0 00 00 */	li r5, 0x0
/* 80016AC8 000136A8  48 36 99 6D */	bl HSD_ArchiveLocateExtern
.L_80016ACC:
/* 80016ACC 000136AC  28 1F 00 00 */	cmplwi r31, 0x0
/* 80016AD0 000136B0  40 82 FF D4 */	bne .L_80016AA4
...
.endfn lbArchive_InitializeDAT

.fn lbArchive_LoadSections, global
/* 80016AF0 000136D0  7C 08 02 A6 */	mflr r0
/* 80016AF4 000136D4  90 01 00 04 */	stw r0, 0x4(r1)
/* 80016AF8 000136D8  94 21 FF 68 */	stwu r1, -0x98(r1)
/* 80016AFC 000136DC  BF 61 00 84 */	stmw r27, 0x84(r1)
/* 80016B00 000136E0  40 86 00 24 */	bne cr1, .L_80016B24
...
.L_80016B24:
/* 80016B24 00013704  90 61 00 08 */	stw r3, 0x8(r1)
/* 80016B28 00013708  3C 00 02 00 */	lis r0, 0x200
/* 80016B2C 0001370C  3B 63 00 00 */	addi r27, r3, 0x0
/* 80016B30 00013710  90 81 00 0C */	stw r4, 0xc(r1)
/* 80016B34 00013714  3B 84 00 00 */	addi r28, r4, 0x0
/* 80016B38 00013718  3B C0 00 00 */	li r30, 0x0
...
/* 80016B68 00013748  38 01 00 08 */	addi r0, r1, 0x8
/* 80016B6C 0001374C  90 01 00 78 */	stw r0, 0x78(r1)
/* 80016B70 00013750  48 00 00 54 */	b .L_80016BC4
.L_80016B74:
/* 80016B74 00013754  38 61 00 70 */	addi r3, r1, 0x70
/* 80016B78 00013758  38 80 00 01 */	li r4, 0x1
/* 80016B7C 0001375C  48 30 BA A5 */	bl __va_arg
/* 80016B80 00013760  83 A3 00 00 */	lwz r29, 0x0(r3)
/* 80016B84 00013764  7F 63 DB 78 */	mr r3, r27
/* 80016B88 00013768  93 DC 00 00 */	stw r30, 0x0(r28)
/* 80016B8C 0001376C  7F A4 EB 78 */	mr r4, r29
/* 80016B90 00013770  48 36 97 C9 */	bl HSD_ArchiveGetPublicAddress
/* 80016B94 00013774  90 7C 00 00 */	stw r3, 0x0(r28)
/* 80016B98 00013778  80 1C 00 00 */	lwz r0, 0x0(r28)
/* 80016B9C 0001377C  28 00 00 00 */	cmplwi r0, 0x0
/* 80016BA0 00013780  40 82 00 14 */	bne .L_80016BB4
/* 80016BA4 00013784  38 7F 00 00 */	addi r3, r31, 0x0
/* 80016BA8 00013788  4C C6 31 82 */	crclr cr1eq
/* 80016BAC 0001378C  38 9D 00 00 */	addi r4, r29, 0x0
/* 80016BB0 00013790  48 32 EA F9 */	bl OSReport
.L_80016BB4:
/* 80016BB4 00013794  38 61 00 70 */	addi r3, r1, 0x70
/* 80016BB8 00013798  38 80 00 01 */	li r4, 0x1
/* 80016BBC 0001379C  48 30 BA 65 */	bl __va_arg
/* 80016BC0 000137A0  83 83 00 00 */	lwz r28, 0x0(r3)
.L_80016BC4:
/* 80016BC4 000137A4  28 1C 00 00 */	cmplwi r28, 0x0
/* 80016BC8 000137A8  40 82 FF AC */	bne .L_80016B74
...
.endfn lbArchive_LoadSections

.fn lbArchive_LoadArchive, global
/* 80016BE0 000137C0  7C 08 02 A6 */	mflr r0
/* 80016BE4 000137C4  90 01 00 04 */	stw r0, 0x4(r1)
...
/* 80016BFC 000137DC  4B FF F7 DD */	bl lbFile_800163D8
/* 80016C00 000137E0  38 03 00 1F */	addi r0, r3, 0x1f
/* 80016C04 000137E4  54 04 00 34 */	clrrwi r4, r0, 5
/* 80016C08 000137E8  38 60 00 00 */	li r3, 0x0
/* 80016C0C 000137EC  4B FF EF C5 */	bl lbHeap_80015BD0
/* 80016C10 000137F0  3B E3 00 00 */	addi r31, r3, 0x0
/* 80016C14 000137F4  38 60 00 00 */	li r3, 0x0
/* 80016C18 000137F8  38 80 00 44 */	li r4, 0x44
/* 80016C1C 000137FC  4B FF EF B5 */	bl lbHeap_80015BD0
/* 80016C20 00013800  3B C3 00 00 */	addi r30, r3, 0x0
/* 80016C24 00013804  38 7D 00 00 */	addi r3, r29, 0x0
/* 80016C28 00013808  38 9F 00 00 */	addi r4, r31, 0x0
/* 80016C2C 0001380C  38 A1 00 0C */	addi r5, r1, 0xc
/* 80016C30 00013810  4B FF FA 5D */	bl lbFile_8001668C
/* 80016C34 00013814  80 A1 00 0C */	lwz r5, 0xc(r1)
/* 80016C38 00013818  38 7E 00 00 */	addi r3, r30, 0x0
/* 80016C3C 0001381C  38 9F 00 00 */	addi r4, r31, 0x0
/* 80016C40 00013820  4B FF FE 15 */	bl lbArchive_InitializeDAT
...
.endfn lbArchive_LoadArchive

.global lbArchive_80016C64
lbArchive_80016C64:
...
/* 80016C74 00013854  40 86 00 24 */	bne cr1, .L_80016C98
...
/* 80016CD8 000138B8  4B FF F7 01 */	bl lbFile_800163D8
...
/* 80016D0C 000138EC  4B FF F9 81 */	bl lbFile_8001668C
...
/* 80016D68 00013948  40 82 00 24 */	bne .L_80016D8C
...
/* 80016DA0 00013980  40 82 FF 98 */	bne .L_80016D38
...
/* 80016DCC 000139AC  40 86 00 24 */	bne cr1, .L_80016DF0
...
/* 80016E30 00013A10  4B FF F5 A9 */	bl lbFile_800163D8
...
/* 80016E64 00013A44  4B FF F8 29 */	bl lbFile_8001668C
...
/* 80016EB8 00013A98  40 82 00 14 */	bne .L_80016ECC
...
/* 80016EE0 00013AC0  40 82 FF AC */	bne .L_80016E8C
...
/* 80016F38 00013B18  40 82 00 14 */	bne .L_80016F4C
...
/* 80016F58 00013B38  4B FF ED 51 */	bl lbHeap_80015CA8
/* 80016F5C 00013B3C  38 60 00 00 */	li r3, 0
/* 80016F60 00013B40  38 9E 00 00 */	addi r4, r30, 0
/* 80016F64 00013B44  4B FF ED 45 */	bl lbHeap_80015CA8
...
/* 80016FA8 00013B88  48 00 11 F5 */	bl lbDvd_8001819C
/* 80016FAC 00013B8C  28 03 00 00 */	cmplwi r3, 0
/* 80016FB0 00013B90  41 82 00 0C */	beq .L_80016FBC
/* 80016FB4 00013B94  38 00 00 01 */	li r0, 1
/* 80016FB8 00013B98  48 00 00 58 */	b .L_80017010
.L_80016FBC:
/* 80016FBC 00013B9C  7F A3 EB 78 */	mr r3, r29
/* 80016FC0 00013BA0  4B FF F4 19 */	bl lbFile_800163D8
...
/* 80016FF4 00013BD4  4B FF F6 99 */	bl lbFile_8001668C
...
/* 80017004 00013BE4  4B FF FA 51 */	bl lbArchive_InitializeDAT
...
/* 80017014 00013BF4  41 82 00 08 */	beq .L_8001701C
...
/* 80017050 00013C30  40 86 00 24 */	bne cr1, .L_80017074
...
/* 800170BC 00013C9C  48 00 10 E1 */	bl lbDvd_8001819C
/* 800170C0 00013CA0  7C 7A 1B 79 */	or. r26, r3, r3
/* 800170C4 00013CA4  41 82 00 0C */	beq .L_800170D0
/* 800170C8 00013CA8  3B 20 00 01 */	li r25, 1
/* 800170CC 00013CAC  48 00 00 58 */	b .L_80017124
.L_800170D0:
/* 800170D0 00013CB0  7F 23 CB 78 */	mr r3, r25
/* 800170D4 00013CB4  4B FF F3 05 */	bl lbFile_800163D8
...
/* 80017108 00013CE8  4B FF F5 85 */	bl lbFile_8001668C
...
/* 80017118 00013CF8  4B FF F9 3D */	bl lbArchive_InitializeDAT
...
/* 8001716C 00013D4C  40 82 00 24 */	bne .L_80017190
...
/* 800171A4 00013D84  40 82 FF 98 */	bne .L_8001713C
/* 800171A8 00013D88  28 1F 00 00 */	cmplwi r31, 0
/* 800171AC 00013D8C  41 82 00 08 */	beq .L_800171B4
...
/* 800171DC 00013DBC  40 86 00 24 */	bne cr1, .L_80017200
...
/* 80017248 00013E28  48 00 0F 55 */	bl lbDvd_8001819C
/* 8001724C 00013E2C  7C 7A 1B 79 */	or. r26, r3, r3
/* 80017250 00013E30  41 82 00 0C */	beq .L_8001725C
/* 80017254 00013E34  3B 20 00 01 */	li r25, 1
/* 80017258 00013E38  48 00 00 58 */	b .L_800172B0
.L_8001725C:
/* 8001725C 00013E3C  7F 23 CB 78 */	mr r3, r25
/* 80017260 00013E40  4B FF F1 79 */	bl lbFile_800163D8
...
/* 80017294 00013E74  4B FF F3 F9 */	bl lbFile_8001668C
...
/* 800172A4 00013E84  4B FF F7 B1 */	bl lbArchive_InitializeDAT
...
/* 800172F0 00013ED0  40 82 00 14 */	bne .L_80017304
...
/* 80017318 00013EF8  40 82 FF AC */	bne .L_800172C4
/* 8001731C 00013EFC  28 1F 00 00 */	cmplwi r31, 0
/* 80017320 00013F00  41 82 00 08 */	beq .L_80017328
...
/* 8001736C 00013F4C  40 82 00 0C */	bne .L_80017378
/* 80017370 00013F50  38 60 FF FF */	li r3, -1
/* 80017374 00013F54  48 00 01 28 */	b .L_8001749C
.L_80017378:
...
/* 800173C8 00013FA8  48 00 00 D4 */	b .L_8001749C
.L_800173CC:
...
/* 800173D8 00013FB8  41 82 00 14 */	beq .L_800173EC
...
/* 800173F4 00013FD4  41 82 00 18 */	beq .L_8001740C
...
/* 80017414 00013FF4  41 82 00 18 */	beq .L_8001742C
...
/* 80017434 00014014  41 82 00 18 */	beq .L_8001744C
...
/* 80017454 00014034  40 80 00 0C */	bge .L_80017460
...
/* 80017468 00014048  48 00 00 24 */	b .L_8001748C
.L_8001746C:
...
/* 80017494 00014074  41 80 FF D8 */	blt .L_8001746C
