...
/* 80021D48 0001E928  C8 42 83 C0 */	lfd f2, .L_804D7DA0@sda21(r2)
/* 80021D4C 0001E92C  38 03 FF FF */	addi r0, r3, -1
/* 80021D50 0001E930  90 C1 00 3C */	stw r6, 0x3c(r1)
/* 80021D54 0001E934  C0 62 83 90 */	lfs f3, .L_804D7D70@sda21(r2)
/* 80021D58 0001E938  90 01 00 34 */	stw r0, 0x34(r1)
/* 80021D5C 0001E93C  C2 A2 83 B0 */	lfs f21, .L_804D7D90@sda21(r2)
/* 80021D60 0001E940  90 A1 00 38 */	stw r5, 0x38(r1)
/* 80021D64 0001E944  C3 42 83 94 */	lfs f26, .L_804D7D74@sda21(r2)
...
/* 80021D78 0001E958  C3 A2 83 98 */	lfs f29, .L_804D7D78@sda21(r2)
/* 80021D7C 0001E95C  EC 00 10 28 */	fsubs f0, f0, f2
/* 80021D80 0001E960  CB C2 83 A0 */	lfd f30, .L_804D7D80@sda21(r2)
/* 80021D84 0001E964  CB E2 83 A8 */	lfd f31, .L_804D7D88@sda21(r2)
/* 80021D88 0001E968  EF 83 08 24 */	fdivs f28, f3, f1
/* 80021D8C 0001E96C  C2 C2 83 B8 */	lfs f22, .L_804D7D98@sda21(r2)
/* 80021D90 0001E970  C2 E2 83 B4 */	lfs f23, .L_804D7D94@sda21(r2)
/* 80021D94 0001E974  EF 63 00 24 */	fdivs f27, f3, f0
/* 80021D98 0001E978  48 00 01 3C */	b .L_80021ED4
.L_80021D9C:
/* 80021D9C 0001E97C  EF 1A 06 B2 */	fmuls f24, f26, f26
/* 80021DA0 0001E980  C3 22 83 94 */	lfs f25, .L_804D7D74@sda21(r2)
/* 80021DA4 0001E984  3B 60 00 00 */	li r27, 0
/* 80021DA8 0001E988  48 00 01 18 */	b .L_80021EC0
.L_80021DAC:
/* 80021DAC 0001E98C  EC 59 C6 7A */	fmadds f2, f25, f25, f24
/* 80021DB0 0001E990  FC 02 E8 40 */	fcmpo cr0, f2, f29
/* 80021DB4 0001E994  40 81 00 48 */	ble .L_80021DFC
...
/* 80021E04 0001E9E4  40 81 00 08 */	ble .L_80021E0C
...
/* 80021E1C 0001E9FC  41 82 00 34 */	beq .L_80021E50
...
/* 80021E2C 0001EA0C  40 81 00 0C */	ble .L_80021E38
/* 80021E30 0001EA10  FC 00 98 90 */	fmr f0, f19
/* 80021E34 0001EA14  48 00 00 14 */	b .L_80021E48
.L_80021E38:
...
/* 80021E4C 0001EA2C  48 00 00 08 */	b .L_80021E54
.L_80021E50:
...
/* 80021E6C 0001EA4C  40 81 00 08 */	ble .L_80021E74
...
/* 80021EC8 0001EAA8  41 80 FE E4 */	blt .L_80021DAC
...
/* 80021EDC 0001EABC  41 80 FE C0 */	blt .L_80021D9C
...
/* 80022028 0001EC08  41 82 00 0C */	beq .L_80022034
...
/* 80022038 0001EC18  41 82 00 0C */	beq .L_80022044
...
/* 80022048 0001EC28  41 82 00 10 */	beq .L_80022058
...
/* 800220A0 0001EC80  41 82 00 0C */	beq .L_800220AC
...
/* 800220B0 0001EC90  41 82 00 24 */	beq .L_800220D4
...
/* 800220C0 0001ECA0  41 82 00 0C */	beq .L_800220CC
/* 800220C4 0001ECA4  38 00 00 07 */	li r0, 7
/* 800220C8 0001ECA8  48 00 00 08 */	b .L_800220D0
.L_800220CC:
...
/* 800220D8 0001ECB8  41 82 00 24 */	beq .L_800220FC
...
/* 800220E8 0001ECC8  41 82 00 0C */	beq .L_800220F4
/* 800220EC 0001ECCC  38 00 00 03 */	li r0, 3
/* 800220F0 0001ECD0  48 00 00 08 */	b .L_800220F8
.L_800220F4:
...
/* 80022108 0001ECE8  41 82 00 0C */	beq .L_80022114
/* 8002210C 0001ECEC  38 00 00 07 */	li r0, 7
/* 80022110 0001ECF0  48 00 00 08 */	b .L_80022118
.L_80022114:
...
/* 80022150 0001ED30  41 82 00 0C */	beq .L_8002215C
...
/* 80022160 0001ED40  41 82 00 10 */	beq .L_80022170
...
/* 80022174 0001ED54  41 82 00 10 */	beq .L_80022184
...
/* 800221EC 0001EDCC  41 82 00 90 */	beq .L_8002227C
/* 800221F0 0001EDD0  40 80 00 14 */	bge .L_80022204
/* 800221F4 0001EDD4  2C 1E 00 03 */	cmpwi r30, 3
/* 800221F8 0001EDD8  41 82 00 18 */	beq .L_80022210
/* 800221FC 0001EDDC  40 80 00 38 */	bge .L_80022234
/* 80022200 0001EDE0  48 00 00 7C */	b .L_8002227C
.L_80022204:
/* 80022204 0001EDE4  2C 1E 00 07 */	cmpwi r30, 7
/* 80022208 0001EDE8  40 80 00 74 */	bge .L_8002227C
/* 8002220C 0001EDEC  48 00 00 4C */	b .L_80022258
.L_80022210:
/* 80022210 0001EDF0  3C 60 80 02 */	lis r3, .L_80021F34@ha
/* 80022214 0001EDF4  38 03 1F 34 */	addi r0, r3, .L_80021F34@l
/* 80022218 0001EDF8  3C 60 80 02 */	lis r3, .L_80021FF8@ha
/* 8002221C 0001EDFC  90 1D 00 18 */	stw r0, 0x18(r29)
/* 80022220 0001EE00  38 03 1F F8 */	addi r0, r3, .L_80021FF8@l
...
/* 80022230 0001EE10  48 00 00 54 */	b .L_80022284
.L_80022234:
/* 80022234 0001EE14  3C 60 80 02 */	lis r3, .L_80021F70@ha
/* 80022238 0001EE18  38 03 1F 70 */	addi r0, r3, .L_80021F70@l
/* 8002223C 0001EE1C  3C 60 80 02 */	lis r3, .L_8002206C@ha
/* 80022240 0001EE20  90 1D 00 18 */	stw r0, 0x18(r29)
/* 80022244 0001EE24  38 03 20 6C */	addi r0, r3, .L_8002206C@l
...
/* 80022254 0001EE34  48 00 00 30 */	b .L_80022284
.L_80022258:
/* 80022258 0001EE38  3C 60 80 02 */	lis r3, .L_80021FB4@ha
/* 8002225C 0001EE3C  38 03 1F B4 */	addi r0, r3, .L_80021FB4@l
/* 80022260 0001EE40  3C 60 80 02 */	lis r3, .L_80022120@ha
/* 80022264 0001EE44  90 1D 00 18 */	stw r0, 0x18(r29)
/* 80022268 0001EE48  38 03 21 20 */	addi r0, r3, .L_80022120@l
...
/* 80022278 0001EE58  48 00 00 0C */	b .L_80022284
.L_8002227C:
/* 8002227C 0001EE5C  38 60 FF FF */	li r3, -1
/* 80022280 0001EE60  48 00 00 08 */	b .L_80022288
.L_80022284:
