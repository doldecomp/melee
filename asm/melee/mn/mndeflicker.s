...
/* 8024A180 00246D60  A0 6D B5 28 */	lhz r3, lbl_804D6BC8-_SDA_BASE_(r13)
/* 8024A184 00246D64  80 8D B5 98 */	lwz r4, lbl_804D6C38-_SDA_BASE_(r13)
...
/* 8024A198 00246D78  B0 0D B5 28 */	sth r0, lbl_804D6BC8-_SDA_BASE_(r13)
/* 8024A19C 00246D7C  38 00 00 00 */	li r0, 0
/* 8024A1A0 00246D80  38 6D B5 28 */	addi r3, r13, lbl_804D6BC8-_SDA_BASE_
...
/* 8024A1F0 00246DD0  80 6D B5 98 */	lwz r3, lbl_804D6C38-_SDA_BASE_(r13)
...
lbl_8024A21C:
/* 8024A21C 00246DFC  88 0D B5 9C */	lbz r0, lbl_804D6C3C-_SDA_BASE_(r13)
...
/* 8024A26C 00246E4C  80 6D B5 98 */	lwz r3, lbl_804D6C38-_SDA_BASE_(r13)
...
/* 8024A284 00246E64  C8 22 C6 B8 */	lfd f1, lbl_804DC098-_SDA2_BASE_(r2)
...
/* 8024A2BC 00246E9C  80 6D B5 98 */	lwz r3, lbl_804D6C38-_SDA_BASE_(r13)
...
/* 8024A374 00246F54  80 6D C1 98 */	lwz r3, lbl_804D7838-_SDA_BASE_(r13)
...
/* 8024A390 00246F70  80 8D C1 9C */	lwz r4, lbl_804D783C-_SDA_BASE_(r13)
...
/* 8024A418 00246FF8  80 6D C1 98 */	lwz r3, lbl_804D7838-_SDA_BASE_(r13)
...
/* 8024A434 00247014  80 8D C1 9C */	lwz r4, lbl_804D783C-_SDA_BASE_(r13)
...
/* 8024A470 00247050  80 6D C1 98 */	lwz r3, lbl_804D7838-_SDA_BASE_(r13)
...
/* 8024A48C 0024706C  80 AD C1 9C */	lwz r5, lbl_804D783C-_SDA_BASE_(r13)
...
/* 8024A4A0 00247080  98 0D B5 9C */	stb r0, lbl_804D6C3C-_SDA_BASE_(r13)
lbl_8024A4A4:
...
/* 8024A4FC 002470DC  93 8D B5 98 */	stw r28, lbl_804D6C38-_SDA_BASE_(r13)
...
/* 8024A50C 002470EC  88 8D C1 A9 */	lbz r4, lbl_804D7849-_SDA_BASE_(r13)
...
/* 8024A530 00247110  48 14 61 6D */	bl func_8039069C
...
/* 8024A54C 0024712C  C0 22 C6 D8 */	lfs f1, lbl_804DC0B8-_SDA2_BASE_(r2)
...
/* 8024A560 00247140  48 13 4C 85 */	bl func_8037F1E4
...
/* 8024A5AC 0024718C  48 14 65 BD */	bl func_80390B68
...
/* 8024A5C4 002471A4  80 AD C1 9C */	lwz r5, lbl_804D783C-_SDA_BASE_(r13)
...
/* 8024A5F8 002471D8  C8 22 C6 B8 */	lfd f1, lbl_804DC098-_SDA2_BASE_(r2)
...
/* 8024A634 00247214  C0 22 C6 D8 */	lfs f1, lbl_804DC0B8-_SDA2_BASE_(r2)
...
/* 8024A654 00247234  80 6D B5 98 */	lwz r3, lbl_804D6C38-_SDA_BASE_(r13)
...
lbl_8024A66C:
/* 8024A66C 0024724C  C0 22 C6 C0 */	lfs f1, lbl_804DC0A0-_SDA2_BASE_(r2)
/* 8024A670 00247250  38 60 00 00 */	li r3, 0
/* 8024A674 00247254  C0 42 C6 C4 */	lfs f2, lbl_804DC0A4-_SDA2_BASE_(r2)
/* 8024A678 00247258  38 80 00 01 */	li r4, 1
/* 8024A67C 0024725C  C0 62 C6 C8 */	lfs f3, lbl_804DC0A8-_SDA2_BASE_(r2)
/* 8024A680 00247260  C0 82 C6 CC */	lfs f4, lbl_804DC0AC-_SDA2_BASE_(r2)
/* 8024A684 00247264  C0 A2 C6 D0 */	lfs f5, lbl_804DC0B0-_SDA2_BASE_(r2)
...
/* 8024A694 00247274  C0 02 C6 D4 */	lfs f0, lbl_804DC0B4-_SDA2_BASE_(r2)
...
/* 8024A6F0 002472D0  B0 0D B5 28 */	sth r0, lbl_804D6BC8-_SDA_BASE_(r13)
...
/* 8024A728 00247308  98 ED B5 9C */	stb r7, lbl_804D6C3C-_SDA_BASE_(r13)
/* 8024A72C 0024730C  80 6D B5 18 */	lwz r3, lbl_804D6BB8-_SDA_BASE_(r13)
...
/* 8024A76C 0024734C  80 8D C1 9C */	lwz r4, lbl_804D783C-_SDA_BASE_(r13)
