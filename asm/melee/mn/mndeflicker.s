...
/* 8024A180 00246D60  A0 6D B5 28 */	lhz r3, mn_804D6BC8@sda21(r13)
/* 8024A184 00246D64  80 8D B5 98 */	lwz r4, mnDeflicker_804D6C38@sda21(r13)
/* 8024A188 00246D68  28 03 00 00 */	cmplwi r3, 0
/* 8024A18C 00246D6C  83 E4 00 2C */	lwz r31, 0x2c(r4)
/* 8024A190 00246D70  41 82 00 20 */	beq .L_8024A1B0
/* 8024A194 00246D74  38 03 FF FF */	addi r0, r3, -1
/* 8024A198 00246D78  B0 0D B5 28 */	sth r0, mn_804D6BC8@sda21(r13)
/* 8024A19C 00246D7C  38 00 00 00 */	li r0, 0
/* 8024A1A0 00246D80  38 6D B5 28 */	addi r3, r13, mn_804D6BC8@sda21
/* 8024A1A4 00246D84  B0 03 00 02 */	sth r0, 2(r3)
/* 8024A1A8 00246D88  90 03 00 04 */	stw r0, 4(r3)
/* 8024A1AC 00246D8C  48 00 01 20 */	b .L_8024A2CC
.L_8024A1B0:
...
/* 8024A1C0 00246DA0  3C 80 80 4A */	lis r4, mn_804A04F0@ha
/* 8024A1C4 00246DA4  3B C4 04 F0 */	addi r30, r4, mn_804A04F0@l
...
/* 8024A1E4 00246DC4  41 82 00 38 */	beq .L_8024A21C
/* 8024A1E8 00246DC8  38 60 00 00 */	li r3, 0
/* 8024A1EC 00246DCC  4B DD 9E 45 */	bl lbAudioAx_80024030
/* 8024A1F0 00246DD0  80 6D B5 98 */	lwz r3, mnDeflicker_804D6C38@sda21(r13)
...
/* 8024A218 00246DF8  48 00 00 B4 */	b .L_8024A2CC
.L_8024A21C:
/* 8024A21C 00246DFC  88 0D B5 9C */	lbz r0, mnDeflicker_804D6C3C@sda21(r13)
/* 8024A220 00246E00  28 00 00 00 */	cmplwi r0, 0
/* 8024A224 00246E04  41 82 00 A8 */	beq .L_8024A2CC
...
/* 8024A23C 00246E1C  41 82 00 90 */	beq .L_8024A2CC
/* 8024A240 00246E20  38 60 00 02 */	li r3, 2
/* 8024A244 00246E24  4B DD 9D ED */	bl lbAudioAx_80024030
...
/* 8024A26C 00246E4C  80 6D B5 98 */	lwz r3, mnDeflicker_804D6C38@sda21(r13)
...
/* 8024A284 00246E64  C8 22 C6 B8 */	lfd f1, mnDeflicker_804DC098@sda21(r2)
...
/* 8024A2BC 00246E9C  80 6D B5 98 */	lwz r3, mnDeflicker_804D6C38@sda21(r13)
...
/* 8024A2EC 00246ECC  3C 80 80 3F */	lis r4, mnDeflicker_803EEFE4@ha
...
/* 8024A300 00246EE0  3B E4 EF E4 */	addi r31, r4, mnDeflicker_803EEFE4@l
...
/* 8024A320 00246F00  40 82 00 0C */	bne .L_8024A32C
/* 8024A324 00246F04  7F C3 F3 78 */	mr r3, r30
/* 8024A328 00246F08  48 14 5F 01 */	bl HSD_GObjPLink_80390228
.L_8024A32C:
...
/* 8024A348 00246F28  3C 80 80 4A */	lis r4, mn_804A04F0@ha
...
/* 8024A360 00246F40  88 04 04 F0 */	lbz r0, mn_804A04F0@l(r4)
...
/* 8024A370 00246F50  41 82 00 3C */	beq .L_8024A3AC
/* 8024A374 00246F54  80 6D C1 98 */	lwz r3, HSD_GObj_804D7838@sda21(r13)
/* 8024A378 00246F58  48 14 5A AD */	bl HSD_GObjProc_8038FE24
/* 8024A37C 00246F5C  3C 60 80 25 */	lis r3, .L_8024A2E8@ha
/* 8024A380 00246F60  38 83 A2 E8 */	addi r4, r3, .L_8024A2E8@l
/* 8024A384 00246F64  38 7E 00 00 */	addi r3, r30, 0
/* 8024A388 00246F68  38 A0 00 00 */	li r5, 0
/* 8024A38C 00246F6C  48 14 59 C9 */	bl HSD_GObjProc_8038FD54
/* 8024A390 00246F70  80 8D C1 9C */	lwz r4, HSD_GObj_804D783C@sda21(r13)
...
/* 8024A3A4 00246F84  48 15 B9 21 */	bl HSD_SisLib_803A5CC4
/* 8024A3A8 00246F88  48 00 00 28 */	b .L_8024A3D0
.L_8024A3AC:
...
/* 8024A3C0 00246FA0  3C 80 80 3F */	lis r4, mnDeflicker_803EEFF0@ha
/* 8024A3C4 00246FA4  80 61 00 14 */	lwz r3, 0x14(r1)
/* 8024A3C8 00246FA8  38 84 EF F0 */	addi r4, r4, mnDeflicker_803EEFF0@l
...
/* 8024A3EC 00246FCC  3C 80 80 4A */	lis r4, mn_804A04F0@ha
...
/* 8024A404 00246FE4  88 04 04 F0 */	lbz r0, mn_804A04F0@l(r4)
...
/* 8024A414 00246FF4  41 82 00 3C */	beq .L_8024A450
/* 8024A418 00246FF8  80 6D C1 98 */	lwz r3, HSD_GObj_804D7838@sda21(r13)
/* 8024A41C 00246FFC  48 14 5A 09 */	bl HSD_GObjProc_8038FE24
/* 8024A420 00247000  3C 60 80 25 */	lis r3, .L_8024A2E8@ha
/* 8024A424 00247004  38 83 A2 E8 */	addi r4, r3, .L_8024A2E8@l
/* 8024A428 00247008  38 7E 00 00 */	addi r3, r30, 0
/* 8024A42C 0024700C  38 A0 00 00 */	li r5, 0
/* 8024A430 00247010  48 14 59 25 */	bl HSD_GObjProc_8038FD54
/* 8024A434 00247014  80 8D C1 9C */	lwz r4, HSD_GObj_804D783C@sda21(r13)
...
/* 8024A448 00247028  48 15 B8 7D */	bl HSD_SisLib_803A5CC4
/* 8024A44C 0024702C  48 00 00 58 */	b .L_8024A4A4
.L_8024A450:
/* 8024A450 00247030  3C 80 80 3F */	lis r4, mnDeflicker_803EEFD8@ha
/* 8024A454 00247034  3B E4 EF D8 */	addi r31, r4, mnDeflicker_803EEFD8@l
...
/* 8024A46C 0024704C  40 82 00 38 */	bne .L_8024A4A4
/* 8024A470 00247050  80 6D C1 98 */	lwz r3, HSD_GObj_804D7838@sda21(r13)
/* 8024A474 00247054  48 14 59 B1 */	bl HSD_GObjProc_8038FE24
/* 8024A478 00247058  3C 60 80 25 */	lis r3, .L_8024A344@ha
/* 8024A47C 0024705C  38 83 A3 44 */	addi r4, r3, .L_8024A344@l
/* 8024A480 00247060  38 7E 00 00 */	addi r3, r30, 0
/* 8024A484 00247064  38 A0 00 00 */	li r5, 0
/* 8024A488 00247068  48 14 58 CD */	bl HSD_GObjProc_8038FD54
/* 8024A48C 0024706C  80 AD C1 9C */	lwz r5, HSD_GObj_804D783C@sda21(r13)
...
/* 8024A4A0 00247080  98 0D B5 9C */	stb r0, mnDeflicker_804D6C3C@sda21(r13)
.L_8024A4A4:
...
.global mnDeflicker_8024A4BC
mnDeflicker_8024A4BC:
/* 8024A4BC 0024709C  7C 08 02 A6 */	mflr r0
/* 8024A4C0 002470A0  3C 80 80 3F */	lis r4, mnDeflicker_803EEFD8@ha
/* 8024A4C4 002470A4  90 01 00 04 */	stw r0, 4(r1)
/* 8024A4C8 002470A8  3C 60 80 4A */	lis r3, mnDeflicker_804A08B8@ha
...
/* 8024A4DC 002470BC  3B C3 08 B8 */	addi r30, r3, mnDeflicker_804A08B8@l
/* 8024A4E0 002470C0  38 60 00 06 */	li r3, 6
/* 8024A4E4 002470C4  93 A1 00 3C */	stw r29, 0x3c(r1)
/* 8024A4E8 002470C8  3B A4 EF D8 */	addi r29, r4, mnDeflicker_803EEFD8@l
...
/* 8024A4FC 002470DC  93 8D B5 98 */	stw r28, mnDeflicker_804D6C38@sda21(r13)
...
/* 8024A50C 002470EC  88 8D C1 A9 */	lbz r4, HSD_GObj_804D7849@sda21(r13)
/* 8024A510 002470F0  38 7C 00 00 */	addi r3, r28, 0
/* 8024A514 002470F4  38 BF 00 00 */	addi r5, r31, 0
/* 8024A518 002470F8  48 14 65 59 */	bl HSD_GObjObjet_80390A70
/* 8024A51C 002470FC  3C 60 80 39 */	lis r3, HSD_GObj_80391070@ha
/* 8024A520 00247100  38 83 10 70 */	addi r4, r3, HSD_GObj_80391070@l
...
/* 8024A54C 0024712C  C0 22 C6 D8 */	lfs f1, mnDeflicker_804DC0B8@sda21(r2)
...
/* 8024A568 00247148  40 82 00 20 */	bne .L_8024A588
...
/* 8024A5B0 00247190  3C 60 80 25 */	lis r3, .L_8024A3E8@ha
/* 8024A5B4 00247194  38 83 A3 E8 */	addi r4, r3, .L_8024A3E8@l
/* 8024A5B8 00247198  38 7C 00 00 */	addi r3, r28, 0
/* 8024A5BC 0024719C  38 A0 00 00 */	li r5, 0
/* 8024A5C0 002471A0  48 14 57 95 */	bl HSD_GObjProc_8038FD54
/* 8024A5C4 002471A4  80 AD C1 9C */	lwz r5, HSD_GObj_804D783C@sda21(r13)
...
/* 8024A5F8 002471D8  C8 22 C6 B8 */	lfd f1, mnDeflicker_804DC098@sda21(r2)
...
/* 8024A634 00247214  C0 22 C6 D8 */	lfs f1, mnDeflicker_804DC0B8@sda21(r2)
...
/* 8024A654 00247234  80 6D B5 98 */	lwz r3, mnDeflicker_804D6C38@sda21(r13)
...
/* 8024A664 00247244  41 82 00 08 */	beq .L_8024A66C
/* 8024A668 00247248  48 15 B6 5D */	bl HSD_SisLib_803A5CC4
.L_8024A66C:
/* 8024A66C 0024724C  C0 22 C6 C0 */	lfs f1, mnDeflicker_804DC0A0@sda21(r2)
/* 8024A670 00247250  38 60 00 00 */	li r3, 0
/* 8024A674 00247254  C0 42 C6 C4 */	lfs f2, mnDeflicker_804DC0A4@sda21(r2)
/* 8024A678 00247258  38 80 00 01 */	li r4, 1
/* 8024A67C 0024725C  C0 62 C6 C8 */	lfs f3, mnDeflicker_804DC0A8@sda21(r2)
/* 8024A680 00247260  C0 82 C6 CC */	lfs f4, mnDeflicker_804DC0AC@sda21(r2)
/* 8024A684 00247264  C0 A2 C6 D0 */	lfs f5, mnDeflicker_804DC0B0@sda21(r2)
/* 8024A688 00247268  48 15 B4 45 */	bl HSD_SisLib_803A5ACC
/* 8024A68C 0024726C  90 7D 00 04 */	stw r3, 4(r29)
/* 8024A690 00247270  38 80 00 BD */	li r4, 0xbd
/* 8024A694 00247274  C0 02 C6 D4 */	lfs f0, mnDeflicker_804DC0B4@sda21(r2)
/* 8024A698 00247278  D0 03 00 24 */	stfs f0, 0x24(r3)
/* 8024A69C 0024727C  D0 03 00 28 */	stfs f0, 0x28(r3)
/* 8024A6A0 00247280  48 15 BC C9 */	bl HSD_SisLib_803A6368
...
.global mnDeflicker_8024A6C4
mnDeflicker_8024A6C4:
/* 8024A6C4 002472A4  7C 08 02 A6 */	mflr r0
/* 8024A6C8 002472A8  3C 80 80 4A */	lis r4, mn_804A04F0@ha
/* 8024A6CC 002472AC  90 01 00 04 */	stw r0, 4(r1)
/* 8024A6D0 002472B0  38 A4 04 F0 */	addi r5, r4, mn_804A04F0@l
/* 8024A6D4 002472B4  3C 80 80 3F */	lis r4, mnDeflicker_803EEFD8@ha
/* 8024A6D8 002472B8  4C C6 31 82 */	crclr 6
/* 8024A6DC 002472BC  94 21 FF E0 */	stwu r1, -0x20(r1)
/* 8024A6E0 002472C0  39 24 EF D8 */	addi r9, r4, mnDeflicker_803EEFD8@l
/* 8024A6E4 002472C4  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 8024A6E8 002472C8  38 00 00 05 */	li r0, 5
/* 8024A6EC 002472CC  3C 80 80 4A */	lis r4, mnDeflicker_804A08B8@ha
/* 8024A6F0 002472D0  B0 0D B5 28 */	sth r0, mn_804D6BC8@sda21(r13)
/* 8024A6F4 002472D4  38 84 08 B8 */	addi r4, r4, mnDeflicker_804A08B8@l
...
/* 8024A728 00247308  98 ED B5 9C */	stb r7, mnDeflicker_804D6C3C@sda21(r13)
/* 8024A72C 0024730C  80 6D B5 18 */	lwz r3, mn_804D6BB8@sda21(r13)
...
/* 8024A748 00247328  4B FF FD 75 */	bl mnDeflicker_8024A4BC
...
/* 8024A75C 0024733C  3C 80 80 25 */	lis r4, mnDeflicker_8024A168@ha
/* 8024A760 00247340  38 84 A1 68 */	addi r4, r4, mnDeflicker_8024A168@l
/* 8024A764 00247344  38 A0 00 00 */	li r5, 0
/* 8024A768 00247348  48 14 55 ED */	bl HSD_GObjProc_8038FD54
/* 8024A76C 0024734C  80 8D C1 9C */	lwz r4, HSD_GObj_804D783C@sda21(r13)
...
.section .data
    .balign 8
.global mnDeflicker_803EEFD8
mnDeflicker_803EEFD8:
    .4byte NULL
    .4byte 0x41980000
    .4byte 0xBDCCCCCD
.global mnDeflicker_803EEFE4
mnDeflicker_803EEFE4:
    .4byte 0x41A00000
    .4byte 0x41F00000
    .4byte 0xBDCCCCCD
.global mnDeflicker_803EEFF0
mnDeflicker_803EEFF0:
    .4byte 0x42480000
    .4byte 0x43AF0000
    .4byte 0x42480000
...
.section .bss, "wa"
    .balign 8
.global mnDeflicker_804A08B8
mnDeflicker_804A08B8:
    .skip 0x10


.section .sbss
    .balign 8
.global mnDeflicker_804D6C38
mnDeflicker_804D6C38:
    .skip 0x4
.global mnDeflicker_804D6C3C
mnDeflicker_804D6C3C:
    .skip 0x4


.section .sdata2
    .balign 8
.global mnDeflicker_804DC098
mnDeflicker_804DC098:
    .4byte 0x43300000
    .4byte 0x00000000
.global mnDeflicker_804DC0A0
mnDeflicker_804DC0A0:
    .4byte 0xC1180000
.global mnDeflicker_804DC0A4
mnDeflicker_804DC0A4:
    .4byte 0x4111999A
.global mnDeflicker_804DC0A8
mnDeflicker_804DC0A8:
    .4byte 0x41880000
.global mnDeflicker_804DC0AC
mnDeflicker_804DC0AC:
    .4byte 0x43B65777
.global mnDeflicker_804DC0B0
mnDeflicker_804DC0B0:
    .4byte 0x42198D06
.global mnDeflicker_804DC0B4
mnDeflicker_804DC0B4:
    .4byte 0x3D5566CF
.global mnDeflicker_804DC0B8
mnDeflicker_804DC0B8:
    .4byte 0x00000000
    .4byte 0x00000000
