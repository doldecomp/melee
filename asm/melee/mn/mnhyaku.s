...
/* 8024C6B8 00249298  41 82 00 20 */	beq mnHyaku_8024C6D8
...
/* 8024C6D4 002492B4  48 00 02 FC */	b mnHyaku_8024C9D0
mnHyaku_8024C6D8:
...
/* 8024C70C 002492EC  41 82 00 24 */	beq mnHyaku_8024C730
...
/* 8024C72C 0024930C  48 00 02 A4 */	b mnHyaku_8024C9D0
mnHyaku_8024C730:
...
/* 8024C744 00249324  41 82 00 94 */	beq mnHyaku_8024C7D8
...
/* 8024C760 00249340  41 82 00 54 */	beq mnHyaku_8024C7B4
/* 8024C764 00249344  40 80 00 1C */	bge mnHyaku_8024C780
/* 8024C768 00249348  2C 00 00 01 */	cmpwi r0, 1
/* 8024C76C 0024934C  41 82 00 30 */	beq mnHyaku_8024C79C
/* 8024C770 00249350  40 80 00 38 */	bge mnHyaku_8024C7A8
/* 8024C774 00249354  2C 00 00 00 */	cmpwi r0, 0
/* 8024C778 00249358  40 80 00 18 */	bge mnHyaku_8024C790
/* 8024C77C 0024935C  48 00 02 54 */	b mnHyaku_8024C9D0
mnHyaku_8024C780:
/* 8024C780 00249360  2C 00 00 05 */	cmpwi r0, 5
/* 8024C784 00249364  41 82 00 48 */	beq mnHyaku_8024C7CC
/* 8024C788 00249368  40 80 02 48 */	bge mnHyaku_8024C9D0
/* 8024C78C 0024936C  48 00 00 34 */	b mnHyaku_8024C7C0
mnHyaku_8024C790:
/* 8024C790 00249370  38 60 00 21 */	li r3, 0x21
/* 8024C794 00249374  4B FD D0 CD */	bl mn_80229860
/* 8024C798 00249378  48 00 02 38 */	b mnHyaku_8024C9D0
mnHyaku_8024C79C:
/* 8024C79C 0024937C  38 60 00 22 */	li r3, 0x22
/* 8024C7A0 00249380  4B FD D0 C1 */	bl mn_80229860
/* 8024C7A4 00249384  48 00 02 2C */	b mnHyaku_8024C9D0
mnHyaku_8024C7A8:
/* 8024C7A8 00249388  38 60 00 23 */	li r3, 0x23
/* 8024C7AC 0024938C  4B FD D0 B5 */	bl mn_80229860
/* 8024C7B0 00249390  48 00 02 20 */	b mnHyaku_8024C9D0
mnHyaku_8024C7B4:
/* 8024C7B4 00249394  38 60 00 24 */	li r3, 0x24
/* 8024C7B8 00249398  4B FD D0 A9 */	bl mn_80229860
/* 8024C7BC 0024939C  48 00 02 14 */	b mnHyaku_8024C9D0
mnHyaku_8024C7C0:
/* 8024C7C0 002493A0  38 60 00 25 */	li r3, 0x25
/* 8024C7C4 002493A4  4B FD D0 9D */	bl mn_80229860
/* 8024C7C8 002493A8  48 00 02 08 */	b mnHyaku_8024C9D0
mnHyaku_8024C7CC:
/* 8024C7CC 002493AC  38 60 00 26 */	li r3, 0x26
/* 8024C7D0 002493B0  4B FD D0 91 */	bl mn_80229860
/* 8024C7D4 002493B4  48 00 01 FC */	b mnHyaku_8024C9D0
mnHyaku_8024C7D8:
...
/* 8024C7EC 002493CC  41 82 00 EC */	beq mnHyaku_8024C8D8
...
/* 8024C800 002493E0  40 82 00 10 */	bne mnHyaku_8024C810
/* 8024C804 002493E4  38 00 00 05 */	li r0, 5
/* 8024C808 002493E8  98 1E 00 00 */	stb r0, 0(r30)
/* 8024C80C 002493EC  48 00 00 0C */	b mnHyaku_8024C818
mnHyaku_8024C810:
...
/* 8024C888 00249468  41 82 00 08 */	beq mnHyaku_8024C890
...
/* 8024C8D4 002494B4  48 00 00 FC */	b mnHyaku_8024C9D0
mnHyaku_8024C8D8:
...
/* 8024C8EC 002494CC  41 82 00 E4 */	beq mnHyaku_8024C9D0
...
/* 8024C900 002494E0  40 82 00 0C */	bne mnHyaku_8024C90C
/* 8024C904 002494E4  9B FE 00 00 */	stb r31, 0(r30)
/* 8024C908 002494E8  48 00 00 0C */	b mnHyaku_8024C914
mnHyaku_8024C90C:
...
/* 8024C984 00249564  41 82 00 08 */	beq mnHyaku_8024C98C
...
/* 8024CA2C 0024960C  40 82 00 0C */	bne mnHyaku_8024CA38
...
/* 8024CA78 00249658  41 82 00 38 */	beq mnHyaku_8024CAB0
/* 8024CA7C 0024965C  80 6D C1 98 */	lwz r3, lbl_804D7838@sda21(r13)
/* 8024CA80 00249660  48 14 33 A5 */	bl func_8038FE24
/* 8024CA84 00249664  3C 60 80 25 */	lis r3, mnHyaku_8024C9F0@ha
/* 8024CA88 00249668  38 83 C9 F0 */	addi r4, r3, mnHyaku_8024C9F0@l
...
/* 8024CAF4 002496D4  41 82 00 3C */	beq mnHyaku_8024CB30
/* 8024CAF8 002496D8  80 6D C1 98 */	lwz r3, lbl_804D7838@sda21(r13)
/* 8024CAFC 002496DC  48 14 33 29 */	bl func_8038FE24
/* 8024CB00 002496E0  3C 60 80 25 */	lis r3, mnHyaku_8024C9F0@ha
/* 8024CB04 002496E4  38 83 C9 F0 */	addi r4, r3, mnHyaku_8024C9F0@l
...
/* 8024CB2C 0024970C  48 00 00 50 */	b mnHyaku_8024CB7C
mnHyaku_8024CB30:
...
/* 8024CB4C 0024972C  40 82 00 30 */	bne mnHyaku_8024CB7C
/* 8024CB50 00249730  80 6D C1 98 */	lwz r3, lbl_804D7838@sda21(r13)
/* 8024CB54 00249734  48 14 32 D1 */	bl func_8038FE24
/* 8024CB58 00249738  3C 60 80 25 */	lis r3, mnHyaku_8024CA50@ha
/* 8024CB5C 0024973C  38 83 CA 50 */	addi r4, r3, mnHyaku_8024CA50@l
...
/* 8024CC3C 0024981C  40 82 00 20 */	bne mnHyaku_8024CC5C
...
/* 8024CCD0 002498B0  3C 60 80 25 */	lis r3, mnHyaku_8024CAC8@ha
/* 8024CCD4 002498B4  38 83 CA C8 */	addi r4, r3, mnHyaku_8024CAC8@l
...
/* 8024CD00 002498E0  41 82 00 08 */	beq mnHyaku_8024CD08
