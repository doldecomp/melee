...
/* 8024BFF8 00248BD8  A0 6D B5 28 */	lhz r3, mn_804D6BC8@sda21(r13)
/* 8024BFFC 00248BDC  80 8D B5 B0 */	lwz r4, mnLanguage_804D6C50@sda21(r13)
/* 8024C000 00248BE0  28 03 00 00 */	cmplwi r3, 0
/* 8024C004 00248BE4  83 E4 00 2C */	lwz r31, 0x2c(r4)
/* 8024C008 00248BE8  41 82 00 20 */	beq .L_8024C028
/* 8024C00C 00248BEC  38 03 FF FF */	addi r0, r3, -1
/* 8024C010 00248BF0  B0 0D B5 28 */	sth r0, mn_804D6BC8@sda21(r13)
/* 8024C014 00248BF4  38 00 00 00 */	li r0, 0
/* 8024C018 00248BF8  38 6D B5 28 */	addi r3, r13, mn_804D6BC8@sda21
/* 8024C01C 00248BFC  B0 03 00 02 */	sth r0, 2(r3)
/* 8024C020 00248C00  90 03 00 04 */	stw r0, 4(r3)
/* 8024C024 00248C04  48 00 01 D0 */	b .L_8024C1F4
.L_8024C028:
...
/* 8024C038 00248C18  3C 80 80 4A */	lis r4, mn_804A04F0@ha
/* 8024C03C 00248C1C  3B A4 04 F0 */	addi r29, r4, mn_804A04F0@l
...
/* 8024C05C 00248C3C  41 82 00 24 */	beq .L_8024C080
/* 8024C060 00248C40  38 60 00 00 */	li r3, 0
/* 8024C064 00248C44  4B DD 7F CD */	bl lbAudioAx_80024030
...
/* 8024C07C 00248C5C  48 00 01 78 */	b .L_8024C1F4
.L_8024C080:
...
/* 8024C094 00248C74  41 82 00 50 */	beq .L_8024C0E4
/* 8024C098 00248C78  80 6D B5 B0 */	lwz r3, mnLanguage_804D6C50@sda21(r13)
...
/* 8024C0AC 00248C8C  41 82 01 48 */	beq .L_8024C1F4
/* 8024C0B0 00248C90  4B DB ED 69 */	bl lbLang_SetSavedLanguage
/* 8024C0B4 00248C94  4B DD 0D 4D */	bl lb_8001CE00
/* 8024C0B8 00248C98  38 60 00 AD */	li r3, 0xad
/* 8024C0BC 00248C9C  4B DD B9 F5 */	bl lbAudioAx_80027AB0
...
/* 8024C0E0 00248CC0  48 00 01 14 */	b .L_8024C1F4
.L_8024C0E4:
/* 8024C0E4 00248CC4  88 1F 00 02 */	lbz r0, 2(r31)
/* 8024C0E8 00248CC8  28 00 00 00 */	cmplwi r0, 0
/* 8024C0EC 00248CCC  41 82 01 08 */	beq .L_8024C1F4
...
/* 8024C104 00248CE4  41 82 00 70 */	beq .L_8024C174
/* 8024C108 00248CE8  38 60 00 02 */	li r3, 2
/* 8024C10C 00248CEC  4B DD 7F 25 */	bl lbAudioAx_80024030
/* 8024C110 00248CF0  88 1F 00 00 */	lbz r0, 0(r31)
/* 8024C114 00248CF4  28 00 00 00 */	cmplwi r0, 0
/* 8024C118 00248CF8  40 82 00 08 */	bne .L_8024C120
...
/* 8024C12C 00248D0C  80 6D B5 B0 */	lwz r3, mnLanguage_804D6C50@sda21(r13)
...
/* 8024C14C 00248D2C  38 8D 99 78 */	addi r4, r13, mnLanguage_804D5018@sda21
...
/* 8024C170 00248D50  48 00 00 84 */	b .L_8024C1F4
.L_8024C174:
...
/* 8024C188 00248D68  41 82 00 6C */	beq .L_8024C1F4
/* 8024C18C 00248D6C  38 60 00 02 */	li r3, 2
/* 8024C190 00248D70  4B DD 7E A1 */	bl lbAudioAx_80024030
/* 8024C194 00248D74  88 1F 00 00 */	lbz r0, 0(r31)
/* 8024C198 00248D78  28 00 00 00 */	cmplwi r0, 0
/* 8024C19C 00248D7C  40 82 00 08 */	bne .L_8024C1A4
...
/* 8024C1B0 00248D90  80 6D B5 B0 */	lwz r3, mnLanguage_804D6C50@sda21(r13)
...
/* 8024C1D0 00248DB0  38 8D 99 78 */	addi r4, r13, mnLanguage_804D5018@sda21
...
/* 8024C214 00248DF4  3C 80 80 3F */	lis r4, mnLanguage_803EF5AC@ha
...
/* 8024C228 00248E08  3B E4 F5 AC */	addi r31, r4, mnLanguage_803EF5AC@l
...
/* 8024C24C 00248E2C  40 82 00 0C */	bne .L_8024C258
/* 8024C250 00248E30  7F C3 F3 78 */	mr r3, r30
/* 8024C254 00248E34  48 14 3F D5 */	bl HSD_GObjPLink_80390228
.L_8024C258:
...
/* 8024C274 00248E54  3C 80 80 4A */	lis r4, mn_804A04F0@ha
...
/* 8024C28C 00248E6C  88 04 04 F0 */	lbz r0, mn_804A04F0@l(r4)
/* 8024C290 00248E70  83 E3 00 2C */	lwz r31, 0x2c(r3)
/* 8024C294 00248E74  28 00 00 17 */	cmplwi r0, 0x17
/* 8024C298 00248E78  41 82 00 38 */	beq .L_8024C2D0
/* 8024C29C 00248E7C  80 6D C1 98 */	lwz r3, HSD_GObj_804D7838@sda21(r13)
/* 8024C2A0 00248E80  48 14 3B 85 */	bl HSD_GObjProc_8038FE24
/* 8024C2A4 00248E84  3C 60 80 25 */	lis r3, .L_8024C210@ha
/* 8024C2A8 00248E88  38 83 C2 10 */	addi r4, r3, .L_8024C210@l
/* 8024C2AC 00248E8C  38 7E 00 00 */	addi r3, r30, 0
/* 8024C2B0 00248E90  38 A0 00 00 */	li r5, 0
/* 8024C2B4 00248E94  48 14 3A A1 */	bl HSD_GObjProc_8038FD54
/* 8024C2B8 00248E98  80 8D C1 9C */	lwz r4, HSD_GObj_804D783C@sda21(r13)
...
/* 8024C2CC 00248EAC  48 15 99 F9 */	bl HSD_SisLib_803A5CC4
.L_8024C2D0:
...
/* 8024C2EC 00248ECC  3C 80 80 4A */	lis r4, mn_804A04F0@ha
...
/* 8024C308 00248EE8  88 04 04 F0 */	lbz r0, mn_804A04F0@l(r4)
...
/* 8024C318 00248EF8  41 82 00 3C */	beq .L_8024C354
/* 8024C31C 00248EFC  80 6D C1 98 */	lwz r3, HSD_GObj_804D7838@sda21(r13)
/* 8024C320 00248F00  48 14 3B 05 */	bl HSD_GObjProc_8038FE24
/* 8024C324 00248F04  3C 60 80 25 */	lis r3, .L_8024C210@ha
/* 8024C328 00248F08  38 83 C2 10 */	addi r4, r3, .L_8024C210@l
/* 8024C32C 00248F0C  38 7D 00 00 */	addi r3, r29, 0
/* 8024C330 00248F10  38 A0 00 00 */	li r5, 0
/* 8024C334 00248F14  48 14 3A 21 */	bl HSD_GObjProc_8038FD54
/* 8024C338 00248F18  80 8D C1 9C */	lwz r4, HSD_GObj_804D783C@sda21(r13)
...
/* 8024C34C 00248F2C  48 15 99 79 */	bl HSD_SisLib_803A5CC4
/* 8024C350 00248F30  48 00 00 58 */	b .L_8024C3A8
.L_8024C354:
/* 8024C354 00248F34  3C 80 80 3F */	lis r4, mnLanguage_803EF5A0@ha
/* 8024C358 00248F38  3B E4 F5 A0 */	addi r31, r4, mnLanguage_803EF5A0@l
...
/* 8024C370 00248F50  40 82 00 38 */	bne .L_8024C3A8
/* 8024C374 00248F54  80 6D C1 98 */	lwz r3, HSD_GObj_804D7838@sda21(r13)
/* 8024C378 00248F58  48 14 3A AD */	bl HSD_GObjProc_8038FE24
/* 8024C37C 00248F5C  3C 60 80 25 */	lis r3, .L_8024C270@ha
/* 8024C380 00248F60  38 83 C2 70 */	addi r4, r3, .L_8024C270@l
/* 8024C384 00248F64  38 7D 00 00 */	addi r3, r29, 0
/* 8024C388 00248F68  38 A0 00 00 */	li r5, 0
/* 8024C38C 00248F6C  48 14 39 C9 */	bl HSD_GObjProc_8038FD54
/* 8024C390 00248F70  80 AD C1 9C */	lwz r5, HSD_GObj_804D783C@sda21(r13)
...
.global mnLanguage_8024C3C4
mnLanguage_8024C3C4:
/* 8024C3C4 00248FA4  7C 08 02 A6 */	mflr r0
/* 8024C3C8 00248FA8  3C 80 80 3F */	lis r4, mnLanguage_803EF5A0@ha
/* 8024C3CC 00248FAC  90 01 00 04 */	stw r0, 4(r1)
/* 8024C3D0 00248FB0  3C 60 80 4A */	lis r3, mnLanguage_804A08D8@ha
...
/* 8024C3E4 00248FC4  3B C3 08 D8 */	addi r30, r3, mnLanguage_804A08D8@l
/* 8024C3E8 00248FC8  38 60 00 06 */	li r3, 6
/* 8024C3EC 00248FCC  93 A1 00 34 */	stw r29, 0x34(r1)
/* 8024C3F0 00248FD0  3B A4 F5 A0 */	addi r29, r4, mnLanguage_803EF5A0@l
...
/* 8024C404 00248FE4  93 8D B5 B0 */	stw r28, mnLanguage_804D6C50@sda21(r13)
...
/* 8024C414 00248FF4  88 8D C1 A9 */	lbz r4, HSD_GObj_804D7849@sda21(r13)
/* 8024C418 00248FF8  38 7C 00 00 */	addi r3, r28, 0
/* 8024C41C 00248FFC  38 BF 00 00 */	addi r5, r31, 0
/* 8024C420 00249000  48 14 46 51 */	bl HSD_GObjObject_80390A70
/* 8024C424 00249004  3C 60 80 39 */	lis r3, HSD_GObj_JObjCallback@ha
/* 8024C428 00249008  38 83 10 70 */	addi r4, r3, HSD_GObj_JObjCallback@l
...
/* 8024C454 00249034  C0 22 C7 48 */	lfs f1, mnLanguage_804DC128@sda21(r2)
...
/* 8024C470 00249050  40 82 00 20 */	bne .L_8024C490
...
/* 8024C4C0 002490A0  3C 60 80 25 */	lis r3, .L_8024C2E8@ha
/* 8024C4C4 002490A4  38 83 C2 E8 */	addi r4, r3, .L_8024C2E8@l
/* 8024C4C8 002490A8  38 7C 00 00 */	addi r3, r28, 0
/* 8024C4CC 002490AC  38 A0 00 00 */	li r5, 0
/* 8024C4D0 002490B0  48 14 38 85 */	bl HSD_GObjProc_8038FD54
/* 8024C4D4 002490B4  80 AD C1 9C */	lwz r5, HSD_GObj_804D783C@sda21(r13)
...
/* 8024C508 002490E8  38 8D 99 78 */	addi r4, r13, mnLanguage_804D5018@sda21
...
/* 8024C530 00249110  C0 22 C7 48 */	lfs f1, mnLanguage_804DC128@sda21(r2)
...
/* 8024C550 00249130  80 6D B5 B0 */	lwz r3, mnLanguage_804D6C50@sda21(r13)
...
/* 8024C560 00249140  41 82 00 08 */	beq .L_8024C568
/* 8024C564 00249144  48 15 97 61 */	bl HSD_SisLib_803A5CC4
.L_8024C568:
/* 8024C568 00249148  C0 22 C7 30 */	lfs f1, mnLanguage_804DC110@sda21(r2)
/* 8024C56C 0024914C  38 60 00 00 */	li r3, 0
/* 8024C570 00249150  C0 42 C7 34 */	lfs f2, mnLanguage_804DC114@sda21(r2)
/* 8024C574 00249154  38 80 00 01 */	li r4, 1
/* 8024C578 00249158  C0 62 C7 38 */	lfs f3, mnLanguage_804DC118@sda21(r2)
/* 8024C57C 0024915C  C0 82 C7 3C */	lfs f4, mnLanguage_804DC11C@sda21(r2)
/* 8024C580 00249160  C0 A2 C7 40 */	lfs f5, mnLanguage_804DC120@sda21(r2)
/* 8024C584 00249164  48 15 95 49 */	bl HSD_SisLib_803A5ACC
/* 8024C588 00249168  90 7D 00 04 */	stw r3, 4(r29)
/* 8024C58C 0024916C  38 80 00 BF */	li r4, 0xbf
/* 8024C590 00249170  C0 02 C7 44 */	lfs f0, mnLanguage_804DC124@sda21(r2)
/* 8024C594 00249174  D0 03 00 24 */	stfs f0, 0x24(r3)
/* 8024C598 00249178  D0 03 00 28 */	stfs f0, 0x28(r3)
/* 8024C59C 0024917C  48 15 9D CD */	bl HSD_SisLib_803A6368
...
.global mnLanguage_8024C5C0
mnLanguage_8024C5C0:
/* 8024C5C0 002491A0  7C 08 02 A6 */	mflr r0
/* 8024C5C4 002491A4  3C 80 80 4A */	lis r4, mn_804A04F0@ha
/* 8024C5C8 002491A8  90 01 00 04 */	stw r0, 4(r1)
/* 8024C5CC 002491AC  38 A4 04 F0 */	addi r5, r4, mn_804A04F0@l
/* 8024C5D0 002491B0  3C 80 80 3F */	lis r4, mnLanguage_803EF5A0@ha
/* 8024C5D4 002491B4  4C C6 31 82 */	crclr 6
/* 8024C5D8 002491B8  94 21 FF E0 */	stwu r1, -0x20(r1)
/* 8024C5DC 002491BC  39 24 F5 A0 */	addi r9, r4, mnLanguage_803EF5A0@l
/* 8024C5E0 002491C0  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 8024C5E4 002491C4  38 00 00 05 */	li r0, 5
/* 8024C5E8 002491C8  3C 80 80 4A */	lis r4, mnLanguage_804A08D8@ha
/* 8024C5EC 002491CC  B0 0D B5 28 */	sth r0, mn_804D6BC8@sda21(r13)
/* 8024C5F0 002491D0  38 84 08 D8 */	addi r4, r4, mnLanguage_804A08D8@l
...
/* 8024C620 00249200  80 AD B5 18 */	lwz r5, mn_804D6BB8@sda21(r13)
...
/* 8024C63C 0024921C  4B DC A4 B5 */	bl lbArchive_LoadSections
/* 8024C640 00249220  7F E3 FB 78 */	mr r3, r31
/* 8024C644 00249224  4B FF FD 81 */	bl mnLanguage_8024C3C4
...
/* 8024C658 00249238  3C 80 80 25 */	lis r4, mnLanguage_8024BFE0@ha
/* 8024C65C 0024923C  38 84 BF E0 */	addi r4, r4, mnLanguage_8024BFE0@l
/* 8024C660 00249240  38 A0 00 00 */	li r5, 0
/* 8024C664 00249244  48 14 36 F1 */	bl HSD_GObjProc_8038FD54
/* 8024C668 00249248  80 8D C1 9C */	lwz r4, HSD_GObj_804D783C@sda21(r13)
...
.section .data
    .balign 8
.global mnLanguage_803EF5A0
mnLanguage_803EF5A0:
    .4byte NULL
    .4byte 0x41980000
    .4byte 0xBDCCCCCD
.global mnLanguage_803EF5AC
mnLanguage_803EF5AC:
    .4byte 0x41A00000
    .4byte 0x41E80000
    .4byte 0xBDCCCCCD
...
.section .sdata2
    .balign 8
.global mnLanguage_804DC110
mnLanguage_804DC110:
    .4byte 0xC1180000
.global mnLanguage_804DC114
mnLanguage_804DC114:
    .4byte 0x4111999A
.global mnLanguage_804DC118
mnLanguage_804DC118:
    .4byte 0x41880000
.global mnLanguage_804DC11C
mnLanguage_804DC11C:
    .4byte 0x43B65777
.global mnLanguage_804DC120
mnLanguage_804DC120:
    .4byte 0x42198D06
.global mnLanguage_804DC124
mnLanguage_804DC124:
    .4byte 0x3D5566CF
.global mnLanguage_804DC128
mnLanguage_804DC128:
    .4byte 0x00000000
    .4byte 0x00000000
