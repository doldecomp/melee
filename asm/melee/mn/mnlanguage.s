...
/* 8024C008 00248BE8  41 82 00 20 */	beq mnLanguage_8024C028
...
/* 8024C024 00248C04  48 00 01 D0 */	b mnLanguage_8024C1F4
mnLanguage_8024C028:
...
/* 8024C05C 00248C3C  41 82 00 24 */	beq mnLanguage_8024C080
...
/* 8024C07C 00248C5C  48 00 01 78 */	b mnLanguage_8024C1F4
mnLanguage_8024C080:
...
/* 8024C094 00248C74  41 82 00 50 */	beq mnLanguage_8024C0E4
...
/* 8024C0AC 00248C8C  41 82 01 48 */	beq mnLanguage_8024C1F4
...
/* 8024C0E0 00248CC0  48 00 01 14 */	b mnLanguage_8024C1F4
mnLanguage_8024C0E4:
/* 8024C0E4 00248CC4  88 1F 00 02 */	lbz r0, 2(r31)
/* 8024C0E8 00248CC8  28 00 00 00 */	cmplwi r0, 0
/* 8024C0EC 00248CCC  41 82 01 08 */	beq mnLanguage_8024C1F4
...
/* 8024C104 00248CE4  41 82 00 70 */	beq mnLanguage_8024C174
...
/* 8024C118 00248CF8  40 82 00 08 */	bne mnLanguage_8024C120
...
/* 8024C170 00248D50  48 00 00 84 */	b mnLanguage_8024C1F4
mnLanguage_8024C174:
...
/* 8024C188 00248D68  41 82 00 6C */	beq mnLanguage_8024C1F4
...
/* 8024C19C 00248D7C  40 82 00 08 */	bne mnLanguage_8024C1A4
...
/* 8024C24C 00248E2C  40 82 00 0C */	bne mnLanguage_8024C258
...
/* 8024C298 00248E78  41 82 00 38 */	beq mnLanguage_8024C2D0
/* 8024C29C 00248E7C  80 6D C1 98 */	lwz r3, lbl_804D7838@sda21(r13)
/* 8024C2A0 00248E80  48 14 3B 85 */	bl func_8038FE24
/* 8024C2A4 00248E84  3C 60 80 25 */	lis r3, mnLanguage_8024C210@ha
/* 8024C2A8 00248E88  38 83 C2 10 */	addi r4, r3, mnLanguage_8024C210@l
...
/* 8024C318 00248EF8  41 82 00 3C */	beq mnLanguage_8024C354
/* 8024C31C 00248EFC  80 6D C1 98 */	lwz r3, lbl_804D7838@sda21(r13)
/* 8024C320 00248F00  48 14 3B 05 */	bl func_8038FE24
/* 8024C324 00248F04  3C 60 80 25 */	lis r3, mnLanguage_8024C210@ha
/* 8024C328 00248F08  38 83 C2 10 */	addi r4, r3, mnLanguage_8024C210@l
...
/* 8024C350 00248F30  48 00 00 58 */	b mnLanguage_8024C3A8
mnLanguage_8024C354:
...
/* 8024C370 00248F50  40 82 00 38 */	bne mnLanguage_8024C3A8
/* 8024C374 00248F54  80 6D C1 98 */	lwz r3, lbl_804D7838@sda21(r13)
/* 8024C378 00248F58  48 14 3A AD */	bl func_8038FE24
/* 8024C37C 00248F5C  3C 60 80 25 */	lis r3, mnLanguage_8024C270@ha
/* 8024C380 00248F60  38 83 C2 70 */	addi r4, r3, mnLanguage_8024C270@l
...
/* 8024C470 00249050  40 82 00 20 */	bne mnLanguage_8024C490
...
/* 8024C4C0 002490A0  3C 60 80 25 */	lis r3, mnLanguage_8024C2E8@ha
/* 8024C4C4 002490A4  38 83 C2 E8 */	addi r4, r3, mnLanguage_8024C2E8@l
...
/* 8024C560 00249140  41 82 00 08 */	beq mnLanguage_8024C568
