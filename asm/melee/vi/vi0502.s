...
/* 8031E25C 0031AE3C  90 6D B9 04 */	stw r3, kirby_gobj@sda21(r13)
/* 8031E260 0031AE40  C0 22 E6 BC */	lfs f1, un_804DE09C@sda21(r2)
/* 8031E264 0031AE44  80 6D B9 04 */	lwz r3, kirby_gobj@sda21(r13)
...
/* 8031E27C 0031AE5C  80 6D B9 04 */	lwz r3, kirby_gobj@sda21(r13)
...
/* 8031E354 0031AF34  38 CD B9 00 */	addi r6, r13, erase_colors_vi0502@sda21
/* 8031E358 0031AF38  88 6D B9 00 */	lbz r3, erase_colors_vi0502@sda21(r13)
...
/* 8031E4F4 0031B0D4  3C 60 80 39 */	lis r3, HSD_GObj_FogCallback@ha
/* 8031E4F8 0031B0D8  38 83 10 B4 */	addi r4, r3, HSD_GObj_FogCallback@l
...
/* 8031E518 0031B0F8  90 0D B9 00 */	stw r0, erase_colors_vi0502@sda21(r13)
...
/* 8031E544 0031B124  3C 60 80 39 */	lis r3, HSD_GObj_LObjCallback@ha
/* 8031E548 0031B128  38 83 10 44 */	addi r4, r3, HSD_GObj_LObjCallback@l
...
/* 8031E5EC 0031B1CC  3C 80 80 39 */	lis r4, HSD_GObj_JObjCallback@ha
/* 8031E5F0 0031B1D0  3C 60 80 32 */	lis r3, .L_8031E304@ha
/* 8031E5F4 0031B1D4  54 1E 10 3A */	slwi r30, r0, 2
/* 8031E5F8 0031B1D8  3B 84 10 70 */	addi r28, r4, HSD_GObj_JObjCallback@l
...
/* 8031E6B4 0031B294  4B FF FA 71 */	bl vi0502_8031E124
