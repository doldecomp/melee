...
/* 8037E224 0037AE04  90 8D C0 5C */	stw r4, lbl_804D76FC-_SDA_BASE_(r13)
/* 8037E228 0037AE08  90 6D C0 58 */	stw r3, lbl_804D76F8-_SDA_BASE_(r13)
...
/* 8037E24C 0037AE2C  80 AD C0 5C */	lwz r5, lbl_804D76FC-_SDA_BASE_(r13)
/* 8037E250 0037AE30  80 0D C0 58 */	lwz r0, lbl_804D76F8-_SDA_BASE_(r13)
/* 8037E254 0037AE34  7C 85 20 10 */	subfc r4, r5, r4
/* 8037E258 0037AE38  7C 60 19 10 */	subfe r3, r0, r3
/* 8037E25C 0037AE3C  4B FA 4B 45 */	bl __cvt_sll_dbl
/* 8037E260 0037AE40  3C 60 80 00 */	lis r3, 0x800000F8@ha
/* 8037E264 0037AE44  C8 42 ED 38 */	lfd f2, lbl_804DE718-_SDA2_BASE_(r2)
...
/* 8037E2C0 0037AEA0  80 AD C0 5C */	lwz r5, lbl_804D76FC-_SDA_BASE_(r13)
/* 8037E2C4 0037AEA4  80 0D C0 58 */	lwz r0, lbl_804D76F8-_SDA_BASE_(r13)
/* 8037E2C8 0037AEA8  7C 85 20 10 */	subfc r4, r5, r4
/* 8037E2CC 0037AEAC  7C 60 19 10 */	subfe r3, r0, r3
/* 8037E2D0 0037AEB0  4B FA 4A D1 */	bl __cvt_sll_dbl
/* 8037E2D4 0037AEB4  3C 60 80 00 */	lis r3, 0x800000F8@ha
/* 8037E2D8 0037AEB8  C8 42 ED 38 */	lfd f2, lbl_804DE718-_SDA2_BASE_(r2)
...
/* 8037E338 0037AF18  80 AD C0 5C */	lwz r5, lbl_804D76FC-_SDA_BASE_(r13)
/* 8037E33C 0037AF1C  80 0D C0 58 */	lwz r0, lbl_804D76F8-_SDA_BASE_(r13)
/* 8037E340 0037AF20  7C 85 20 10 */	subfc r4, r5, r4
/* 8037E344 0037AF24  7C 60 19 10 */	subfe r3, r0, r3
/* 8037E348 0037AF28  4B FA 4A 59 */	bl __cvt_sll_dbl
/* 8037E34C 0037AF2C  3C 60 80 00 */	lis r3, 0x800000F8@ha
/* 8037E350 0037AF30  C8 42 ED 38 */	lfd f2, lbl_804DE718-_SDA2_BASE_(r2)
...
/* 8037E3BC 0037AF9C  38 6D A8 98 */	addi r3, r13, lbl_804D5F38-_SDA_BASE_
/* 8037E3C0 0037AFA0  38 80 00 A4 */	li r4, 0xa4
/* 8037E3C4 0037AFA4  38 AD A8 A0 */	addi r5, r13, lbl_804D5F40-_SDA_BASE_
/* 8037E3C8 0037AFA8  48 00 9E 59 */	bl func_80388220
lbl_8037E3CC:
