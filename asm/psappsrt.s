...
/* 803A4154 003A0D34  B0 0D C2 3E */	sth r0, lbl_804D78DE-_SDA_BASE_(r13)
/* 803A4158 003A0D38  B0 0D C2 38 */	sth r0, lbl_804D78D8-_SDA_BASE_(r13)
/* 803A415C 003A0D3C  B0 8D C2 B8 */	sth r4, lbl_804D7958-_SDA_BASE_(r13)
...
/* 803A41A4 003A0D84  4B FD 6A 25 */	bl func_8037ABC8
/* 803A41A8 003A0D88  7C 7F 1B 79 */	or. r31, r3, r3
/* 803A41AC 003A0D8C  41 82 00 14 */	beq lbl_803A41C0
/* 803A41B0 003A0D90  A0 AD C2 B8 */	lhz r5, lbl_804D7958-_SDA_BASE_(r13)
...
/* 803A41E0 003A0DC0  C0 02 F0 88 */	lfs f0, lbl_804DEA68-_SDA2_BASE_(r2)
...
/* 803A41FC 003A0DDC  C0 02 F0 8C */	lfs f0, lbl_804DEA6C-_SDA2_BASE_(r2)
...
/* 803A421C 003A0DFC  A0 6D C2 3E */	lhz r3, lbl_804D78DE-_SDA_BASE_(r13)
/* 803A4220 003A0E00  A0 0D C2 38 */	lhz r0, lbl_804D78D8-_SDA_BASE_(r13)
/* 803A4224 003A0E04  38 63 00 01 */	addi r3, r3, 1
/* 803A4228 003A0E08  B0 6D C2 3E */	sth r3, lbl_804D78DE-_SDA_BASE_(r13)
/* 803A422C 003A0E0C  A0 6D C2 3E */	lhz r3, lbl_804D78DE-_SDA_BASE_(r13)
/* 803A4230 003A0E10  7C 03 00 40 */	cmplw r3, r0
/* 803A4234 003A0E14  40 81 00 08 */	ble lbl_803A423C
/* 803A4238 003A0E18  B0 6D C2 38 */	sth r3, lbl_804D78D8-_SDA_BASE_(r13)
lbl_803A423C:
...
/* 803A43B0 003A0F90  4B FD 69 71 */	bl func_8037AD20
/* 803A43B4 003A0F94  A0 6D C2 3E */	lhz r3, lbl_804D78DE-_SDA_BASE_(r13)
/* 803A43B8 003A0F98  38 03 FF FF */	addi r0, r3, -1
/* 803A43BC 003A0F9C  B0 0D C2 3E */	sth r0, lbl_804D78DE-_SDA_BASE_(r13)
lbl_803A43C0:
