...
/* 80391318 0038DEF8  4B FF FF 49 */	bl HSD_GObj_80391260
...
/* 803913A8 0038DF88  90 6D C1 84 */	stw r3, HSD_GObj_804D7824@sda21(r13)
...
/* 803913C0 0038DFA0  90 6D C1 80 */	stw r3, HSD_GObj_804D7820@sda21(r13)
...
.L_803913D0:
/* 803913D0 0038DFB0  80 6D C1 80 */	lwz r3, HSD_GObj_804D7820@sda21(r13)
/* 803913D4 0038DFB4  38 C6 00 01 */	addi r6, r6, 1
/* 803913D8 0038DFB8  7C 83 29 2E */	stwx r4, r3, r5
/* 803913DC 0038DFBC  80 6D C1 84 */	lwz r3, HSD_GObj_804D7824@sda21(r13)
...
/* 8039140C 0038DFEC  90 6D C1 A0 */	stw r3, HSD_GObj_804D7840@sda21(r13)
...
.L_8039141C:
/* 8039141C 0038DFFC  80 6D C1 A0 */	lwz r3, HSD_GObj_804D7840@sda21(r13)
...
/* 80391454 0038E034  90 6D C1 A4 */	stw r3, HSD_GObj_804D7844@sda21(r13)
...
.L_80391464:
/* 80391464 0038E044  80 6D C1 A4 */	lwz r3, HSD_GObj_804D7844@sda21(r13)
...
/* 803914E8 0038E0C8  90 6D C1 70 */	stw r3, HSD_GObj_804D7810@sda21(r13)
...
/* 80391510 0038E0F0  80 6D C1 70 */	lwz r3, HSD_GObj_804D7810@sda21(r13)
...
/* 80391548 0038E128  90 0D C1 70 */	stw r0, HSD_GObj_804D7810@sda21(r13)
.L_8039154C:
/* 8039154C 0038E12C  38 00 00 00 */	li r0, 0
/* 80391550 0038E130  90 0D C1 9C */	stw r0, HSD_GObj_804D783C@sda21(r13)
/* 80391554 0038E134  3C 60 80 4D */	lis r3, HSD_GObj_804CE3E4@ha
/* 80391558 0038E138  90 0D C1 7C */	stw r0, HSD_GObj_804D781C@sda21(r13)
/* 8039155C 0038E13C  90 0D C1 98 */	stw r0, HSD_GObj_804D7838@sda21(r13)
/* 80391560 0038E140  90 03 E3 E4 */	stw r0, HSD_GObj_804CE3E4@l(r3)
/* 80391564 0038E144  90 0D C1 78 */	stw r0, HSD_GObj_804D7818@sda21(r13)
/* 80391568 0038E148  90 0D C1 74 */	stw r0, HSD_GObj_804D7814@sda21(r13)
...
.section .data
    .balign 8
.global HSD_GObj_804085F0
HSD_GObj_804085F0:
    .4byte 0x00000001
    .4byte 0x00000004
    .4byte 0x00000002
    .4byte NULL
.global HSD_GObj_80408600
HSD_GObj_80408600:
    .4byte HSD_GObj_80391120
    .4byte HSD_LObjRemoveAll
    .4byte HSD_JObjRemoveAll
    .4byte HSD_GObj_803911C0
.global HSD_GObj_80408610
HSD_GObj_80408610:
    .4byte NULL
    .4byte 0x04000000
    .4byte HSD_GObj_80408600
    .4byte NULL
.global HSD_GObj_80408620
HSD_GObj_80408620:
    .4byte 0x3F3F0200
    .4byte NULL
    .4byte NULL
...
.section .sbss
    .balign 8
.global HSD_GObj_804D7810
HSD_GObj_804D7810:
    .skip 0x4
.global HSD_GObj_804D7814
HSD_GObj_804D7814:
    .skip 0x4
.global HSD_GObj_804D7818
HSD_GObj_804D7818:
    .skip 0x4
.global HSD_GObj_804D781C
HSD_GObj_804D781C:
    .skip 0x4
.global HSD_GObj_804D7820
HSD_GObj_804D7820:
    .skip 0x4
.global HSD_GObj_804D7824
HSD_GObj_804D7824:
    .skip 0x4
...
HSD_GObj_804D7830:
    .skip 0x4
.global HSD_GObj_804D7834
HSD_GObj_804D7834:
    .skip 0x4
.global HSD_GObj_804D7838
HSD_GObj_804D7838:
    .skip 0x4
.global HSD_GObj_804D783C
HSD_GObj_804D783C:
    .skip 0x4
.global HSD_GObj_804D7840
HSD_GObj_804D7840:
    .skip 0x4
.global HSD_GObj_804D7844
HSD_GObj_804D7844:
    .skip 0x4
.global HSD_GObj_804D7848
HSD_GObj_804D7848:
    .skip 0x1
.global HSD_GObj_804D7849
HSD_GObj_804D7849:
    .skip 0x1
.global HSD_GObj_804D784A
HSD_GObj_804D784A:
    .skip 0x1
.global HSD_GObj_804D784B
HSD_GObj_804D784B:
    .skip 0x5
