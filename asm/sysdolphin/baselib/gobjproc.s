...
/* 8038FAC8 0038C6A8  81 2D C1 A4 */	lwz r9, HSD_GObj_804D7844@sda21(r13)
...
/* 8038FAE0 0038C6C0  41 82 00 60 */	beq .L_8038FB40
/* 8038FAE4 0038C6C4  7C 86 23 78 */	mr r6, r4
/* 8038FAE8 0038C6C8  48 00 00 4C */	b .L_8038FB34
.L_8038FAEC:
/* 8038FAEC 0038C6CC  80 E6 00 18 */	lwz r7, 0x18(r6)
/* 8038FAF0 0038C6D0  48 00 00 38 */	b .L_8038FB28
.L_8038FAF4:
/* 8038FAF4 0038C6D4  88 A7 00 0C */	lbz r5, 0xc(r7)
/* 8038FAF8 0038C6D8  7C 05 00 40 */	cmplw r5, r0
/* 8038FAFC 0038C6DC  40 82 00 28 */	bne .L_8038FB24
...
/* 8038FB64 0038C744  48 00 00 10 */	b .L_8038FB74
.L_8038FB68:
/* 8038FB68 0038C748  7C E6 28 2E */	lwzx r7, r6, r5
/* 8038FB6C 0038C74C  28 07 00 00 */	cmplwi r7, 0
/* 8038FB70 0038C750  40 82 00 38 */	bne .L_8038FBA8
.L_8038FB74:
...
/* 8038FB80 0038C760  40 82 FF E8 */	bne .L_8038FB68
/* 8038FB84 0038C764  80 CD C1 A0 */	lwz r6, HSD_GObj_804D7840@sda21(r13)
...
/* 8038FB98 0038C778  80 CD C1 A0 */	lwz r6, HSD_GObj_804D7840@sda21(r13)
/* 8038FB9C 0038C77C  7C 66 39 2E */	stwx r3, r6, r7
/* 8038FBA0 0038C780  90 A3 00 08 */	stw r5, 8(r3)
/* 8038FBA4 0038C784  48 00 00 14 */	b .L_8038FBB8
.L_8038FBA8:
