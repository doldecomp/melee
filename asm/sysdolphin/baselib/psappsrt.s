...
/* 803A417C 003A0D5C  3C A0 80 4D */	lis r5, HSD_PSAppSrt_804D10B0@ha
/* 803A4180 003A0D60  90 01 00 04 */	stw r0, 4(r1)
/* 803A4184 003A0D64  38 05 10 B0 */	addi r0, r5, HSD_PSAppSrt_804D10B0@l
...
/* 803A41AC 003A0D8C  41 82 00 14 */	beq .L_803A41C0
/* 803A41B0 003A0D90  A0 AD C2 B8 */	lhz r5, HSD_PSAppSrt_804D7958@sda21(r13)
...
/* 803A41C4 003A0DA4  41 82 00 78 */	beq .L_803A423C
...
/* 803A41E0 003A0DC0  C0 02 F0 88 */	lfs f0, HSD_PSAppSrt_804DEA68@sda21(r2)
...
/* 803A41FC 003A0DDC  C0 02 F0 8C */	lfs f0, HSD_PSAppSrt_804DEA6C@sda21(r2)
...
/* 803A421C 003A0DFC  A0 6D C2 3E */	lhz r3, hsd_804D78DE@sda21(r13)
/* 803A4220 003A0E00  A0 0D C2 38 */	lhz r0, hsd_804D78D8@sda21(r13)
/* 803A4224 003A0E04  38 63 00 01 */	addi r3, r3, 1
/* 803A4228 003A0E08  B0 6D C2 3E */	sth r3, hsd_804D78DE@sda21(r13)
/* 803A422C 003A0E0C  A0 6D C2 3E */	lhz r3, hsd_804D78DE@sda21(r13)
/* 803A4230 003A0E10  7C 03 00 40 */	cmplw r3, r0
/* 803A4234 003A0E14  40 81 00 08 */	ble .L_803A423C
/* 803A4238 003A0E18  B0 6D C2 38 */	sth r3, hsd_804D78D8@sda21(r13)
.L_803A423C:
...
/* 803A42D0 003A0EB0  41 82 00 18 */	beq .L_803A42E8
/* 803A42D4 003A0EB4  28 03 00 00 */	cmplwi r3, 0
/* 803A42D8 003A0EB8  41 82 00 10 */	beq .L_803A42E8
/* 803A42DC 003A0EBC  80 03 00 8C */	lwz r0, 0x8c(r3)
/* 803A42E0 003A0EC0  28 00 00 00 */	cmplwi r0, 0
/* 803A42E4 003A0EC4  41 82 00 0C */	beq .L_803A42F0
.L_803A42E8:
...
/* 803A430C 003A0EEC  41 82 00 18 */	beq .L_803A4324
/* 803A4310 003A0EF0  28 03 00 00 */	cmplwi r3, 0
/* 803A4314 003A0EF4  41 82 00 10 */	beq .L_803A4324
/* 803A4318 003A0EF8  80 03 00 54 */	lwz r0, 0x54(r3)
/* 803A431C 003A0EFC  28 00 00 00 */	cmplwi r0, 0
/* 803A4320 003A0F00  41 82 00 0C */	beq .L_803A432C
.L_803A4324:
...
/* 803A4368 003A0F48  40 82 00 0C */	bne .L_803A4374
/* 803A436C 003A0F4C  38 60 FF FF */	li r3, -1
/* 803A4370 003A0F50  48 00 00 5C */	b .L_803A43CC
.L_803A4374:
...
/* 803A4384 003A0F64  40 82 00 3C */	bne .L_803A43C0
...
/* 803A4394 003A0F74  41 82 00 10 */	beq .L_803A43A4
/* 803A4398 003A0F78  7D 88 03 A6 */	mtlr r12
/* 803A439C 003A0F7C  38 7F 00 00 */	addi r3, r31, 0
/* 803A43A0 003A0F80  4E 80 00 21 */	blrl
.L_803A43A4:
/* 803A43A4 003A0F84  3C 60 80 4D */	lis r3, HSD_PSAppSrt_804D10B0@ha
/* 803A43A8 003A0F88  38 63 10 B0 */	addi r3, r3, HSD_PSAppSrt_804D10B0@l
/* 803A43AC 003A0F8C  38 9F 00 00 */	addi r4, r31, 0
/* 803A43B0 003A0F90  4B FD 69 71 */	bl HSD_ObjFree
/* 803A43B4 003A0F94  A0 6D C2 3E */	lhz r3, hsd_804D78DE@sda21(r13)
/* 803A43B8 003A0F98  38 03 FF FF */	addi r0, r3, -1
/* 803A43BC 003A0F9C  B0 0D C2 3E */	sth r0, hsd_804D78DE@sda21(r13)
.L_803A43C0:
...
/* 803A440C 003A0FEC  40 82 00 0C */	bne .L_803A4418
/* 803A4410 003A0FF0  38 60 FF FF */	li r3, -1
/* 803A4414 003A0FF4  48 00 00 74 */	b .L_803A4488
.L_803A4418:
/* 803A4418 003A0FF8  84 03 00 04 */	lwzu r0, 4(r3)
/* 803A441C 003A0FFC  7C 00 E8 40 */	cmplw r0, r29
/* 803A4420 003A1000  40 82 00 0C */	bne .L_803A442C
...
/* 803A4440 003A1020  40 82 00 3C */	bne .L_803A447C
...
/* 803A4450 003A1030  41 82 00 10 */	beq .L_803A4460
/* 803A4454 003A1034  7D 88 03 A6 */	mtlr r12
/* 803A4458 003A1038  38 7F 00 00 */	addi r3, r31, 0
/* 803A445C 003A103C  4E 80 00 21 */	blrl
.L_803A4460:
/* 803A4460 003A1040  3C 60 80 4D */	lis r3, HSD_PSAppSrt_804D10B0@ha
/* 803A4464 003A1044  38 63 10 B0 */	addi r3, r3, HSD_PSAppSrt_804D10B0@l
/* 803A4468 003A1048  38 9F 00 00 */	addi r4, r31, 0
/* 803A446C 003A104C  4B FD 68 B5 */	bl HSD_ObjFree
/* 803A4470 003A1050  A0 6D C2 3E */	lhz r3, hsd_804D78DE@sda21(r13)
/* 803A4474 003A1054  38 03 FF FF */	addi r0, r3, -1
/* 803A4478 003A1058  B0 0D C2 3E */	sth r0, hsd_804D78DE@sda21(r13)
.L_803A447C:
...
.section .sbss
    .balign 8
.global HSD_PSAppSrt_804D7958
HSD_PSAppSrt_804D7958:
    .skip 0x8


.section .sdata2
    .balign 8
.global HSD_PSAppSrt_804DEA68
HSD_PSAppSrt_804DEA68:
    .4byte NULL
.global HSD_PSAppSrt_804DEA6C
HSD_PSAppSrt_804DEA6C:
    .float 1.0
