...
/* 80378A38 00375618  C0 02 EC 44 */	lfs f0, HSD_Spline_804DE624@sda21(r2)
/* 80378A3C 0037561C  ED 41 00 72 */	fmuls f10, f1, f1
/* 80378A40 00375620  C1 02 EC 40 */	lfs f8, HSD_Spline_804DE620@sda21(r2)
/* 80378A44 00375624  C0 E2 EC 48 */	lfs f7, HSD_Spline_804DE628@sda21(r2)
...
/* 80378A98 00375678  C1 02 EC 58 */	lfs f8, HSD_Spline_804DE638@sda21(r2)
/* 80378A9C 0037567C  FC 01 40 40 */	fcmpo cr0, f1, f8
/* 80378AA0 00375680  41 80 04 90 */	blt .L_80378F30
/* 80378AA4 00375684  C0 02 EC 48 */	lfs f0, HSD_Spline_804DE628@sda21(r2)
/* 80378AA8 00375688  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80378AAC 0037568C  40 81 00 08 */	ble .L_80378AB4
/* 80378AB0 00375690  48 00 04 80 */	b .L_80378F30
.L_80378AB4:
/* 80378AB4 00375694  40 80 03 24 */	bge .L_80378DD8
...
/* 80378AC8 003756A8  C8 62 EC 60 */	lfd f3, HSD_Spline_804DE640@sda21(r2)
...
/* 80378B18 003756F8  41 82 01 1C */	beq .L_80378C34
/* 80378B1C 003756FC  40 80 00 14 */	bge .L_80378B30
/* 80378B20 00375700  2C 00 00 00 */	cmpwi r0, 0
/* 80378B24 00375704  41 82 00 18 */	beq .L_80378B3C
/* 80378B28 00375708  40 80 00 64 */	bge .L_80378B8C
/* 80378B2C 0037570C  48 00 04 04 */	b .L_80378F30
.L_80378B30:
/* 80378B30 00375710  2C 00 00 04 */	cmpwi r0, 4
/* 80378B34 00375714  40 80 03 FC */	bge .L_80378F30
/* 80378B38 00375718  48 00 01 CC */	b .L_80378D04
.L_80378B3C:
...
/* 80378B88 00375768  48 00 03 A8 */	b .L_80378F30
.L_80378B8C:
/* 80378B8C 0037576C  EC A0 10 28 */	fsubs f5, f0, f2
/* 80378B90 00375770  C0 22 EC 44 */	lfs f1, HSD_Spline_804DE624@sda21(r2)
...
/* 80378C30 00375810  48 00 03 00 */	b .L_80378F30
.L_80378C34:
/* 80378C34 00375814  ED 82 00 B2 */	fmuls f12, f2, f2
/* 80378C38 00375818  C0 22 EC 54 */	lfs f1, HSD_Spline_804DE634@sda21(r2)
/* 80378C3C 0037581C  7C E0 07 34 */	extsh r0, r7
/* 80378C40 00375820  C0 E2 EC 44 */	lfs f7, HSD_Spline_804DE624@sda21(r2)
/* 80378C44 00375824  ED 40 10 28 */	fsubs f10, f0, f2
/* 80378C48 00375828  ED 6C 00 B2 */	fmuls f11, f12, f2
/* 80378C4C 0037582C  C1 22 EC 4C */	lfs f9, HSD_Spline_804DE62C@sda21(r2)
/* 80378C50 00375830  EC 21 03 32 */	fmuls f1, f1, f12
/* 80378C54 00375834  C0 82 EC 50 */	lfs f4, HSD_Spline_804DE630@sda21(r2)
...
/* 80378D00 003758E0  48 00 02 30 */	b .L_80378F30
.L_80378D04:
...
/* 80378D14 003758F4  C0 62 EC 44 */	lfs f3, HSD_Spline_804DE624@sda21(r2)
/* 80378D18 003758F8  C0 E2 EC 40 */	lfs f7, HSD_Spline_804DE620@sda21(r2)
...
/* 80378DD4 003759B4  48 00 01 5C */	b .L_80378F30
.L_80378DD8:
...
/* 80378DE8 003759C8  41 82 00 7C */	beq .L_80378E64
/* 80378DEC 003759CC  40 80 00 14 */	bge .L_80378E00
/* 80378DF0 003759D0  2C 00 00 00 */	cmpwi r0, 0
/* 80378DF4 003759D4  41 82 00 18 */	beq .L_80378E0C
/* 80378DF8 003759D8  40 80 00 40 */	bge .L_80378E38
/* 80378DFC 003759DC  48 00 01 34 */	b .L_80378F30
.L_80378E00:
/* 80378E00 003759E0  2C 00 00 04 */	cmpwi r0, 4
/* 80378E04 003759E4  40 80 01 2C */	bge .L_80378F30
/* 80378E08 003759E8  48 00 00 FC */	b .L_80378F04
.L_80378E0C:
...
/* 80378E34 00375A14  48 00 00 FC */	b .L_80378F30
.L_80378E38:
...
/* 80378E60 00375A40  48 00 00 D0 */	b .L_80378F30
.L_80378E64:
...
/* 80378E74 00375A54  C0 E2 EC 4C */	lfs f7, HSD_Spline_804DE62C@sda21(r2)
...
/* 80378E84 00375A64  C0 C2 EC 44 */	lfs f6, HSD_Spline_804DE624@sda21(r2)
...
/* 80378F00 00375AE0  48 00 00 30 */	b .L_80378F30
.L_80378F04:
...
/* 80378F94 00375B74  C3 E2 EC 58 */	lfs f31, HSD_Spline_804DE638@sda21(r2)
/* 80378F98 00375B78  C3 C2 EC 48 */	lfs f30, HSD_Spline_804DE628@sda21(r2)
/* 80378F9C 00375B7C  FC 01 F8 40 */	fcmpo cr0, f1, f31
/* 80378FA0 00375B80  4C 40 13 82 */	cror 2, 0, 2
/* 80378FA4 00375B84  40 82 00 0C */	bne .L_80378FB0
/* 80378FA8 00375B88  FC 20 F8 90 */	fmr f1, f31
/* 80378FAC 00375B8C  48 00 02 C4 */	b .L_80379270
.L_80378FB0:
/* 80378FB0 00375B90  FC 01 F0 40 */	fcmpo cr0, f1, f30
/* 80378FB4 00375B94  4C 41 13 82 */	cror 2, 1, 2
/* 80378FB8 00375B98  40 82 00 0C */	bne .L_80378FC4
/* 80378FBC 00375B9C  FC 20 F0 90 */	fmr f1, f30
/* 80378FC0 00375BA0  48 00 02 B0 */	b .L_80379270
.L_80378FC4:
/* 80378FC4 00375BA4  80 9B 00 10 */	lwz r4, 0x10(r27)
/* 80378FC8 00375BA8  7C 83 23 78 */	mr r3, r4
/* 80378FCC 00375BAC  48 00 00 0C */	b .L_80378FD8
.L_80378FD0:
...
/* 80378FE0 00375BC0  41 80 FF F0 */	blt .L_80378FD0
/* 80378FE4 00375BC4  88 1B 00 00 */	lbz r0, 0(r27)
/* 80378FE8 00375BC8  2C 00 00 00 */	cmpwi r0, 0
/* 80378FEC 00375BCC  41 82 00 14 */	beq .L_80379000
/* 80378FF0 00375BD0  41 80 02 3C */	blt .L_8037922C
/* 80378FF4 00375BD4  2C 00 00 04 */	cmpwi r0, 4
/* 80378FF8 00375BD8  40 80 02 34 */	bge .L_8037922C
/* 80378FFC 00375BDC  48 00 00 24 */	b .L_80379020
.L_80379000:
...
/* 8037901C 00375BFC  48 00 02 10 */	b .L_8037922C
.L_80379020:
/* 80379020 00375C00  57 80 10 3A */	slwi r0, r28, 2
/* 80379024 00375C04  C3 22 EC 58 */	lfs f25, HSD_Spline_804DE638@sda21(r2)
...
/* 80379040 00375C20  C3 62 EC 68 */	lfs f27, HSD_Spline_804DE648@sda21(r2)
/* 80379044 00375C24  EE C2 00 32 */	fmuls f22, f2, f0
/* 80379048 00375C28  C3 42 EC 50 */	lfs f26, HSD_Spline_804DE630@sda21(r2)
/* 8037904C 00375C2C  C3 82 EC 40 */	lfs f28, HSD_Spline_804DE620@sda21(r2)
/* 80379050 00375C30  C2 42 EC 74 */	lfs f18, HSD_Spline_804DE654@sda21(r2)
/* 80379054 00375C34  C2 22 EC 70 */	lfs f17, HSD_Spline_804DE650@sda21(r2)
/* 80379058 00375C38  C2 02 EC 6C */	lfs f16, HSD_Spline_804DE64C@sda21(r2)
/* 8037905C 00375C3C  C1 E2 EC 44 */	lfs f15, HSD_Spline_804DE624@sda21(r2)
/* 80379060 00375C40  48 00 01 B0 */	b .L_80379210
.L_80379064:
/* 80379064 00375C44  EC 1F F0 2A */	fadds f0, f31, f30
/* 80379068 00375C48  80 1B 00 14 */	lwz r0, 0x14(r27)
/* 8037906C 00375C4C  C3 02 EC 58 */	lfs f24, HSD_Spline_804DE638@sda21(r2)
...
/* 80379090 00375C70  40 82 00 58 */	bne .L_803790E8
...
/* 803790CC 00375CAC  40 80 00 10 */	bge .L_803790DC
/* 803790D0 00375CB0  FC 01 D8 40 */	fcmpo cr0, f1, f27
/* 803790D4 00375CB4  40 81 00 08 */	ble .L_803790DC
...
/* 803790E4 00375CC4  48 00 00 54 */	b .L_80379138
.L_803790E8:
...
/* 80379120 00375D00  40 80 00 10 */	bge .L_80379130
/* 80379124 00375D04  FC 01 D8 40 */	fcmpo cr0, f1, f27
/* 80379128 00375D08  40 81 00 08 */	ble .L_80379130
...
/* 80379144 00375D24  40 81 FF 48 */	ble .L_8037908C
...
/* 80379180 00375D60  40 80 00 10 */	bge .L_80379190
/* 80379184 00375D64  FC 01 D8 40 */	fcmpo cr0, f1, f27
/* 80379188 00375D68  40 81 00 08 */	ble .L_80379190
...
/* 803791D0 00375DB0  40 80 00 10 */	bge .L_803791E0
/* 803791D4 00375DB4  FC 01 D8 40 */	fcmpo cr0, f1, f27
/* 803791D8 00375DB8  40 81 00 08 */	ble .L_803791E0
...
/* 803791FC 00375DDC  40 80 00 0C */	bge .L_80379208
/* 80379200 00375DE0  FF C0 E8 90 */	fmr f30, f29
/* 80379204 00375DE4  48 00 00 0C */	b .L_80379210
.L_80379208:
...
/* 80379218 00375DF8  40 80 00 08 */	bge .L_80379220
...
/* 80379228 00375E08  41 82 FE 3C */	beq .L_80379064
.L_8037922C:
...
/* 80379244 00375E24  C8 62 EC 60 */	lfd f3, HSD_Spline_804DE640@sda21(r2)
/* 80379248 00375E28  90 61 00 38 */	stw r3, 0x38(r1)
/* 8037924C 00375E2C  C0 02 EC 48 */	lfs f0, HSD_Spline_804DE628@sda21(r2)
...
.section .sdata2
    .balign 8
.global HSD_Spline_804DE620
HSD_Spline_804DE620:
    .4byte 0x40000000
.global HSD_Spline_804DE624
HSD_Spline_804DE624:
    .4byte 0x40400000
.global HSD_Spline_804DE628
HSD_Spline_804DE628:
    .4byte 0x3F800000
.global HSD_Spline_804DE62C
HSD_Spline_804DE62C:
    .4byte 0x3E2AAAAB
.global HSD_Spline_804DE630
HSD_Spline_804DE630:
    .4byte 0x40800000
.global HSD_Spline_804DE634
HSD_Spline_804DE634:
    .4byte 0x40C00000
.global HSD_Spline_804DE638
HSD_Spline_804DE638:
    .4byte 0x00000000
    .4byte 0x00000000
.global HSD_Spline_804DE640
HSD_Spline_804DE640:
    .4byte 0x43300000
    .4byte 0x80000000
.global HSD_Spline_804DE648
HSD_Spline_804DE648:
    .4byte 0xBA83126F
.global HSD_Spline_804DE64C
HSD_Spline_804DE64C:
    .4byte 0x3E000000
.global HSD_Spline_804DE650
HSD_Spline_804DE650:
    .4byte 0x3F000000
.global HSD_Spline_804DE654
HSD_Spline_804DE654:
    .4byte 0x3727C5AC
