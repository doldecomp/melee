...
void GXBeginDisplayList(void* list, u32 size)
{
    ...
    ASSERTMSGLINE(0x7D, !gx->inDispList,
                  "GXBeginDisplayList: display list already in progress");
    ASSERTMSGLINE(0x7E, (size & 0x1F) == 0,
                  "GXBeginDisplayList: size is not 32 byte aligned");
    ASSERTMSGLINE(0x7F, ((u32) list & 0x1F) == 0,
...
unsigned long GXEndDisplayList(void)
{
    ...
    ASSERTMSGLINE(0xB6, gx->inDispList == TRUE,
    ...
    ASSERTMSGLINE(0xC3, !ov,
                  "GXEndDisplayList: display list commands overflowed buffer");
...
void GXCallDisplayList(void* list, u32 nbytes)
{
    ...
    ASSERTMSGLINE(0xED, !gx->inDispList,
                  "GXCallDisplayList: display list already in progress");
    ASSERTMSGLINE(0xEE, (nbytes & 0x1F) == 0,
                  "GXCallDisplayList: nbytes is not 32 byte aligned");
    ASSERTMSGLINE(0xEF, ((u32) list & 0x1F) == 0,
