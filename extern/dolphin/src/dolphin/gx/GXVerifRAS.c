...
void __GXVerifySU(void)
{
    ...
    case 2:
        if (__gxVerif->verifyLevel >= 1) {
            if ((u32) GET_REG_FIELD(__gxVerif->rasRegs[33], 11, 12) > 979) {
                sprintf(__gxvDummyStr, __gxvWarnings[4], 979,
                        "RGB multisample");
                __gxVerif->cb(1, 4U, __gxvDummyStr);
            }
            if ((u32) GET_REG_FIELD(__gxVerif->rasRegs[33], 11, 0) > 603) {
                sprintf(__gxvDummyStr, __gxvWarnings[5], 603,
                        "RGB multisample");
                __gxVerif->cb(1, 5U, __gxvDummyStr);
            }
        }
...
void __GXVerifyBUMP(void)
{
    ...
    for (i = 0; i < nTev; i++) {
        ...
        if (__gxVerif->verifyLevel >= 1) {
            if ((u32) (__gxVerif->rasRegs[16 + i] & 0xFF000000) + 0x01000000 ==
                0U)
            {
    ...
    if (__gxVerif->verifyLevel >= 1) {
        ...
        if (nBmp > 2U &&
            GET_REG_FIELD(__gxVerif->rasRegs[0x27], 3, 15) >= nTex)
        {
            sprintf(__gxvDummyStr, __gxvWarnings[12], 2U);
            __gxVerif->cb(1, 0xCU, __gxvDummyStr);
        }
        if (nBmp > 3U &&
            GET_REG_FIELD(__gxVerif->rasRegs[0x27], 3, 21) >= nTex)
        {
    ...
    for (i = 0; i < nTev + nBmp; i++) {
        if (i < nTev) {
            if (__gxVerif->verifyLevel >= 1) {
                ...
                if (i & 1) {
                    enabled = GET_REG_FIELD(
                        __gxVerif->rasRegs[(i >> 1U) + 0x28], 1, 18);
                    if (enabled &&
                    ...
                    texId = GET_REG_FIELD(__gxVerif->rasRegs[(i >> 1U) + 0x28],
                                          3, 12);
                } else {
                    enabled = GET_REG_FIELD(
                        __gxVerif->rasRegs[(i >> 1U) + 0x28], 1, 6);
                    if (enabled &&
                        (GET_REG_FIELD(__gxVerif->rasRegs[(i >> 1U) + 0x28], 3,
                                       3) >= nTex))
                    {
        ...
        if (enabled) {
            if (__gxVerif->verifyLevel >= 1) {
                ...
                if (GET_REG_FIELD(__gxVerif->rasRegs[0x8C + SOMEINDEX(texId)],
                                  1, 21) == 0 &&
                ...
                if (((u32) GET_REG_FIELD(
                     ...
                     (u32) GET_REG_FIELD(
                         __gxVerif->rasRegs[0x88 + SOMEINDEX(texId)], 4, 20) ==
                         10) &&
                    (__gxVerif->rasRegs[0x98 + SOMEINDEX(texId)] &
                     0xFF000000) +
                            0x01000000 ==
                        0U)
                {
                ...
                if (GET_REG_FIELD(__gxVerif->rasRegs[0x88 + SOMEINDEX(texId)],
                                  10, 0) +
                        1 ==
                    0)
                {
                    ...
                    w2 = (GET_REG_FIELD(
                              __gxVerif->rasRegs[0x88 + SOMEINDEX(texId)], 10,
                              0) +
                          1) == w2;
                }
                ...
                if (GET_REG_FIELD(__gxVerif->rasRegs[0x80 + SOMEINDEX(texId)] &
                    ...
                    ((u32) GET_REG_FIELD(
                     ...
                     (u32) GET_REG_FIELD(
                         ...
                         10) &&
                    (u32) GET_REG_FIELD(
                        __gxVerif->rasRegs[0x80 + SOMEINDEX(texId)], 3, 5) !=
                        1 &&
                    (u32) GET_REG_FIELD(
                        __gxVerif->rasRegs[0x80 + SOMEINDEX(texId)], 3, 5) !=
                        5)
                ...
                if (GET_REG_FIELD(__gxVerif->rasRegs[0x80 + SOMEINDEX(texId)],
                                  2, 19) &&
                    (GET_REG_FIELD(
                         __gxVerif->rasRegs[0x80 + SOMEINDEX(texId)] & 0xFFFF,
                         2, 5) == 0 ||
                     (u32) GET_REG_FIELD(
                         __gxVerif->rasRegs[0x80 + SOMEINDEX(texId)], 3, 5) !=
                         6 ||
                     (u32) GET_REG_FIELD(
                         __gxVerif->rasRegs[0x80 + SOMEINDEX(texId)], 1, 4) !=
                         1 ||
                     (u32) GET_REG_FIELD(
                         __gxVerif->rasRegs[0x88 + SOMEINDEX(texId)], 4, 20) ==
                         8 ||
...
void __GXVerifyTEV(void)
{
    ...
    for (i = 0; i < nTev; i++) {
        ...
        if (__gxVerif->verifyLevel >= 1) {
            if (!enabled &&
                ((u32) GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC0], 4,
                                     12) == 8 ||
                 (u32) GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC0], 4,
                                     12) == 9))
            {
            ...
            if (!enabled &&
                (u32) GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC1], 3,
                                    13) == 4)
            {
            ...
            if (!enabled && (u32) GET_REG_FIELD(
                                __gxVerif->rasRegs[(i * 2) + 0xC1], 3, 7) == 4)
            {
                sprintf(__gxvDummyStr, __gxvWarnings[0x23], "C", i);
                __gxVerif->cb(1, 0x23U, __gxvDummyStr);
            }
            if (!enabled && (u32) GET_REG_FIELD(
                                __gxVerif->rasRegs[(i * 2) + 0xC1], 3, 4) == 4)
            {
                sprintf(__gxvDummyStr, __gxvWarnings[0x23], "D", i);
                __gxVerif->cb(1, 0x23U, __gxvDummyStr);
            }
            if ((u32) GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC0], 4,
                                    12) <= 7 &&
                ((__gxVerif->rasRegs[GET_REG_FIELD(
                                         __gxVerif->rasRegs[(i * 2) + 0xC0], 4,
                                         12) +
                                     0xE1] &
                  0xFF000000) +
                 0x01000000) == 0U)
            {
                              ...
                              __gxVerif->rasRegs[(i * 2) + 0xC0], 3, 13)])
                {
                    sprintf(__gxvDummyStr, __gxvWarnings[0x24], "A", i,
                            GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC0],
                                          1, 0xCU)
                                ? "alpha"
                                : "color",
            ...
            if ((u32) GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC1], 3,
                                    13) <= 3 &&
                ((__gxVerif->rasRegs[GET_REG_FIELD(
                                         __gxVerif->rasRegs[(i * 2) + 0xC1], 4,
                                         14) +
                                     0xE0] &
                  0xFF000000) +
                 0x01000000) == 0U &&
                Awritten[GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC1], 3,
                                       13)] == 0U)
            {
                sprintf(
                    __gxvDummyStr, __gxvWarnings[0x25], "A", i,
            ...
            {
                sprintf(
                    __gxvDummyStr, __gxvWarnings[0x25], "B", i,
            ...
            {
                sprintf(
                    __gxvDummyStr, __gxvWarnings[0x25], "C", i,
            ...
            {
                sprintf(
                    __gxvDummyStr, __gxvWarnings[0x25], "D", i,
        ...
        if (__gxVerif->verifyLevel >= 3) {
            ...
            {
                if (GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC0], 1, 12)
                        ? Alh[GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC0],
                                            3, 13)]
                        : Clh[GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC0],
                                            3, 13)])
                {
                                    ...
                                    8) <= 7)
            {
                ...
                {
                    sprintf(
                        __gxvDummyStr, __gxvWarnings[0x26], "B", i,
                        GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC0], 1, 8)
                            ? "alpha"
                            : "color",
                        GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC0], 3,
                                      9));
                    __gxVerif->cb(3, 0x26U, __gxvDummyStr);
                }
            }
                                    ...
                                    4) <= 7)
            {
                ...
                {
                    sprintf(
                        __gxvDummyStr, __gxvWarnings[0x26], "C", i,
            ...
            if ((u32) GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC1], 3,
                                    13) <= 3 &&
                (u32) Alh[GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC1], 3,
                                        13)] != 0)
            {
                sprintf(__gxvDummyStr, __gxvWarnings[0x27], "A", i,
                        GET_REG_FIELD(__gxVerif->rasRegs[(i * 2) + 0xC1], 3,
                                      0xDU));
            ...
            {
                sprintf(
                    __gxvDummyStr, __gxvWarnings[0x27], "C", i,
    ...
    if (__gxVerif->verifyLevel >= 3) {
        if (!GET_REG_FIELD(__gxVerif->rasRegs[((nTev - 1) * 2) + 0xC1], 2,
                           0) &&
