...
Mtx* MTXPush(MTXStack* sPtr, Mtx m)
{
    ...
    if (sPtr->stackPtr == NULL) {
        ...
        ASSERTMSGLINE(0x76,
                      ((((s32) sPtr->stackPtr - (s32) sPtr->stackBase) / 16) /
                       3) < (sPtr->numMtx - 1),
...
Mtx* MTXPushFwd(MTXStack* sPtr, Mtx m)
{
    ...
    if (sPtr->stackPtr == NULL) {
        ...
        MTXConcat((void*) sPtr->stackPtr, (void*) m,
                  (void*) (sPtr->stackPtr + 1));
        sPtr->stackPtr++;
    }
    return sPtr->stackPtr;
}
...
Mtx* MTXPushInv(MTXStack* sPtr, Mtx m)
{
    ...
    if (sPtr->stackPtr == NULL) {
        ...
        MTXConcat((void*) &mInv, (void*) sPtr->stackPtr,
                  (void*) (sPtr->stackPtr + 1));
        sPtr->stackPtr++;
    }
    return sPtr->stackPtr;
...
Mtx* MTXPushInvXpose(MTXStack* sPtr, Mtx m)
{
    ...
    if (sPtr->stackPtr == NULL) {
        ...
        MTXConcat((void*) sPtr->stackPtr, (void*) &mIT,
                  (void*) (sPtr->stackPtr + 1));
        sPtr->stackPtr++;
    }
    return sPtr->stackPtr;
