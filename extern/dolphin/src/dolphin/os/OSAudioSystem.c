...
static u8 DSPInitCode[128] = {
    ...
    0x12, 0x06, 0x12, 0x03, 0x12, 0x04, 0x12, 0x05, 0x00, 0x80,
    0x80, 0x00, 0x00, 0x88, 0xFF, 0xFF, 0x00, 0x84, 0x10, 0x00, 0x00, 0x64, 0x00, 0x1D, 0x02, 0x18,
    0x00, 0x00, 0x81, 0x00, 0x1C, 0x1E, 0x00, 0x44, 0x1B, 0x1E, 0x00, 0x84, 0x08, 0x00, 0x00, 0x64,
    0x00, 0x27, 0x19, 0x1E, 0x00, 0x00, 0x00, 0xDE, 0xFF, 0xFC, 0x02, 0xA0, 0x80, 0x00, 0x02, 0x9C, 0x00, 0x28,
...
void __OSInitAudioSystem(void)
{
    ...
    memcpy((void*) ((u32) OSGetArenaHi() - 0x80), __DSPWorkBuffer,
           sizeof(DSPInitCode));
    ...
    *(u32*) &__DSPRegs[20] = 0x20;
    ...
    if (((u32) ((reg16 << 16) | __DSPRegs[3]) + 0x7FAC0000U) != 0x4348) {
        ASSERTMSGLINE(0xB7, 0,
                      "__OSInitAudioSystem(): DSP returns invalid message");
    }
