...
// ? lbvector_angle(?);
// ? lbvector_angle_xy(?);
// ? lbvector_rotate_about_unit_axis(?);
// ? func_8000DB00(?);
// ? lbvector_mirror(?);
// ? lbvector_cos_angle(?);
// ? lbvector_lerp(?);
// ? func_8000DE38(?);
// ? lbvector_euler_angles_from_onb(?);
// ? lbvector_euler_angles_from_implicit_onb(?);
// ? lbvector_apply_euler_rotation(?);
// ? lbvector_sqrtf_accurate(?);
// ? lbvector_project_world_to_screen_coord(?);
// ? lbvector_create_euler_matrix(?);
// ? lbvector_some_camera_vector_computation(?);
// ? func_8000E9F0(?);
// ? func_8000ED54(?);
// ? func_8000EE8C(?);
// ? func_8000EEE0(?);
