...
// ? func_8033E11C(?);
// ? func_8033E144(?);
void GXSetChanAmbColor(int, GXColor); // GXSetChanAmbColor(GXChannelID chan, GXColor amb_color);
void GXSetChanMatColor(int, GXColor); //GXSetChanMatColor(GXChannelID chan, GXColor mat_color);
// ? func_8033E55C(?);
void GXSetChanCtrl(int,int, int, int, int, int, int); //GXSetChanCtrl(GXChannelID chan, GXBool enable, GXColorSrc amb_src, GXColorSrc mat_src, GXLightID light_mask, GXDiffuseFn diff_fn, GXAttnFn attn_fn );
// ? func_8033E78C(?);
// ? func_8033E8E8(?);
// ? func_8033E9B0(?);
// ? func_8033EC24(?);
...
void func_80388220(char*, u32, char*);
void func_80388278(char*, u32, char*);
// ? func_80388320(?);
// ? func_80388328(?);
// ? HSD_AudioMalloc(?);
// ? HSD_AudioFree(?);
