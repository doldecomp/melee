...
// ? func_80146CCC(?);
// ? ftMewtwo_SpecialN_CheckShadowBallRemove(?);
// ? ftMewtwo_SpecialN_CheckShadowBallCancel(?);
// ? ftMewtwo_SpecialN_SetNULL(?);
// ? ftMewtwo_SpecialN_OnTakeDamage(?);
// ? ftMewtwo_SpecialN_OnDeath(?);
// ? ftMewtwo_SpecialN_ReleaseShadowBall(?);
// ? ftMewtwo_SpecialN_PlayChargeSFX(?);
// ? ftMewtwo_SpecialN_Shoot(?);
