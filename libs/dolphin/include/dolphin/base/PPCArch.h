...
#define L2CR_RAM_FLOW_THRU_BURST                                              \
    0x00000000 // L2 RAM type flow-through sync. burst SRAM
#define L2CR_RAM_PIPELINE_BURST                                               \
    0x01000000 // L2 RAM type pipelined sync. burst SRAM
#define L2CR_RAM_PIPELINE_LATE                                                \
    0x01800000 // L2 RAM type pipelined sync. late-write SRAM
...
#define MMCR0_ENINT                                                           \
    0x04000000 // Enables performance monitor interrupt signaling
#define MMCR0_DISCOUNT                                                        \
    0x02000000 // Disables counting of PMCn when a performance monitor
               // interrupt is signaled or...
#define MMCR0_RTCSELECT_MASK                                                  \
    0x01800000                        // 64-bit time base, bit selection enable
...
#define MMCR0_INTONBITTRANS                                                   \
    0x00400000 // Causes interrupt signaling on bit transition from off to on
#define MMCR0_THRESHOLD_MASK 0x003F0000 // Threshold value
#define MMCR0_THRESHOLD(n) ((n) << 16)  // Threshold value (0 - 63)
#define MMCR0_PMC1INTCONTROL                                                  \
    0x00008000 // Enables interrupt signaling due to PMC1 counter overflow
#define MMCR0_PMC2INTCONTROL                                                  \
    0x00004000 // Enables interrupt signaling due to PMC2-PMC4 counter overflow
#define MMCR0_PMCTRIGGER                                                      \
    0x00002000 // Can be used to trigger counting of PMC2-PMC4 after PMC1 has
               // overflowed or...
...
#define MMCR0_PMC1_ITLB_CYCLE                                                 \
    0x00000180 // # of cycles spent performing table search op. for the ITLB
#define MMCR0_PMC1_L2_HIT 0x000001C0 // # of access that hit the L2.
#define MMCR0_PMC1_EA                                                         \
    0x00000200 // # of valid instruction EAs delivered to the memory subsystem
#define MMCR0_PMC1_IABR                                                       \
    0x00000240 // # of time the address of an instruction matches the IABR
#define MMCR0_PMC1_L1_MISS 0x00000280 // # of loads that miss the L1
#define MMCR0_PMC1_Bx_UNRESOLVED                                              \
    0x000002C0 // # of branches that are unresolved when processed
...
#define MMCR0_PMC1_IC_FETCH_MISS                                              \
    0x00000340 // # of times an instruction fetch missed the L1 Icache
...
#define MMCR0_PMC2_TRANSITION                                                 \
    0x00000003 // # of time-base (lower) bit transitions
...
#define MMCR0_PMC2_IC_FETCH_MISS                                              \
    0x0000000F // # of instruction fetch misses in the L1
#define MMCR0_PMC2_Bx_OUT_OF_ORDER                                            \
    0x00000010 // # of branches allowing out-of-order execution
...
#define MMCR1_PMC3_TRANSITION                                                 \
    0x18000000 // # of time-base (lower) bit transitions
...
#define MMCR1_PMC3_PM_SWITCH                                                  \
    0x48000000 // # of transitions between marked and unmarked processes
#define MMCR1_PMC3_COND_STORE                                                 \
    0x50000000 // # of store conditional instructions completed
#define MMCR1_PMC3_FPU 0x58000000 // # of instructions completed from the FPU
#define MMCR1_PMC3_L2_SNOOP_CASTOUT                                           \
    0x60000000 // # of L2 castout caused by snoops to modified lines
#define MMCR1_PMC3_L2_HIT                                                     \
    0x68000000 // # of cache operations that hit in the L2 cache
#define MMCR1_PMC3_L1_MISS_CYCLE                                              \
    0x78000000 // # of cycles generated by L1 load misses
...
#define MMCR1_PMC4_TRANSITION                                                 \
    0x00C00000 // # of time-base (lower) bit transitions
#define MMCR1_PMC4_DISPATCHED 0x01000000 // # of instructions dispatched
#define MMCR1_PMC4_L2_CASTOUT 0x01400000 // # of L2 castouts
#define MMCR1_PMC4_DTLB_CYCLE                                                 \
    0x01800000 // # of cycles spent performing table searches for DTLB accesses
