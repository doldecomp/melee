...
/* 80345A74 00342654  3C A0 80 4A */	lis r5, Ecb@ha
/* 80345A78 00342658  90 01 00 04 */	stw r0, 4(r1)
/* 80345A7C 0034265C  2C 03 00 01 */	cmpwi r3, 1
/* 80345A80 00342660  38 A5 7C 80 */	addi r5, r5, Ecb@l
...
/* 80345B78 00342758  3C 60 80 4A */	lis r3, Ecb@ha
/* 80345B7C 0034275C  57 88 30 32 */	slwi r8, r28, 6
/* 80345B80 00342760  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 80345E74 00342A54  3C 60 80 4A */	lis r3, Ecb@ha
/* 80345E78 00342A58  57 68 30 32 */	slwi r8, r27, 6
/* 80345E7C 00342A5C  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 803461B0 00342D90  3C 60 80 4A */	lis r3, Ecb@ha
/* 803461B4 00342D94  57 60 30 32 */	slwi r0, r27, 6
/* 803461B8 00342D98  3B E3 7C 80 */	addi r31, r3, Ecb@l
...
/* 8034622C 00342E0C  3C 60 80 4A */	lis r3, Ecb@ha
/* 80346230 00342E10  2C 1C 00 02 */	cmpwi r28, 2
/* 80346234 00342E14  57 84 30 32 */	slwi r4, r28, 6
/* 80346238 00342E18  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 803463A4 00342F84  3C 60 80 4A */	lis r3, Ecb@ha
/* 803463A8 00342F88  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 80346424 00343004  3C 60 80 4A */	lis r3, Ecb@ha
/* 80346428 00343008  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 803464D4 003430B4  3C 60 80 4A */	lis r3, Ecb@ha
/* 803464D8 003430B8  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 803465E8 003431C8  3C 60 80 4A */	lis r3, Ecb@ha
/* 803465EC 003431CC  57 A4 30 32 */	slwi r4, r29, 6
/* 803465F0 003431D0  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 8034669C 0034327C  3C 60 80 4A */	lis r3, Ecb@ha
/* 803466A0 00343280  57 66 30 32 */	slwi r6, r27, 6
/* 803466A4 00343284  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 803467C8 003433A8  3C 60 80 4A */	lis r3, Ecb@ha
/* 803467CC 003433AC  93 C1 00 18 */	stw r30, 0x18(r1)
/* 803467D0 003433B0  57 E4 30 32 */	slwi r4, r31, 6
/* 803467D4 003433B4  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 8034690C 003434EC  3C 60 80 4A */	lis r3, Ecb@ha
/* 80346910 003434F0  57 E5 30 32 */	slwi r5, r31, 6
/* 80346914 003434F4  70 C6 07 F5 */	andi. r6, r6, 0x7f5
/* 80346918 003434F8  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 803469C0 003435A0  3C 60 80 4A */	lis r3, Ecb@ha
...
/* 803469D0 003435B0  38 63 7C 80 */	addi r3, r3, Ecb@l
...
/* 80346D3C 0034391C  3C 60 80 4A */	lis r3, Ecb@ha
/* 80346D40 00343920  38 83 7C 80 */	addi r4, r3, Ecb@l
...
/* 80346D94 00343974  3C 60 80 4A */	lis r3, Ecb@ha
/* 80346D98 00343978  57 66 30 32 */	slwi r6, r27, 6
/* 80346D9C 0034397C  38 03 7C 80 */	addi r0, r3, Ecb@l
...
/* 80346E94 00343A74  3C 60 80 4A */	lis r3, Ecb@ha
/* 80346E98 00343A78  57 84 30 32 */	slwi r4, r28, 6
/* 80346E9C 00343A7C  38 03 7C 80 */	addi r0, r3, Ecb@l
...
{ // clang-format off
    nofralloc
/* 80346F50 00343B30  3C 80 80 4A */	lis r4, Ecb@ha
/* 80346F54 00343B34  54 63 30 32 */	slwi r3, r3, 6
/* 80346F58 00343B38  38 04 7C 80 */	addi r0, r4, Ecb@l
...
/* 80346FA4 00343B84  3C 60 80 4A */	lis r3, Ecb@ha
/* 80346FA8 00343B88  2C 1A 00 02 */	cmpwi r26, 2
/* 80346FAC 00343B8C  57 46 30 32 */	slwi r6, r26, 6
/* 80346FB0 00343B90  38 03 7C 80 */	addi r0, r3, Ecb@l
