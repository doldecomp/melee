...
extern unk_t LCDisable();
extern unk_t __OSUnlockSram();
extern unk_t __OSLockSram();
extern unk_t __OSSyncSram();
extern unk_t __PADDisableRecalibration();
extern unk_t __OSStopAudioSystem();

#pragma push
asm void OSResetSystem(BOOL reset, u32 resetCode, BOOL forceMenu)
{ // clang-format off
    nofralloc
...
lbl_8034848C:
/* 8034848C 0034506C  83 6D BD 00 */	lwz r27, ResetFunctionQueue(r13)
...
/* 80348534 00345114  83 8D BD 00 */	lwz r28, ResetFunctionQueue(r13)
...
lbl_803485E0:
/* 803485E0 003451C0  48 00 2E 81 */	bl OSCancelThread
lbl_803485E4:
...
lbl_80348634:
/* 80348634 00345214  48 00 2E 2D */	bl OSCancelThread
lbl_80348638:
