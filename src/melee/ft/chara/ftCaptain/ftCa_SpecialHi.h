...
/* 0E4838 */ void ftCa_SpecialLwAirEnd_Coll(HSD_GObj* gobj);
/* 0E49DC */ void ftCa_SpecialLwRebound_Coll(HSD_GObj* gobj);
...
/* 0E5310 */ void ftCa_SpecialHiThrow_Anim(HSD_GObj* gobj);
/* 0E5384 */ void ftCa_SpecialHiThrow_IASA(HSD_GObj* gobj);
/* 0E5388 */ void ftCa_SpecialHiThrow_Phys(HSD_GObj* gobj);
/* 0E54B8 */ void ftCa_SpecialHiThrow_Coll(HSD_GObj* gobj);
