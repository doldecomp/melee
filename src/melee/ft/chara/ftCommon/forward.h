...
typedef enum ftCommon_MotionState {
    ftCo_MS_None = -1,
    /* 0x000 */ ftCo_MS_DeadDown,
    /* 0x001 */ ftCo_MS_DeadLeft,
    /* 0x002 */ ftCo_MS_DeadRight,
    /* 0x003 */ ftCo_MS_DeadUp,
    /* 0x004 */ ftCo_MS_DeadUpStar,
    /* 0x005 */ ftCo_MS_DeadUpStarIce,
    /* 0x006 */ ftCo_MS_DeadUpFall,
    /* 0x007 */ ftCo_MS_DeadUpFallHitCamera,
    /* 0x008 */ ftCo_MS_DeadUpFallHitCameraFlat,
    /* 0x009 */ ftCo_MS_DeadUpFallIce,
    /* 0x00A */ ftCo_MS_DeadUpFallHitCameraIce,
    /* 0x00B */ ftCo_MS_Sleep,
    /* 0x00C */ ftCo_MS_Rebirth,
    /* 0x00D */ ftCo_MS_RebirthWait,
    /* 0x00E */ ftCo_MS_Wait,
    /* 0x00F */ ftCo_MS_WalkSlow,
    /* 0x010 */ ftCo_MS_WalkMiddle,
    /* 0x011 */ ftCo_MS_WalkFast,
    ftCo_MS_Turn,
    ftCo_MS_TurnRun,
    ftCo_MS_Dash,
    ftCo_MS_Run,
    ...
    /* 0x0E0 */ ftCo_MS_CaptureWaitHi,
    /* 0x0E1 */ ftCo_MS_CaptureDamageHi,
    /* 0x0E2 */ ftCo_MS_CapturePulledLw,
    /* 0x0E3 */ ftCo_MS_CaptureWaitLw,
    /* 0x0E4 */ ftCo_MS_CaptureDamageLw,
    /* 0x0E5 */ ftCo_MS_CaptureCut,
    ftCo_MS_CaptureJump,
    ftCo_MS_CaptureNeck,
    ftCo_MS_CaptureFoot,
    ftCo_MS_EscapeF,
    ...
    /* 0x142 */ ftCo_MS_Entry,
    /* 0x143 */ ftCo_MS_EntryStart,
    /* 0x144 */ ftCo_MS_EntryEnd,
    ftCo_MS_DamageIce,
    ...
    ftCo_MS_DownReflect,
    /* 0x150 */ ftCo_MS_CaptureCrazyHand,
