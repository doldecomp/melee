...
/* 09DB88 */ UNK_RET ftCo_800A0C8C(UNK_T);
...
/* 09F06C */ UNK_RET ftCo_800A2170(UNK_PARAMS);
...
/* 0A1AB4 */ UNK_RET ftCo_800A1AB4(UNK_PARAMS);
/* 0A1BA8 */ UNK_RET ftCo_800A1BA8(UNK_PARAMS);
...
/* 0A2804 */ UNK_RET ftCo_800A5908(UNK_PARAMS);
/* 0A287C */ UNK_RET ftCo_800A5980(UNK_PARAMS);
/* 0A28BC */ bool ftCo_800A59C0(UNK_T);
/* 0A28E0 */ bool ftCo_800A59E4(ftCo_Fighter* fp);
/* 0A2924 */ UNK_RET ftCo_800A5A28(UNK_PARAMS);
/* 0A41F4 */ UNK_RET ftCo_800B395C(UNK_PARAMS);
/* 0A5A5C */ UNK_RET ftCo_800A5A5C(UNK_PARAMS);
