...
{
    ft_80082C74(fighter_gobj, &ftDonkey_800E05E4);
}

bool ftDonkey_800E0378(HSD_GObj* fighter_gobj)
{
    bool result = ft_800CAE80(fighter_gobj);
...
void ftDonkey_800E03C0(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, donkey_attr->action_state + 7, 0,
                              NULL, 0.0f, 1.0, 0.0f);
    ftAnim_SetAnimRate(fighter_gobj, 0.0f);
    ft_800CB110(fighter_gobj, 1, 1.0f);
}
