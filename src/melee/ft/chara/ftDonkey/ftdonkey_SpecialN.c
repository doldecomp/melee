...
void ftDonkey_SpecialN_StartMotion(HSD_GObj* fighter_gobj)
{
    ...
    if (fp->ev.dk.x222C == donkey_attr->SpecialN.x2C_MAX_ARM_SWINGS) {
        Fighter_ChangeMotionState(fighter_gobj, 0x175, 0, NULL, 0.0f, 1.0f,
                                  0.0f);
        fp->sv.dk.specialn.x8 = 1;
        fp->sv.dk.specialn.xC = fp->ev.dk.x222C;
        fp->ev.dk.x222C = 0;
    } else {
        Fighter_ChangeMotionState(fighter_gobj, 0x171, 0, NULL, 0.0f, 1.0f,
                                  0.0f);
...
void ftDonkey_SpecialAirN_StartMotion(HSD_GObj* fighter_gobj)
{
    ...
    if (fp->ev.dk.x222C == donkey_attr->SpecialN.x2C_MAX_ARM_SWINGS) {
        Fighter_ChangeMotionState(fighter_gobj, 0x17A, 0, NULL, 0.0f, 1.0f,
                                  0.0f);
        fp->sv.dk.specialn.x8 = 1;
        fp->sv.dk.specialn.xC = fp->ev.dk.x222C;
        fp->ev.dk.x222C = 0;
    } else {
        Fighter_ChangeMotionState(fighter_gobj, 0x176, 0, NULL, 0.0f, 1.0f,
                                  0.0f);
        fp->sv.dk.specialn.x8 = 0;
        fp->sv.dk.specialn.xC = 0;
    }
...
void ftDonkey_8010E7B4(HSD_GObj* fighter_gobj)
{
    if (!ftAnim_IsFramesRemaining(fighter_gobj)) {
        Fighter_ChangeMotionState(fighter_gobj, 0x172, 0, NULL, 0.0f, 1.0f,
                                  0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010E930(HSD_GObj* fighter_gobj)
{
    ...
    if (fp->sv.dk.specialn.x8 == 1) {
        ...
        if (fp->xE0_ground_or_air == GA_Air) {
            efSync_Spawn(0x4C9, fighter_gobj, fp->x5E8_fighterBones[0].x0_jobj,
                         &fp->facing_dir);
        } else {
            efSync_Spawn(0x4C8, fighter_gobj, fp->x5E8_fighterBones[0].x0_jobj,
                         &fp->facing_dir);
        }
    }
...
{
    if (!ftAnim_IsFramesRemaining(fighter_gobj)) {
        Fighter_ChangeMotionState(fighter_gobj, 0x177, 0, NULL, 0.0f, 1.0f,
                                  0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010EDD8(HSD_GObj* fighter_gobj)
{
    ...
    if (!ftAnim_IsFramesRemaining(fighter_gobj)) {
        ...
        if (donkey_attr->SpecialN.x38_LANDING_LAG == 0.0f) {
            ...
            ft_80096900(fighter_gobj, 1, 0, 1, 1.0f,
...
void ftDonkey_8010F098(HSD_GObj* fighter_gobj)
{
    ...
    if (!ft_8009917C(fighter_gobj)) {
        if ((fp->input.x668 & 0x200)) {
            Fighter_ChangeMotionState(fighter_gobj, 0x174, 0, NULL, 0.0f, 1.0f,
                                      0.0f);
            fp->sv.dk.specialn.xC = fp->ev.dk.x222C;
            fp->ev.dk.x222C = 0;
            ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
        ...
        if ((fp->x894_currentAnimFrame == 0.0f) && (fp->sv.dk.specialn.x0)) {
            Fighter_ChangeMotionState(fighter_gobj, 0x173, 0, NULL, 0.0f, 1.0f,
                                      0.0f);
            ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
        }
    }
...
void ftDonkey_8010F1E8(HSD_GObj* fighter_gobj)
{
    ...
    if ((fp->input.x668 & 0x200)) {
        Fighter_ChangeMotionState(fighter_gobj, 0x179, 0, NULL, 0.0f, 1.0f,
                                  0.0f);
        fp->sv.dk.specialn.xC = fp->ev.dk.x222C;
        fp->ev.dk.x222C = 0;
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    ...
    if ((fp->x894_currentAnimFrame == 0.0f) && (fp->sv.dk.specialn.x0)) {
        Fighter_ChangeMotionState(fighter_gobj, 0x178, 0, NULL, 0.0f, 1.0f,
                                  0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010F468(HSD_GObj* fighter_gobj)
{
    ...
    if (!ft_80082708(fighter_gobj)) {
        ...
        Fighter_ChangeMotionState(fighter_gobj, 0x176, 0x0C4C5080, NULL,
...
void ftDonkey_8010F50C(HSD_GObj* fighter_gobj)
{
    ...
    if (!ft_80082708(fighter_gobj)) {
        ftCommon_8007D5D4(fp);
        Fighter_ChangeMotionState(fighter_gobj, 0x177, 0x0C4C5080, NULL,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010F5B0(HSD_GObj* fighter_gobj)
{
    ...
    if (!ft_80082708(fighter_gobj)) {
        ftCommon_8007D5D4(fp);
        Fighter_ChangeMotionState(fighter_gobj, 0x178, 0x0C4C5080, NULL,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010F654(HSD_GObj* fighter_gobj)
{
    ...
    if (ft_800827A0(fighter_gobj) == 0) {
        ftCommon_8007D5D4(fp);
        Fighter_ChangeMotionState(fighter_gobj, 0x179, 0x0C4D508E, NULL,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010F6F8(HSD_GObj* fighter_gobj)
{
    ...
    if (ft_800827A0(fighter_gobj) == 0) {
        ftCommon_8007D5D4(fp);
        Fighter_ChangeMotionState(fighter_gobj, 0x17A, 0x0C4D508E, NULL,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010F79C(HSD_GObj* fighter_gobj)
{
    ...
    if (ft_80081D0C(fighter_gobj) == 1) {
        ftCommon_8007D7FC(fp);
        Fighter_ChangeMotionState(fighter_gobj, 0x171, 0x0C4C5080, NULL,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010F840(HSD_GObj* fighter_gobj)
{
    ...
    if (ft_80081D0C(fighter_gobj) == 1) {
        ftCommon_8007D7FC(fp);
        Fighter_ChangeMotionState(fighter_gobj, 0x172, 0x0C4C5080, NULL,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010F8E4(HSD_GObj* fighter_gobj)
{
    ...
    if (ft_80081D0C(fighter_gobj) == 1) {
        ftCommon_8007D7FC(fp);
        Fighter_ChangeMotionState(fighter_gobj, 0x173, 0x0C4C5080, NULL,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010F988(HSD_GObj* fighter_gobj)
{
    ...
    if (ft_80081D0C(fighter_gobj)) {
        ftCommon_8007D7FC(fp);
        Fighter_ChangeMotionState(fighter_gobj, 0x174, 0x0C4D508E, NULL,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
...
void ftDonkey_8010FA2C(HSD_GObj* fighter_gobj)
{
    ...
    if (ft_80081D0C(fighter_gobj)) {
        ftCommon_8007D7FC(fp);
        Fighter_ChangeMotionState(fighter_gobj, 0x175, 0x0C4D508E, NULL,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
        ftDonkey_SetCallbacks_SpecialN(fighter_gobj);
    }
}
