...
MotionState ftFalco_MotionStateTable[] = {
    ...
    { 304, 0x00340612, 0x13000000, ftFox_SpecialAirSStart_Anim,
      ...
      ftFox_SpecialAirSStart_Coll, Fighter_UpdateCameraBox },
