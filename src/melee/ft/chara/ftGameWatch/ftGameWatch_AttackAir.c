...
static void ftGw_AttackAir_ExitItemHitlag(HSD_GObj*);
...
void ftGw_ItemParachuteSetup(HSD_GObj* gobj)
{
    ...
    if (fp->fv.gw.x2258_parachuteGObj != NULL) {
        ...
        if (fp->fv.gw.x2258_parachuteGObj != NULL) {
            ...
            fp->cb.x21D4_callback_EnterHitlag = ftGw_AttackAir_EnterItemHitlag;
            fp->cb.x21D8_callback_ExitHitlag = ftGw_AttackAir_ExitItemHitlag;
        }
    }
...
void ftGw_ItemParachuteOnLand(HSD_GObj* gobj)
{
    ...
    if (fp->fv.gw.x2258_parachuteGObj != NULL) {
        ftGw_AttackAir_ExitItemHitlag(gobj);
...
void ftGw_ItemParachuteRemove(HSD_GObj* gobj)
{
    ...
    if (fp->fv.gw.x2258_parachuteGObj != NULL) {
        ...
        ftGw_ItemParachuteSetFlag(gobj);
    }
}
...
static void ftGw_ItemTurtleOnLand(HSD_GObj*);
...
static void ftGw_ItemTurtleOnLand(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);
...
static void ftGw_AttackAir_ExitItemHitlag(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);
...
static void ftGw_AttackAirB_Action(HSD_GObj*);
static void ftGw_AttackAirHi_Action(HSD_GObj*);
...
void ftGw_AttackAirN_Action(HSD_GObj* gobj)
{
    ...
    fp->cb.x21BC_callback_Accessory4 = ftGw_ItemParachuteSetup;
}
...
{
    ft_80082C74(gobj, ftGw_LandingAirN_Action);
}
...
void ftGw_LandingAirN_Action(HSD_GObj* gobj)
{
    ...
    if ((u32) fp->x2200_ftcmd_var0 != 0U) {
        ...
        fp->cb.x21BC_callback_Accessory4 = ftGw_ItemParachuteOnLand;
        return;
    }
...
// State handler
static void ftGw_AttackAirB_Action(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);

    ft_8008CFAC(gobj, ftGw_MS_AttackAirB);
    fp->cb.x21BC_callback_Accessory4 = ftGw_ItemTurtleSetup;
}
...
{
    ft_80082C74(gobj, ftGw_LandingAirB_Action);
}
...
void ftGw_LandingAirB_Action(HSD_GObj* gobj)
{
    ...
    if ((u32) fp->x2200_ftcmd_var0 != 0) {
        ...
        fp->cb.x21BC_callback_Accessory4 = ftGw_ItemTurtleOnLand;
        return;
    }
...
static void ftGw_AttackAirHi_Action(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);

    ft_8008CFAC(gobj, ftGw_MS_AttackAirHi);
    fp->cb.x21BC_callback_Accessory4 = ftGw_ItemSparkySetup;
}
...
{
    ft_80082C74(gobj, ftGw_LandingAirHi_Action);
}
...
void ftGw_LandingAirHi_Action(HSD_GObj* gobj)
{
    ...
    if (fp->x2200_ftcmd_var0 != 0) {
        ...
        fp->cb.x21BC_callback_Accessory4 = ftGw_ItemSparkyOnLand;
        return;
    }
