...
void ftGw_ItemTorchSetup(HSD_GObj* gobj)
{
    ...
    fp->cb.x21D4_callback_EnterHitlag = ftGw_ItemTorchEnterHitlag;
    fp->cb.x21D8_callback_ExitHitlag = ftGw_ItemTorchExitHitlag;
