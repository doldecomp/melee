...
/* 14B7A8 */ void ftGw_LandingAirN_Enter(HSD_GObj* gobj, float lag);
...
/* 14B904 */ void ftGw_LandingAirB_Enter(HSD_GObj* gobj, float lag);
...
/* 14BA60 */ void ftGw_LandingAirHi_Enter(HSD_GObj* gobj, float lag);
