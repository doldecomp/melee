...
#define FTGAMEWATCH_SPECIALS_COLL_FLAG FIGHTER_HITSTATUS_COLANIM_PRESERVE | FIGHTER_UNK_HAMMER | FIGHTER_NOCHANGEMODEL | FIGHTER_MATANIM_NOUPDATE | FIGHTER_UNK_0x1000 | FIGHTER_CMD_UPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_UNK_0x400000 | FIGHTER_UNK_0x4000000 | FIGHTER_UNK_0x2227

// Oil Panic (SpecialLw/SpecialAirLw) //
#define FTGAMEWATCH_SPECIALLW_COLL_FLAG FIGHTER_GFX_PRESERVE | FIGHTER_HITSTATUS_COLANIM_PRESERVE | FIGHTER_UNK_HAMMER | FIGHTER_MATANIM_NOUPDATE | FIGHTER_UNK_0x1000 | FIGHTER_CMD_UPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_UNK_0x400000 | FIGHTER_UNK_0x4000000 | FIGHTER_UNK_0x2227

#define FTGAMEWATCH_SPECIALLW_UPDATE_FLAG FIGHTER_GFX_PRESERVE | FIGHTER_UNK_HAMMER | FIGHTER_MATANIM_NOUPDATE | FIGHTER_UNK_0x1000 | FIGHTER_CMD_UPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_UNK_0x400000 | FIGHTER_UNK_0x4000000 | FIGHTER_UNK_0x2227
...
void ftGameWatch_SpecialS_Action(HSD_GObj* fighter_gobj);
void ftGameWatch_SpecialAirS_Action(HSD_GObj* fighter_gobj);
