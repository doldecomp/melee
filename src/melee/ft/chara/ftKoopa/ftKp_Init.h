...
/* 132B3C */ void ftKp_Init_OnItemPickup(HSD_GObj* gobj, bool bool);
...
/* 133654 */ void ftKp_SpecialS_Anim(HSD_GObj* gobj);
/* 133690 */ void ftKp_SpecialAirS_Anim(HSD_GObj* gobj);
/* 1336CC */ void ftKp_SpecialSCatch_Anim(HSD_GObj* gobj);
/* 13383C */ void ftKp_SpecialAirSCatch_Anim(HSD_GObj* gobj);
/* 1339AC */ void ftKp_SpecialSWait_Anim(HSD_GObj* gobj);
/* 1339B0 */ void ftKp_SpecialAirSWait_Anim(HSD_GObj* gobj);
/* 1339B4 */ void ftKp_SpecialSThrowF_Anim(HSD_GObj* gobj);
/* 133A90 */ void ftKp_SpecialSThrowB_Anim(HSD_GObj* gobj);
/* 133AD4 */ void ftKp_SpecialAirSThrowF_Anim(HSD_GObj* gobj);
/* 133BB0 */ void ftKp_SpecialAirSThrowB_Anim(HSD_GObj* gobj);
/* 133BF4 */ void ftKp_SpecialSCatch_IASA(HSD_GObj* gobj);
/* 133D20 */ void ftKp_SpecialAirSCatch_IASA(HSD_GObj* gobj);
/* 133E4C */ void ftKp_SpecialSWait_IASA(HSD_GObj* gobj);
/* 134038 */ void ftKp_SpecialAirSWait_IASA(HSD_GObj* gobj);
/* 134224 */ void ftKp_SpecialS_Phys(HSD_GObj* gobj);
/* 134244 */ void ftKp_SpecialAirS_Phys(HSD_GObj* gobj);
/* 134288 */ void ftKp_SpecialSCatch_Phys(HSD_GObj* gobj);
/* 1342A8 */ void ftKp_SpecialAirSCatch_Phys(HSD_GObj* gobj);
/* 1342C8 */ void ftKp_SpecialSWait_Phys(HSD_GObj* gobj);
/* 1342E8 */ void ftKp_SpecialAirSWait_Phys(HSD_GObj* gobj);
/* 134308 */ void ftKp_SpecialSThrowF_Phys(HSD_GObj* gobj);
/* 134328 */ void ftKp_SpecialSThrowB_Phys(HSD_GObj* gobj);
/* 134348 */ void ftKp_SpecialAirSThrowF_Phys(HSD_GObj* gobj);
/* 134368 */ void ftKp_SpecialAirSThrowB_Phys(HSD_GObj* gobj);
/* 134388 */ void ftKp_SpecialS_Coll(HSD_GObj* gobj);
/* 1343B0 */ void ftKp_SpecialAirS_Coll(HSD_GObj* gobj);
/* 1343D8 */ void ftKp_SpecialSCatch_Coll(HSD_GObj* gobj);
/* 134400 */ void ftKp_SpecialAirSCatch_Coll(HSD_GObj* gobj);
/* 134428 */ void ftKp_SpecialSWait_Coll(HSD_GObj* gobj);
/* 134450 */ void ftKp_SpecialAirSWait_Coll(HSD_GObj* gobj);
/* 134478 */ void ftKp_SpecialSThrowF_Coll(HSD_GObj* gobj);
/* 1344A0 */ void ftKp_SpecialSThrowB_Coll(HSD_GObj* gobj);
/* 1344C8 */ void ftKp_SpecialAirSThrowF_Coll(HSD_GObj* gobj);
/* 1344F0 */ void ftKp_SpecialAirSThrowB_Coll(HSD_GObj* gobj);
/* 13460C */ void ftKp_SpecialLw_Enter(HSD_GObj* gobj);
/* 1346A4 */ void ftKp_SpecialAirLw_Enter(HSD_GObj* gobj);
/* 13474C */ void ftKp_SpecialLwStart_Anim(HSD_GObj* gobj);
/* 134788 */ void ftKp_SpecialAirLw_Anim(HSD_GObj* gobj);
/* 1347C4 */ void ftKp_SpecialLwStart_Phys(HSD_GObj* gobj);
/* 134804 */ void ftKp_SpecialAirLw_Phys(HSD_GObj* gobj);
/* 1348A0 */ void ftKp_SpecialLwStart_Coll(HSD_GObj* gobj);
