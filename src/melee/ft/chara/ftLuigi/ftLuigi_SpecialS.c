...
void ftLuigi_SpecialS_SetVars(HSD_GObj* fighter_gobj)
{
    ...
    {
        fp->x2340_stateVar1 = (s32)luigiAttrs->x8_LUIGI_GREENMISSILE_CHARGE_RATE;
        fp->x2072_b4 = 1;
    }
    else fp->x2340_stateVar1 = 0;
...
void ftLuigi_SpecialSHold_Anim(HSD_GObj* fighter_gobj)
{
    ...
    if ((f32)fp->x2340_stateVar1 > luigiAttrs->xC_LUIGI_GREENMISSILE_MAX_CHARGE_FRAMES)
    {
...
void ftLuigi_SpecialSLaunch_Anim(HSD_GObj* fighter_gobj)
{
    ...
    if (((s32)fp->x2344_stateVar2 == 0) && ((s32)fp->x914[0].x0 == 1))
    {
        func_8007ABD0(&fp->x914[0], (u32)(((f32)fp->x2340_stateVar1 * luigiAttrs->x14_LUIGI_GREENMISSILE_DAMAGE_SLOPE) + luigiAttrs->x10_LUIGI_GREENMISSILE_DAMAGE_TILT), fighter_gobj);
    }
    if ((u32)fp->x2200_ftcmd_var0 != 0U)
    {
        func_8007D5D4(fp);
...
void ftLuigi_SpecialSFly_Action(HSD_GObj* fighter_gobj)
{
    ...
    {
        fp->x80_self_vel.x = (f32)((luigiAttrs->x28_LUIGI_GREENMISSILE_MUL_X * (f32)fp->x2340_stateVar1) + luigiAttrs->x24_LUIGI_GREENMISSILE_VEL_X);
    }
    ...
    else
    {
        ...
        fp->x80_self_vel.y = (f32)((0.5f * temp_vel) + (temp_vel * ((0.5f * (f32)fp->x2340_stateVar1) / luigiAttrs->xC_LUIGI_GREENMISSILE_MAX_CHARGE_FRAMES)));
    }
