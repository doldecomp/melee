...
MotionState ftLg_Init_MotionStateTable[] = {
    { 295, 0x00340111, 0x12000000, ftLg_SpecialN_Anim,
      ftLg_SpecialN_IASA, ftLg_SpecialN_Phys, ftLg_SpecialN_Coll,
      ftCamera_UpdateCameraBox },
    { 296, 0x00340511, 0x12000000, ftLg_SpecialAirN_Anim,
      ftLg_SpecialAirN_IASA, ftLg_SpecialAirN_Phys,
      ftLg_SpecialAirN_Coll, ftCamera_UpdateCameraBox },
    ...
    { 298, 0x00340212, 0x13000000, ftLg_SpecialSHold_Anim,
      ftLg_SpecialSHold_IASA, ftLg_SpecialSHold_Phys,
      ftLg_SpecialSHold_Coll, ftCamera_UpdateCameraBox },
    { 301, 0x00340212, 0x13000000, ftLg_SpecialSFly_Anim,
      ftLg_SpecialSFly_IASA, ftLg_SpecialSFly_Phys,
      ftLg_SpecialSFly_Coll, ftCamera_UpdateCameraBox },
    { 302, 0x00340212, 0x13000000, ftLg_SpecialSEnd_Anim,
      ftLg_SpecialSEnd_IASA, ftLg_SpecialSEnd_Phys,
      ftLg_SpecialSEnd_Coll, ftCamera_UpdateCameraBox },
    ...
    { 308, 0x00340213, 0x14000000, ftLg_SpecialHi_Anim,
      ftLg_SpecialHi_IASA, ftLg_SpecialHi_Phys, ftLg_SpecialHi_Coll,
      ftCamera_UpdateCameraBox },
    { 309, 0x00340613, 0x14000000, ftLg_SpecialAirHi_Anim,
      ftLg_SpecialAirHi_IASA, ftLg_SpecialAirHi_Phys,
      ftLg_SpecialAirHi_Coll, ftCamera_UpdateCameraBox },
    { 310, 0x00340214, 0x15000000, ftLg_SpecialLw_Anim,
      ftLg_SpecialLw_IASA, ftLg_SpecialLw_Phys, ftLg_SpecialLw_Coll,
      ftCamera_UpdateCameraBox },
    { 311, 0x00340614, 0x15000000, ftLg_SpecialAirLw_Anim,
      ftLg_SpecialAirLw_IASA, ftLg_SpecialAirLw_Phys,
      ftLg_SpecialAirLw_Coll, ftCamera_UpdateCameraBox },
};
