...
#define FTLUIGI_SPECIALS_COLL_FLAG FIGHTER_HITSTATUS_COLANIM_PRESERVE | FIGHTER_MATANIM_NOUPDATE | FIGHTER_SFX_PRESERVE | FIGHTER_CMD_UPDATE | FIGHTER_COLANIM_NOUPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_MODELPART_VIS_NOUPDATE | FIGHTER_MODELFLAG_NOUPDATE | FIGHTER_UNK_0x2227

#define FTLUIGI_SPECIALS_GROUND_AIR_FLAG FIGHTER_GFX_PRESERVE | FIGHTER_HITSTATUS_COLANIM_PRESERVE | FIGHTER_MATANIM_NOUPDATE | FIGHTER_CMD_UPDATE | FIGHTER_COLANIM_NOUPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_MODELPART_VIS_NOUPDATE | FIGHTER_MODELFLAG_NOUPDATE | FIGHTER_UNK_0x2227

// Misfire

#define FTLUIGI_SPECIALS_MISFIRE_FLAG FIGHTER_GFX_PRESERVE | FIGHTER_HIT_NOUPDATE | FIGHTER_MATANIM_NOUPDATE | FIGHTER_CMD_UPDATE | FIGHTER_COLANIM_NOUPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_MODELPART_VIS_NOUPDATE | FIGHTER_MODELFLAG_NOUPDATE | FIGHTER_UNK_0x2227

// SpecialLw (Luigi Cyclone)

#define FTLUIGI_SPECIALLW_FLAG FIGHTER_GFX_PRESERVE | FIGHTER_HIT_NOUPDATE | FIGHTER_MATANIM_NOUPDATE | FIGHTER_CMD_UPDATE | FIGHTER_COLANIM_NOUPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_MODELPART_VIS_NOUPDATE | FIGHTER_MODELFLAG_NOUPDATE | FIGHTER_UNK_0x2227
...
typedef struct _ftLuigiAttributes {
    ...
    f32 x50_LUIGI_SUPERJUMP_FREEFALL_MAX; // Multiplies Luigi's max horionztal aerial mobility
    ...
    f32 x60_LUIGI_SUPERJUMP_AIR_MOBILITY;
    f32 x64_LUIGI_SUPERJUMP_VEL_X; 
    f32 x68_LUIGI_SUPERJUMP_GRAVITY_START;
    f32 x6C_LUIGI_SUPERJUMP_VEL_MUL;
