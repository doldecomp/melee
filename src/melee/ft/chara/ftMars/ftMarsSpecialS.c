...
void func_801374A0(HSD_GObj* gobj) {
    ...
    ft->phys.x80_self_vel.x = ft->phys.x80_self_vel.x / attr->x14;
    if ((s32)ft->x222C == 0) {
        ft->x222C = 1;
        ft->phys.x80_self_vel.y = attr->x1C;
    } else {
    ...
    if (ft2->phys.xE0_airborne == GA_Ground) {
        thing = 0x15D;
    } else {
        thing = 0x166;
    }
...
void lbl_801375B8(HSD_GObj* gobj) {
    ...
    if (ft->x2200_ftcmd_var0 != 0) {
        if (ft->x2200_ftcmd_var1 == 0 && (ft->x668 & 0x300) != 0) {
            func_80137A9C(gobj);
        }
    } else {
        if ((ft->x668 & 0x300) != 0) {
...
void func_801376E8(HSD_GObj* gobj) {
    ...
    func_8007D5D4(ft);
    // ActionStateChange
    func_800693AC(gobj, 0x166, 0x0C4E508C, 0, ft->x894, 1.0f, 0.0f);
}
...
void func_80137748(HSD_GObj* gobj) {
    ...
    func_8007D7FC(ft);
    // ActionStateChange
    func_800693AC(gobj, 0x15D, 0x0C4E508C, 0, ft->x894, 1.0f, 0.0f);
}
...
void func_80137940(HSD_GObj* gobj) {
    ...
    func_800693AC(gobj, thing, 0x0C4E508C, 0, ft->x894, 1.0f, 0.0f);
}
...
void func_80137A9C(HSD_GObj* gobj) {
    ...
    func_800693AC(gobj, thing, 0x02000000, 0, 0.0f, 1.0f, 0.0f);
}
