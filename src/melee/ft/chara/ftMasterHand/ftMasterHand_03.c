...
void func_80150C8C(HSD_GObj* gobj)
{
        ...
        (r31_fp->sa.masterhand.x2258 == 0x185))
    {
        Fighter_ActionStateChange_800693AC(
            gobj, 0x185, 0, 0, r31_fp->x894_currentAnimFrame, 1.0f, 0.0f);
    } else {
...
void func_80150D28(HSD_GObj* gobj)
{
    ...
    {
        Fighter_ActionStateChange_800693AC(
            gobj, 0x186, 0, 0, r31_fp->x894_currentAnimFrame, 1.0f, 0.0f);
    } else {
...
void func_80150DC4(HSD_GObj* gobj, void* arg1_stateVar2, Vec3* arg2_pos)
{
    ...
    if (r32_fp->sa.masterhand.x2258 == 0x156) {
        ...
        {
            Fighter_ActionStateChange_800693AC(
                gobj, 0x186, 0, 0, r32_fp->x894_currentAnimFrame, 1.0f, 0.0f);
        } else {
            temp_f1 = 0.0f;
            Fighter_ActionStateChange_800693AC(gobj, 0x186, 0, 0, temp_f1, 1.0f,
                                               temp_f1);
            func_8006EBA4(gobj);
        }
        r32_fp->sa.masterhand.x2258 = 0x186;
        ...
        {
            Fighter_ActionStateChange_800693AC(
                gobj, 0x185, 0, 0, r32_fp->x894_currentAnimFrame, 1.0f, 0.0f);
        } else {
            Fighter_ActionStateChange_800693AC(gobj, 0x185, 0, 0, 0.0f, 1.0f,
                                               0.0f);
            func_8006EBA4(gobj);
        }
        r32_fp->sa.masterhand.x2258 = 0x185;
    }
    r32_fp->masterhandVars[0].x2344_callback = arg1_stateVar2;
    r32_fp->masterhandVars[0].x234C_pos = *arg2_pos;
}
...
void lbl_80150F68(HSD_GObj* gobj)
{
    ...
    func_80085134(gobj);
    func_8015BE40(gobj, &r31_fp->masterhandVars[0].x234C_pos, &r31_fp->masterhandVars[0].x2358,
...
void lbl_80150FC8(HSD_GObj* gobj)
{
    ...
    if (0.0f == r4_fp->masterhandVars[0].x2358) {
...
void func_80151018(HSD_GObj* gobj)
{
    ...
    r6_fp->masterhandVars[0].x2360 = 0;
    ...
    r31_fp->masterhandVars[0].x2344_callback = lbl_8014FFDC;
    r31_fp->masterhandVars[0].x234C_pos = sp1C_pos;
}
