...
void ftMh_Unk03_80150C8C(HSD_GObj* gobj)
{
...
void ftMh_Unk03_80150D28(HSD_GObj* gobj)
{
    Fighter* r31_fp = gobj->user_data;
...
void ftMh_Unk03_80150DC4(HSD_GObj* gobj, void* arg1_stateVar2, Vec3* arg2_pos)
{
...
void ftMh_Unk03_80150F00(HSD_GObj* gobj)
{
    /// @todo Unused stack.
#ifdef MUST_MATCH
    u8 _[4];
...
void ftMh_Unk03_80150F68(HSD_GObj* gobj)
{
    Fighter* r31_fp;
...
void ftMh_Unk03_80150FC8(HSD_GObj* gobj)
{
    Fighter* r4_fp;
...
void ftMh_Unk03_80151018(HSD_GObj* gobj)
{
    Vec3 sp1C_pos;
    ...
    if (r31_fp->fv.mh.x2258 == 0x156) {
        ftMh_Unk03_80150D28(gobj);
    } else {
        ftMh_Unk03_80150C8C(gobj);
    }
    r31_fp->mv.mh.unk0.x4 = ftMh_Unk02_8014FFDC;
