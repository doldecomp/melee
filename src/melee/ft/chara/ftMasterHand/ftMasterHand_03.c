...
void func_80150C8C(HSD_GObj* gobj)
{
    ...
    if ((r31_fp->ev.masterhand.x2258 == 0x155) ||
        (r31_fp->ev.masterhand.x2258 == 0x185))
    {
...
{
    Fighter* r31_fp = gobj->user_data;
    if ((r31_fp->ev.masterhand.x2258 == 0x156) ||
        (r31_fp->ev.masterhand.x2258 == 0x186))
    {
...
void func_80150DC4(HSD_GObj* gobj, void* arg1_stateVar2, Vec3* arg2_pos)
{
    ...
    if (r32_fp->ev.masterhand.x2258 == 0x156) {
        if ((r32_fp->ev.masterhand.x2258 == 0x156) ||
            (r32_fp->ev.masterhand.x2258 == 0x186))
        {
        ...
        if ((r32_fp->ev.masterhand.x2258 == 0x155) ||
            (r32_fp->ev.masterhand.x2258 == 0x185))
        {
            Fighter_ActionStateChange_800693AC(
...
void func_80151018(HSD_GObj* gobj)
{
    ...
    sp1C_pos.z = 0;
    r6_fp->ev.masterhand.x2258 = 0x186;
