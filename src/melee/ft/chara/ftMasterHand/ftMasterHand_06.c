...
void func_80151918(HSD_GObj* gobj)
{
    ...
    r8_fp->masterhandVars[0].x234C_pos.x = (r8_fp->xB0_pos.x - r7_attributes->x3C);
    r8_fp->masterhandVars[0].x234C_pos.y = r7_attributes->x38;
    r8_fp->masterhandVars[0].x234C_pos.z = 0.0f;
...
void lbl_8015198C(HSD_GObj* gobj)
{
    ...
    if (!ftAnim_IsFramesRemaining(gobj)) {
        ...
        temp_r8->masterhandVars[0].x234C_pos.x = temp_r8->xB0_pos.x - temp_r7->x3C;
        temp_r8->masterhandVars[0].x234C_pos.y = temp_r7->x38;
        temp_r8->masterhandVars[0].x234C_pos.z = 0.0f;
        Fighter_ActionStateChange_800693AC(gobj, 0x15B, 0, 0, 0.0f, 1.0f, 0.0f);
        func_8006EBA4(gobj);
    }
}
...
void lbl_80151A88(HSD_GObj* gobj)
{
    ...
    func_8015BE40(gobj, &r5_fp->masterhandVars[0].x234C_pos, &r5_fp->masterhandVars[0].x2358,
