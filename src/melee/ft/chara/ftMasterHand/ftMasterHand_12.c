...
void lbl_801526D8(HSD_GObj* arg0)
{
    ...
    func_8006EBA4(arg0);
    temp_r31->masterhandVars[0].x2340_unk = 0.0f;
}
...
void lbl_801527B8(HSD_GObj* gobj)
{
    ...
    tmp = ++r31_fp->masterhandVars[0].x2340_unk;
    if (tmp > r30_attributes->xB0 && r31_fp->masterhandVars[0].x2340_unk < r30_attributes->xB4) {
