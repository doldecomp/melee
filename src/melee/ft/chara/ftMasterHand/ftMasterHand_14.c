...
void ftMh_Unk14_80152BCC(HSD_GObj* arg0)
{
    Fighter* temp_r31;
...
void ftMh_Unk14_80152CD8(HSD_GObj* arg0)
{
    Fighter* fp = arg0->user_data;
    Fighter_ChangeMotionState(arg0, 0x16A, 0, 0, 0.0f, 1.0f, 0.0f);
    ftAnim_8006EBA4(arg0);
    fp->cb.x21BC_callback_Accessory4 = &ftMh_Unk14_80152E28;
