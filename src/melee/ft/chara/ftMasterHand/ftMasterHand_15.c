...
void ftMh_Unk15_80153000(HSD_GObj* arg0)
{
...
// 8015303C 14FC1C
void ftMh_Unk15_8015303C(HSD_GObj* arg0)
{
...
// 80153080 14FC60
void ftMh_Unk15_80153080(HSD_GObj* gobj)
{
    ft_80085134(gobj);
}
...
void ftMh_Unk15_801530A0(HSD_GObj* arg0)
{
    return;
}
...
void ftMh_Unk15_801530A4(HSD_GObj* gobj)
{
...
void ftMh_Unk15_80153160(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);
...
void ftMh_Unk15_80153210(HSD_GObj* arg0)
{
    Fighter* fp = arg0->user_data;
    if (Player_GetPlayerSlotType(fp->xC_playerID) == 0) {
        ftBossLib_8015BD20(arg0);
...
void ftMh_Unk15_80153254(HSD_GObj* gobj)
{
...
// 801533C8 14FFA8
void ftMh_Unk15_801533C8(HSD_GObj* gobj)
{
    return;
}
...
void ftMh_Unk15_801533CC(HSD_GObj* arg0)
{
    Fighter* fp;
    ftMasterHand_SpecialAttrs* attr;
    ...
    fp->cb.x21BC_callback_Accessory4 = &ftMh_Unk15_801535B0;
}
...
static inline void lbl_8015346C_inline(HSD_GObj* gobj)
{
    ...
    ft30->cb.x21BC_callback_Accessory4 = ftMh_Unk15_801535B0;
}

void ftMh_Unk15_8015346C(HSD_GObj* gobj)
{
    if (!ftAnim_IsFramesRemaining(gobj)) {
        Fighter* ft4 = GET_FIGHTER(gobj);
        if (--ft4->mv.mh.unk0.x54 == 0) {
            ftAnim_SetAnimRate(gobj, 1.0f);
            ftMh_Unk15_80153730(gobj);
        } else {
...
void ftMh_Unk15_80153548(HSD_GObj* arg0)
{
    Fighter* fp = arg0->user_data;
    if (Player_GetPlayerSlotType(fp->xC_playerID) == 0) {
        ftBossLib_8015BD20(arg0);
...
// 8015358C 15016C
void ftMh_Unk15_8015358C(HSD_GObj* gobj)
{
    ft_80085134(gobj);
}

// 801535AC 15018C
void ftMh_Unk15_801535AC(HSD_GObj* gobj)
{
    return;
}
...
void ftMh_Unk15_801535B0(HSD_GObj* gobj)
{
    Fighter* fp;
    ftMasterHand_SpecialAttrs* attr;
    ...
    if (fp->x2200_ftcmd_var0 != 0) {
        ftMh_Unk15_8015364C(gobj, fp->ft_bones[8].x0_jobj, attr->xF8,
                            attr->xFC);
        fp->x2200_ftcmd_var0 = 0;
    }
    if (fp->x2204_ftcmd_var1 != 0) {
        ftMh_Unk15_8015364C(gobj, fp->ft_bones[13].x0_jobj, attr->x100,
                            attr->x104);
        fp->x2204_ftcmd_var1 = 0;
    }
}
...
void ftMh_Unk15_8015364C(HSD_GObj* arg0, HSD_JObj* arg1, f32 arg2, f32 arg3)
{
...
void ftMh_Unk15_80153730(HSD_GObj* arg0)
{
    /// @todo Unused stack.
#ifdef MUST_MATCH
    u8 _[8];
