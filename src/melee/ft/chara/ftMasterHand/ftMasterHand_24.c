...
void func_80154C78(HSD_GObj* arg0)
{
    ...
    func_8006EBA4(arg0);
    temp_r31->masterhandVars[0].x234C_pos.x = temp_r30->x118_pos.x;
    temp_r31->masterhandVars[0].x234C_pos.y = temp_r30->x118_pos.y;
    temp_r31->masterhandVars[0].x234C_pos.z = 0.0f;
}
...
void func_80154CF8(HSD_GObj* gobj, Fighter* fp)
{
    ...
    func_8006EBA4(gobj);
    temp_r31->masterhandVars[0].x234C_pos.x = temp_r30->x30_pos2.x;
    temp_r31->masterhandVars[0].x234C_pos.y = temp_r30->x30_pos2.y;
    temp_r31->masterhandVars[0].x234C_pos.z = 0.0f;
}
