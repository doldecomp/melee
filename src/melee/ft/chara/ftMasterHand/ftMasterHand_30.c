...
void ftMh_Unk30_8015550C(HSD_GObj* gobj)
{
...
// 80155580 152160
void ftMh_Unk30_80155580(HSD_GObj* gobj)
{
    Fighter* fp = gobj->user_data;
...
// 801555C4 1521A4
void ftMh_Unk30_801555C4(HSD_GObj* gobj)
{
    ft_80085134(gobj);
}

// 801555E4 1521C4
void ftMh_Unk30_801555E4(HSD_GObj* gobj)
{
    return;
}
...
void ftMh_Unk30_801555E8(HSD_GObj* gobj)
{
    if (ftBossLib_8015C31C() || ftBossLib_8015C3A0() ||
        !ftAnim_IsFramesRemaining(gobj))
    {
        ...
        Fighter_UnkSetFlag_8006CFBC(gobj);
        fp->x1A5C = 0;
        ftMh_Unk30_80155818(gobj);
    }
}

// 8015565C 15223C
void ftMh_Unk30_8015565C(HSD_GObj* gobj)
{
    Fighter* fp = gobj->user_data;
    if (Player_GetPlayerSlotType(fp->xC_playerID) == 0) {
        ftBossLib_8015BD20(gobj);
...
// 801556A0 152280
void ftMh_Unk30_801556A0(HSD_GObj* gobj)
{
    ft_80085134(gobj);
}

// 801556C0 1522A0
void ftMh_Unk30_801556C0(HSD_GObj* gobj)
{
    return;
}
...
void ftMh_Unk30_801556C4(HSD_GObj* gobj)
{
...
// 801557B0 152390
void ftMh_Unk30_801557B0(HSD_GObj* gobj)
{
    Fighter* fp = gobj->user_data;
    if (Player_GetPlayerSlotType(fp->xC_playerID) == 0) {
        ftBossLib_8015BD20(gobj);
...
// 801557F4 1523D4
void ftMh_Unk30_801557F4(HSD_GObj* gobj)
{
    ft_80085134(gobj);
}

// 80155814 1523F4
void ftMh_Unk30_80155814(HSD_GObj* gobj)
{
    return;
}
...
void ftMh_Unk30_80155818(HSD_GObj* gobj)
{
...
void ftMh_Unk30_80155864(HSD_GObj* gobj)
{
...
// 801558A0 152480
void ftMh_Unk30_801558A0(HSD_GObj* gobj)
{
    Fighter* fp = gobj->user_data;
    if (Player_GetPlayerSlotType(fp->xC_playerID) == 0) {
        ftBossLib_8015BD20(gobj);
...
// 801558E4 1524C4
void ftMh_Unk30_801558E4(HSD_GObj* gobj)
{
    ft_80085134(gobj);
}

// 80155904 1524E4
void ftMh_Unk30_80155904(HSD_GObj* gobj)
{
    return;
}
...
void ftMh_Unk30_80155908(HSD_GObj* gobj)
{
    Fighter* fp = gobj->user_data;
    if ((--fp->mv.mh.unk0.x24 <= 0.0f) && (fp->x2200_ftcmd_var0 != 0)) {
        ftMh_Unk34_80155D1C(fp->x1A58_interactedFighter);
        fp->x2200_ftcmd_var0 = 0;
    }
...
// 80155990 152570
void ftMh_Unk30_80155990(HSD_GObj* gobj)
{
    Fighter* fp = gobj->user_data;
    if (Player_GetPlayerSlotType(fp->xC_playerID) == 0) {
        ftBossLib_8015BD20(gobj);
...
void ftMh_Unk30_801559D4(HSD_GObj* gobj)
{
    Fighter* fp = gobj->user_data;
...
void ftMh_Unk30_80155A34(HSD_GObj* gobj)
{
    Fighter* fp = gobj->user_data;
