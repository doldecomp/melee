...
{
    GET_FIGHTER(fighter_gobj)->ev.mewtwo.x222C_disableGObj = NULL;
}
...
{
    if (GET_FIGHTER(fighter_gobj)->ev.mewtwo.x222C_disableGObj != NULL) {
        func_802C49E0(GET_FIGHTER(fighter_gobj)->ev.mewtwo.x222C_disableGObj);
        GET_FIGHTER(fighter_gobj)->ev.mewtwo.x222C_disableGObj = NULL;
    }
}
...
void ftMewtwo_SpecialLw_Anim(HSD_GObj* fighter_gobj)
{
    if (!ftAnim_IsFramesRemaining(fighter_gobj)) {
        if (GET_FIGHTER(fighter_gobj)->ev.mewtwo.x222C_disableGObj != NULL) {
            func_802C49E0(
                GET_FIGHTER(fighter_gobj)->ev.mewtwo.x222C_disableGObj);
            GET_FIGHTER(fighter_gobj)->ev.mewtwo.x222C_disableGObj = NULL;
        }
...
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    if (fp->ev.mewtwo.x222C_disableGObj != NULL) {
...
void ftMewtwo_SpecialLw_GroundToAir(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ActionStateChange_800693AC(fighter_gobj, AS_MEWTWO_SPECIALAIRLW,
...
void ftMewtwo_SpecialAirLw_AirToGround(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ActionStateChange_800693AC(fighter_gobj, AS_MEWTWO_SPECIALLW,
                                       FTMEWTWO_SPECIALLW_COLL_FLAG, NULL,
                                       fp->x894_currentAnimFrame, 1.0f, 0.0f);
...
void ftMewtwo_SpecialLw_CreateDisable(HSD_GObj* fighter_gobj)
{
    ...
    if ((u32) fp->x2200_ftcmd_var0 != 0U) {
        ...
        fp->ev.mewtwo.x222C_disableGObj =
