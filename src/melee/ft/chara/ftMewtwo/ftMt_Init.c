...
MotionState ftMt_Init_MotionStateTable[] = {
    ...
    { 296, 0x003C0111, 0x12000000, ftMt_SpecialNLoop_Anim,
      ftMt_SpecialNLoop_IASA, ftMt_SpecialNLoop_Phys,
      ftMt_SpecialNLoop_Coll, ftCamera_UpdateCameraBox },
    { 297, 0x003C0111, 0x12000000, ftMt_SpecialNFull_Anim,
      ftMt_SpecialNFull_IASA, ftMt_SpecialNFull_Phys,
      ftMt_SpecialNFull_Coll, ftCamera_UpdateCameraBox },
    ...
    { 299, 0x00340111, 0x12000000, ftMt_SpecialNEnd_Anim,
      ftMt_SpecialNEnd_IASA, ftMt_SpecialNEnd_Phys,
      ftMt_SpecialNEnd_Coll, ftCamera_UpdateCameraBox },
    ...
    { 305, 0x00341012, 0x13000000, ftMt_SpecialS_Anim,
      ftMt_SpecialS_IASA, ftMt_SpecialS_Phys, ftMt_SpecialS_Coll,
      ftCamera_UpdateCameraBox },
    { 306, 0x00341412, 0x13000000, ftMt_SpecialAirS_Anim,
      ftMt_SpecialAirS_IASA, ftMt_SpecialAirS_Phys,
      ftMt_SpecialAirS_Coll, ftCamera_UpdateCameraBox },
    ...
    { 309, 0x00340013, 0x14000000, ftMt_SpecialHi_Anim,
      ftMt_SpecialHi_IASA, ftMt_SpecialHi_Phys,
      ftMt_SpecialHi_Coll, ftCamera_UpdateCameraBox },
    ...
    { 309, 0x00340413, 0x14000000, ftMt_SpecialAirHi_Anim,
      ftMt_SpecialAirHi_IASA, ftMt_SpecialAirHi_Phys,
      ftMt_SpecialAirHi_Coll, ftCamera_UpdateCameraBox },
    ...
    { 312, 0x00340114, 0x15000000, ftMt_SpecialLw_Anim,
      ftMt_SpecialLw_IASA, ftMt_SpecialLw_Phys,
      ftMt_SpecialLw_Coll, ftCamera_UpdateCameraBox },
    { 313, 0x00340514, 0x15000000, ftMt_SpecialAirLw_Anim,
      ftMt_SpecialAirLw_IASA, ftMt_SpecialAirLw_Phys,
      ftMt_SpecialAirLw_Coll, ftCamera_UpdateCameraBox },
};
