...
typedef enum ftMewtwoAction {
    MS_MEWTWO_SPECIALN_START = ftCo_MS_Count,
    MS_MEWTWO_SPECIALN_LOOP,
    MS_MEWTWO_SPECIALN_FULL,
    MS_MEWTWO_SPECIALN_CANCEL,
    MS_MEWTWO_SPECIALN_END,
    MS_MEWTWO_SPECIALAIRN_START,
    MS_MEWTWO_SPECIALAIRN_LOOP,
    MS_MEWTWO_SPECIALAIRN_FULL,
    MS_MEWTWO_SPECIALAIRN_CANCEL,
    MS_MEWTWO_SPECIALAIRN_END,
    MS_MEWTWO_SPECIALS,
    MS_MEWTWO_SPECIALAIRS,
    MS_MEWTWO_SPECIALHI_START,
    MS_MEWTWO_SPECIALHI,
    MS_MEWTWO_SPECIALHI_LOST,
    MS_MEWTWO_SPECIALAIRHI_START,
    MS_MEWTWO_SPECIALAIRHI,
    MS_MEWTWO_SPECIALAIRHI_LOST,
    MS_MEWTWO_SPECIALLW,
    MS_MEWTWO_SPECIALAIRLW,
...
extern MotionState ms_table_mewtwo[];
