...
MotionState ftNess_MotionStateTable[] = {
    ...
    { 304, 0x00340511, 0x12000000, ftNess_SpecialAirNHold_Anim,
      ...
      ftNess_SpecialAirNHold_Coll, ftCamera_UpdateCameraBox },
    ...
    { 306, 0x00340511, 0x12000000, ftNess_SpecialAirNEnd_Anim,
      ...
      ftNess_SpecialAirNEnd_Coll, ftCamera_UpdateCameraBox },
    { 307, 0x00340112, 0x13000000, ftNess_SpecialS_Anim, NULL,
      ftNess_SpecialS_Phys, ftNess_SpecialS_Coll, ftCamera_UpdateCameraBox },
