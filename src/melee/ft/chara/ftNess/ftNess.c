...
MotionState ftNs_Init_MotionStateTable[] = {
    ...
    { 300, 0x00340111, 0x12000000, ftNs_SpecialNHold_Anim,
      ftNs_SpecialNHold_IASA, ftNs_SpecialNHold_Phys,
      ftNs_SpecialNHold_Coll, ftCamera_UpdateCameraBox },
    { 301, 0x00340111, 0x12000000, ftNs_SpecialNHold_Anim,
      ftNs_SpecialNHold_IASA, ftNs_SpecialNHold_Phys,
      ftNs_SpecialNHold_Coll, ftCamera_UpdateCameraBox },
    { 302, 0x00340111, 0x12000000, ftNs_SpecialNEnd_Anim,
      ftNs_SpecialNEnd_IASA, ftNs_SpecialNEnd_Phys,
      ftNs_SpecialNEnd_Coll, ftCamera_UpdateCameraBox },
    ...
    { 308, 0x00340512, 0x13000000, ftNs_SpecialAirS_Anim, NULL,
      ftNs_SpecialAirS_Phys, ftNs_SpecialAirS_Coll,
    ...
    { 311, 0x00340113, 0x14000000, ftNs_SpecialHiEnd_Anim,
      ftNs_SpecialHiEnd_IASA, ftNs_SpecialHiEnd_Phys,
      ftNs_SpecialHiEnd_Coll, ftCamera_UpdateCameraBox },
    { 312, 0x00340113, 0x14000000, ftNs_SpecialHi_Anim,
      ftNs_SpecialHi_IASA, ftNs_SpecialHi_Phys, ftNs_SpecialHi_Coll,
      ftCamera_UpdateCameraBox },
    ...
    { 316, 0x00340513, 0x14000000, ftNs_SpecialAirHi_Anim,
      ftNs_SpecialAirHi_IASA, ftNs_SpecialAirHi_Phys,
      ftNs_SpecialAirHi_Coll, ftCamera_UpdateCameraBox },
    ...
    { 320, 0x00340014, 0x15000000, ftNs_SpecialLwHit_Anim,
      ftNs_SpecialLwHit_IASA, ftNs_SpecialLwHit_Phys,
      ftNs_SpecialLwHit_Coll, ftCamera_UpdateCameraBox },
    { 321, 0x00340014, 0x15000000, ftNs_SpecialLwEnd_Anim,
      ftNs_SpecialLwEnd_IASA, ftNs_SpecialLwEnd_Phys,
      ftNs_SpecialLwEnd_Coll, ftCamera_UpdateCameraBox },
