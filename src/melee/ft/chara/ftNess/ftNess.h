...
#define FTNESS_SPECIALN_COLL_FLAG FIGHTER_MATANIM_NOUPDATE | FIGHTER_UNK_0x1000 | FIGHTER_CMD_UPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_UNK_0x400000 | FIGHTER_UNK_0x4000000 | FIGHTER_UNK_0x2227

// SpecialHi/SpecialAirHi (PK Thunder) //
#define FTNESS_SPECIALHI_COLL_FLAG FIGHTER_MATANIM_NOUPDATE | FIGHTER_UNK_0x1000 | FIGHTER_CMD_UPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_UNK_0x400000 | FIGHTER_UNK_0x4000000 | FIGHTER_UNK_0x2227

// SpecialHi Jibaku (PK Thunder 2 Self-Hit) //
#define FTNESS_JIBAKU_COLL_FLAG FIGHTER_GFX_PRESERVE | FIGHTER_UNK_HAMMER | FIGHTER_MATANIM_NOUPDATE | FIGHTER_UNK_0x1000 | FIGHTER_CMD_UPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_UNK_0x400000 | FIGHTER_UNK_0x4000000 | FIGHTER_UNK_0x2227

// SpecialLw (PSI Magnet) //
#define FTNESS_SPECIALLW_COLL_FLAG FIGHTER_GFX_PRESERVE | FIGHTER_MATANIM_NOUPDATE | FIGHTER_UNK_0x1000 | FIGHTER_CMD_UPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_UNK_0x400000 | FIGHTER_UNK_0x4000000 | FIGHTER_UNK_0x2227

#define FTNESS_SPECIALLW_END_FLAG FIGHTER_MATANIM_NOUPDATE | FIGHTER_UNK_0x1000 | FIGHTER_CMD_UPDATE | FIGHTER_ITEMVIS_NOUPDATE | FIGHTER_SKIP_UNK_0x2222 | FIGHTER_UNK_0x400000 | FIGHTER_UNK_0x4000000 | FIGHTER_UNK_0x2227
