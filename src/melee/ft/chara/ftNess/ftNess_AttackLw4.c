...
// Ness' Down Smash IASA callback
void ftNess_AttackLw4_IASA(HSD_GObj* fighter_gobj)
{
    Fighter* fp = getFighter(fighter_gobj);
...
void ftNess_AttackLw4_Phys(HSD_GObj* fighter_gobj) // Ness' Down Smash Physics callback
{
...
void ftNess_AttackLw4_Coll(HSD_GObj* fighter_gobj) // Ness' Down Smash Collision callback
{
    Fighter* fp = getFighter(fighter_gobj);
...
void ftNess_AttackLw4_Charge_Anim(HSD_GObj* fighter_gobj) // Ness' Down Smash Charge Animation callback
{
...
void ftNess_AttackLw4_Charge_IASA(HSD_GObj* fighter_gobj) // Ness' Down Smash Charge IASA callback
{
    Fighter* fp = getFighter(fighter_gobj);
...
void ftNess_AttackLw4_Charge_Phys(HSD_GObj* fighter_gobj) // Ness' Down Smash Charge Physics callback
{
    func_80084F3C(fighter_gobj);
}
...
void ftNess_AttackLw4_Charge_Coll(HSD_GObj* fighter_gobj) // Ness' Down Smash Charge Collision callback
{
    Fighter* fp = getFighter(fighter_gobj);
...
void ftNess_AttackLw4_Charge_Action(HSD_GObj* fighter_gobj) // Ness' Down Smash Charge Action State handler
{
    Fighter* fp = getFighter(fighter_gobj);
...
void ftNess_AttackLw4_Release_Anim(HSD_GObj* fighter_gobj) // Ness' Down Smash Post-Charge Animation callback
{
    s32 yoyoSmashFrameCurr;
    Fighter* fp;
...
void ftNess_AttackLw4_Release_IASA(HSD_GObj* fighter_gobj) // Ness' Down Smash Post-Charge IASA callback
{
    Fighter* fp = getFighter(fighter_gobj);
    if (fp->x2218_flag.bits.b0 != 0) {
        func_8008A4D4(fighter_gobj);
...
void ftNess_AttackLw4_Release_Phys(HSD_GObj* fighter_gobj) // Ness' Down Smash Post-Charge Physics callback
{
    f32 yoyoSmashUnk;
    s32 yoyoSmashFrameCurr;
    Fighter* fp;
...
void ftNess_AttackLw4_Release_Coll(HSD_GObj* fighter_gobj) // Ness' Down Smash Post-Charge Collision callback
{
    Fighter* fp = getFighter(fighter_gobj);
...
void ftNess_AttackLw4_Release_Action(HSD_GObj* fighter_gobj) // Ness' Down Smash Post-Charge Action State handler
{
    Fighter* fp = getFighter(fighter_gobj);
