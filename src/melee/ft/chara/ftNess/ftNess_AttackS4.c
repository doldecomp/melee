...
// 0x80114BF4
void ftNess_AttackS4_OnReflect(HSD_GObj* fighter_gobj) // Ness' F-Smash OnReflect callback
{
...
void ftNess_AttackS4_IASA(HSD_GObj* fighter_gobj) // Ness' F-Smash IASA Callback
{
...
void ftNess_AttackS4_Phys(HSD_GObj* fighter_gobj) // Ness' F-Smash Physics Callback
...
void ftNess_AttackS4_Coll(HSD_GObj* fighter_gobj) // Ness' F-Smash Collision Callback
{
