                            ...
                            // handler
{
    ...
    Fighter_ActionStateChange_800693AC(fighter_gobj, AS_NESS_SPECIALHI_START,
...
/// @todo Unused assignment.
    ...
    Fighter_ActionStateChange_800693AC(
        fighter_gobj, AS_NESS_SPECIALAIRHI_START, 0, NULL, 0.0f, 1.0f, 0.0f);
    fp->x220C_ftcmd_var3 = 0;
    fp->x2208_ftcmd_var2 = 0;
    fp->x2204_ftcmd_var1 = 0;
    fp->x2200_ftcmd_var0 = 0;
...
void ftNess_SpecialHiStart_Anim(HSD_GObj* fighter_gobj)
{
    ...
    if (!ftAnim_IsFramesRemaining(fighter_gobj)) {
        Fighter_ActionStateChange_800693AC(
            fighter_gobj, AS_NESS_SPECIALHI_HOLD, 0, NULL, 0.0f, 1.0f, 0.0f);
                            ...
                            // Animation callback
{
    ...
    } else if (func_802AB568(fp->ev.ns.x2244_pkThunderGObj) == fighter_gobj) {
...
void ftNess_SpecialAirHiStart_Anim(HSD_GObj* fighter_gobj)
{
    ...
    if (!ftAnim_IsFramesRemaining(fighter_gobj)) {
        Fighter_ActionStateChange_800693AC(fighter_gobj,
                                           AS_NESS_SPECIALAIRHI_HOLD, 0, NULL,
                                           0.0f, 1.0f, 0.0f);
...
void ftNess_SpecialAirHiHold_Anim(HSD_GObj* fighter_gobj)
{
    ...
    } else if (func_802AB568(fp0->ev.ns.x2244_pkThunderGObj) == fighter_gobj) {
        if (ftNess_ItemPKThunder_CheckNessCollide(fighter_gobj) == true) {
            NessFloatMath_PKThunder2(fighter_gobj);
            Fighter_ActionStateChange_800693AC(
                            ...
                            // Collision callback
{
    ...
    if (func_80082708(fighter_gobj) == false) {
        func_8007D60C(fp);
        Fighter_ActionStateChange_800693AC(
            fighter_gobj, AS_NESS_SPECIALAIRHI_HOLD,
            FTNESS_SPECIALHI_COLL_FLAG, NULL, fp->x894_currentAnimFrame, 1.0f,
            0.0f);
    }
}
    ...
    if (func_80082708(fighter_gobj) == false) {
        ...
        if ((env_flags & 0b111111) || (env_flags & 0b111111 << 6)) {
            ...
            Fighter_ActionStateChange_800693AC(
                ...
                FTNESS_SPECIALHI_COLL_FLAG, NULL, fp0->x894_currentAnimFrame,
                1, 0);
            return;
        }
