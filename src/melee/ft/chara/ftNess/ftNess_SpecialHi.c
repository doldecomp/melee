...
bool ftNess_ItemPKThunder_CheckNessCollide(HSD_GObj* gobj)
{
    ...
    case 0:
        ...
        func_802AB3F0(fp->ev.ns.x2244_pkThunderGObj, &pair, 0);
        if (check_distance(&pos, &pair) == true) {
            fp->sv.ns.specialhi.thunderColl = 2;
            func_802AB3F0(fp->ev.ns.x2244_pkThunderGObj,
    ...
    case 1:
        ...
        func_802AB3F0(fp->ev.ns.x2244_pkThunderGObj, &pair2, 0);
...
void ftNess_SpecialHiTakeDamage(HSD_GObj* gobj) // OnTakeDamage again?
{
    ...
    fp = temp_fp;
    if (temp_fp->ev.ns.x2244_pkThunderGObj != NULL) {
        func_802AB9C0(temp_fp->ev.ns.x2244_pkThunderGObj);
                                                  ...
                                                  // Start Action State handler
{
    ...
    Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALHI_START, 0, NULL,
                                       0.0f, 1.0f, 0.0f);
...
/// @todo Unused assignment.
    ...
    Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALAIRHI_START, 0,
                                       NULL, 0.0f, 1.0f, 0.0f);
    fp->x220C_ftcmd_var3 = 0;
    fp->x2208_ftcmd_var2 = 0;
    fp->x2204_ftcmd_var1 = 0;
                           ...
                           ness_attr->x60_PK_THUNDER_2_KNOCKDOWN_ANGLE)))
                {
                    ...
                    fp->sv.ns.specialhi.aerialVel = atan2f(sp40.y, sp40.x);
                    {
                        ...
                        Fighter_ActionStateChange_800693AC(
                            gobj, AS_NESS_SPECIALHI, 0, NULL, 0.0f, 1.0f,
                            0.0f);
                        fp->xEC_ground_vel =
...
void ftNess_SpecialAirHi_Action(HSD_GObj* gobj)
{
    ...
    Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALAIRHI, 0, NULL,
                                       0.0f, 1.0f, 0.0f);
    fighter_data2 = GET_FIGHTER(gobj);
...
void ftNess_SpecialHiStart_Anim(HSD_GObj* gobj)
{
    ...
    if (!ftAnim_IsFramesRemaining(gobj)) {
        Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALHI_HOLD, 0,
                                           NULL, 0.0f, 1.0f, 0.0f);
                    ...
                    // Animation callback
{
    ...
    if (fp->ev.ns.x2244_pkThunderGObj == NULL) {
        ...
        {
            Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALHI_END, 0,
                                               NULL, 0.0f, 1.0f, 0.0f);
    ...
    } else if (func_802AB568(fp->ev.ns.x2244_pkThunderGObj) == gobj) {
...
void ftNess_SpecialAirHiStart_Anim(HSD_GObj* gobj)
{
    ...
    if (!ftAnim_IsFramesRemaining(gobj)) {
        Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALAIRHI_HOLD, 0,
                                           NULL, 0.0f, 1.0f, 0.0f);
...
void ftNess_SpecialAirHiHold_Anim(HSD_GObj* gobj)
{
    ...
    if (fp0->ev.ns.x2244_pkThunderGObj == NULL) {
        ...
        {
            Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALAIRHI_END,
                                               0, NULL, 0, 1, 0);
            {
    ...
    } else if (func_802AB568(fp0->ev.ns.x2244_pkThunderGObj) == gobj) {
        if (ftNess_ItemPKThunder_CheckNessCollide(gobj) == true) {
            NessFloatMath_PKThunder2(gobj);
            Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALAIRHI, 0,
                                               NULL, 0.0f, 1.0f, 0.0f);
        ...
        Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALAIRHI_END, 0,
                                           NULL, 0.0f, 1.0f, 0.0f);
        {
            Fighter* fp1 = gobj->user_data;
            enum_t asid = fp1->action_id;
    ...
    HSD_GObj* gobj) // Ness's grounded PK Thunder Start Collision callback
{
    ...
    if (func_80082708(gobj) == false) {
        func_8007D60C(fp);
        Fighter_ActionStateChange_800693AC(
            gobj, AS_NESS_SPECIALAIRHI_START, FTNESS_SPECIALHI_COLL_FLAG, NULL,
                    ...
                    // Collision callback
{
    ...
    if (func_80082708(gobj) == false) {
        func_8007D60C(fp);
        Fighter_ActionStateChange_800693AC(
            gobj, AS_NESS_SPECIALAIRHI_HOLD, FTNESS_SPECIALHI_COLL_FLAG, NULL,
            fp->x894_currentAnimFrame, 1.0f, 0.0f);
    }
}
    ...
    HSD_GObj* gobj) // Ness's grounded PK Thunder End Collision callback
{
    ...
    if (func_80082708(gobj) == false) {
        func_8007D60C(fp);
        Fighter_ActionStateChange_800693AC(
            gobj, AS_NESS_SPECIALAIRHI_END, FTNESS_SPECIALHI_COLL_FLAG, NULL,
            fp->x894_currentAnimFrame, 1.0f, 0.0f);
    }
}
...
void ftNess_SpecialHi_Coll(HSD_GObj* gobj)
{
    ...
    if (func_80082708(gobj) == false) {
        ...
        if ((env_flags & 0b111111) || (env_flags & 0b111111 << 6)) {
            ...
            Fighter_ActionStateChange_800693AC(
                gobj, AS_NESS_SPECIALAIRHI_END, FTNESS_SPECIALHI_COLL_FLAG,
                NULL, fp0->x894_currentAnimFrame, 1, 0);
            return;
        }

        func_8007D60C(fp0);
        Fighter_ActionStateChange_800693AC(gobj, AS_NESS_SPECIALAIRHI,
    ...
    HSD_GObj* gobj) // Ness's aerial PK Thunder Start Collision callback
{
    ...
    if (func_80081D0C(gobj) != false) {
        func_8007D7FC(fp);
        Fighter_ActionStateChange_800693AC(
            gobj, AS_NESS_SPECIALHI_START, FTNESS_SPECIALHI_COLL_FLAG, NULL,
            fp->x894_currentAnimFrame, 1.0f, 0.0f);
    }
}
                    ...
                    // callback
{
    ...
    if (func_80081D0C(gobj) != false) {
        func_8007D7FC(fp);
        Fighter_ActionStateChange_800693AC(
            gobj, AS_NESS_SPECIALHI_HOLD, FTNESS_SPECIALHI_COLL_FLAG, NULL,
            fp->x894_currentAnimFrame, 1.0f, 0.0f);
    }
}
    ...
    HSD_GObj* gobj) // Ness's aerial PK Thunder End Collision callback
{
    ...
    if (func_80081D0C(gobj) != false) {
        func_8007D7FC(fp);
        Fighter_ActionStateChange_800693AC(
            gobj, AS_NESS_SPECIALHI_END, FTNESS_SPECIALHI_COLL_FLAG, NULL,
            fp->x894_currentAnimFrame, 1.0f, 0.0f);
    }
}
...
void ftNess_SpecialAirHi_Coll(HSD_GObj* gobj)
{
    ...
    if (EnvColl_CheckGroundAndLedge(gobj, ledgeGrabDir) != false) {
        ...
        Fighter_ActionStateChange_800693AC(
            gobj, AS_NESS_SPECIALHI, FTNESS_JIBAKU_COLL_FLAG, NULL,
    ...
    if ((ecbFlag & 0x6000) != 0) {
        ...
        if ((ecbFlag & 0x3F) != 0) {
                 ...
                 (90.0f + ness_attr->x64_PK_THUNDER_2_WALLHUG_ANGLE)))
            {
                ...
                ftNess_SpecialHiStopGFX(gobj);
                Fighter_ActionStateChange_800693AC(
                    gobj, AS_NESS_SPECIALAIRHI_HITWALL,
                ...
                ef_Spawn(0x406, gobj, &fighter_data4->xB0_pos, &spB8);
                return;
            }
        ...
        if ((ecbFlag & 0xFC0) != 0) {
                 ...
                 (90.0f + ness_attr->x64_PK_THUNDER_2_WALLHUG_ANGLE)))
            {
                ...
                ef_Spawn(0x406, gobj, &fighter_data5->xB0_pos, &spAC);
                return;
            }
            ftNess_SpecialAirHi_CollisionModVel(gobj,
                                                &fighter_r31->x6F0_collData);
