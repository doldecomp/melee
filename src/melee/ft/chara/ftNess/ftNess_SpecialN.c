...
bool ftNess_CheckSpecialNHold(HSD_GObj* fighter_gobj)
{
    if (fighter_gobj != NULL) {
        ...
        if (fp != NULL && fp->ev.ness.x2240_flashGObj != NULL) {
...
void ftNess_SpecialNSetNULL(HSD_GObj* fighter_gobj)
{
...

    {
        ...
        if (fp->ev.ness.x2240_flashGObj != NULL)
            fp->ev.ness.x2240_flashGObj = NULL;
...
void ftNess_ItemPKFlushSetNULL(HSD_GObj* fighter_gobj)
{
...

    {
        ...
        if (fp->ev.ness.x2240_flashGObj != NULL) {
            func_802AAA50(fp->ev.ness.x2240_flashGObj);
            fp->ev.ness.x2240_flashGObj = NULL;
        }
...
void ftNess_SpecialNStart_Action(HSD_GObj* fighter_gobj)
{
...

    {
        ...
        fp1->ev.ness.x2240_flashGObj = NULL;
...
void ftNess_SpecialAirNStart_Action(HSD_GObj* fighter_gobj)
{
...

    {
        ...
        temp_fp->ev.ness.x2240_flashGObj = NULL;
...

    {
        ...
        if (fp->ev.ness.x2240_flashGObj == NULL) {
...

            {
                ...
                fp->ev.ness.x2240_flashGObj = pk_flash;
...
void ftNess_SpecialNHold_Anim(HSD_GObj* fighter_gobj)
{
    ...
    if (func_802AA7E4(fp->ev.ness.x2240_flashGObj) != fighter_gobj) {
        fp->ev.ness.x2240_flashGObj = NULL;
        return;
    }

    if (func_802AA7F0(fp->ev.ness.x2240_flashGObj) == true &&
...
void ftNess_SpecialAirNStart_Anim(HSD_GObj* fighter_gobj)
{
...

    {
            ...
            fighter_gobj, AS_NESS_SPECIALAIRN_HOLD, 0, NULL, 0, 1, 0);
        {
            ...
            if (fighter_data2->ev.ness.x2240_flashGObj == NULL) {
                Vec3 vec;
...

                {
                    ...
                    fighter_data2->ev.ness.x2240_flashGObj = flash_GObj;
                    if (flash_GObj != NULL) {
