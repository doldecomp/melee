...
void ftNess_ItemPKFireSpawn(HSD_GObj* fighter_gobj) //* Ness' PK Fire spawn function, stored as Accessory4 and summoned with Subaction Event 0x60 *//
{
...
void ftNess_SpecialS_StartAction(HSD_GObj* fighter_gobj) // Ness' grounded PK Fire Action State handler
{
    Fighter* fp;
...
void ftNess_SpecialAirS_Action(HSD_GObj* fighter_gobj) // Ness' aerial PK Fire Action State handler
{
    Fighter* fp;
...
void ftNess_SpecialAirS_Anim(HSD_GObj* fighter_gobj) // Ness' aerial PK Fire Animation callback
{
    if (ftAnim_IsFramesRemaining(fighter_gobj) == FALSE)
    {
...
void ftNess_SpecialS_Phys(HSD_GObj* fighter_gobj) // Ness' grounded PK Fire Physics callback
{
...
void ftNess_SpecialAirS_Phys(HSD_GObj* fighter_gobj) // Ness' aerial PK Fire Physics callback
{
...
void ftNess_SpecialS_Coll(HSD_GObj* fighter_gobj) // Ness' grounded PK Fire Collision callback
{
...
void ftNess_SpecialAirS_Coll(HSD_GObj* fighter_gobj) // Ness' aerial PK Fire Collision callback
{
    Fighter* fp = getFighter(fighter_gobj);
