...
void ftPikachu_SpecialN_StartMotion(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 0x155, 0, 0, 0.0f, 1.0f, 0.0f);
...
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    Fighter_ChangeMotionState(fighter_gobj, 0x156, 0, 0, 0.0f, 1.0f, 0.0f);
    fp->x220C_ftcmd_var3 = 0;
    fp->x2208_ftcmd_var2 = 0;
    fp->x2204_ftcmd_var1 = 0;
    fp->x2200_ftcmd_var0 = 0;
...
void ftPikachu_80124908(HSD_GObj* fighter_gobj)
{
    ...
    if (fp->x2200_ftcmd_var0 == 1) {
        ...
        if (!fp->x2204_ftcmd_var1) {
            ...
            sp14.z = 0.0f;
            it_802B338C(fighter_gobj, &sp14, fp->facing_dir, pika_attr->x14);
...
void ftPikachu_80124A20(HSD_GObj* fighter_gobj)
{
    ...
    if (!ftAnim_IsFramesRemaining(fighter_gobj)) {
        ...
        ft_80096900(fighter_gobj, 1, 0, 1, 1.0f, pika_attr->x10);
    }
}
...
void ftPikachu_ActionChange_80124BB4(HSD_GObj* fighter_gobj)
{
    ...
    if (!ft_80082708(fighter_gobj)) {
        ...
        Fighter_ChangeMotionState(fighter_gobj, 0x156, 0xc4c5082, 0,
...
void ftPikachu_ActionChange_80124C20(HSD_GObj* fighter_gobj)
{
    ...
    if (ft_80081D0C(fighter_gobj) == 1) {
        ...
        Fighter_ChangeMotionState(fighter_gobj, 0x155, 0xc4c5082, 0,
                                  fp->x894_currentAnimFrame, 1.0f, 0.0f);
    }
}
