...
void ftPikachu_SpecialS_StartMotion(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 343, 0, 0, 0, 1, 0);
...
void ftPikachu_SpecialAirS_StartMotion(HSD_GObj* fighter_gobj)
{
    ...
    fp->x80_self_vel.y = 0;
    Fighter_ChangeMotionState(fighter_gobj, 348, 0, 0, 0, 1, 0);
    ftAnim_8006EBA4(fighter_gobj);
}
...
void ftPikachu_ActionChange_801250FC(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 348, transition_flags0, 0,
...
void ftPikachu_ActionChange_8012515C(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 343, transition_flags0, 0,
...
void ftPikachu_ActionChange_80125414(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D5D4(fp);
    Fighter_ChangeMotionState(fighter_gobj, 349, transition_flags1, 0,
                              fp->x894_currentAnimFrame, 1, 0);
}
...
void ftPikachu_ActionChange_80125474(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D7FC(fp);
    Fighter_ChangeMotionState(fighter_gobj, 344, transition_flags1, 0,
                              fp->x894_currentAnimFrame, 1, 0);
}
...
void ftPikachu_ActionChange_801254D4(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 344, FtStateChange_PreserveSfx, 0,
                              0, 1, 0);
...
void ftPikachu_ActionChange_80125528(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 349, FtStateChange_PreserveSfx, 0,
                              0, 1, 0);
...
void ftPikachu_8012557C(HSD_GObj* fighter_gobj)
{
    ...
    if (fp->x914[0].state == HitCapsule_Enabled) {
        ...
        ftColl_8007ABD0(&fp->x914[0], damage_amount, fighter_gobj);
    }
...
void ftPikachu_ActionChange_80125774(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D5D4(fp);
    Fighter_ChangeMotionState(fighter_gobj, 352, transition_flags2, 0,
                              fp->x894_currentAnimFrame, 1, 0);
}
...
void ftPikachu_ActionChange_801257D4(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D7FC(fp);
    Fighter_ChangeMotionState(fighter_gobj, 347, transition_flags2, 0,
                              fp->x894_currentAnimFrame, 1, 0);
}
...
void ftPikachu_ActionChange_80125834(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 347, 0, 0, 0, 1, 0);
    {
        Fighter* fp = GET_FIGHTER(fighter_gobj);
...
void ftPikachu_ActionChange_801258A0(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 352, 0, 0, 0, 1, 0);
...
void ftPikachu_ActionChange_80125A54(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 350, transition_flags3, 0,
                              fp->x894_currentAnimFrame, 1, 0);
...
void ftPikachu_ActionChange_80125CD0(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 346, 0, 0, 0, 1, 0);
}
...
void ftPikachu_ActionChange_80125D28(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 351, 0, 0, 0, 1, 0);
}
