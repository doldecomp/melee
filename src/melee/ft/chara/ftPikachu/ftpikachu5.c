...
void ftPikachu_EfSpawn_801277AC(HSD_GObj* fighter_gobj)
{
...

    {
        ...
        if (result && fp->sv.pk.unk4.x0 == 0) {
            ...
            efSync_Spawn(0x4C3, fighter_gobj, &ef_pos);
            {
                vec.z = 0.0f;
                vec.x = 0.0f;
                vec.y = pika_attr->xC0;
                fp->sv.pk.unk4.x0 =
                    it_802B1DF8(fighter_gobj, &pos, &vec, pika_attr->xD4,
...
void ftPikachu_SpecialLw_StartMotion(HSD_GObj* fighter_gobj)
{
    ...
    *((u32*) (&fp->x2210_ThrowFlags)) = 0;
    fp->sv.pk.unk4.x4 = 1;
    fp->sv.pk.unk4.x0 = 0;
    Fighter_ChangeMotionState(fighter_gobj, 0x167, 0, 0, 0.0f, 1.0f, 0.0f);
...
void ftPikachu_SpecialAirLw_StartMotion(HSD_GObj* fighter_gobj)
{
    ...
    *((u32*) (&fp->x2210_ThrowFlags)) = 0;
    fp->sv.pk.unk4.x4 = 1;
    fp->sv.pk.unk4.x0 = 0;
    Fighter_ChangeMotionState(fighter_gobj, 0x16B, 0, 0, 0.0f, 1.0f, 0.0f);
    ftAnim_8006EBA4(fighter_gobj);
}
...
void ftPikachu_ActionChange_8012798C(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 0x167, 0xC4C5086, 0,
...
void ftPikachu_ActionChange_801279EC(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 0x16B, 0xC4C5086, 0,
                              fp->x894_currentAnimFrame, 1.0f, 0.0f);
...
void ftPikachu_ActionChange_80127A54(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D7FC(fp);
    Fighter_ChangeMotionState(fighter_gobj, 0x168, 0xC4C588E, 0,
                              fp->x894_currentAnimFrame, 1.0f, 0.0f);
...
void ftPikachu_ActionChange_80127ACC(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D5D4(fp);
    Fighter_ChangeMotionState(fighter_gobj, 0x16C, 0xC4C588E, 0,
                              fp->x894_currentAnimFrame, 1.0f, 0.0f);
    fp->cb.x21DC_callback_OnTakeDamage = &ftPikachu_SetState_8012779C;
    fp->cb.x21BC_callback_Accessory4 = &ftPikachu_EfSpawn_801277AC;
    ftCommon_8007D468(fp);
...
void ftPikachu_ActionChange_80127B4C(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D7FC(fp);
    Fighter_ChangeMotionState(fighter_gobj, 0x169, 0xC4C508E, 0,
                              fp->x894_currentAnimFrame, 1.0f, 0.0f);
}
...
void ftPikachu_ActionChange_80127BAC(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D5D4(fp);
    Fighter_ChangeMotionState(fighter_gobj, 0x16D, 0xC4C508E, 0,
                              fp->x894_currentAnimFrame, 1.0f, 0.0f);
    ftCommon_8007D468(fp);
}
...
void ftPikachu_ActionChange_80127C14(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D7FC(fp);
    Fighter_ChangeMotionState(fighter_gobj, 0x16A, 0xC4C5086, 0,
                              fp->x894_currentAnimFrame, 1.0f, 0.0f);
}
...
void ftPikachu_ActionChange_80127C74(HSD_GObj* fighter_gobj)
{
    Fighter* fp = GET_FIGHTER(fighter_gobj);
    ftCommon_8007D5D4(fp);
    Fighter_ChangeMotionState(fighter_gobj, 0x16E, 0xC4C5086, 0,
                              fp->x894_currentAnimFrame, 1.0f, 0.0f);
    ftCommon_8007D468(fp);
}
...
void ftPikachu_ActionChange_80127CDC(HSD_GObj* fighter_gobj)
{
    ...
    if (!ftAnim_IsFramesRemaining(fighter_gobj)) {
        ...
        Fighter* fp = GET_FIGHTER(fighter_gobj);
        Fighter_ChangeMotionState(fighter_gobj, 0x168, 0x800, 0, 0.0f, 1.0f,
                                  0.0f);
...
void ftPikachu_ActionChange_80127D60(HSD_GObj* fighter_gobj)
{
    ...
    if (!ftAnim_IsFramesRemaining(fighter_gobj)) {
        Fighter* fighter_copy;
        Fighter* fp = GET_FIGHTER(fighter_gobj);
        Fighter_ChangeMotionState(fighter_gobj, 0x16C, 0x800, 0, 0.0f, 1.0f,
                                  0.0f);
        fighter_copy = GET_FIGHTER(fighter_gobj);
        *((u32*) (&fighter_copy->x2210_ThrowFlags)) = 0;
        fighter_copy->cb.x21DC_callback_OnTakeDamage =
...
void ftPikachu_ActionChange_80127DE4(HSD_GObj* fighter_gobj)
{
    ...
    if ((fp->sv.pk.unk4.x4 == 3) || fp->x2200_ftcmd_var0) {
        ...
        Fighter_ChangeMotionState(fighter_gobj, 0x16A, 0, 0, 0.0f, 1.0f, 0.0f);
        return;
    }
    if (ftPikachu_8012765C(fighter_gobj)) {
        Fighter* fighter_copy = GET_FIGHTER(fighter_gobj);
        Fighter_ChangeMotionState(fighter_gobj, 0x169, 0, 0, 0.0f, 1.0f, 0.0f);
...
void ftPikachu_ActionChange_80127EC0(HSD_GObj* fighter_gobj)
{
    ...
    if ((fp->sv.pk.unk4.x4 == 3) || fp->x2200_ftcmd_var0) {
        fp->cb.x21DC_callback_OnTakeDamage = 0;
        Fighter_ChangeMotionState(fighter_gobj, 0x16E, 0, 0, 0.0f, 1.0f, 0.0f);
        return;
    }
    if (ftPikachu_8012765C(fighter_gobj)) {
        Fighter* fighter_copy = GET_FIGHTER(fighter_gobj);
        ftPikachuAttributes* pika_attr = fighter_copy->x2D4_specialAttributes;
        Fighter_ChangeMotionState(fighter_gobj, 0x16D, 0, 0, 0.0f, 1.0f, 0.0f);
        fighter_copy->x2200_ftcmd_var0 = 0;
        fighter_copy->cb.x21DC_callback_OnTakeDamage = 0;
