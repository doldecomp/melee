...
/* 13E014 */ void ftPr_SpecialNChargeStart_Anim(HSD_GObj* gobj);
/* 13E0F0 */ void ftPr_SpecialNChargeLoop_Anim(HSD_GObj* gobj);
/* 13E2A0 */ void ftPr_SpecialNChargeFull_Anim(HSD_GObj* gobj);
/* 13E410 */ void ftPr_SpecialNChargeRelease_Anim(HSD_GObj* gobj);
/* 13E7E0 */ void ftPr_SpecialNStartTurn_Anim(HSD_GObj* gobj);
/* 13EAD8 */ void ftPr_SpecialNEnd_Anim(HSD_GObj* gobj);
/* 13EDB0 */ void ftPr_SpecialAirNChargeStart_Anim(HSD_GObj* gobj);
...
/* 13FF00 */ void ftPr_SpecialNChargeStart_IASA(HSD_GObj* gobj);
/* 13FF04 */ void ftPr_SpecialNChargeLoop_IASA(HSD_GObj* gobj);
/* 140064 */ void ftPr_SpecialNChargeFull_IASA(HSD_GObj* gobj);
/* 1401C4 */ void ftPr_SpecialNChargeRelease_IASA(HSD_GObj* gobj);
/* 140344 */ void ftPr_SpecialNStartTurn_IASA(HSD_GObj* gobj);
/* 140348 */ void ftPr_SpecialNEnd_IASA(HSD_GObj* gobj);
/* 14034C */ void ftPr_SpecialAirNChargeStart_IASA(HSD_GObj* gobj);
...
/* 140620 */ void ftPr_SpecialNChargeStart_Phys(HSD_GObj* gobj);
/* 140650 */ void ftPr_SpecialNChargeLoop_Phys(HSD_GObj* gobj);
/* 140680 */ void ftPr_SpecialNChargeFull_Phys(HSD_GObj* gobj);
/* 1406B0 */ void ftPr_SpecialNChargeRelease_Phys(HSD_GObj* gobj);
/* 1408B8 */ void ftPr_SpecialNStartTurn_Phys(HSD_GObj* gobj);
/* 140BAC */ void ftPr_SpecialNEnd_Phys(HSD_GObj* gobj);
/* 140BE8 */ void ftPr_SpecialAirNChargeStart_Phys(HSD_GObj* gobj);
...
/* 140FA4 */ void ftPr_SpecialNChargeStart_Coll(HSD_GObj* gobj);
/* 141054 */ void ftPr_SpecialNChargeLoop_Coll(HSD_GObj* gobj);
/* 141154 */ void ftPr_SpecialNChargeFull_Coll(HSD_GObj* gobj);
/* 141254 */ void ftPr_SpecialNChargeRelease_Coll(HSD_GObj* gobj);
/* 1415F4 */ void ftPr_SpecialNStartTurn_Coll(HSD_GObj* gobj);
/* 1416D0 */ void ftPr_SpecialNEnd_Coll(HSD_GObj* gobj);
/* 141730 */ void ftPr_SpecialAirNChargeStart_Coll(HSD_GObj* gobj);
