...
static inline void ftPurin_SpecialHi_StartAction_inline(HSD_GObj* fighter_gobj)
{
    Fighter* fp = getFighter(fighter_gobj);
...
void ftPurin_SpecialHi_StartAction(HSD_GObj* fighter_gobj)
{
    ...
    if (lbl_804D9C10 == fp->x2C_facing_direction)
        Fighter_ActionStateChange_800693AC(fighter_gobj, 365, 0, NULL, lbl_804D9C14, lbl_804D9C18, lbl_804D9C14);
    else
        Fighter_ActionStateChange_800693AC(fighter_gobj, 367, 0, NULL, lbl_804D9C14, lbl_804D9C18, lbl_804D9C14);
...
static void func_8013CD34(HSD_GObj* fighter_gobj);
