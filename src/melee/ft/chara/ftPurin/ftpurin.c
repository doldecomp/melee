...
static inline void ftPurin_SpecialHi_SetVars(HSD_GObj* fighter_gobj)
{
    Fighter* fp = getFighter(fighter_gobj);
...
static inline void ftPurin_SpecialHi_SetActionFromFacingDirection(HSD_GObj* fighter_gobj, u32 left_id, u32 right_id)
{
