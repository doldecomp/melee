...
/* 12B150 */ void ftSs_SpecialLwBombEnd_Anim(HSD_GObj* gobj);
/* 12B264 */ void ftSs_SpecialAirLwBomb_Anim(HSD_GObj* gobj);
/* 12B358 */ void ftSs_SpecialLwBombEnd_IASA(HSD_GObj* gobj);
/* 12B3A4 */ void ftSs_SpecialAirLwBomb_IASA(HSD_GObj* gobj);
/* 12B3A8 */ void ftSs_SpecialLwBombEnd_Phys(HSD_GObj* gobj);
/* 12B41C */ void ftSs_SpecialAirLwBomb_Phys(HSD_GObj* gobj);
/* 12B488 */ void ftSs_SpecialLwBombEnd_Coll(HSD_GObj* gobj);
