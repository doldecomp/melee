...
/* 111588 */ void ftSk_SpecialSLoop_Anim(HSD_GObj* gobj);
/* 111708 */ void ftSk_SpecialSLoop_IASA(HSD_GObj* gobj);
/* 111778 */ void ftSk_SpecialSLoop_Phys(HSD_GObj* gobj);
/* 1117B8 */ void ftSk_SpecialSLoop_Coll(HSD_GObj* gobj);
...
/* 12A51C */ void ftSs_SpecialAirSmash_Anim(HSD_GObj* gobj);
/* 12A558 */ void ftSs_SpecialSSmash_IASA(HSD_GObj* gobj);
/* 12A55C */ void ftSs_SpecialAirSmash_IASA(HSD_GObj* gobj);
/* 12A560 */ void ftSs_SpecialSSmash_Phys(HSD_GObj* gobj);
/* 12A580 */ void ftSs_SpecialAirSmash_Phys(HSD_GObj* gobj);
