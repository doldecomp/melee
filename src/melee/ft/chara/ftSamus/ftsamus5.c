...
void ftSs_SpecialHi_StartMotion(HSD_GObj* gobj)
{
...
void ftSs_SpecialAirHi_StartMotion(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);
...
void ftSs_Unk5_8012A81C(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);
...
void ftSs_Unk5_8012A8C4(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);
    ftSamusAttributes* samus_attr;
    ftSamusAttributes* samus_attr2;
...
void ftSs_Unk5_8012A96C(HSD_GObj* gobj)
{
    f32 mag;
    f32 lstick_x;
    Fighter* fp = GET_FIGHTER(gobj);
...
void ftSs_Unk5_8012AA3C(HSD_GObj* gobj)
{
    f32 mag;
    f32 lstick_x;
    Fighter* fp = GET_FIGHTER(gobj);
...
void ftSs_Unk5_8012AB0C(HSD_GObj* gobj)
{
...
void ftSs_Unk5_8012ABB4(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);
    ftSamusAttributes* samus_attr = fp->x2D4_specialAttributes;
...
void ftSs_Unk5_8012AC00(HSD_GObj* gobj)
{
    Fighter* fp = getFighter(gobj);
    ftSamusAttributes* samus_attr = fp->x2D4_specialAttributes;
...
void ftSs_Unk5_8012ACF8(HSD_GObj* gobj)
{
    Fighter* fp = GET_FIGHTER(gobj);
    ftSamusAttributes* samus_attr = fp->x2D4_specialAttributes;
