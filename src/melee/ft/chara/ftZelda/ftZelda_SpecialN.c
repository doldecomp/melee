...
void ftZelda_8013A830(HSD_GObj* fighter_gobj)
{
    ...
    if (!fp->x2219_flag.bits.b0) {
        efSync_Spawn(0x4F4, fighter_gobj, fp->x5E8_fighterBones[1].x0_jobj);
...
void ftZelda_8013A8AC(HSD_GObj* fighter_gobj)
{
    ...
    if (fp->x2219_flag.bits.b0 == 0) {
        efSync_Spawn(0x4F5, fighter_gobj, fp->x5E8_fighterBones[1].x0_jobj);
...
void ftZelda_SpecialN_StartMotion(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 0x155, 0, NULL, temp_f1, 1.0,
                              temp_f1);
...
void ftZelda_SpecialAirN_StartMotion(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 0x156, 0, NULL, 0, 1.0, 0);
    ftAnim_8006EBA4(fighter_gobj);
...
void ftZelda_8013AC88(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 0x156, 0x0C4C508E, NULL,
...
void ftZelda_8013AD1C(HSD_GObj* fighter_gobj)
{
    ...
    Fighter_ChangeMotionState(fighter_gobj, 0x155, 0x0C4C508E, NULL,
                              fp->x894_currentAnimFrame, 1.0, 0);
