...
void ftZelda_8013BDD0(HSD_GObj* fighterObj) {return;}
...
void ftZelda_8013BE50(HSD_GObj* fighterObj) {return;}
void ftZelda_8013BE54(HSD_GObj* fighterObj) {return;}
...
void ftZelda_8013BED4(HSD_GObj* fighterObj) {return;}
...
void ftZelda_8013BF10(HSD_GObj* fighterObj) {
    func_80084F3C(fighterObj);
}

// 8013BF30 - 8013BF50 (0x20 bytes)
void ftZelda_8013BF30(HSD_GObj* fighterObj) {
    func_80084F3C(fighterObj);
}
