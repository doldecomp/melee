...
typedef struct _Fighter {
    ...
    struct attr
    {
        /* 0x110 */ float x110_walk_initial_velocity;
        /* 0x114 */ float x114_walk_acceleration;
        /* 0x118 */ float x118_walk_maximum_velocity;
        /* 0x11C */ float x11C_slow_walk_max;
        /* 0x120 */ float x120_mid_walk_point;
        /* 0x124 */ float x124_fast_walk_min;
        /* 0x128 */ float x128_x128_ground_friction;
        /* 0x12C */ float x12C_dash_initial_velocity;
        /* 0x130 */ float x130_dashrun_acceleration_a;
        /* 0x134 */ float x134_dashrun_acceleration_b;
        /* 0x138 */ float x138_dashrun_terminal_velocity;
        /* 0x13C */ float x13C_run_animation_scaling;
        /* 0x140 */ float x140_max_runbrake_frames;
        /* 0x144 */ float x144_grounded_max_horizontal_velocity;
        /* 0x148 */ float x148_jump_startup_time;
        /* 0x14C */ float x14C_jump_h_initial_velocity;
        /* 0x150 */ float x150_jump_v_initial_velocity;
        /* 0x154 */ float x154_ground_to_air_jump_momentum_multiplier;
        /* 0x158 */ float x158_jump_h_max_velocity;
        /* 0x15C */ float x15C_hop_v_initial_velocity;
        /* 0x160 */ float x160_air_jump_v_multiplier;
        /* 0x164 */ float x164_air_jump_h_multiplier;
        /* 0x168 */ int x168_max_jumps;
        /* 0x16C */ float x16C_gravity;
        /* 0x170 */ float x170_terminal_velocity;
        /* 0x174 */ float x174_aerialDriftStickMult;
        /* 0x178 */ float x178_aerialDriftBase;
        /* 0x17C */ float x17C_aerialDriftMax;
        /* 0x180 */ float x180_aerialFriction;
        /* 0x184 */ float x184_fastfall_velocity;
        /* 0x188 */ float x188_horizontal_air_mobility_constant;
        ...
        /* 0x198 */ float x198_weight;
        /* 0x19C */ float x19C_model_scaling;
        /* 0x1A0 */ float x1A0_initial_shield_size;
        /* 0x1A4 */ float x1A4_shield_break_initial_velocity;
        /* 0x1A8 */ int x1A8_rapid_jab_window;
        /* 0x1AC */ int x1AC_unknown1AC;
        /* 0x1B0 */ int x1B0_unknown1B0;
        /* 0x1B4 */ int x1B4_unknown1B4;
        /* 0x1B8 */ float x1B8_ledge_jump_horizontal_velocity;
        /* 0x1BC */ float x1BC_ledge_jump_vertical_velocity;
        /* 0x1C0 */ float x1C0_item_throw_velocity_multiplier;
        ...
        /* 0x1F0 */ float x1F0_kirby_b_star_damage;
        /* 0x1F4 */ float x1F4_normal_landing_lag;
        /* 0x1F8 */ float x1F8_n_air_landing_lag;
        /* 0x1FC */ float x1FC_f_air_landing_lag;
        /* 0x200 */ float x200_b_air_landing_lag;
        /* 0x204 */ float x204_u_air_landing_lag;
        /* 0x208 */ float x208_d_air_landing_lag;
        /* 0x20C */ float x20C_nametag_height;
        /* 0x210 */ int x210_unknown210;
        /* 0x214 */ float x214_wall_jump_horizontal_velocity;
        /* 0x218 */ float x218_wall_jump_vertical_velocity;
        /* 0x21C */ int x21C_unknown21C;
        /* 0x220 */ float x220_trophy_scale;
