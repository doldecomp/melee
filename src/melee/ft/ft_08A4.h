...
void ftCo_CaptureKirby_Anim(ftCo_GObj* gobj);
void ftCo_CaptureKirby_Coll(ftCo_GObj* gobj);
void ftCo_CaptureKirby_IASA(ftCo_GObj* gobj);
void ftCo_CaptureKirby_Phys(ftCo_GObj* gobj);
