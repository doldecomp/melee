...
void ftAction_80072320(Fighter_GObj* gobj, CommandInfo* cmd)
{
    ...
    case 1:
        ...
        fp->x214C = lbAudioAx_800264E4(
            lbAudioAx_800263E8(direction, gobj, behavior, sfx, 127, 127,
                               temp_r8, temp_r9, temp_r10, sp8 + 0x36, -1));
        break;
    ...
    case 2:
        if (!fp->x2225_b6) {
            ...
            fp->x2144 = lbAudioAx_800264E4(
                lbAudioAx_800263E8(direction, gobj, behavior, sfx, 127, 127,
                                   temp_r8, temp_r9, temp_r10, sp8 + 0x1E,
                                   -1));
            break;
        }
        switch (fp->kind) {
    ...
    case 3:
        ...
        fp->x2150 = lbAudioAx_800264E4(
            lbAudioAx_800263E8(direction, gobj, behavior, sfx, 127, 127,
                               temp_r8, temp_r9, temp_r10, sp8 + 0x42, -1));
        break;
    ...
    case 4:
        ...
        fp->x2154 = lbAudioAx_800264E4(
            lbAudioAx_800263E8(direction, gobj, behavior, sfx, 127, 127,
                               temp_r8, temp_r9, temp_r10, sp8 + 0x4E, -1));
        break;
    ...
    case 5:
        ...
        fp->x2158 = lbAudioAx_800264E4(
            lbAudioAx_800263E8(direction, gobj, behavior, sfx, 127, 127,
                               temp_r8, temp_r9, temp_r10, sp8 + 0x5A, -1));
        break;
    ...
    case 6:
        if (!fp->x2225_b6) {
            ...
            fp->x2148 = lbAudioAx_800264E4(
                lbAudioAx_800263E8(direction, gobj, behavior, sfx, 127, 127,
                                   temp_r8, temp_r9, temp_r10, sp8 + 0x2A,
                                   -1));
            break;
        }
