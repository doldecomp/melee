                     ...
                     HurtCapsuleState state)
{
    ...
    OSReport("fighter parts num over!\n");
    HSD_ASSERT(2184, 0);
}
...
void ftColl_8007B5AC(Fighter* fp, FighterHurtCapsule* hurt, struct UNK_SAMUS_S2* arg2)
{
    hurt->capsule.bone_idx = arg2->parts[0];
    ...
    hurt->capsule.a_offset = arg2->vec1;
    hurt->capsule.b_offset = arg2->vec2;
    hurt->capsule.scale = arg2->scale;
    fp->x221A_b6 = true;
}
