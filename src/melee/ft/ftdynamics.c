...
void ftCo_8009CB40(Fighter* fp, ssize_t bone_idx, bool arg2, FigaTree* arg3)
{
    ...
    if (dyn->dynamicsNum != 0) {
        ...
        { s32 tmp_r21 = 1 - var_r22; temp_r21 = tmp_r21; }
        while (var_r28 != NULL) {
            if (var_r29 < (s32) arg3) {
                if (temp_r21 != 0 && !(fp->parts[bone_id].flags_b0)) {
                    ...
                    { HSD_JObj* tmp_jobj = var_r28->desc.lb_unk0.jobj; temp_jobj = tmp_jobj; }
                ...
                fp->parts[bone_id].flags_b0 = temp_r21;
            } else {
                if (var_r22 != 0 && !(fp->parts[bone_id].flags_b0)) {
                    var_r28->desc.lb_unk0.unk_2C.x =
                        var_r28->desc.lb_unk0.jobj->mtx[0][3];
                    var_r28->desc.lb_unk0.unk_2C.y =
                        var_r28->desc.lb_unk0.jobj->mtx[1][3];
                ...
                fp->parts[bone_id].flags_b0 = var_r22;
            }
