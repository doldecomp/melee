...
bool ftCo_80094EA4(HSD_GObj* gobj)
{
    ...
    if (fp->item_gobj != NULL) {
        if (fp->input.pressed_buttons & (HSD_PAD_A | HSD_PAD_B)) {
            ...
            var_f28 = fp->active_sticky.lstick_x;
            var_f31 = fp->active_sticky.lstick_y;
...
bool ftCo_80095328(Fighter_GObj* gobj, bool* arg1)
{
    ...
    if (fp->item_gobj != NULL && ftCo_800DF50C(fp)) {
        ...
        var_f30 = fp->active_sticky.lstick_x;
        var_f29 = fp->active_sticky.lstick_y;
            ...
            p_ftCommonData->dash_smash_window + p_ftCommonData->x44)
    {
                ...
                p_ftCommonData->xD0 + fp->co_attrs.jump_startup_time)
        {
            ...
            if (fp->input.lstick[0].y <= p_ftCommonData->xD4 &&
                fp->active_sticky.lstick_y < p_ftCommonData->xD8)
            {
                var_r29 = 0x6F;
            } else {
