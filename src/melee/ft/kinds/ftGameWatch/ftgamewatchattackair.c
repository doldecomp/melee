...
/// 0x8014B074
/// Parachute Accessory Callback - Landing
/// Lag
...
/// 0x8014B0F0
/// Parachute item flag update on land +
/// clear pointers
...
/// 0x8014B268
/// Turtle Accessory Callback - Landing Lag
...
/// 0x8014B2E4
/// Turtle item flag update on land + clear
/// pointers
...
/// 0x8014B45C
/// Sparky Accessory Callback - Landing Lag
...
/// 0x8014B4D8
/// Sparky item flag update on land + clear
/// pointers
...
/// 0x8014B574
/// Apply hitlag for available AttackAir
/// items
...
/// 0x8014B64C
/// Decide Mr. Game & Watch's Aerial Attack
/// Motion State
...
/// 0x8014B6E4
/// Mr. Game & Watch's Neutral Aerial Action
/// State handler
...
/// 0x8014B720
/// Mr. Game & Watch's Neutral Aerial
/// Animation callback
...
/// 0x8014B740
/// Mr. Game & Watch's Neutral Aerial IASA
/// callback
...
/// 0x8014B840
/// Mr. Game & Watch's Back Aerial Action
/// State handler
...
/// 0x8014B87C
/// Mr. Game & Watch's Back Aerial Animation
/// callback
...
/// 0x8014B89C
/// Mr. Game & Watch's Back Aerial IASA
/// callback
...
/// 0x8014B8BC
/// Mr. Game & Watch's Back Aerial Physics
/// callback
...
/// 0x8014B8DC
/// Mr. Game & Watch's Back Aerial Collision
/// callback
...
/// 0x8014BBE0
/// Mr. Game & Watch's Back Aerial Landing
/// prefunction
...
/// 0x8014BCF4
/// Mr. Game & Watch's Up Aerial Landing
/// Animation callback
