...
void ftMt_SpecialLw_Enter(HSD_GObj* gobj)
{
    ...
    Fighter_ChangeMotionState(gobj, ftMt_MS_SpecialLw, Ft_MF_None, 0.0f, 1.0f, 0.0f,
                              NULL);
...
void ftMt_SpecialAirLw_Enter(HSD_GObj* gobj)
{
    ...
    Fighter_ChangeMotionState(gobj, ftMt_MS_SpecialAirLw, Ft_MF_None, 0.0f, 1.0f, 0.0f,
                              NULL);
    ftAnim_8006EBA4(gobj);
