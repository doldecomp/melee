...
struct Fighter {
    ...
    /* fp+2CC */ void* x2CC;
    /* fp+2D0 */ void* x2D0;
    /* fp+2D4 */ void* x2D4_specialAttributes;
    ...
    /* fp+6D8 */ Vec3 x6D8;
    /* fp+6E4 */ Vec3 x6E4;
    /* fp+6F0 */ CollData x6F0_collData;
    /* fp+890 */ CameraBox* x890_cameraBox;
    /* fp+894 */ f32 x894_currentAnimFrame;
    /* fp+898 */ f32 x898_unk;
    ...
    /* fp+2200 */ u32 x2200_ftcmd_var0;
    /* fp+2204 */ u32 x2204_ftcmd_var1;
    /* fp+2208 */ u32 x2208_ftcmd_var2;
