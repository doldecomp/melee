...
STATIC_ASSERT(sizeof(struct Fighter_x1A88_t) == 0x570);
...
struct Fighter {
    ...
    /* fp+1A88 */ union {
        struct Fighter_x1A88_t x1A88_t;
        struct {
            ...
            /* fp+1AD0 */ UNK_T x1AD0;
            /* fp+1AD4 */ Fighter* x1AD4;
            /* fp+1AD8 */ UNK_T x1AD8;
            /* fp+1ADC */ float x1ADC;
            /* fp+1AE0 */ UNK_T x1AE0;
            /* fp+1AE4 */ UNK_T x1AE4;
            /* fp+1AE8 */ int x1AE8;
            /* fp+1AEC */ u8 x1AEC[0x1B04 - 0x1AEC];
            /* fp+1B04 */ int x1B04;
            /* fp+1B08 */ u8 x1B08[0x1B82 - 0x1B08];
            ...
            /* fp+1FDC */ uint x1FDC;
            /* fp+1FE0 */ u8 x1FE0[0x1FF8 - 0x1FE0];
        };
    };
    /* fp+1FF8 */ int x1FF8;
    /* fp+1FFC */ int x1FFC;
