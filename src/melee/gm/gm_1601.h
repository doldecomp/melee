...
/* 162968 */ UNK_RET gm_80162968(u32 seconds);
...
/* 162BFC */ UNK_RET fn_80162BFC(s8, int);
...
/* 162DF8 */ UNK_RET fn_80162DF8(s8, int);
...
/* 162FF4 */ UNK_RET fn_80162FF4(s8, int);
...
/* 168B34 */ float gm_80168B34(int, int, int);
