...
/* 3B75F8 */ static const struct gmMainLib_8015ED8C_arg0_t lbl_803B75F8 = {
    0
};
...
/* 3B78C8 */ static struct lbl_803B78C8_0x6
    lbl_803B78C8[NUM_UNLOCKABLE_CHARACTERS] = {
        { 0, 3, { 4, 0, 1, 0x16 } },      { 1, 7, { 2, 0, 1, 0x14 } },
        { 2, 9, { 3, 0, 1, 0x15 } },      { 3, 0xA, { 1, 0, 1, 0x13 } },
        { 4, 0xF, { 0, 0, 1, 0x12 } },    { 5, 0x13, { 8, 0, 1, 0x1A } },
        { 6, 0x14, { 7, 0, 1, 0x19 } },   { 7, 0x15, { 5, 0, 1, 0x17 } },
        { 8, 0x16, { 0xA, 0, 1, 0x1C } }, { 9, 0x17, { 9, 0, 1, 0x1B } },
        { 0xA, 0x18, { 6, 0, 1, 0x18 } },
    };
