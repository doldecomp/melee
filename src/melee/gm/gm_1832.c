...
void fn_80184AB8(HSD_GObj* arg0)
{
    ...
    if ((s32) lbl_8047368C.model_scale_kind != 3) {
        ...
        case 0x2D:
            break;
        case 0x46:
            if ((s32) lbl_8047368C.model_scale_kind == 4 || (s32) lbl_8047368C.model_scale_kind == 1) {
...
void fn_8018504C(void)
{
    ...
    if (((u16) lbl_804735A8.x38 == 0x2D) && ((s32) lbl_8047368C.model_scale_kind == 3)) {
...
void fn_80186634(void* arg0)
{
    ...
    lbl_804D65F4 = lbArchive_80016DBC(names[lbl_8047368C.game_type], &lbl_804D65FC,
...
static inline void fn_80187AB4_LoadAnim(HSD_JObj* jobj)
{
    DynamicModelDesc* desc =
        (*lbl_804736C0.x0)[11 - lbl_804736C0.x36.stage_index];
    int anim_state;
