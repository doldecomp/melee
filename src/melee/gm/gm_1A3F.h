...
/* 1A42B4 */ u8 gm_GetPreviousSceneIndex(void); ///< get previous scene
/* 1A42C4 */ u8 gm_GetCurrentSceneIndex(void);  ///< get current scene
...
/* 1A4310 */ u8 gm_GetCurrentGameMode(void);  ///< get current mode
/* 1A4320 */ u8 gm_GetPreviousGameMode(void); ///< get previous mode
