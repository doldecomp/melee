...
void gm_801AD088(void)
{
    ...
    gm_80480D70.x0 = lbArchive_80016DBC("NtProge.dat", &spC, "ScNtcProgressive_scene_data", 0);
    ...
    gm_80480D70.x8 = HSD_SisLib_803A5ACC(0, gm_80480D70.xC, 0.0F, 0.0F, 0.0F, 640.0F, 480.0F);
    text = gm_80480D70.x8;
    text->x24.x = 1.0F;
    text->x24.y = 1.0F;
...
void gm_801AD620_OnFrame(void)
{
    ...
    if (gm_80480D70.x10 == 3) {
        ...
        if ((gm_801A36A0(4) & 0x4000000000) && gm_80480D70.x10 == 2 && gm_80480D70.x14 == 0) {
            lbAudioAx_80024030(2);
            gm_80480D70.x10 = 1;
            gm_801AD254(gm_80480D70.x10);
        }
        if ((gm_801A36A0(4) & 0x8000000000) && gm_80480D70.x10 == 1 && gm_80480D70.x14 == 0) {
            lbAudioAx_80024030(2);
            gm_80480D70.x10 = 2;
            gm_801AD254(gm_80480D70.x10);
        }
...
void fn_801AD920(HSD_GObj* gobj)
{
    HSD_JObj* jobj = GET_JOBJ(gobj);
    HSD_JObj* var_r3 = jobj == NULL ? NULL : jobj->child;
...
void gm_801ADB04(void)
{
    ...
    gm_80480D98.x0 = lbArchive_80016DBC("NtAppro", &spC, "ScNtcApproach_scene_data", 0);
    gobj = GObj_Create(0x13, 0x14, 0);
    cobj = HSD_CObjLoadDesc(spC->cameras[0].desc);
    HSD_GObjObject_80390A70(gobj, HSD_GObj_804D784B, cobj);
    GObj_SetupGXLinkMax(gobj, HSD_GObj_803910D8, 0);
...
{
    if (gm_80480D98.xC++ >= 0xB4 && (HSD_PadCopyStatus[gm_80480D98.xE].trigger & 0x1100)) {
        gm_801A4B60();
    }
}
...
void gm_801ADCE4_OnEnter(void* arg0_)
{
    ...
    gm_801ADB04();
    var_r0 = arg0[0];
    if (var_r0 != 3 && var_r0 != 7 && var_r0 != 9 &&
        var_r0 != 0xA && var_r0 != 0xF && var_r0 != 0x14 &&
        var_r0 != 0x15 && var_r0 != 0x16 && var_r0 != 0x17 &&
        var_r0 != 0x18 && var_r0 != 0x19) {
        var_r0 = 0x19;
    }
...
void gm_801ADDA8_OnLeave(UNK_T unused)
{
        ...
        if (var_r31->unkC == arg0) {
            ...
            if (var_r4 == NULL) {
                ...
                if (temp_r3->unk20 != NULL) {
                    HSD_JObjSetTranslateX(GET_JOBJ(temp_r3->unk20), temp_r3->unk10);
                }
                temp_r3_3 = temp_r3->unk20;
                if (temp_r3_3 != NULL) {
                    HSD_JObjSetTranslateY(GET_JOBJ(temp_r3_3), temp_r3->unk14);
                }
                temp_r3->unk24 = HSD_SisLib_803A5ACC(3, gm_804D686C,
                        2.2F * temp_r3->unk10 - 1.0F,
            ...
            for (; true; var_r4 = var_r4->next) {
                ...
                if (temp_r3->unk20 != NULL) {
                    HSD_JObjSetTranslateY(GET_JOBJ(temp_r3->unk20), temp_r3->unk14);
                }
                temp_r3->unk24 = HSD_SisLib_803A5ACC(3, gm_804D686C,
                        2.2F * temp_r3->unk10 - 1.0F,
                        2.232143F * -temp_r3->unk14 - 1.3F, 0.0F, 2.0F, 2.0F);
...
void fn_801AE948(HSD_GObj* arg0)
{
    ...
    while (var_r31 != NULL) {
        ...
        while (var_r30 != NULL) {
            if (var_r30->unk20 != NULL) {
                HSD_JObjSetTranslateX(GET_JOBJ(var_r30->unk20), var_r30->unk10);
                HSD_JObjSetTranslateY(GET_JOBJ(var_r30->unk20), var_r30->unk14);
            }
            var_r30 = var_r30->next;
        }
        var_r31 = var_r31->next;
...
HSD_GObj* gm_801AECC4(int model_idx)
{
    ...
    HSD_JObjAnimAll(jobj);
    if (model_idx == 1) {
        HSD_JObjSetFlagsAll(jobj->child->child->next->child->next, JOBJ_HIDDEN);
