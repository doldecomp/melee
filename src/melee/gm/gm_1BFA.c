...
void gm_801BFBA8(MinorScene* arg0)
{
    ...
    if ((temp_r0 != 7) && (temp_r0 != 8) && ((s8) mei->match_end.player_standings[0].stocks != 0)) {
...
void gm_801BFCFC(MinorScene* arg0)
{
    ...
    /// @remarks these for loops were converted from the do-whiles with very little scrutiny... take them with a grain of salt
    var_r28 = gm_8049E558;
    for (var_r25 = 0; (s32)var_r25 < 0x42; var_r25++) {
        if (gm_8017219C(var_r25) != 0) {
            temp_r3 = gm_801BFC60((s16) var_r25, var_r30, 0, *gmMainLib_8015D804((s32) var_r25), (void*)var_r31);
            *var_r28 = 1;
            var_r31 = temp_r3;
            var_r30 += 1;
        }
    ...
    for (var_r25_2 = 0; (s32)var_r25_2 < 0x125; var_r25_2++) {
        if (gmMainLib_8015DA1C(var_r25_2) != 0) {
            ...
            *var_r28_2 = un_803048C0((s32) var_r25_2);
            var_r31 = gm_801BFC60(0x3E, var_r30, (s16) var_r25_2, *gmMainLib_8015D970((s32) var_r25_2), (void*)var_r31);
            var_r30 += 1;
        }
        var_r28_2 += 1;
    }
    ...
    for (var_r28_3 = 0; (s32)var_r28_3 < 0x42; var_r28_3++) {
        if (((u8) *var_r27 == 0) && (gm_8017219C(var_r28_3) != 0)) {
            var_r31 = gm_801BFC60((s16) var_r28_3, var_r30, 0, *gmMainLib_8015D804((s32) var_r28_3), (void*)var_r31);
            var_r30 += 1;
        }
        var_r27 += 1;
    }
    ...
    for (var_r27_2 = 0; var_r27_2 < 0x125; var_r27_2++) {
        if ((((s32) *var_r26 < un_803048C0(var_r27_2)) || (un_803048C0(var_r27_2) == 0)) && (gmMainLib_8015DA1C((u32) var_r27_2) != 0)) {
            ...
            var_r31 = gm_801BFC60(0x3E, var_r30, (s16) var_r27_2, *gmMainLib_8015D970(var_r27_2), (void*)var_r31);
            var_r30 += 1;
        }
        var_r26 += 1;
    }
