...
void gm_801B254C(GameModeState* state)
{
    ...
    temp_r31 = &gmMainLib_804D3EE0->modes.table[VSMODE_CAMERA];
...
void gm_801B26AC(GameModeState* state)
{
    SSSData* sss;
    VsModeData* vs;
    vs = &gmMainLib_804D3EE0->modes.table[VSMODE_CAMERA];
...
{
    VsModeData* vs = &gmMainLib_804D3EE0->modes.table[VSMODE_CAMERA];
...
{
    gm_InitVsMode(&gmMainLib_804D3EE0->modes.table[VSMODE_CAMERA]);
}
