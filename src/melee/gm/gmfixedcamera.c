...
{
    gmVsMelee_ExitSss(
        scene, &gmMainLib_804D3EE0->modes.table[GmVsMode_FixedCamera], 0);
}
...
{
    VsModeData* data = &gmMainLib_804D3EE0->modes.table[GmVsMode_FixedCamera];
...
{
    gm_InitVsMode(&gmMainLib_804D3EE0->modes.table[GmVsMode_FixedCamera]);
}
