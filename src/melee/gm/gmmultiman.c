...
{
    gm_InitVsMode(&gmMainLib_804D3EE0->modes.table[VSMODE_MULTIMAN]);
}
...
bool gm_801B688C(bool arg0)
{
    ...
    temp_r29 = &gmMainLib_804D3EE0->modes.table[VSMODE_MULTIMAN];
    lbCardNew_AllocWorkArea();
    lbCardGame_LoadArchive(0);
    lbCardGame_SaveChanges();
...
static void gm_801B6AD8_inline(GameModeState* scene, int x)
{
    ...
    temp_r31 = &gmMainLib_804D3EE0->modes.table[VSMODE_MULTIMAN];
...
void gm_801B6B70(GameModeState* scene)
{
    ...
    data = &gmMainLib_804D3EE0->modes.table[VSMODE_MULTIMAN];
...
{
    return &gmMainLib_804D3EE0->modes.table[VSMODE_MULTIMAN];
}
...
void gm_801B7AA0(GameModeState* scene)
{
    ...
    temp_r30 = &gmMainLib_804D3EE0->modes.table[VSMODE_MULTIMAN];
    temp_r3 = gm_GetGameModeStateExitData(scene);
    if (temp_r3->match_end.outcome == OUTCOME_RETRY) {
        gm_SetNextGameModeStateId(1);
        return;
...
{
    VsModeData* temp_r30 = &gmMainLib_804D3EE0->modes.table[VSMODE_MULTIMAN];
...
{
    VsModeData* temp_r29 = &gmMainLib_804D3EE0->modes.table[VSMODE_MULTIMAN];
    StartMeleeData* temp_r3 = gm_GetGameModeStateEnterData(scene);
    s32* temp_r28;
    int i;
