    ...
    if (list->mode == 2 || entry->check != NULL) {
        if (list->mode != 2) {
            ...
            found2:
                ...
                if (stat_value < 0) {
                    value_id =
                        HSD_SisLib_803A6B98(text3, const_zero, const_neg30,
                                            "%s%d", lbl_804D3FA0, -stat_value);
                } else {
