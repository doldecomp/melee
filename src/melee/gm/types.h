...
struct lbl_8046B6A0_t {
    /* 0x0000 */ u8 unk_0;  ///< 0 During a match
                            ///< 1 While GAME! or "TIMEOUT!" is displayed/match is frozen on final frame
                            ///< 2 While in 1p and scores are shown calculating
                            ///< 3 When match is finished.
                            ///< Stays 0 when LRA+Start ends a match
    /* 0x0001 */ s8 pauser;
