...
static StageCallbacks grBb_803E29E0[] = {
...
{
    HSD_GObj* gobj;
    StageCallbacks* cb = &grBb_803E29E0[id];
...
void grBigBlue_801E6298(Ground_GObj* arg0)
{
    ...
    Ground_801C4E70(Ground_801C3FA4(arg0, 5), temp_r31, temp_r30,
                    temp_r29, temp_r28, temp_r27);
    gp->x11_flags.b012 = 2;
}
