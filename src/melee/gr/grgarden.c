...
StageCallbacks grGd_803E5248[] = {
    { grGarden_80202D60, grGarden_80202D8C,
      grGarden_80202D94, grGarden_80202D98, 0 },
    { grGarden_80203004, grGarden_80203090,
      grGarden_80203098, grGarden_802031A0, 0 }, //cranky kong
    { grGarden_80202DC8, grGarden_80202E40,
      grGarden_80202E48, grGarden_80202E68, 0xC0000000 }, //main stage
    { grGarden_802031A4, grGarden_80203248,
      grGarden_80203250, grGarden_80203494, 0 }, //klaptrap
    { grGarden_80202E6C, grGarden_80202F34,
      grGarden_80202F3C, grGarden_80202F40, 0 }, //background
    { grGarden_80202F44, grGarden_80202F94,
      grGarden_80202F9C, grGarden_80202FA0, 0 }, //birds
    { grGarden_80202FA4, grGarden_80202FF4,
      grGarden_80202FFC, grGarden_80203000, 0 }  //water
};
...
void grGarden_80203098(Ground_GObj* gobj) {
    int iVar1;
    Ground* gp = GET_GROUND(gobj);
    if ((grAnime_801C83D0(gobj,0,7) != NULL) || (grAnime_801C84A4(gobj,0,7) != NULL)) {
...
void grGarden_802031A4(Ground_GObj* gobj) {
    int iVar1;
    Ground* gp = GET_GROUND(gobj);
    gp->gv.garden2.xc4 = grMaterial_801C8CFC(0,0,gp,Ground_801C3FA4(gobj,8),fn_80203498,0,0);
