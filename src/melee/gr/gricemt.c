...
S16Vec3 grIm_803E40B0[] = { { 0, 0, 0 }, { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 0 }, { 2, 0, 0 } };
...
void grIceMt_801F686C(void)
{
	...
	if (iVar3 == 76) { //adventure mode
		//foreach (uVar4 = 0; (uVar4 < 7) && (grIm_804D69F4->xAC == grIm_803E4068[uVar4]); uVar4++) {
...
void grIceMt_801F8A34(HSD_GObj* arg0) {
	...
	grAnime_801C8138(arg0,gp->map_id,0);
	grAnime_801C77FC(arg0,0,7);
	Ground_801C4E70(Ground_801C3FA4(arg0,1),Ground_801C3FA4(arg0,2),Ground_801C3FA4(arg0,3),Ground_801C3FA4(arg0,4),Ground_801C3FA4(arg0,5),Ground_801C3FA4(arg0,6));
...
int fn_801FA4CC(int num) { //https://decomp.me/scratch/pSJNA
    if (num == 1) {
        Ground_801C5740(num);
        num = 1;
    } else {
...
void grIceMt_801FA6D8(HSD_GObj* param1) {
	if ((Stage_80225194() == 76) && (Ground_801C2BA4(10)) && GET_GROUND(param1)) {
		Ground* gp = GET_GROUND(param1);
		//if (param1->user_data) {
...
void grIceMt_801FA7F0(Ground* gp, UNK_T arg1, UNK_T arg2, UNK_T arg3,
	...
	if ((Ground_801C2BA4(10)) && (playerGObj->user_data)) {// && playerGObj->userdata) {
