...
void grPura_80212024(HSD_GObj* arg0) {
	...
	Camera_SetBackgroundColor(grPu_803E6AA0[gp->gv.pura.xC4].r,grPu_803E6AA0[gp->gv.pura.xC4].g,grPu_803E6AA0[gp->gv.pura.xC4].b);
	gp->gv.pura.xC8 = 0;
}
...
void grPura_8021231C(HSD_GObj* arg0) {
	...
	if ((HSD_JObjGetFlags(gp->gv.pura2.xC8) & 0x10) && ((HSD_JObjGetFlags(jobj) & 0x10) == NULL)) {
		HSD_JObjSetFlagsAll(jobj,0x10);
	} else if (((HSD_JObjGetFlags(gp->gv.pura2.xC8) & 0x10) == NULL) && (HSD_JObjGetFlags(jobj) & 0x10)) {
...
void grPura_802125F0(HSD_GObj* arg0) {
	...
	do {
	    ...
	    HSD_JObjSetTranslateX(arg0->hsd_obj,HSD_JObjGetTranslationX(gp->gv.pura.xC8));
	    HSD_JObjSetTranslateY(arg0->hsd_obj,HSD_JObjGetTranslationY(gp->gv.pura.xC8));
	    HSD_JObjSetTranslateZ(arg0->hsd_obj,HSD_JObjGetTranslationZ(gp->gv.pura.xC8));
	    ...
	    HSD_JObjSetTranslateX(arg0->hsd_obj,HSD_JObjGetTranslationX(jobj->child));
	    HSD_JObjSetTranslateY(arg0->hsd_obj,HSD_JObjGetTranslationY(jobj->child));
	    HSD_JObjSetTranslateZ(arg0->hsd_obj,HSD_JObjGetTranslationZ(jobj->child));
        
	    HSD_JObjSetTranslateX(arg0->hsd_obj,HSD_JObjGetTranslationX(Ground_801C3FA4(arg0,uVar3)));
	    HSD_JObjSetTranslateY(arg0->hsd_obj,HSD_JObjGetTranslationY(Ground_801C3FA4(arg0,uVar3)));
	    HSD_JObjSetTranslateZ(arg0->hsd_obj,HSD_JObjGetTranslationZ(Ground_801C3FA4(arg0,uVar3)));
	    uVar6++;
	} while (uVar6 < 27);
}
