...
static bool lbl_80221800(HSD_GObj*);
static void lbl_80221808(HSD_GObj*);
static void lbl_8022180C(HSD_GObj*);
static void lbl_80221810(HSD_GObj* gobj);
static bool lbl_80221860(HSD_GObj*);
static void lbl_80221868(HSD_GObj* gobj);
static void lbl_8022189C(HSD_GObj*);
static void lbl_802218A0(HSD_GObj* gobj);
static bool lbl_802218F0(HSD_GObj*);
static void lbl_802218F8(HSD_GObj*);
static void lbl_80221918(HSD_GObj*);
static bool lbl_8022191C(int);
static bool lbl_80221924(Vec3*, int, struct _HSD_JObj*);
