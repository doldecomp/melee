    ...
    PAD_STACK(4);
    {
...

        {
            ...
            if (a != NULL) {
                ...
                if ((gp->gv.venom.xE4 < grVe_804DB768 &&
                     grVe_804DB768 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB76C &&
                     grVe_804DB76C <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB770 &&
                     grVe_804DB770 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB774 &&
                     grVe_804DB774 <= frame))
                {
                    Ground_801C53EC(0x6B6C5);
                }
                if ((gp->gv.venom.xE4 < grVe_804DB778 &&
                     grVe_804DB778 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB77C &&
                     grVe_804DB77C <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB780 &&
                     grVe_804DB780 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB784 &&
                     grVe_804DB784 <= frame))
                {
                    Ground_801C53EC(0x6B6C6);
                }
                if ((gp->gv.venom.xE4 < grVe_804DB788 &&
                     grVe_804DB788 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB78C &&
                     grVe_804DB78C <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB790 &&
                     grVe_804DB790 <= frame))
                {
                ...
                if ((gp->gv.venom.xE4 < grVe_804DB788 &&
                     grVe_804DB788 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB794 &&
                     grVe_804DB794 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB798 &&
                     grVe_804DB798 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB79C &&
                     grVe_804DB79C <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB7A0 &&
                     grVe_804DB7A0 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB78C &&
                     grVe_804DB78C <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB7A4 &&
                     grVe_804DB7A4 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB790 &&
                     grVe_804DB790 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB7A8 &&
                     grVe_804DB7A8 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB7AC &&
                     grVe_804DB7AC <= frame))
                {
                    Ground_801C53EC(0x6B6C7);
                }
                if ((gp->gv.venom.xE4 < grVe_804DB7B0 &&
                     grVe_804DB7B0 <= frame) ||
                    (gp->gv.venom.xE4 < grVe_804DB7B4 &&
                     grVe_804DB7B4 <= frame) ||
...
void grVenom_80205758(Ground_GObj* gobj)
{
    ...
    if (data->x20[gp->gv.venom.xC8] != NULL) {
        ...
        if (angle < grVe_804DB7E8) {
            ...
            if (ABS(gp->gv.venom.xDC) < grVe_804DB744) {
