...
struct StageSelection selected_stage = { StKind_IZUMI, NULL };
StageIdPair default_stage_pair = { IZUMI, StKind_IZUMI };
...
struct StageIdMapEntry stage_id_map[] = {
    { GrKind_Unk00, 0, 0 }, { TEST, 0, 0 },         { IZUMI, 0, 0 },
    { PSTADIUM, 0, 0 },     { CASTLE, 0, 0 },       { KONGO, 0, 0 },
    { ZEBES, 0, 0 },        { CORNERIA, 0, 0 },     { STORY, 0, 0 },
    { ONETT, 0, 0 },        { MUTECITY, 0, 0 },     { RCRUISE, 0, 0 },
    { GARDEN, 0, 0 },       { GREATBAY, 0, 0 },     { SHRINE, 0, 0 },
    { KRAID, 0, 0 },        { YORSTER, 0, 0 },      { GREENS, 0, 0 },
    { FOURSIDE, 0, 0 },     { INISHIE1, 0, 0 },     { INISHIE2, 0, 0 },
    { GrKind_Unk26, 0, 0 }, { VENOM, 0, 0 },        { PURA, 0, 0 },
    { BIGBLUE, 0, 0 },      { ICEMTN, 0, 0 },       { ICEMTN, 0, 0 },
    { FLATZONE, 0, 0 },     { OLDPUPUPU, 0, 0 },    { OLDYOSHI, 0, 0 },
    { OLDKONGO, 0, 0 },     { BATTLE, 0, 0 },       { LAST, 0, 0 },
    { TMARIO, 0, 0 },       { TCAPTAIN, 0, 0 },     { TCLINK, 0, 0 },
    { TDONKEY, 0, 0 },      { TDRMARIO, 0, 0 },     { TFALCO, 0, 0 },
    { TFOX, 0, 0 },         { TICECLIMBER, 0, 0 },  { TKIRBY, 0, 0 },
    { TKOOPA, 0, 0 },       { TLINK, 0, 0 },        { TLUIGI, 0, 0 },
    { TMARS, 0, 0 },        { TMEWTWO, 0, 0 },      { TNESS, 0, 0 },
    { TPEACH, 0, 0 },       { TPICHU, 0, 0 },       { TPIKACHU, 0, 0 },
    { TPURIN, 0, 0 },       { TSAMUS, 0, 0 },       { TSEAK, 0, 0 },
    { TYOSHI, 0, 0 },       { TZELDA, 0, 0 },       { TGAMEWATCH, 0, 0 },
    { TEMBLEM, 0, 0 },      { TGANON, 0, 0 },       { KINOKOROUTE, 0, 0 },
    { CASTLE, 0, 0 },       { KONGO, 0, 0 },        { GARDEN, 0, 0 },
    { SHRINEROUTE, 0, 0 },  { SHRINE, 0, 0 },       { ZEBES, 0, 0 },
    { ZEBESROUTE, 0, 0 },   { GREENS, 0, 0 },       { GREENS, 0, 0 },
    { GREENS, 0, 0 },       { CORNERIA, 0, 0 },     { CORNERIA, 0, 0 },
    { PSTADIUM, 0, 0 },     { BIGBLUEROUTE, 0, 0 }, { MUTECITY, 0, 0 },
    { ONETT, 0, 0 },        { ICEMTN, 0, 0 },       { ICEMTN, 0, 0 },
    { BATTLE, 0, 0 },       { BATTLE, 0, 0 },       { LAST, 0, 0 },
    { LAST, 0, 0 },         { PUSHON, 0, 0 },       { FIGUREGET, 0, 0 },
    { HOMERUN, 0, 0 },      { HEAL, 0, 0 },         { CASTLE, 0, 0 },
    { RCRUISE, 0, 0 },      { KONGO, 0, 0 },        { GARDEN, 0, 0 },
    { GREATBAY, 0, 0 },     { SHRINE, 0, 0 },       { ZEBES, 0, 0 },
    { KRAID, 0, 0 },        { STORY, 0, 0 },        { YORSTER, 0, 0 },
    { IZUMI, 0, 0 },        { GREENS, 0, 0 },       { CORNERIA, 0, 0 },
    { VENOM, 0, 0 },        { PSTADIUM, 0, 0 },     { INISHIE1, 0, 0 },
    { INISHIE2, 0, 0 },     { MUTECITY, 0, 0 },     { BIGBLUE, 0, 0 },
    { ONETT, 0, 0 },        { FOURSIDE, 0, 0 },     { PSTADIUM, 0, 0 },
    { CASTLE, 0, 0 },       { BATTLE, 0, 0 },       { CASTLE, 0, 0 },
    { INISHIE2, 0, 0 },     { SHRINE, 0, 0 },       { GREATBAY, 0, 0 },
    { LAST, 0, 0 },         { PSTADIUM, 0, 0 },     { ICEMTN, 0, 0 },
    { ICEMTN, 0, 0 },       { INISHIE1, 0, 0 },     { GREATBAY, 0, 0 },
    { SHRINE, 0, 0 },       { CORNERIA, 0, 0 },     { VENOM, 0, 0 },
    { GREATBAY, 0, 0 },     { PSTADIUM, 0, 0 },     { BATTLE, 0, 0 },
    { INISHIE2, 0, 0 },     { KONGO, 0, 0 },        { SHRINE, 0, 0 },
    { GREATBAY, 0, 0 },     { INISHIE1, 0, 0 },     { GREATBAY, 0, 0 },
    { BIGBLUE, 0, 0 },      { ZEBES, 0, 0 },        { STORY, 0, 0 },
    { YORSTER, 0, 0 },      { GREENS, 0, 0 },       { IZUMI, 0, 0 },
    { GREENS, 0, 0 },       { ICEMTN, 0, 0 },       { CORNERIA, 0, 0 },
    { MUTECITY, 0, 0 },     { PSTADIUM, 0, 0 },     { PSTADIUM, 0, 0 },
    { INISHIE1, 0, 0 },     { ONETT, 0, 0 },        { FOURSIDE, 0, 0 },
    { BIGBLUE, 0, 0 },      { BATTLE, 0, 0 },       { BATTLE, 0, 0 },
    { BATTLE, 0, 0 },       { SHRINE, 0, 0 },       { GREATBAY, 0, 0 },
    { SHRINE, 0, 0 },       { GREATBAY, 0, 0 },     { CASTLE, 0, 0 },
    { KONGO, 0, 0 },        { GREATBAY, 0, 0 },     { STORY, 0, 0 },
    { INISHIE2, 0, 0 },     { MUTECITY, 0, 0 },     { PSTADIUM, 0, 0 },
    { IZUMI, 0, 0 },        { INISHIE1, 0, 0 },     { SHRINE, 0, 0 },
    { RCRUISE, 0, 0 },      { GARDEN, 0, 0 },       { IZUMI, 0, 0 },
    { INISHIE2, 0, 0 },     { ONETT, 0, 0 },        { PSTADIUM, 0, 0 },
    { ICEMTN, 0, 0 },       { PSTADIUM, 0, 0 },     { FLATZONE, 0, 0 },
    { MUTECITY, 0, 0 },     { BATTLE, 0, 0 },       { LAST, 0, 0 },
    { RCRUISE, 0, 0 },      { KONGO, 0, 0 },        { GREATBAY, 0, 0 },
    { ZEBES, 0, 0 },        { STORY, 0, 0 },        { GREENS, 0, 0 },
    { CORNERIA, 0, 0 },     { PSTADIUM, 0, 0 },     { INISHIE1, 0, 0 },
    { MUTECITY, 0, 0 },     { ONETT, 0, 0 },        { PURA, 0, 0 },
    { ICEMTN, 0, 0 },       { CASTLE, 0, 0 },       { SHRINE, 0, 0 },
    { IZUMI, 0, 0 },        { BATTLE, 0, 0 },       { YORSTER, 0, 0 },
    { INISHIE2, 0, 0 },     { GARDEN, 0, 0 },       { VENOM, 0, 0 },
    { FOURSIDE, 0, 0 },     { LAST, 0, 0 },         { FLATZONE, 0, 0 },
    { KRAID, 0, 0 },        { BATTLE, 0, 0 },       { SHRINE, 0, 0 },
    { CASTLE, 0, 0 },       { STORY, 0, 0 },        { ONETT, 0, 0 },
    { IZUMI, 0, 0 },        { PSTADIUM, 0, 0 },     { ZEBES, 0, 0 },
    { GREATBAY, 0, 0 },     { YORSTER, 0, 0 },      { ICEMTN, 0, 0 },
    { MUTECITY, 0, 0 },     { RCRUISE, 0, 0 },      { FIGURE1, 0, 0 },
    { BATTLE, 0, 0 },       { CORNERIA, 0, 0 },     { GARDEN, 0, 0 },
    { KONGO, 0, 0 },        { LAST, 0, 0 },         { ZEBES, 0, 0 },
    { CASTLE, 0, 0 },       { INISHIE2, 0, 0 },     { KRAID, 0, 0 },
    { YORSTER, 0, 0 },      { FOURSIDE, 0, 0 },     { FIGURE2, 0, 0 },
    { VENOM, 0, 0 },        { GREENS, 0, 0 },       { SHRINE, 0, 0 },
    { IZUMI, 0, 0 },        { INISHIE1, 0, 0 },     { CORNERIA, 0, 0 },
    { BIGBLUEROUTE, 0, 0 }, { GREATBAY, 0, 0 },     { OLDPUPUPU, 0, 0 },
    { FOURSIDE, 0, 0 },     { IZUMI, 0, 0 },        { INISHIE2, 0, 0 },
    { PSTADIUM, 0, 0 },     { SHRINE, 0, 0 },       { SHRINE, 0, 0 },
    { PURA, 0, 0 },         { BIGBLUE, 0, 0 },      { BATTLE, 0, 0 },
    { FLATZONE, 0, 0 },     { SHRINE, 0, 0 },       { FIGURE3, 0, 0 },
    { STORY, 0, 0 },        { INISHIE1, 0, 0 },     { LAST, 0, 0 },
    { LAST, 0, 0 },         { GARDEN, 0, 0 },       { STORY, 0, 0 },
    { CASTLE, 0, 0 },       { RCRUISE, 0, 0 },      { GREATBAY, 0, 0 },
    { SHRINE, 0, 0 },       { MUTECITY, 0, 0 },     { CORNERIA, 0, 0 },
    { PSTADIUM, 0, 0 },     { ONETT, 0, 0 },        { ICEMTN, 0, 0 },
    { INISHIE2, 0, 0 },     { PURA, 0, 0 },         { LAST, 0, 0 },
    { FLATZONE, 0, 0 },     { VENOM, 0, 0 },        { PSTADIUM, 0, 0 },
    { GREATBAY, 0, 0 },     { SHRINE, 0, 0 },       { LAST, 0, 0 },
    { BATTLE, 0, 0 },       { PSTADIUM, 0, 0 },     { LAST, 0, 0 },
    { INISHIE2, 0, 0 },     { IZUMI, 0, 0 },        { FLATZONE, 0, 0 },
    { CASTLE, 0, 0 },       { LAST, 0, 0 },         { GREATBAY, 0, 0 },
    { BATTLE, 0, 0 },       { PSTADIUM, 0, 0 },     { SHRINE, 0, 0 },
    { BATTLE, 0, 0 },
};
