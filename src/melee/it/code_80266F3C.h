...
s32 it_8026D604(HSD_GObj* item_gobj);
void it_8026F9A0(void);
void it_802701BC(HSD_GObj* item_gobj);
void it_802703E8(HSD_GObj* item_gobj);

void it_802706D0(HSD_GObj* item_gobj);
void it_80270E30(HSD_GObj* item_gobj);
void it_8027137C(HSD_GObj* item_gobj);
void it_8027146C(HSD_GObj* item_gobj);
void it_802714C0(HSD_GObj* item_gobj);
void it_80271508(HSD_GObj* item_gobj, s32 arg1);
void it_8027163C(HSD_GObj* item_gobj);
void it_80271A58(HSD_GObj* item_gobj);
void it_802721B8(HSD_GObj* item_gobj);
void it_80272280(HSD_GObj* item_gobj);
void it_8027163C(HSD_GObj* item_gobj);
void it_80271A58(HSD_GObj* item_gobj);
void it_802721B8(HSD_GObj* item_gobj);
void it_80272298(HSD_GObj* item_gobj);
void it_802722B0(HSD_GObj* item_gobj);
void it_80272304(HSD_GObj* item_gobj);
void it_80272460(itHit* hitbox, s32 damage, HSD_GObj* item_gobj);
void it_802725D4(HSD_GObj*);
void it_80272784(HSD_GObj* item_gobj);
void it_802728C8(HSD_GObj* item_gobj);
void it_80272A18(HSD_JObj* item_jobj);
void it_80272A3C(HSD_JObj* item_jobj);

/// Check if GObj is Item class
bool it_80272D1C(HSD_GObj* item_gobj);

/// Check GObj entity class
s32 it_80272D40(HSD_GObj* item_gobj);

void it_80272F7C(HSD_JObj*, f32);
void it_802728C8(HSD_GObj* item_gobj);
void it_80273168(HSD_GObj* item_gobj);
void it_802731A4(HSD_GObj*);
void it_802731E0(HSD_GObj*);
void it_8027327C(HSD_GObj* item_gobj, s32 ID1, s32 ID2);
void it_8027346C(HSD_GObj* item_gobj);
void it_80273484(HSD_GObj* item_gobj);
void it_80272F7C(HSD_JObj*, f32);
void it_802728C8(HSD_GObj* item_gobj);
void it_80273168(HSD_GObj* item_gobj);
void it_802731A4(HSD_GObj*);
...
void it_80274740(HSD_GObj* item_gobj);
void it_80274A64(HSD_GObj* item_gobj);
bool it_80274C78(HSD_GObj* item_gobj);
void it_80274DAC(HSD_GObj*);
void it_8027737C(HSD_GObj* item_gobj, Vec3* pos);

/// Toggle flag in 0xDC8 off
void it_80274EF8(HSD_GObj* item_gobj);

void it_80274F10(HSD_GObj* item_gobj);

/// Set item lifetime
void it_80275158(HSD_GObj* item_gobj, f32 lifetime);
...
void it_80275474(HSD_GObj* item_gobj);

void it_802754D4(HSD_GObj*);

/// Toggle several flags in 0xDCE off
void it_80275504(HSD_GObj* item_gobj);

void it_802756D0(HSD_GObj* item_gobj);
void it_802756E0(HSD_GObj* item_gobj);
void it_8027574C(HSD_GObj* item_gobj);
void it_80275870(HSD_GObj* item_gobj);
void it_80275E98(HSD_GObj*, SpawnItem*);
void it_802762B0(Item*);
void it_802762BC(Item*);

/// Advance Item Script
void it_802799E4(HSD_GObj* item_gobj);

void it_80279B64(Item*);

void it_80279B88(Item* item_data, s32 arg1, s32 arg2);
void it_80279BBC(Item* item_data);
void it_80279BE0(HSD_GObj* item_gobj);
