...
void func_8029C6A4(f32, f32, HSD_GObj*, Vec3*, s32);
void func_802AE1D0(HSD_GObj*);
void func_802AEAB4(HSD_GObj*);
HSD_GObj* func_802AE8A8(f32, HSD_GObj*, Vec3*, s32, s32);
void func_802ADDD0(HSD_GObj*, s32);
void func_802AE538(HSD_GObj*);
HSD_GObj* func_802C61F4(HSD_GObj*, Vec3*, s32, f32);
void func_802C6328(HSD_GObj*);
void func_802C6374(HSD_GObj*);
void func_802C6394(HSD_GObj*);
void func_802C6430(HSD_GObj*);
void func_802C6458(HSD_GObj*);
void func_802C6480(HSD_GObj*);
void func_802C64A8(HSD_GObj*);
HSD_GObj* func_802C6C38(HSD_GObj*, Vec3*, s32, f32);
void func_802C7158(HSD_GObj*);
void func_802C7074(HSD_GObj*);
void func_802C7424(HSD_GObj*);
void func_802C6E50(HSD_GObj*);
void func_802C6D6C(HSD_GObj*);
HSD_GObj* func_802C6F40(HSD_GObj*, Vec3*, s32, f32);
HSD_GObj* func_802C65E4(HSD_GObj*, Vec3*, s32, f32);
HSD_GObj* func_802C68F8(HSD_GObj*, Vec3*, s32, f32);
void func_802C6A2C(HSD_GObj*);
void func_802C6A78(HSD_GObj*);
void func_802C6A98(HSD_GObj*);
HSD_GObj* func_802C8038(HSD_GObj*, Vec3*, s32, s32, f32, f32);
HSD_GObj* func_802C7D60(HSD_GObj*, Vec3*, s32, f32);
void func_802C7E94(HSD_GObj*);
void func_802C7EE0(HSD_GObj*);
void func_802C7F00(HSD_GObj*);
HSD_GObj* func_802C837C(HSD_GObj*, Vec3*, s32, u32, f32);
HSD_GObj* func_802C7774(f32, HSD_GObj*, Vec3*, s32, u32);
void func_8028FAF4(HSD_GObj*, Vec3*);
void func_802C7A84(HSD_GObj*);
void func_802C7AD0(HSD_GObj*);
...
void func_802B26E0(HSD_GObj*);
void func_802C49E0(HSD_GObj*);
void func_802BFE5C(HSD_GObj*, Vec3*, f32);
void func_802C0010(HSD_GObj*, void*);
void func_802BE5D8(void*, f32);
void func_802BE958(void*);
void func_802BFEC4(void*);
