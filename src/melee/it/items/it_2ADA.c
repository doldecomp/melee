...
/* 2ADB48 */ static bool it_2ADA_UnkMotion_Anim(Item_GObj* gobj);
/* 2ADB80 */ static void it_2ADA_UnkMotion_Phys(Item_GObj* gobj);
/* 2ADBB0 */ static bool it_2ADA_UnkMotion_Coll(Item_GObj* gobj);

ItemStateTable it_803F6C88[] = {
    {
        0,
        it_2ADA_UnkMotion_Anim,
        it_2ADA_UnkMotion_Phys,
        it_2ADA_UnkMotion_Coll,
    },
};
...
bool it_2ADA_UnkMotion_Anim(Item_GObj* gobj)
{
    Item* item = GET_ITEM(gobj);
...
void it_2ADA_UnkMotion_Phys(Item_GObj* gobj)
{
    ItemAttr* attrs = GET_ITEM(gobj)->xCC_item_attr;
    it_80272860(gobj, attrs->x10_fall_speed, attrs->x14_fall_speed_max);
}

bool it_2ADA_UnkMotion_Coll(Item_GObj* gobj)
{
