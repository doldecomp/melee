...
ItemStateTable it_803F8BD8[] = {
    { 0, it_2E5A_UnkMotion0_Anim, it_2E5A_UnkMotion0_Phys, it_2E5A_UnkMotion0_Coll },
    { -1, it_2E5A_UnkMotion0_Anim, it_2E5A_UnkMotion0_Phys, NULL },
...
bool it_2E5A_UnkMotion0_Anim(HSD_GObj* item_gobj)
{
    f32 var_f2;
    Item* item;
...
void it_2E5A_UnkMotion0_Phys(HSD_GObj* item_gobj)
{
    ItemAttr* comm_attr;
