...
static bool it_2F28_UnkMotion_Anim(Item_GObj*);  /* static */
static void it_2F28_UnkMotion_Phys(HSD_GObj*);   /* static */
// static bool it_2F28_UnkMotion_Coll(HSD_GObj*); /* static */
static bool it_2F28_UnkMotion_Coll(Item_GObj*); /* static */

ItemStateTable it_803F9470[] = {
    { 0, it_2F28_UnkMotion_Anim, it_2F28_UnkMotion_Phys, it_2F28_UnkMotion_Coll },
};
...
bool it_2F28_UnkMotion_Anim(Item_GObj* item_gobj)
{
    Item* item;
...
void it_2F28_UnkMotion_Phys(HSD_GObj* item_gobj)
{
...
bool it_2F28_UnkMotion_Coll(Item_GObj* item_gobj)
// bool it_2F28_UnkMotion_Coll(HSD_GObj* item_gobj)
{
