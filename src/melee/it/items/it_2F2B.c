...
/* 2F2CCC */ static bool it_2F2B_UnkMotion_Anim(Item_GObj* gobj);
/* 2F2CD4 */ static void it_2F2B_UnkMotion_Phys(Item_GObj* gobj);
/* 2F2CD8 */ static bool it_2F2B_UnkMotion_Coll(Item_GObj* gobj);

ItemStateTable it_803F9480[] = {
    { -1, it_2F2B_UnkMotion_Anim, it_2F2B_UnkMotion_Phys, it_2F2B_UnkMotion_Coll },
};
...
bool it_2F2B_UnkMotion_Anim(Item_GObj* gobj)
{
    return false;
}

void it_2F2B_UnkMotion_Phys(Item_GObj* gobj) {}

bool it_2F2B_UnkMotion_Coll(Item_GObj* gobj)
{
    return false;
}
