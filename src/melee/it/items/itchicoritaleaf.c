...
ItemStateTable it_803F7AC8[] = {
    { 0, itChicoritaleaf_UnkMotion_Anim, itChicoritaleaf_UnkMotion_Phys, itChicoritaleaf_UnkMotion_Coll },
};
...
bool itChicoritaleaf_UnkMotion_Anim(HSD_GObj* item_gobj)
{
    Item* item;
...
void itChicoritaleaf_UnkMotion_Phys(HSD_GObj* item_gobj) {}

bool itChicoritaleaf_UnkMotion_Coll(HSD_GObj* item_gobj)
{
