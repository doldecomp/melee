...
/* 2C9CE8 */ bool itChicoritaleaf_UnkMotion_Anim(HSD_GObj*);
/* 2C9D1C */ void itChicoritaleaf_UnkMotion_Phys(HSD_GObj*);
/* 2C9D20 */ bool itChicoritaleaf_UnkMotion_Coll(HSD_GObj*);
