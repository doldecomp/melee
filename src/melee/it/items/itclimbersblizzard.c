...
bool itClimbersblizzard_UnkMotion_Coll(Item_GObj* gobj)
{
    s32 flags = 0;
    it_8026D9A0(gobj);
...
void itClimbersblizzard_UnkMotion_Phys(Item_GObj* gobj)
{
...
bool itClimbersblizzard_UnkMotion_Anim(Item_GObj* gobj)
{
    Item* ip = GET_ITEM(gobj);
