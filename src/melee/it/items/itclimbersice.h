...
/* 2C198C */ bool it_802C198C(Item_GObj* gobj);
/* 2C1A14 */ void it_802C1A14(Item_GObj* gobj);
/* 2C1A18 */ bool it_802C1A18(Item_GObj* gobj);
/* 2C1A58 */ UNK_RET it_802C1A58(UNK_PARAMS);
/* 2C1A80 */ bool it_802C1A80(Item_GObj* gobj);
/* 2C1A88 */ void it_802C1A88(Item_GObj* gobj);
/* 2C1AB8 */ bool it_802C1AB8(Item_GObj* gobj);
/* 2C1AE4 */ UNK_RET it_802C1AE4(UNK_PARAMS);
/* 2C1B80 */ bool it_802C1B80(Item_GObj* gobj);
/* 2C1BB4 */ void it_802C1BB4(Item_GObj* gobj);
/* 2C1C7C */ bool it_802C1C7C(Item_GObj* gobj);
/* 2C1D44 */ UNK_RET fn_802C1D44(UNK_PARAMS);
/* 2C1D80 */ bool it_802C1D80(Item_GObj* gobj);
/* 2C1DB4 */ void it_802C1DB4(Item_GObj* gobj);
/* 2C1E94 */ bool it_802C1E94(Item_GObj* gobj);
