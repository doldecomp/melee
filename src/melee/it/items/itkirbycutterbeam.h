...
/* 29BC88 */ bool itKirbycutterbeam_UnkMotion_Anim(Item_GObj* gobj);
/* 29BCA8 */ void itKirbycutterbeam_UnkMotion_Phys(Item_GObj* gobj);
/* 29BDD4 */ bool itKirbycutterbeam_UnkMotion_Coll(Item_GObj* gobj);
