...
/* 2F2E68 */ static bool itKirbyyoshispecialn_UnkMotion_Anim(Item_GObj* gobj);
/* 2F2E70 */ static void itKirbyyoshispecialn_UnkMotion_Phys(Item_GObj* gobj);
/* 2F2E74 */ static bool itKirbyyoshispecialn_UnkMotion_Coll(Item_GObj* gobj);

ItemStateTable it_803F9490[] = {
    { -1, itKirbyyoshispecialn_UnkMotion_Anim, itKirbyyoshispecialn_UnkMotion_Phys, itKirbyyoshispecialn_UnkMotion_Coll },
};
...
bool itKirbyyoshispecialn_UnkMotion_Anim(Item_GObj* gobj)
{
    return false;
}

void itKirbyyoshispecialn_UnkMotion_Phys(Item_GObj* gobj) {}

bool itKirbyyoshispecialn_UnkMotion_Coll(Item_GObj* gobj)
{
    return false;
}
