...
static bool itLgunbeam_UnkMotion_Anim(Item_GObj*);
static bool itLgunbeam_UnkMotion_Coll(Item_GObj*);
static void it_802998A0(Item_GObj*, HSD_GObj*, s32);
static void itLgunbeam_UnkMotion_Phys(Item_GObj*);

ItemStateTable it_803F6630[] = {
    { 0, itLgunbeam_UnkMotion_Anim, itLgunbeam_UnkMotion_Phys, itLgunbeam_UnkMotion_Coll },
};
...
void it_802998A0(Item_GObj* gobj, HSD_GObj* fighter_gobj, s32 arg2)
{
    ...
    // item->unkDCA = item->unkDCA & ~0x10;
    {
        ...
        pos = ip->pos;
        Item_802694CC(gobj);
        itLgunbeam_UnkMotion_Phys(gobj);
...
bool itLgunbeam_UnkMotion_Anim(HSD_GObj* gobj)
{
    PAD_STACK(4 * 4);
...
void itLgunbeam_UnkMotion_Phys(HSD_GObj* gobj)
{
    Item* ip = GET_ITEM(gobj);
    PAD_STACK(4);
...
bool itLgunbeam_UnkMotion_Coll(HSD_GObj* gobj)
{
    s32 flags = 0;
    Item* ip = GET_ITEM(gobj);
    while (ip->xDD4_itemVar.lgunbeam.angle0 < -M_PI) {
