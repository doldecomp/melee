...
/* 298300 */ static bool itLgunray_UnkMotion_Anim(Item_GObj*);
/* 2983AC */ static void it_802982AC(Item_GObj*, Item_GObj*, Article*);
/* 2985D8 */ static void itLgunray_UnkMotion_Phys(Item_GObj*);
/* 2985F8 */ static bool itLgunray_UnkMotion_Coll(Item_GObj*);

static float const scale = 1e-3f;

ItemStateTable it_803F64F8[] = {
    { 0, itLgunray_UnkMotion_Anim, itLgunray_UnkMotion_Phys, itLgunray_UnkMotion_Coll },
};
...
bool itLgunray_UnkMotion_Anim(Item_GObj* gobj)
{
    Item* ip = GET_ITEM(gobj);
...
void itLgunray_UnkMotion_Phys(HSD_GObj* gobj)
{
    Item* ip = GET_ITEM(gobj);
    ip->xDD4_itemVar.lgunray.pos = ip->pos;
}

bool itLgunray_UnkMotion_Coll(Item_GObj* gobj)
{
    Item* ip = GET_ITEM(gobj);
