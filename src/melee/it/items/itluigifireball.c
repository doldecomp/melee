...
/* 2C02E4 */ static bool itLuigifireball_UnkMotion_Anim(Item_GObj* gobj);
/* 2C031C */ static void itLuigifireball_UnkMotion_Phys(Item_GObj* gobj);
/* 2C0368 */ static bool itLuigifireball_UnkMotion_Coll(Item_GObj* gobj);

ItemStateTable it_803F75C0[] = {
    { 0, itLuigifireball_UnkMotion_Anim, itLuigifireball_UnkMotion_Phys, itLuigifireball_UnkMotion_Coll },
};
...
bool itLuigifireball_UnkMotion_Anim(Item_GObj* gobj)
{
...
void itLuigifireball_UnkMotion_Phys(Item_GObj* gobj)
{
...
bool itLuigifireball_UnkMotion_Coll(Item_GObj* gobj)
{
    it_8026D9A0(gobj);
    if (it_8027781C(gobj)) {
        Item* ip = GET_ITEM(gobj);
