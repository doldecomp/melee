...
/* 2D66F8 */ bool itHinoarashi_UnkMotion_Anim(Item_GObj* gobj);
/* 2D6740 */ void itHinoarashi_UnkMotion_Phys(Item_GObj* gobj);
/* 2D6798 */ bool itHinoarashi_UnkMotion_Coll(Item_GObj* gobj);
