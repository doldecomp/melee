...
ItemStateTable it_803F6788[] = {
    { 0, itMariofireball_UnkMotion_Anim, itMariofireball_UnkMotion_Phys, itMariofireball_UnkMotion_Coll },
};
...
bool itMariofireball_UnkMotion_Anim(Item_GObj* gobj)
{
...
void itMariofireball_UnkMotion_Phys(Item_GObj* gobj)
{
...
bool itMariofireball_UnkMotion_Coll(Item_GObj* gobj)
{
    it_8026D9A0(gobj);
    if (it_8027781C(gobj)) {
        Item* it = GET_ITEM(gobj);
