...
bool itMasterhandlaser_UnkMotion_Anim(Item_GObj* gobj)
{
    Item* ip = GET_ITEM(gobj);
...
void itMasterhandlaser_UnkMotion_Phys(Item_GObj* gobj) {}

bool itMasterhandlaser_UnkMotion_Coll(Item_GObj* gobj)
{
    return false;
}
...
void it_802F063C(Item_GObj* gobj, Item_GObj* arg1)
{
    ...
    if (mpLib_80051EC8(&pos_1, NULL, NULL, NULL, 1, -1, -1, pos_0.x, pos_0.y,
                       pos_2.x, pos_2.y) != 0)
    {
        translate.x = 0;
        translate.z = 0;
