...
/* 2F04F0 */ bool itMasterhandlaser_UnkMotion_Anim(Item_GObj*);
/* 2F059C */ void itMasterhandlaser_UnkMotion_Phys(Item_GObj* gobj);
/* 2F05A0 */ bool itMasterhandlaser_UnkMotion_Coll(Item_GObj* gobj);
