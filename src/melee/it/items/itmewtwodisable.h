...
/* 2C4B38 */ UNK_RET it_802C4B38(UNK_PARAMS);
/* 2C4BB8 */ UNK_RET it_802C4BB8(UNK_PARAMS);
/* 2C4C08 */ bool itMewtwodisable_UnkMotion_Anim(Item_GObj* gobj);
/* 2C4C3C */ void itMewtwodisable_UnkMotion_Phys(Item_GObj* gobj);
/* 2C4C40 */ bool itMewtwodisable_UnkMotion_Coll(Item_GObj* gobj);
