...
/* 2C4F50 */ UNK_RET it_802C4F50(UNK_PARAMS);
...
/* 2C57C8 */ bool it_802C57C8(Item_GObj* gobj);
/* 2C5B0C */ void it_802C5B0C(Item_GObj* gobj);
/* 2C5B10 */ bool it_802C5B10(Item_GObj* gobj);
/* 2C5B18 */ UNK_RET it_802C5B18(UNK_PARAMS);
/* 2C5BF8 */ bool it_802C5BF8(Item_GObj* gobj);
/* 2C5CF4 */ void it_802C5CF4(Item_GObj* gobj);
/* 2C5D64 */ bool it_802C5D64(Item_GObj* gobj);
/* 2C5DAC */ bool it_802C5DAC(Item_GObj* gobj);
/* 2C5DCC */ void it_802C5DCC(Item_GObj* gobj);
/* 2C5DD0 */ bool it_802C5DD0(Item_GObj* gobj);
/* 2C5E18 */ UNK_RET fn_802C5E18(UNK_PARAMS);
/* 2C5E5C */ UNK_RET it_802C5E5C(UNK_PARAMS);
/* 2C5F7C */ bool it_802C5F7C(Item_GObj* gobj);
/* 2C6094 */ void it_802C6094(Item_GObj*);
/* 2C60AC */ bool it_802C60AC(Item_GObj* gobj);
