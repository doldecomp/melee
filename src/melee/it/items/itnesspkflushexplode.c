...
/* 2AFD44 */ static bool itNesspkflushexplode_UnkMotion_Coll(Item_GObj* gobj);
...
/// #itNesspkflushexplode_UnkMotion_Anim

void itNesspkflushexplode_UnkMotion_Phys(Item_GObj* gobj)
{
    Item* it = GET_ITEM(gobj);
    it->x40_vel.z = it->x40_vel.y = it->x40_vel.z = 0;
}

bool itNesspkflushexplode_UnkMotion_Coll(Item_GObj* gobj)
{
    return false;
}
