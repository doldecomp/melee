...
/* 2B4C38 */ bool it_802B4C38(Item_GObj* gobj);
/* 2B4CC4 */ void it_802B4CC4(Item_GObj* gobj);
/* 2B4CC8 */ bool it_802B4CC8(Item_GObj* gobj);
/* 2B4CF4 */ UNK_RET it_802B4CF4(UNK_PARAMS);
/* 2B4D1C */ bool it_802B4D1C(Item_GObj* gobj);
/* 2B4F1C */ void it_802B4F1C(Item_GObj* gobj);
/* 2B4F4C */ bool it_802B4F4C(Item_GObj* gobj);
/* 2B4F78 */ void it_802B4F78(Item_GObj*);
/* 2B4FA0 */ bool it_802B4FA0(Item_GObj* gobj);
/* 2B51A0 */ void it_802B51A0(Item_GObj* gobj);
/* 2B5284 */ bool it_802B5284(Item_GObj* gobj);
...
/* 2B5458 */ bool it_802B5458(Item_GObj* gobj);
