...
/* 2B5A98 */ UNK_RET it_802B5A98(UNK_PARAMS);
/* 2B5CB0 */ UNK_RET it_802B5CB0(UNK_PARAMS);
/* 2B5CB4 */ UNK_RET it_802B5CB4(UNK_PARAMS);
/* 2B5CBC */ UNK_RET it_802B5CBC(UNK_PARAMS);
/* 2B5D54 */ UNK_RET it_802B5D54(UNK_PARAMS);
/* 2B5E50 */ UNK_RET it_802B5E50(UNK_PARAMS);
/* 2B5EA0 */ UNK_RET it_802B5EA0(UNK_PARAMS);
