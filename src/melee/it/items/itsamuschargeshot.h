...
/* 2B5A98 */ bool it_802B5A98(Item_GObj* gobj);
/* 2B5CB0 */ void it_802B5CB0(Item_GObj* gobj);
/* 2B5CB4 */ bool it_802B5CB4(Item_GObj* gobj);
/* 2B5CBC */ UNK_RET it_802B5CBC(UNK_PARAMS);
/* 2B5D54 */ bool it_802B5D54(Item_GObj* gobj);
/* 2B5E50 */ void it_802B5E50(Item_GObj* gobj);
/* 2B5EA0 */ bool it_802B5EA0(Item_GObj* gobj);
