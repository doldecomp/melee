...
/* 2B62D0 */ Item_GObj* it_802B62D0(Item_GObj*, Vec3* pos, bool, float facing_dir);
/* 2B63F8 */ void it_802B63F8(HSD_GObj* gobj);
/* 2B64FC */ UNK_RET it_802B64FC(UNK_PARAMS);
/* 2B66A8 */ void* it_802B66A8(HSD_GObj* gobj);
/* 2B6774 */ long itSamusmissile_UnkMotion0_Anim(struct HSD_GObj*);
/* 2B67E4 */ UNK_RET itSamusmissile_UnkMotion0_Phys(UNK_PARAMS);
