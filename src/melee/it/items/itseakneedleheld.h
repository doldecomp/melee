...
/* 2B1AD4 */ bool itSeakneedleheld_UnkMotion_Anim(Item_GObj* gobj);
/* 2B1C34 */ void itSeakneedleheld_UnkMotion_Phys(Item_GObj* gobj);
/* 2B1C38 */ bool itSeakneedleheld_UnkMotion_Coll(Item_GObj* gobj);
