...
ItemStateTable it_803F57A0[] = {
    {
        0,
        itStar_UnkMotion_Anim,
        itStar_UnkMotion_Phys,
        itStar_UnkMotion_Coll,
    },
};
...
bool itStar_UnkMotion_Anim(Item_GObj* item_gobj)
{
    return false;
}

void itStar_UnkMotion_Phys(Item_GObj* item_gobj)
{
    Item* item = GET_ITEM(item_gobj);
...
bool itStar_UnkMotion_Coll(Item_GObj* item_gobj)
{
    Item* item = GET_ITEM(item_gobj);
    bool val = false;
