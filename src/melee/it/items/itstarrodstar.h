...
/* 298ACC */ bool itStarrodstar_UnkMotion_Anim(Item_GObj* gobj);
/* 298BAC */ void itStarrodstar_UnkMotion_Phys(Item_GObj* gobj);
/* 298BB0 */ bool itStarrodstar_UnkMotion_Coll(Item_GObj* gobj);
