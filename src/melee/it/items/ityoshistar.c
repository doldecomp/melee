...
ItemStateTable it_803F7158[] = { {
    0,
    itYoshistar_UnkMotion_Anim,
    itYoshistar_UnkMotion_Phys,
    itYoshistar_UnkMotion_Coll,
} };
...
bool itYoshistar_UnkMotion_Anim(Item_GObj* item_gobj)
{
...
void itYoshistar_UnkMotion_Phys(Item_GObj* item_gobj)
{
    Item* item = GET_ITEM(item_gobj);
...
bool itYoshistar_UnkMotion_Coll(Item_GObj* item_gobj)
{
