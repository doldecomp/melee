...
void it_802C46C4(Item_GObj* gobj, Item* arg1)
{
    ...
    Item_802694CC(gobj);
    itZeldadinfireexplode_UnkMotion_Anim(gobj);
...
bool itZeldadinfireexplode_UnkMotion_Anim(Item_GObj* gobj)
{
    Item* ip = GET_ITEM(gobj);
...
void itZeldadinfireexplode_UnkMotion_Phys(Item_GObj* gobj)
{
    Item* ip = GET_ITEM(gobj);
#ifndef BUGFIX
...
bool itZeldadinfireexplode_UnkMotion_Coll(Item_GObj* gobj)
{
    return false;
}
