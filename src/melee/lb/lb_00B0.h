...
void lbDObjSetRateAll(HSD_DObj*, f32);
void lbDObjReqAnimAll(HSD_DObj*, f32);
static HSD_JObj* lbFindJObjWithAObj(HSD_JObj*);
f32 lbGetJObjFramerate(HSD_JObj*);
f32 lbGetJObjCurrFrame(HSD_JObj*);
f32 lbGetJObjEndFrame(HSD_JObj*);
