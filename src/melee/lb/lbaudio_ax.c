...
s32 lbAudioAx_80023B24(s32 arg0)
{
    ...
    {
        s32 tmp = lbAudioAx_800233EC_inline(arg0, lbl_803BB300);
        slot = tmp;
    }

    off = slot * 4;
    if ((int) s32_arr_803BB5D0[slot][1] != 5) {
        HSD_AudioSFXKeyOffAll();
