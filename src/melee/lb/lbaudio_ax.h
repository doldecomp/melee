...
/* 023730 */ bool lbAudioAx_80023730(UNK_PARAMS);
...
/* 02411C */ UNK_RET lbAudioAx_8002411C(int);
...
/* 0245F4 */ s32
    lbAudioAx_800245F4(u8); /// i dont believe this actually returns anything
...
/* 0263E8 */ UNK_T lbAudioAx_800263E8(HSD_GObj*, int, int, int, float);
