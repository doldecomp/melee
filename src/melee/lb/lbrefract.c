...
/* static */ extern f32 lbl_804D7DB0; // = 0x80000000;
/* static */ extern f32 lbl_804D7DB4; // = -1.5707963705062866;
/* static */ extern f32 lbl_804D7DB8; // = 3.1415927410125732;
/* static */ extern f32 lbl_804D7DBC; // = 0.0;
/* static */ extern f32 lbl_804D7DC0; // = 1.5707963705062866;
/* static */ extern f32 lbl_804D7DC4; // = 1.0;
/* static */ extern f32 lbl_804D7DC8; // = 0.5;
/* static */ extern f32 lbl_804D7DCC; // = 3.0;
/* static */ extern f32 lbl_804D7DD0; // = 2.4142136573791504;
/* static */ extern f32 lbl_804D7DD4; // = 0.4142135679721832;

#define SIGN_BIT (1 << 31)
#define BITWISE(f) (*(long *)&f)
#define GET_SIGN_BIT(f) ((signed)(BITWISE(f) & SIGN_BIT))
...
f32 atan2f(f32 y, f32 x)
{
    ...
    {
        if (GET_SIGN_BIT(x) != 0)
            return lbl_804D7DB0 == x ? lbl_804D7DB4 : atanf(y / x) - lbl_804D7DB8;

        return x != lbl_804D7DBC ? atanf(y / x) : lbl_804D7DC0;
    }

    if (x < lbl_804D7DBC)
        return lbl_804D7DB8 + atanf(y / x);
...
// https://decomp.me/scratch/TeCho // 220 (94.50%)
...
/* 80022D28 0001F908  C0 42 83 E4 */	lfs f2, lbl_804D7DC4(r2)
/* 80022D2C 0001F90C  C0 02 83 DC */	lfs f0, lbl_804D7DBC(r2)
...
/* 80022D40 0001F920  C0 82 83 E8 */	lfs f4, lbl_804D7DC8(r2)
/* 80022D44 0001F924  C0 62 83 EC */	lfs f3, lbl_804D7DCC(r2)
...
/* 80022DA4 0001F984  C0 02 83 E0 */	lfs f0, lbl_804D7DC0(r2)
...
{
    return atanf(x * local_80022DF8(-((x * x) - lbl_804D7DC4)));
}

f32 local_80022DF8(f32 x)
{
    f32 temp_f0;

    temp_f0 = lbl_804D7DBC;
    if (x > temp_f0)
    {
        f32 temp_f2;
        f32 temp_f2_2;
        ...
        f32 temp_f3;
        f32 temp_f4;
        temp_f4 = lbl_804D7DC8;
        temp_f3 = lbl_804D7DCC;
        temp_f2_2 = __frsqrte(x);
        temp_f2_3 = temp_f4 * temp_f2_2 * -((x * (temp_f2_2 * temp_f2_2)) - temp_f3);
        temp_f2 = temp_f4 * temp_f2_3 * -((x * (temp_f2_3 * temp_f2_3)) - temp_f3);
        return temp_f4 * temp_f2 * -((x * (temp_f2 * temp_f2)) - temp_f3);
    }

    if (x != temp_f0)
        return lbl_80400770[0];

    return lbl_80400774[0];
}

#define M_PI_2 lbl_804D7DC0
...
#define BITWISE_1_0 0x3F800000 /* = lbl_804D7DC4 */
...
f32 atanf(f32 x)
{
    ...
    else if (SILVER_RATIO_1_CONJUGATE < x)
    {
        ...
        case BITWISE_0_5:
        {
            if (!((signed)BITWISE(x) < BITWISE_THRESHOLD_0))
                lookup_index = 1;

            if (!((signed)BITWISE(x) < BITWISE_THRESHOLD_1))
                lookup_index += 1;
        ...
        {
            lookup_index = 2;
            if (!((signed)BITWISE(x) < BITWISE_THRESHOLD_2))
                lookup_index = 3;

            if (!((signed)BITWISE(x) < BITWISE_THRESHOLD_3))
                lookup_index += 1;
        ...
        }
        {
            ...
            result = lbl_804D7DC4 / (offset_33 + (x + offset_39));
...

    {
        ...
        result = result *
                     result_squared * (result_squared * (result_squared * (result_squared * (result_squared * (result_squared * (atanf_lookup[6]) + atanf_lookup[5]) + atanf_lookup[4]) + atanf_lookup[3]) + atanf_lookup[2]) + atanf_lookup[1]) +
                 result;
