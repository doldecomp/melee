...
void func_8000C07C(HSD_JObj*, s32 i, HSD_AnimJoint**,
                   HSD_MatAnimJoint**, HSD_ShapeAnimJoint**);
void func_8000C0E8(HSD_JObj* jobj, s32 i, UnkAnimContainer*);
...
static s32 lbGetFreeColorRegImpl(s32 i0, HSD_TevDesc*,
...
static s32 lbGetFreeAlphaRegImpl(s32 i0, HSD_TevDesc* cur,
                                 union _HSD_TExp*, union _HSD_TExp*);
