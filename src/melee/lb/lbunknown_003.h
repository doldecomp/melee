...
void func_800119DC(Vec3*, s32, f32, f32, f32);
void func_80011A50(Vec3*, s32, f32, f32, f32, f32, f32, f32, f32);
void func_80014574(u8, s32, s32, s32);
void func_800145C0(u8);
void func_800122C8(int*, int, int, int);
void func_80011C18(void);
...
void func_800121FC(int*, int, int, int, int);
