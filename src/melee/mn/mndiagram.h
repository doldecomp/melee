...
/* 23EB84 */ s32 GetHitPercentage(u8 is_name_mode, u8 player_index);
/* 23ECC4 */ s32 GetPlayPercentage(u8 is_name_mode, u8 player_index);
/* 23EE38 */ s32 GetAveragePlayerCount(u8 is_name_mode, u8 player_index);
