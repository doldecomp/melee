...
static inline void mnHyaku_8024C68C_inline_2(HSD_GObj *gobj)
{
    ...
    }
    {
        ...
        struct sislib_idk* temp_r3_6 = (struct sislib_idk*) HSD_SisLib_803A5ACC(
...
void fn_8024CAC8(HSD_GObj *gobj) {
    ...
    if (mn_8022EC18(gobj->hsd_obj, &mnHyaku_803EF668[0], 0x80) == mnHyaku_803EF668[1]) {
        HSD_GObjProc *gobj_proc;
        HSD_GObjProc_8038FE24(HSD_GObj_804D7838);
...
void mnHyaku_8024CD64(u8 arg0) {
    ...
    pos.z = 0;
    archive = mn_804D6BB8;
    lbArchive_LoadSections(archive, (void **) &mnHyaku_804A08E8,
        "MenMainConKm_Top_joint", &mnHyaku_804A08E8.animjoint,
        "MenMainConKm_Top_animjoint", &mnHyaku_804A08E8.matanim_joint,
        "MenMainConKm_Top_matanim_joint",
        &mnHyaku_804A08E8.shapeanim_joint,
        "MenMainConKm_Top_shapeanim_joint", 0);
    mnHyaku_8024CB94(arg0);
    temp_r3 = HSD_GObjProc_8038FD54(GObj_Create(0U, 1U, 0x80U), mnHyaku_8024C68C, 0U);
