...
static inline void fn_8024AED0_inline(HSD_GObj* arg0)
{
    ...
    temp_f1 = vec_8.y;
    temp_r3_6->pos_x = vec_8.x;
    temp_r3_6->pos_y = temp_f1;
...
void fn_8024AED0(HSD_GObj* arg0)
{
    ...
    {
        soundtest_user_data* menu_data = mnSoundTest_804D6C40->user_data;
        temp_r26 = menu_data;
    }
    ...
    if (temp_f1 < 1.0f) {
        ...
        if (temp_r26->unk8 <= 0.0f) {
            temp_r26->unk8 = 1.0f;
            temp_r27 = fn_8024AED0_GetUserData();
            lbAudioAx_800236DC();
            temp_r27->unk2 = 0x50;
        }
    }
    ...
    if ((u8) mnSoundTest_804D6C44 == 0) {
        ...
        if (events & MenuInput_AButton) {
            ...
            temp_r3_4 = fn_8024AED0_GetUserData();
