...
#ifdef NON_MATCHING // TODO: floats are hard
...
s32 func_80043754(s32 (*arg0)(void*, u32), CollData* arg1, u32 arg2) {
    ...
    var_f5 = fabs_inline(arg1->x84_ecb.left.x - arg1->xA4_ecbCurrCorrect.left.x);
    var_f0 = fabs_inline(arg1->x84_ecb.right.x - arg1->xA4_ecbCurrCorrect.right.x);
...
#else
const f64 magic_signed_conversion = 4503601774854144.0;
asm s32 func_80043754(s32 (*arg0)(void*, u32), CollData* arg1, u32 arg2) {
    nofralloc
...
/* 8004378C 0004036C  C0 02 85 C4 */	lfs f0, 0.0f
...
/* 800437A0 00040380  C0 02 85 C4 */	lfs f0, 0.0f
...
/* 800437B8 00040398  C0 02 85 C4 */	lfs f0, 0.0f
...
/* 800437E0 000403C0  C0 02 85 C4 */	lfs f0, 0.0f
...
/* 8004380C 000403EC  C0 02 85 C4 */	lfs f0, 0.0f
...
/* 80043834 00040414  C0 02 85 C4 */	lfs f0, 0.0f
...
lbl_80043888:
/* 80043888 00040468  C0 02 85 F8 */	lfs f0, lbl_804D7FD8
...
/* 8004389C 0004047C  C8 62 86 10 */	lfd f3, magic_signed_conversion
...
/* 80043940 00040520  C3 C2 85 C8 */	lfs f30, 1.0f
/* 80043944 00040524  CB E2 86 10 */	lfd f31, magic_signed_conversion
...
/* 800439BC 0004059C  80 0D AE 0C */	lwz r0, lbl_804D64AC
