...
void mpLib_8004D184(mp_CollData* coll_data)
{
    ...
    verts = coll_data->verts;
    if (stage_info.internal_stage_id != PURA) {
        line = coll_data->lines;
        var_r8 = 0;
        while (var_r8 < coll_data->line_count) {
            temp_r5 = &verts[line->p0_idx];
            temp_r4 = &verts[line->p1_idx];
            if (temp_r5->x == temp_r4->x && temp_r5->y == temp_r4->y) {
                var_r4 = coll_data->lines;
                var_r5 = 0;
                while (var_r5 < coll_data->line_count) {
                    if (var_r4->x4_line_id == var_r8) {
                        var_r4->x4_line_id = line->x4_line_id;
                    }
                    if (var_r4->x6_line_id == var_r8) {
                        var_r4->x6_line_id = line->x6_line_id;
                    }
                    if (var_r4->x8_line_id == var_r8) {
                        var_r4->x8_line_id = line->x4_line_id;
                    }
                    if (var_r4->xA_line_id == var_r8) {
                        var_r4->xA_line_id = line->x6_line_id;
                    }
                    var_r5 += 1;
                    var_r4 += 1;
                }
...
int mpLib_8004DB78(int line_id)
{
    ...
    if (result != -1) {
        ...
        if ((flags & 0x10000) && !(flags & 0x40000)) {
            CollVtx* p1 = &groundCollVtx[groundCollLine[line_id].x0->p1_idx];
            CollVtx* p0 = &groundCollVtx[groundCollLine[result].x0->p0_idx];

            if (SQ(p1->pos.x - p0->pos.x) + SQ(p1->pos.y - p0->pos.y) < 4.0) {
                return result;
            }
        }
    }
...
int mpLib_8004DC04(int line_id)
{
    ...
    if (result != -1) {
        ...
        if ((flags & 0x10000) && !(flags & 0x40000)) {
            CollVtx* p0 = &groundCollVtx[groundCollLine[line_id].x0->p0_idx];
            CollVtx* p1 = &groundCollVtx[groundCollLine[result].x0->p1_idx];

            if (SQ(p0->pos.x - p1->pos.x) + SQ(p0->pos.y - p1->pos.y) < 4.0) {
                return result;
            }
        }
    }
                   ...
                   Vec3* normal_out)
{
    ...
    while (true) {
        ...
        x0_f0 = groundCollVtx[line_r4->x0->p0_idx].pos.x;
        x1_f1 = groundCollVtx[line_r4->x0->p1_idx].pos.x;
        if (pos_out->x < x0_f0) {
            if (r31 != 1) {
    ...
    y0_f6 = groundCollVtx[groundCollLine[r27].x0->p0_idx].pos.y;
    y1_f7 = groundCollVtx[groundCollLine[r27].x0->p1_idx].pos.y;
    if (y_out != NULL) {
                   ...
                   Vec3* normal_out)
{
    ...
    while (true) {
        ...
        x0 = groundCollVtx[line_r4->x0->p0_idx].pos.x;
        x1 = groundCollVtx[line_r4->x0->p1_idx].pos.x;
        if (vec->x < x1) {
            if (dir_r31 != 1) {
    ...
    y0 = groundCollVtx[groundCollLine[line_id].x0->p0_idx].pos.y;
    y1 = groundCollVtx[groundCollLine[line_id].x0->p1_idx].pos.y;
                   ...
                   Vec3* normal_out)
{
    ...
    while (true) {
        CollLine* line_r4 = &groundCollLine[line_id];
        y0 = groundCollVtx[line_r4->x0->p0_idx].pos.y;
        y1 = groundCollVtx[line_r4->x0->p1_idx].pos.y;
        if (vec->y < y0) {
            if (dir_r31 != 1) {
                int new_id = mpLib_8004DC04(line_id);
                if (new_id == -1 ||
    ...
    x0 = groundCollVtx[groundCollLine[line_id].x0->p0_idx].pos.x;
    x1 = groundCollVtx[groundCollLine[line_id].x0->p1_idx].pos.x;
                    ...
                    float* y1_out)
{
    ...
    float x0_f0 = groundCollVtx[line_r11->p0_idx].pos.x;
    float y0_f1 = groundCollVtx[line_r11->p0_idx].pos.y;
    float x1_f2 = groundCollVtx[line_r11->p1_idx].pos.x;
    float y1_f3 = groundCollVtx[line_r11->p1_idx].pos.y;
    float distance;
...
bool mpLib_8004F008(Vec3* vec_out, int* line_id_out, int* flags_out,
                    Vec3* normal_out, float x0_f1, float y0_f2, float x1_f3,
                    float y1_f4, float y_offset_f5, int r7, int r8, int r9,
...
bool mpLib_8004F400(Vec3* vec_out, int* line_id_out, int* flags_out,
                    Vec3* normal_out, float x_f1, float y_f2, float x_f3,
                    float y_f4, float y_offset_f5, int r7, int r8, int r9,
                    bool (*cb)(Fighter_GObj*, int), Fighter_GObj* gobj)
{
         ...
         joint_r29 = joint_r29->next)
    {
        ...
        block_8:
            ...
            {
                CollVtx* p0_r5 = &groundCollVtx[line_r26->x0->p0_idx];
                CollVtx* p1_r6 = &groundCollVtx[line_r26->x0->p1_idx];
                float x_f23;
                float y_f22;
                float px_sp4C;
                float py_sp48;
                float x0_f27 = p0_r5->pos.x;
                float y0_f26 = y_offset_f5 + p0_r5->pos.y;
                float x1_f25 = p1_r6->pos.x;
                float y1_f24 = y_offset_f5 + p1_r6->pos.y;

                if (joint_r29->flags & 0x700) {
                    mpLib_8004DC90(&x_f1, &y_f2, p0_r5->x10, p0_r5->x14,
                                   p1_r6->x10, p1_r6->x14, x0_f27, y0_f26,
...
bool mpLib_8004F8A4(Vec3* vec_out, int* line_id_out, int* flags_out,
                    Vec3* normal_out, int r6, int r7, float x_f1, float y_f2,
                    float x_f3, float y_f4)
{
...
bool mpLib_8004FC2C(Vec3* vec_out, int* line_id_out, int* flags_out,
                    Vec3* normal_out, int joint_id0, int joint_id1, float f1,
        ...
        block_8:
                ...
                !(r26->flags & 0x80))
            {
                ...
                if (joint->flags & 0x700) {
                    ...
                    CollVtx* v1_r6 = &groundCollVtx[line_r3->p1_idx];
                    CollVtx* v0_r5 = &groundCollVtx[line_r3->p0_idx];
...
bool mpLib_800501CC(Vec3* vec_out, int* line_id_out, int* flags_out,
    ...
    for (joint = mpLib_804D64C4; joint != NULL; joint = joint->next) {
        ...
        block_8:
                ...
                !(p26->flags & 0x80))
            {
                ...
                CollVtx* v0 = &groundCollVtx[line->p0_idx];
                CollVtx* v1 = &groundCollVtx[line->p1_idx];
                float x0 = v0->pos.x;
                float y0 = v0->pos.y;
                float x1 = v1->pos.x;
                float y1 = v1->pos.y;
...
bool mpLib_8005057C(Vec3* vec_out, int* line_id_out, int* flags_out,
                    Vec3* normal_out, int joint_id0, int joint_id1, float f1,
                    float f2, float f3, float f4)
{
    float min_f30;
...
bool mpLib_800509B8(Vec3* vec_out, int* line_id_out, int* flags_out,
                    Vec3* normal_out, int joint_id0, int joint_id1,
    ...
    for (joint = mpLib_804D64C4; joint != NULL; joint = joint->next) {
        ...
        block_8:
                ...
                !(p26->flags & 0x80))
            {
                ...
                float y;
                if (ABS(x0 - x1) > 0.0001) {
                    if (mpLib_8004E97C(x0, y0, x1, y1, f1, f2,
                                       left_x, left_y, &x, &y))
                    {
                        dx2 = SQ(x - f1);
                        dy2 = SQ(y - f2);
                    ...
                    if (f1 >= left_x &&
                        mpLib_80050068(&x, &y, x0, y0, y1, f1, f2,
                                       left_x, left_y))
                    {
                        dx2 = SQ(x - f1);
                        dy2 = SQ(y - f2);
...
bool mpLib_80050D68(Vec3* vec_out, int* line_id_out, int* flags_out,
                    Vec3* normal_out, int joint_id0, int joint_id1, float f1,
                    float f2, float f3, float f4)
{
    float min_f30;
...
bool mpLib_800511A4(int* line_id_out, int joint_id0, int joint_id1,
                    float normal_x, float normal_y, float left_x, float left_y,
    ...
    for (joint = mpLib_804D64C4; joint != NULL; joint = joint->next) {
        ...
        block_8:
                ...
                !(p26->flags & 0x80))
            {
                ...
                float dy0;
                {
                    vtx = &groundCollVtx[p26->x0->p0_idx];
                    x0 = vtx->pos.x;
                    y0 = vtx->pos.y;
                    x1 = vtx->x10;
                    y1 = vtx->x14;
                ...
                {
                    vtx = &groundCollVtx[p26->x0->p1_idx];
                    x0 = vtx->pos.x;
                    y0 = vtx->pos.y;
                    x1 = vtx->x10;
                    y1 = vtx->x14;
...
bool mpLib_800515A0(int* line_id, int arg1, int arg2, float arg8, float arg9,
                    float argA, float argB, float argC, float argD, float argE,
                    float argF)
{
    float sp48;
    float sp44;
    ...
    for (r29 = mpLib_804D64C4; r29 != NULL; r29 = r29->next) {
            ...
            (arg2 == -1 || arg2 == r29 - groundCollJoint))
        {
            ...
            block_8:
                ...
                {
                    p0_r3 = &groundCollVtx[r26->x0->p0_idx];
                    x0_f16 = p0_r3->pos.x;
                    y0_f17 = p0_r3->pos.y;
                    f18 = p0_r3->x10;
                    f19 = p0_r3->x14;
                    ...
                    r3_4 = &groundCollVtx[r26->x0->p1_idx];
                    f21_2 = r3_4->pos.x;
                    f20_2 = r3_4->pos.y;
                    f19_2 = r3_4->x10;
                    f18_2 = r3_4->x14;
...
int mpLib_8005199C(Vec3* vec, int arg1, int arg2)
{
    int line_id_r30 = -1;
    float x_f31 = vec->x;
    float y_f30 = vec->y;
    ...
    for (r3 = mpLib_804D64C4; r3 != NULL; r3 = r3->next) {
        ...
        if (arg2 == -1 || arg2 == r3 - groundCollJoint) {
            ...
            while (true) {
                ...
                {
                    CollVtx* p1_r4 = &groundCollVtx[line_r11->x0->p1_idx];
                    CollVtx* p0_r5 = &groundCollVtx[line_r11->x0->p0_idx];
                    float x0_f4 = p0_r5->pos.x;
                    float x1_f0 = p1_r4->pos.x;
                    float y0_f6 = p0_r5->pos.y;
                    float y1_f1 = p1_r4->pos.y;

                    if (x_f31 >= p0_r5->pos.x && x_f31 <= x1_f0) {
                        if (y_f30 >= y0_f6 && y_f30 >= y1_f1) {
                            line_id_r30 = (line_r11 - groundCollLine);
                            goto end;
                        }
                        if (ABS(x1_f0 - p0_r5->pos.x) > 0.0001 &&
                            y_f30 >= (y1_f1 - y0_f6) / (x1_f0 - p0_r5->pos.x) *
                                             (x_f31 - p0_r5->pos.x) +
                                         y0_f6)
                        {
                            line_id_r30 = (line_r11 - groundCollLine);
                ...
                if (arg1 != new_id) {
                    ...
                    if (flags & 1 && flags & 0x10000 && !(flags & 0x80)) {
                        ...
                        if (inner->flags & LINE_FLAG_LEDGE) {
                            float x0 = groundCollVtx[inner->p0_idx].pos.x;
                            float y0 = groundCollVtx[inner->p0_idx].pos.y;
                            float x1 = groundCollVtx[inner->p1_idx].pos.x;
                            float y1 = groundCollVtx[inner->p1_idx].pos.y;
                            float line_left;
                            float line_bottom;
                            float line_right;
                            float line_top;
                    ...
                    f32 x1, f32 y1, f32 x2, f32 y2)
{
    ...
    if (arg4 & 0x10) {
        if (arg4 & 1) {
            if (mpLib_8004F400(&pos_sp68, &line_id_sp40, &flags_sp3C,
        ...
        if ((arg4 & 2) && (mpLib_8004FC2C(&pos_sp68, &line_id_sp40,
                                          &flags_sp3C, &normal_sp5C, joint_id0,
                                          joint_id1, x1, y1, x2, y2)))
        {
            dx = SQ(pos_sp68.x - x1);
            dy = SQ(pos_sp68.y - y1);
        ...
        if ((arg4 & 4) && (mpLib_8005057C(&pos_sp68, &line_id_sp40,
                                          &flags_sp3C, &normal_sp5C, joint_id0,
                                          joint_id1, x1, y1, x2, y2)))
        {
            dx = SQ(pos_sp68.x - x1);
        ...
        if ((arg4 & 8) && (mpLib_80050D68(&pos_sp68, &line_id_sp40,
                                          &flags_sp3C, &normal_sp5C, joint_id0,
                                          joint_id1, x1, y1, x2, y2)))
        {
            dx = SQ(pos_sp68.x - x1);
        ...
        if (arg4 & 1) {
            if (mpLib_8004F008(&pos_sp68, &line_id_sp40, &flags_sp3C,
                               &normal_sp5C, x1, y1, x2, y2, 0.0F, -1,
        ...
        if ((arg4 & 2) && (mpLib_8004F8A4(&pos_sp68, &line_id_sp40,
                                          &flags_sp3C, &normal_sp5C, joint_id0,
                                          joint_id1, x1, y1, x2, y2)))
        {
            dx = SQ(pos_sp68.x - x1);
        ...
        if ((arg4 & 4) && (mpLib_800501CC(&pos_sp68, &line_id_sp40,
                                          &flags_sp3C, &normal_sp5C, joint_id0,
                                          joint_id1, x1, y1, x2, y2)))
        {
            dx = SQ(pos_sp68.x - x1);
        ...
        if ((arg4 & 8) && (mpLib_800509B8(&pos_sp68, &line_id_sp40,
                                          &flags_sp3C, &normal_sp5C, joint_id0,
                                          joint_id1, x1, y1, x2, y2)))
        {
            dx = SQ(pos_sp68.x - x1);
...
int mpLib_80052700(int line_id)
{
    int new_id;
    bool valid_id;
...
int mpLib_800528CC(int line_id)
{
    int new_id;
    bool valid_id;
...
int mpLib_80052A98(int line_id)
{
    int new_id;
    bool valid_id;
...
int mpLib_80052C64(int line_id)
{
    int new_id;
    bool valid_id;
...
int mpLib_80052E30(int line_id)
{
    int new_id;
    bool valid_id;
...
int mpLib_80052FFC(int line_id)
{
    int new_id;
    bool valid_id;
...
int mpLib_800531C8(int line_id)
{
    int new_id;
    bool valid_id;
...
int mpLib_80053394(int line_id)
{
    int new_id;
...
int mpLib_80053448(int line_id)
{
    int new_id;
...
int mpLib_800534FC(int line_id)
{
    int new_id;
...
int mpLib_800536CC(int line_id)
{
    int new_id;
...
int mpLib_8005389C(int line_id)
{
    int new_id;
...
int mpLib_80053950(int line_id)
{
    int new_id;
...
int mpLib_80053A04(int line_id)
{
    int new_id;
...
int mpLib_80053BD4(int line_id)
{
    int new_id;
...
void mpLib_80053DA4(int ledge_id, Vec3* pos_out)
{
    int r29 = ledge_id;
    int r5;
    CollVtx* temp_r3;
...
skip:
    ...
    temp_r3 = &groundCollVtx[groundCollLine[r29].x0->p1_idx];
    pos_out->x = temp_r3->pos.x;
    pos_out->y = temp_r3->pos.y;
    pos_out->z = 0.0F;
}

void mpLib_80053ECC(int ledge_id, Vec* vec)
{
    CollVtx* temp_r3;
    ...
    temp_r3 = &groundCollVtx[groundCollLine[ledge_id].x0->p0_idx];
    vec->x = temp_r3->pos.x;
    vec->y = temp_r3->pos.y;
    vec->z = 0.0F;
}
...
void mpLib_80053FF4(int line_id, Vec3* pos_out)
{
    ...
    vtx = &groundCollVtx[groundCollLine[new_id].x0->p1_idx];
    pos_out->x = vtx->pos.x;
    pos_out->y = vtx->pos.y;
    pos_out->z = 0.0F;
}
...
void mpLib_80054158(int line_id, Vec3* arg1)
{
    ...
    point = &groundCollVtx[temp_r8->p0_idx];
    arg1->x = point->pos.x;
    arg1->y = point->pos.y;
    arg1->z = 0.0F;
}
...
void mpLib_800542BC(int line_id, Vec3* out)
{
    ...
    do {
        new_id = mpLib_8004DC04(new_id);
                                 ...
                                 (groundCollLine[new_id].flags & 0xF));
    temp_r3 = &groundCollVtx[groundCollLine[new_id].x0->p0_idx];
    out->x = temp_r3->pos.x;
    out->y = temp_r3->pos.y;
    out->z = 0.0F;
}
...
CollVtx* mpLib_80054584(int line_id, Vec3* out)
{
    ...
    do {
        new_id = mpLib_8004DB78(new_id);
                                 ...
                                 (groundCollLine[new_id].flags & 0xF));
    p1 = &groundCollVtx[groundCollLine[new_id].x0->p1_idx];
    out->x = p1->pos.x;
    out->y = p1->pos.y;
    out->z = 0.0F;
    return p1;
...
void mpLib_800546E8(int line_id, Vec3* out)
{
    ...
    do {
        new_id = mpLib_8004DC04(new_id);
                                 ...
                                 (groundCollLine[new_id].flags & 0xF));
    p0 = &groundCollVtx[groundCollLine[new_id].x0->p0_idx];
    out->x = p0->pos.x;
    out->y = p0->pos.y;
    out->z = 0.0F;
}
...
void mpLib_80054B14(int line_id, Vec3* out_vec)
{
    ...
    temp_r3 = &groundCollVtx[groundCollLine[line_id].x0->p1_idx];
...
void mpLib_80054BC0(int line_id, Vec3* arg1)
{
    ...
    temp_r3 = &groundCollVtx[groundCollLine[line_id].x0->p0_idx];
...
u32 mpLib_80054CEC(int line_id)
{
...
Vec3* mpLib_80054DFC(int line_id, Vec3* normal_out)
{
    ...
    {
        float y0 = groundCollVtx[temp_r4->p0_idx].pos.y;
        float y1 = groundCollVtx[temp_r4->p1_idx].pos.y;
        float x0 = groundCollVtx[temp_r4->p0_idx].pos.x;
        float x1 = groundCollVtx[temp_r4->p1_idx].pos.x;
        normal_out->x = -(y1 - y0);
        normal_out->y = +(x1 - x0);
        normal_out->z = 0.0F;
    }
...
void mpLib_8005541C(int joint_id)
{
    ...
    l = &groundCollLine[joint->coll_data->floor_start];
    while (count-- > 0) {
        l->flags |= 0x40000;
        l++;
    }
    ...
    l = &groundCollLine[joint->coll_data->ceiling_start];
    while (count-- > 0) {
        l->flags |= 0x40000;
        l++;
    }
    ...
    l = &groundCollLine[joint->coll_data->left_wall_start];
    while (count-- > 0) {
        l->flags |= 0x40000;
        l++;
    }
    ...
    l = &groundCollLine[joint->coll_data->right_wall_start];
    while (count-- > 0) {
        l->flags |= 0x40000;
        l++;
    }
    ...
    l = &groundCollLine[joint->coll_data->dynamic_start];
    while (count-- > 0) {
        l->flags |= 0x40000;
        l++;
    }
...
void mpLib_800557D0(int joint_id)
{
    ...
    temp_r3->flags &= ~0x40000;

    count = temp_r3->coll_data->floor_count;
    l = &groundCollLine[temp_r3->coll_data->floor_start];
    while (count-- > 0) {
        l->flags &= ~0x40000;
        l++;
    }

    count = temp_r3->coll_data->ceiling_count;
    l = &groundCollLine[temp_r3->coll_data->ceiling_start];
    while (count-- > 0) {
        l->flags &= ~0x40000;
        l++;
    }

    count = temp_r3->coll_data->left_wall_count;
    l = &groundCollLine[temp_r3->coll_data->left_wall_start];
    while (count-- > 0) {
        l->flags &= ~0x40000;
        l++;
    }

    count = temp_r3->coll_data->right_wall_count;
    l = &groundCollLine[temp_r3->coll_data->right_wall_start];
    while (count-- > 0) {
        l->flags &= ~0x40000;
        l++;
    }

    count = temp_r3->coll_data->dynamic_count;
    l = &groundCollLine[temp_r3->coll_data->dynamic_start];
    while (count-- > 0) {
        l->flags &= ~0x40000;
        l++;
    }

    count = temp_r3->coll_data->point_count;
    p = &groundCollVtx[temp_r3->coll_data->point_start];
    while (count-- > 0) {
        p->x10 = p->pos.x;
        p->x14 = p->pos.y;
        p++;
...
void mpLib_80055C5C(int index)
{
    ...
    for (i = 0; i < temp_r28; i++, var_r30++) {
        ...
        CollVtx* temp_r3 = &groundCollVtx[temp_r5->p1_idx];
        CollVtx* temp_r3_2 = &groundCollVtx[temp_r5->p0_idx];
...
void mpLib_80055E24(int index)
{
    ...
    mpIsland_8005B334(index, temp_r31->coll_data->point_start,
                      temp_r31->coll_data->point_count, var_r6);
}
...
void mpLib_80055E9C(int x)
{
    ...
    point_count = mp_info->coll_data->point_count;
    p_r4 = &groundCollVtx[mp_info->coll_data->point_start];
    for (i = 0; i < point_count; i++, p_r4++) {
        p_r4->x10 = p_r4->pos.x;
        p_r4->x14 = p_r4->pos.y;
    }
    jobj = mp_info->x20;
    ...
    if (HSD_JObjGetFlags(jobj) & 0x10) {
        if (!(mp_info->flags & 0x40000)) {
            ...
            mpIsland_8005B334(x, mp_info->coll_data->point_start,
                              mp_info->coll_data->point_count, var_r6);
        }
        return;
    }
    ...
    if (m0_0 == mtx[1][1] && m0_0 == mtx[2][2]) {
        ...
        p_r4 = &groundCollVtx[mp_info->coll_data->point_start];
        for (i = 0; i < point_count; i++, p_r4++) {
            p_r4->pos.x = p_r4->x0 * m0_0 + m0_3;
            p_r4->pos.y = p_r4->x4 * m0_0 + m1_3;
        }
    ...
    i = 0;
    p_r26 = &groundCollVtx[mp_info->coll_data->point_start];
    ...
    while (i < point_count) {
        ...
        p_r26->pos.x = sp28.x;
        p_r26->pos.y = sp28.y;
        if (mpLib_804D64CC == 0 || p_r26->pos.x != p_r26->x10 ||
            p_r26->pos.y != p_r26->x14 || (++var_r25 <= 1))
        {
            i += 1;
            p_r26 += 1;
        } else {
...
void mpLib_800565DC(int index)
{
    ...
    CollVtx* cur = &groundCollVtx[temp_r5->coll_data->point_start];
    int temp_r4_2 = temp_r5->coll_data->point_count;
...
void mpLib_8005667C(int index)
{
    ...
    mpIsland_8005B334(index, temp_r7->coll_data->point_start,
                      temp_r7->coll_data->point_count, var_r6);
}
...
void mpLib_80056758(int index, f32 arg8, f32 arg9, f32 argA, f32 argB)
{
    ...
    CollVtx* temp_r3 = &groundCollVtx[temp_r5->x0->p0_idx];
    temp_r3->pos.x = temp_r3->x0 + arg8;
    temp_r3->pos.y = temp_r3->x4 + arg9;

    temp_r3 = &groundCollVtx[temp_r5->x0->p1_idx];
...
bool mpGetSpeed(int wall_id, Vec3* ecb_side_vtx, Vec3* speed)
{
    ...
    sp8 = ecb_side_vtx->x;
    spC = ecb_side_vtx->y;
    p0_r5 = &groundCollVtx[line_r6->p0_idx];
    p0_r6 = &groundCollVtx[line_r6->p1_idx];
    mpLib_8004DC90(&sp20, &sp1C, p0_r5->x0, p0_r6->x0, p0_r5->x10, p0_r5->x14,
                   p0_r6->x10, p0_r6->x14, p0_r5->pos.x, p0_r5->pos.y,
                   p0_r6->pos.x, p0_r6->pos.y);
...
int mpLib_80056B6C(int line_id)
{
    if (line_id != -1) {
        ...
        p0_idx = groundCollLine[line_id].x0->p0_idx;
        count = mpLib_804D64B4->x28;
        joint = groundCollJoint;
        for (i = 0; i < count; i++) {
            if (joint->coll_data->point_start <= p0_idx &&
                p0_idx < joint->coll_data->point_start +
                             joint->coll_data->point_count)
            {
...
block_10:
    ...
    if (mpLib_8004DD90(line_id, pos, &sp64, NULL, NULL) == -1) {
        return false;
    }
    sp58 = *pos;
    sp58.y += sp64;
    ...
    if (line_id != -1) {
        if (flags_out != NULL) {
            *flags_out = mpLib_80054CEC(line_id);
        }
        if (normal_out != NULL) {
...
void mpLib_80057424(int idx)
{
    ...
    u32 count = coll_data->point_count;
    s16 start = coll_data->point_start;
    int new_var;
...
void mpLib_80057528(int index)
{
    ...
    if (temp_r3 != -1) {
        ...
        tmp->flags |= 0x10000;
        mpIsland_8005B334(temp_r3, temp_r31->coll_data->point_start,
                          temp_r31->coll_data->point_count,
...
void mpLib_80057638(int joint_id)
{
    ...
    coll_data = joint->coll_data;
    mpIsland_8005B334(joint_id, coll_data->point_start, coll_data->point_count,
                      !(joint->flags & 0x800));
    joint->xE = true;
}
...
// void mpLib_80057BC0(s32 arg0)
// {
//     mpLib_CollData* temp_r3_2;
//     mpLib_CollData* temp_r3_3;
//     mpLib_CollData* temp_r3_4;
//     mpLib_CollData* temp_r3_5;
//     mpLib_CollData* temp_r3_6;
//     mpLib_CollData* temp_r5_6;
//     CollJoint* temp_r4;
//     CollLine* var_r4;
//     CollLine* var_r4_2;
//     CollLine* var_r4_3;
...
//     temp_r4 = &groundCollJoint[arg0];
//     temp_r3 = temp_r4->flags;
//     if (temp_r3 & 0x10000) {
//         temp_r4->flags = temp_r3 & 0xFFFEFFFF;
//         mpLib_80057B4C(temp_r4);
//         temp_r3_2 = temp_r4->coll_data;
//         temp_r5 = temp_r3_2->floor_count;
//         var_r3 = temp_r5;
//         var_r4 = &groundCollLine[temp_r3_2->floor_start];
//         if (temp_r5 > 0) {
//             temp_r0 = (u32) var_r3 >> 3U;
//             var_ctr = temp_r0;
//             if (temp_r0 != 0) {
//                 do {
//                     var_r4->flags &= 0xFFFEFFFF;
//                     var_r4->unkC = (s32) (var_r4->unkC & 0xFFFEFFFF);
//                     var_r4->unk14 = (s32) (var_r4->unk14 & 0xFFFEFFFF);
//                     var_r4->unk1C = (s32) (var_r4->unk1C & 0xFFFEFFFF);
//                     var_r4->unk24 = (s32) (var_r4->unk24 & 0xFFFEFFFF);
//                     var_r4->unk2C = (s32) (var_r4->unk2C & 0xFFFEFFFF);
//                     var_r4->unk34 = (s32) (var_r4->unk34 & 0xFFFEFFFF);
//                     var_r4->unk3C = (s32) (var_r4->unk3C & 0xFFFEFFFF);
//                     var_r4 += 0x40;
//                     var_ctr -= 1;
//                 } while (var_ctr != 0);
//                 var_r3 &= 7;
...
//             }
//         }
//         temp_r3_3 = temp_r4->coll_data;
//         temp_r5_2 = temp_r3_3->ceiling_count;
//         var_r3_2 = temp_r5_2;
//         var_r4_2 = &groundCollLine[temp_r3_3->ceiling_start];
//         if (temp_r5_2 > 0) {
//             temp_r0_2 = (u32) var_r3_2 >> 3U;
//             var_ctr_3 = temp_r0_2;
//             if (temp_r0_2 != 0) {
//                 do {
//                     var_r4_2->flags &= 0xFFFEFFFF;
//                     var_r4_2->unkC = (s32) (var_r4_2->unkC & 0xFFFEFFFF);
//                     var_r4_2->unk14 = (s32) (var_r4_2->unk14 & 0xFFFEFFFF);
//                     var_r4_2->unk1C = (s32) (var_r4_2->unk1C & 0xFFFEFFFF);
//                     var_r4_2->unk24 = (s32) (var_r4_2->unk24 & 0xFFFEFFFF);
//                     var_r4_2->unk2C = (s32) (var_r4_2->unk2C & 0xFFFEFFFF);
//                     var_r4_2->unk34 = (s32) (var_r4_2->unk34 & 0xFFFEFFFF);
//                     var_r4_2->unk3C = (s32) (var_r4_2->unk3C & 0xFFFEFFFF);
//                     var_r4_2 += 0x40;
//                     var_ctr_3 -= 1;
//                 } while (var_ctr_3 != 0);
//                 var_r3_2 &= 7;
...
//             }
//         }
//         temp_r3_4 = temp_r4->coll_data;
//         temp_r5_3 = temp_r3_4->left_wall_count;
//         var_r3_3 = temp_r5_3;
//         var_r4_3 = &groundCollLine[temp_r3_4->left_wall_start];
//         if (temp_r5_3 > 0) {
//             temp_r0_3 = (u32) var_r3_3 >> 3U;
//             var_ctr_5 = temp_r0_3;
//             if (temp_r0_3 != 0) {
//                 do {
//                     var_r4_3->flags &= 0xFFFEFFFF;
//                     var_r4_3->unkC = (s32) (var_r4_3->unkC & 0xFFFEFFFF);
//                     var_r4_3->unk14 = (s32) (var_r4_3->unk14 & 0xFFFEFFFF);
//                     var_r4_3->unk1C = (s32) (var_r4_3->unk1C & 0xFFFEFFFF);
//                     var_r4_3->unk24 = (s32) (var_r4_3->unk24 & 0xFFFEFFFF);
//                     var_r4_3->unk2C = (s32) (var_r4_3->unk2C & 0xFFFEFFFF);
//                     var_r4_3->unk34 = (s32) (var_r4_3->unk34 & 0xFFFEFFFF);
//                     var_r4_3->unk3C = (s32) (var_r4_3->unk3C & 0xFFFEFFFF);
//                     var_r4_3 += 0x40;
//                     var_ctr_5 -= 1;
//                 } while (var_ctr_5 != 0);
//                 var_r3_3 &= 7;
...
//             }
//         }
//         temp_r3_5 = temp_r4->coll_data;
//         temp_r5_4 = temp_r3_5->right_wall_count;
//         var_r3_4 = temp_r5_4;
//         var_r4_4 = &groundCollLine[temp_r3_5->right_wall_start];
//         if (temp_r5_4 > 0) {
//             temp_r0_4 = (u32) var_r3_4 >> 3U;
//             var_ctr_7 = temp_r0_4;
//             if (temp_r0_4 != 0) {
//                 do {
//                     var_r4_4->flags &= 0xFFFEFFFF;
//                     var_r4_4->unkC = (s32) (var_r4_4->unkC & 0xFFFEFFFF);
//                     var_r4_4->unk14 = (s32) (var_r4_4->unk14 & 0xFFFEFFFF);
//                     var_r4_4->unk1C = (s32) (var_r4_4->unk1C & 0xFFFEFFFF);
//                     var_r4_4->unk24 = (s32) (var_r4_4->unk24 & 0xFFFEFFFF);
//                     var_r4_4->unk2C = (s32) (var_r4_4->unk2C & 0xFFFEFFFF);
//                     var_r4_4->unk34 = (s32) (var_r4_4->unk34 & 0xFFFEFFFF);
//                     var_r4_4->unk3C = (s32) (var_r4_4->unk3C & 0xFFFEFFFF);
//                     var_r4_4 += 0x40;
//                     var_ctr_7 -= 1;
//                 } while (var_ctr_7 != 0);
//                 var_r3_4 &= 7;
...
//             }
//         }
//         temp_r3_6 = temp_r4->coll_data;
//         temp_r5_5 = temp_r3_6->x12_line_cnt;
//         var_r3_5 = temp_r5_5;
//         var_r4_5 = &groundCollLine[temp_r3_6->x10_line_id];
//         if (temp_r5_5 > 0) {
//             temp_r0_5 = (u32) var_r3_5 >> 3U;
//             var_ctr_9 = temp_r0_5;
//             if (temp_r0_5 != 0) {
//                 do {
//                     var_r4_5->flags &= 0xFFFEFFFF;
//                     var_r4_5->unkC = (s32) (var_r4_5->unkC & 0xFFFEFFFF);
//                     var_r4_5->unk14 = (s32) (var_r4_5->unk14 & 0xFFFEFFFF);
//                     var_r4_5->unk1C = (s32) (var_r4_5->unk1C & 0xFFFEFFFF);
//                     var_r4_5->unk24 = (s32) (var_r4_5->unk24 & 0xFFFEFFFF);
//                     var_r4_5->unk2C = (s32) (var_r4_5->unk2C & 0xFFFEFFFF);
//                     var_r4_5->unk34 = (s32) (var_r4_5->unk34 & 0xFFFEFFFF);
//                     var_r4_5->unk3C = (s32) (var_r4_5->unk3C & 0xFFFEFFFF);
//                     var_r4_5 += 0x40;
//                     var_ctr_9 -= 1;
//                 } while (var_ctr_9 != 0);
//                 var_r3_5 &= 7;
...
//             }
//         }
//         temp_r5_6 = temp_r4->coll_data;
//         mpIsland_8005B334(arg0, (s32) temp_r5_6->point_start, (s32)
//         temp_r5_6->point_count, 0); temp_r4->unkE = (u8) (temp_r4->unkE |
//         0x80);
//     }
// }
...
void mpLib_80057FDC(int index)
{
    ...
    mpIsland_8005B334(index, temp_r5->point_start, temp_r5->point_count,
                      var_r6);
}
...
void mpLib_800581DC(int j0_idx, int j1_idx)
{
    ...
    start0 = cd0->point_start; /*  r4 */
    count0 = cd0->point_count; /* r31 */
    ...
    for (i = 0; i < count0; i++) {
        ...
        int idx;
        int start1_r4;
        start1_r4 = j1_r10->coll_data->point_start;
        count1 = j1_r10->coll_data->point_count;
        idx = start1_r4;
        var_r26 = start1_r4;
        for (v = 0; v < count1; v++, idx++, var_r26++) {
            ...
            for (var_r25 = 0; var_r25 < 5; var_r25++) {
                ...
                for (i_r23 = 0; i_r23 < count_r22; i_r23++) {
                    ...
                    s16 count_r17;
                    CollLine* iter_r3;
                    if (start0 + i == lines[i_r23].x0->p0_idx) {
                        for (j = 0; j < 5; j++) {
                            int k;
                            start_r20 =
                    ...
                    } else if (start0 + i == lines[i_r23].x0->p1_idx) {
                        for (j = 0; j < 5; j++) {
                            int k;
                            count_r17 =
                                ((struct pair*) j1_r10->coll_data)[j].count;
    ...
    for (i = 0; i < count_r8; i++, joint_r7++) {
...

        {
            ...
            block_8:
                ...
                p0 = &groundCollVtx[line_r31->x0->p0_idx];
                p1 = &groundCollVtx[line_r31->x0->p1_idx];
                x0 = p0->pos.x;
                y0 = p0->pos.y;
                x1 = p1->pos.x;
                y1 = p1->pos.y;
    ...
    for (i = 0; i < total_r27; i++) {
        if (line_r31->flags & 0x10000 && !(line_r31->flags & 0x40000)) {
            if (value == (line_r31->x0->flags & flag)) {
                PAD_STACK(8);
                GXPosition3f32(groundCollVtx[line_r31->x0->p0_idx].pos.x,
                               groundCollVtx[line_r31->x0->p0_idx].pos.y,
                               25.0F);
                GXPosition3f32(groundCollVtx[line_r31->x0->p1_idx].pos.x,
                               groundCollVtx[line_r31->x0->p1_idx].pos.y,
                               25.0F);
                GXPosition3f32(groundCollVtx[line_r31->x0->p1_idx].pos.x,
                               groundCollVtx[line_r31->x0->p1_idx].pos.y,
                               -25.0F);
    ...
    if (total_r29 != 0) {
        ...
        for (i = 0; i < count_r30; i++) {
            if (line_r7->flags & 0x10000 && !(line_r7->flags & 0x40000)) {
                GXPosition3f32(groundCollVtx[line_r7->x0->p0_idx].pos.x,
                               groundCollVtx[line_r7->x0->p0_idx].pos.y,
                               25.0F);
                GXPosition3f32(groundCollVtx[line_r7->x0->p1_idx].pos.x,
                               groundCollVtx[line_r7->x0->p1_idx].pos.y,
                               25.0F);
                GXPosition3f32(groundCollVtx[line_r7->x0->p1_idx].pos.x,
                               groundCollVtx[line_r7->x0->p1_idx].pos.y,
                               -25.0F);
