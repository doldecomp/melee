...
static s16 mpLib_ItemSpawnVtxIds[0xAE] = {
    ...
    0xEE, 0xEF, 0xF0, 0xF1, 0xF2, 0xF3, 0xF4, 0,
...
#define mpLib_EnemySpawnVtxIds (mpLib_ItemSpawnVtxIds + 0x16)
#define mpLib_TrophySpawnVtxIds (mpLib_ItemSpawnVtxIds + 0x66)
#define mpLib_ExitVtxIds (mpLib_ItemSpawnVtxIds + 0x80)
