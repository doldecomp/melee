                  ...
                  Fighter_GObj* gobj)
{
    ...
    for (joint = jointListStart; joint != NULL; joint = joint->next) {
        ...
        block_8:
            ...
            if (line_id_skip == (line_offset = (s32) line_r26 -
                                 (s32) groundCollLine) / 8)
            {
                continue;
            }
...
void mpLib_80055E9C(int joint_id)
{
    ...
    }
    {
        mtx = HSD_JObjGetMtxPtr(jobj);
        f1 = mpLib_804D8050;
        if (f1 != mtx[0][1] || f1 != mtx[0][2] ||
            f1 != mtx[1][0] || f1 != mtx[1][2] ||
            f1 != mtx[2][0] || f1 != mtx[2][1])
        {
...
void mpLib_80058820(void)
{
    ...
    box[0].right = mpLib_804D80AC;
    box[0].top = mpLib_804D80AC;
    box[0].left = mpLib_804D80B8;
    box[0].bottom = mpLib_804D80B8;
    box[1] = box[0];
}
...
{
    GXColor sp110 = mpLib_804D80E0;
    GXColor sp10C = mpLib_804D80E4;
    HSD_GObj* item_r28;
    HSD_GObj* ft_r27;
    bool var_r31;
...
void mpLib_DrawCrosses(s16* idx, int len, GXColor arg2)
{
    ...
    for (var_r31 = &idx[var_r28 = 0], len_r27 = 0;
         var_r28 < len && len_r27 < 0x80; var_r28++) {
...
static s16 mpLib_ItemSpawnVtxIds[] = {
    ...
    0x8A, 0x8B, 0x8C, 0x8D, 0x8E, 0x8F, 0x90, 0x91, 0x92, 0x93, 0,
