...
static struct mpLib_803BF248_t mpLib_803BF248[0x47] = {
    { GrKind_Unk00, &mpLib_803BDC18 }, { TEST, &mpLib_803BDC68 },
    { CASTLE, &mpLib_803BDCB8 },       { RCRUISE, &mpLib_803BDD08 },
    { KONGO, &mpLib_803BDD58 },        { GARDEN, &mpLib_803BDDA8 },
    { GREATBAY, &mpLib_803BDDF8 },     { SHRINE, &mpLib_803BDE48 },
    { ZEBES, &mpLib_803BDE98 },        { KRAID, &mpLib_803BDEE8 },
    { STORY, &mpLib_803BDF38 },        { YORSTER, &mpLib_803BDF88 },
    { IZUMI, &mpLib_803BDFD8 },        { GREENS, &mpLib_803BE028 },
    { CORNERIA, &mpLib_803BE078 },     { VENOM, &mpLib_803BE0C8 },
    { PSTADIUM, &mpLib_803BE118 },     { PURA, &mpLib_803BE168 },
    { MUTECITY, &mpLib_803BE1B8 },     { BIGBLUE, &mpLib_803BE208 },
    { ONETT, &mpLib_803BE258 },        { FOURSIDE, &mpLib_803BE2A8 },
    { ICEMTN, &mpLib_803BE2F8 },       { GrKind_Unk23, &mpLib_803BE348 },
    { INISHIE1, &mpLib_803BE398 },     { INISHIE2, &mpLib_803BE3E8 },
    { GrKind_Unk26, &mpLib_803BE438 }, { FLATZONE, &mpLib_803BE488 },
    { OLDPUPUPU, &mpLib_803BE4D8 },    { OLDYOSHI, &mpLib_803BE528 },
    { OLDKONGO, &mpLib_803BE578 },     { KINOKOROUTE, &mpLib_803BE5C8 },
    { SHRINEROUTE, &mpLib_803BE618 },  { ZEBESROUTE, &mpLib_803BE668 },
    { BIGBLUEROUTE, &mpLib_803BE6B8 }, { GrKind_Unk35, &mpLib_803BE708 },
    { BATTLE, &mpLib_803BE758 },       { LAST, &mpLib_803BE7A8 },
    { FIGUREGET, &mpLib_803BE7F8 },    { PUSHON, &mpLib_803BE848 },
    { TMARIO, &mpLib_803BE898 },       { TCAPTAIN, &mpLib_803BE8E8 },
    { TCLINK, &mpLib_803BE938 },       { TDONKEY, &mpLib_803BE988 },
    { TDRMARIO, &mpLib_803BE9D8 },     { TFALCO, &mpLib_803BEA28 },
    { TFOX, &mpLib_803BEA78 },         { TICECLIMBER, &mpLib_803BEAC8 },
    { TKIRBY, &mpLib_803BEB18 },       { TKOOPA, &mpLib_803BEB68 },
    { TLINK, &mpLib_803BEBB8 },        { TLUIGI, &mpLib_803BEC08 },
    { TMARS, &mpLib_803BEC58 },        { TMEWTWO, &mpLib_803BECA8 },
    { TNESS, &mpLib_803BECF8 },        { TPEACH, &mpLib_803BED48 },
    { TPICHU, &mpLib_803BED98 },       { TPIKACHU, &mpLib_803BEDE8 },
    { TPURIN, &mpLib_803BEE38 },       { TSAMUS, &mpLib_803BEE88 },
    { TSEAK, &mpLib_803BEED8 },        { TYOSHI, &mpLib_803BEF28 },
    { TZELDA, &mpLib_803BEF78 },       { TGAMEWATCH, &mpLib_803BEFC8 },
    { TEMBLEM, &mpLib_803BF018 },      { TGANON, &mpLib_803BF068 },
    { HEAL, &mpLib_803BF0B8 },         { HOMERUN, &mpLib_803BF108 },
    { FIGURE1, &mpLib_803BF158 },      { FIGURE2, &mpLib_803BF1A8 },
