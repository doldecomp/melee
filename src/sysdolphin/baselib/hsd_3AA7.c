    ...
    while (1) {
        ...
        case 0:
            ...
            if (hsd_804D7990 != hsd_804D7994 ||
                ((CardWork*) op)->cmd_queue[hsd_804D7990].type != 0)
            {
                result = fn_803AA790();
                if (result >= 0) {
                    hsd_804D799C = 0;
...
s32 fn_803AE7F8(struct CardState* arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4)
{
    ...
    {
        s32 loaded_size = state->x4C[arg1];
    ...
    if (file_size <= 0) {
        ...
        u32 sector_size = state->x8;
        s32 rem = state->x4C[0] - (s32) ((sector_size - 0x20) -
...
static inline void fn_803AF3F0_file_size(s32 arg1, CardState* state,
                                         s32* file_size)
{
    {
...
s32 fn_803AF3F0(s32 arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4)
{
    ...
    fn_803AF3F0_file_size(arg1, state, &file_size);
    if (file_size <= 0) {
        file_blocks = 0;
    } else if (arg1 == 0) {
        u32 sector_size = state->x8;
...
static inline void fn_803B0120_blk97637(s32 arg1, CardState* state,
                                        s32* file_size)
{
    {
        s32 size = state->x4C[arg1];
                ...
                s32 callback)
{
    ...
    for (i = 0, hsd_804D7998 = hsd_804D7984;
         i < (0x2F + state->x24 + state->x8) / state->x8;)
    {
        buf[0] = 11;
        buf[1] = (s32) state;
        buf[2] = (s32) i;
