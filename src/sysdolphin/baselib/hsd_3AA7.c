                                        ...
                                        s32 remaining)
{
    ...
    return remaining -
           (s32) (usable - (file_desc->x24 + 48) % sector_size);
}
                ...
                void* expected_data, s32 data_size)
{
    ...
    retries = 0;
    buf = state->x0;
    offset = state->x24 + sector_size;
    offset = (offset + 0x2F) / sector_size;
                ...
                void* payload, s32 payload_size, s32 version)
{
    ...
    fn_803AC3F8(state, fn_803ACFC0_header(state, hdr_offset) + 0x13,
                version);
...
s32 fn_803ADF90(struct CardState* arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4)
{
    ...
    if (file_size <= 0) {
        ...
        s32 rem = state->x4C[0] -
                  (s32) ((sector_size - 0x20) -
                         (state->x24 + 0x30) % sector_size);
        if (rem <= 0) {
            file_blocks = 1;
        } else {
            file_blocks = (u32) (rem + sector_size - 0x21) /
                          (sector_size - 0x20) + 1;
        }
    } else {
        u32 sector_size = state->x8;
        file_blocks = (u32) (remaining + sector_size - 0x21) /
                      (sector_size - 0x20);
    }
...
s32 fn_803B0120(s32 arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4)
{
    ...
    if (file_size <= 0) {
        ...
        u32 sector_size = state->x8;
        file_blocks = (u32) (file_size + sector_size - 0x21) /
                      (sector_size - 0x20);
    }
        ...
        for (i = 0; i < file_blocks && remaining > 0; i++) {
            ...
            if (remaining > chunk) {
                if (arg3 != 0) {
                    ...
                    result = fn_803ACC0C(state, block_map[0][i], blocks_before + i,
                                         current_seq, data, chunk);
                    if (result < 0) {
                        s32 retries;
                        for (retries = 0; retries < 10; retries++) {
    ...
    for (i = 0; i < file_blocks && remaining > 0; i++) {
        ...
        if (remaining > chunk) {
            if (arg3 != 0) {
                s32 ofs = fn_803ACBE8(state, block_map[0][i]);
                if (block_map[0][i] == 0 && blocks_before + i != 0) {
                    result = -0x101;
                } else {
                    if (block_map[0][i] == 0) {
                        s32 cmd[9];
    ...
    while (secondary_count > 0) {
        ...
        if (arg3 != 0) {
            ...
            result = fn_803ACFC0(state, block_map[1][secondary_count], 0xFFFF, 0,
                                 NULL, 0, arg1);
...
s32 fn_803B0E9C(struct CardState* arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4)
{
    ...
    if (arg0->x24 + 0x30 < sector_size) {
        if (arg3 != 0) {
            ...
            for (retries = 0; retries < 10; retries++) {
                result =
                    CARDRead(&arg0->file_info, arg0->x0, sector_size, 0);
                if (result != -1) {
                    break;
                }
            }
    ...
    while (remaining >= 0) {
        ...
        if ((u32) (payload_pos + remaining) > sector_size) {
            ...
            memcpy(arg0->x0 + payload_pos, (void*) arg2, copied);
            arg2 += copied;
            remaining -= copied;
