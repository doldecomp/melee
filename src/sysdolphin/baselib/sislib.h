...
typedef struct sislib_UnkAllocReturn sislib_UnkAllocReturn;
...
struct sislib_UnkAllocData {
    ...
    sislib_UnkAllocReturn* data_1;
    u32 size;
};

// @todo: this is probably what gets put in gobj user_data
struct sislib_UnkAllocReturn {
    f32 x0;
    f32 x4;
    f32 x8;
    f32 xC;
...
void HSD_SisLib_803A84BC(HSD_GObj*, sislib_UnkAllocReturn*);
s32 HSD_SisLib_803A7F0C(sislib_UnkAllocReturn*, s32);
void HSD_SisLib_803A8134(void*, sislib_UnkAllocReturn*, f32*, f32*);
...
void HSD_SisLib_803A74F0(sislib_UnkAllocReturn*, s32 arg1, u8* arg2);
void HSD_SisLib_803A746C(sislib_UnkAllocReturn*, s32, f32, f32);
...
void HSD_SisLib_803A6368(sislib_UnkAllocReturn*, s32);
void HSD_SisLib_803A62A0(s32, HSD_Archive*, char*);
s32 HSD_SisLib_803A611C(u16, u32, u16, u8, u8, u8, u8, u32);
void lbl_803A60EC(void);
sislib_UnkAllocReturn* HSD_SisLib_803A5ACC(s8, s32, f32, f32, f32, f32, f32);
void* HSD_SisLib_803A5798(s32);
void HSD_SisLib_803A594C(void*);
void HSD_SisLib_803A5CC4(sislib_UnkAllocReturn*);
void HSD_SisLib_803A5A2C(sislib_UnkAllocReturn*);
