...
void test_s16(s16 h) {
    ...
    foo(sp8 / 360);
    foo(sp8 / 65534);
    temp_r3 = (u32) sp8 >> 0x1FU;
    foo(((sp8 & 1) ^ temp_r3) - temp_r3);
    foo(sp8 % 3);
    foo(sp8 % 5);
    foo(sp8 % 7);
    foo(sp8 % 10);
...
void test_s32_mod(s32 d) {
    ...
    foo(((sp8 & 1) ^ temp_r3) - temp_r3);
    foo(sp8 % 3);
    temp_r3_2 = (u32) d >> 0x1FU;
    temp_r0 = (d << 0x1E) - temp_r3_2;
    foo(((temp_r0 << 2) | (temp_r0 >> 0x1EU)) + temp_r3_2);
    foo(sp8 % 5);
    foo(sp8 % 6);
    foo(sp8 % 7);
    temp_r3_3 = (u32) d >> 0x1FU;
    temp_r0_2 = (d << 0x1D) - temp_r3_3;
    foo(((temp_r0_2 << 3) | (temp_r0_2 >> 0x1DU)) + temp_r3_3);
    foo(sp8 % 9);
    foo(sp8 % 10);
    foo(sp8 % 11);
    foo(sp8 % 12);
    ...
    foo(sp8 % 14);
    foo(sp8 % 15);
    temp_r3_4 = (u32) d >> 0x1FU;
    temp_r0_3 = (d << 0x1C) - temp_r3_4;
    foo(((temp_r0_3 << 4) | (temp_r0_3 >> 0x1CU)) + temp_r3_4);
    foo(sp8 % 17);
    foo(sp8 % 18);
    foo(sp8 % 19);
    foo(sp8 % 20);
    ...
    foo(sp8 % 30);
    foo(sp8 % 31);
    temp_r3_5 = (u32) d >> 0x1FU;
    temp_r0_4 = (d << 0x1B) - temp_r3_5;
    foo(((temp_r0_4 << 5) | (temp_r0_4 >> 0x1BU)) + temp_r3_5);
    foo(sp8 % 33);
    foo(sp8 % 100);
    foo(sp8 % 255);
    foo(sp8 % 360);
    ...
    foo(sp8 % 10000000);
    foo(sp8 % 100000000);
    temp_r3_6 = sp8 / 1073741822;
    foo(sp8 - ((temp_r3_6 + (temp_r3_6 >> 0x1FU)) * 0x3FFFFFFE));
    temp_r3_7 = sp8 / 1073741822;
    foo(sp8 - ((temp_r3_7 + (temp_r3_7 >> 0x1FU)) * 0x3FFFFFFF));
    temp_r3_8 = (u32) d >> 0x1FU;
    temp_r0_5 = (d * 4) - temp_r3_8;
    foo(((temp_r0_5 << 0x1E) | (temp_r0_5 >> 2U)) + temp_r3_8);
    temp_r3_9 = sp8 / 1073741824;
    foo(sp8 - ((temp_r3_9 + (temp_r3_9 >> 0x1FU)) * 0x40000001));
    temp_r3_10 = sp8 / 2147483648;
    foo(sp8 - ((temp_r3_10 + (temp_r3_10 >> 0x1FU)) * 0x7FFFFFFD));
    temp_r3_11 = sp8 / 2147483645;
    foo(sp8 - ((temp_r3_11 + (temp_r3_11 >> 0x1FU)) * 0x7FFFFFFE));
    temp_r3_12 = sp8 / 2147483648;
    foo(sp8 - ((temp_r3_12 + (temp_r3_12 >> 0x1FU)) * 0x7FFFFFFF));
    foo(sp8 % 2147483648);
    temp_r3_13 = sp8 / 715827883;
    foo(sp8 - ((temp_r3_13 + (temp_r3_13 >> 0x1FU)) * 0x80000001));
    temp_r3_14 = (s32) (MULT_HI(0x7FFFFFFD, sp8) - sp8) >> 0x1E;
    foo(sp8 - ((temp_r3_14 + ((u32) temp_r3_14 >> 0x1FU)) * 0x80000002));
...
void test_u32_mod(u32 u) {
    ...
    foo(sp8 % 1000);
    foo(sp8 % 10000);
    temp_r4 = MULTU_HI(0x4F8B588F, sp8);
    foo(sp8 - (((u32) (((u32) (sp8 - temp_r4) >> 1U) + temp_r4) >> 0x10U) * 0x186A0));
    foo(sp8 % 1000000);
    foo(sp8 % 10000000);
    foo(sp8 % 100000000);
    foo(sp8 & 0x3FFFFFFF);
